...
class UskillButton_C : public UUserWidget
{
    ...
    FString Name;                                                                     // 0x0300 (size: 0x10)
    int32 ID;                                                                         // 0x0310 (size: 0x4)
    class UTexture2D* skillIcon;                                                      // 0x0318 (size: 0x8)
    bool activated;                                                                   // 0x0320 (size: 0x1)
    int32 numSquadsToRemove;                                                          // 0x0324 (size: 0x4)
    TArray<int32> squadsToRemove;                                                     // 0x0328 (size: 0x10)
