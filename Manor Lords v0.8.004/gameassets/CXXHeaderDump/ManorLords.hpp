...
class ARTSMultiEngineCPP : public AActor
{
    ...
    TArray<class UStaticMesh*> youngTreeMeshes;                                       // 0x0620 (size: 0x10)
    TArray<class UStaticMesh*> treeMeshesTriggeringForestBiome;                       // 0x0630 (size: 0x10)
    TArray<class UStaticMesh*> fieldBorderMeshes;                                     // 0x0640 (size: 0x10)
    TArray<class UStaticMesh*> fieldstoneMeshes;                                      // 0x0650 (size: 0x10)
    TSubclassOf<class AResource> treeBP;                                              // 0x0660 (size: 0x8)
    TSubclassOf<class AResource> ironResourceBP;                                      // 0x0668 (size: 0x8)
    TSubclassOf<class AResource> stoneResourceBP;                                     // 0x0670 (size: 0x8)
    TSubclassOf<class AResource> beeResourceBP;                                       // 0x0678 (size: 0x8)
    TSubclassOf<class AResource> shrubResourceBP;                                     // 0x0680 (size: 0x8)
    TSubclassOf<class AResource> shroomResourceBP;                                    // 0x0688 (size: 0x8)
    TSubclassOf<class AResource> handcartResourceBP;                                  // 0x0690 (size: 0x8)
    TSubclassOf<class AResource> bigcartResourceBP;                                   // 0x0698 (size: 0x8)
    TSubclassOf<class AResource> fishResourceBP;                                      // 0x06A0 (size: 0x8)
    class AWeatherMaster* WMaster;                                                    // 0x06A8 (size: 0x8)
    TSubclassOf<class AActor> ThunderLightBP;                                         // 0x06B0 (size: 0x8)
    class APMaster* PMaster;                                                          // 0x06B8 (size: 0x8)
    class APawnCPP* playerRef;                                                        // 0x06C0 (size: 0x8)
    TArray<FPPStruct> PPoints;                                                        // 0x06C8 (size: 0x10)
    class USnapDebris* SnapDebris;                                                    // 0x06F8 (size: 0x8)
    float startleDist;                                                                // 0x0700 (size: 0x4)
    float startleDistSq;                                                              // 0x0704 (size: 0x4)
    class ASoundBuddy* SoundBuddy;                                                    // 0x0708 (size: 0x8)
    class UDataTable* DT_resourceSounds;                                              // 0x0710 (size: 0x8)
    TArray<class ASMUnit*> unitsMarkedForDestruction;                                 // 0x0718 (size: 0x10)
    class UParticleSystem* PS_dustPuff;                                               // 0x0728 (size: 0x8)
    class UParticleSystem* PS_BLoodSplatter;                                          // 0x0730 (size: 0x8)
    class UParticleSystem* PS_Thunder;                                                // 0x0738 (size: 0x8)
    class UParticleSystem* PS_dragDust;                                               // 0x0740 (size: 0x8)
    class UParticleSystem* PS_Impact_Smithing;                                        // 0x0748 (size: 0x8)
    class UParticleSystem* PS_Impact_Leaves;                                          // 0x0750 (size: 0x8)
    class UParticleSystem* PS_Impact_Wood;                                            // 0x0758 (size: 0x8)
    class UParticleSystem* PS_Impact_WoodDry;                                         // 0x0760 (size: 0x8)
    class UParticleSystem* PS_Impact_Stone;                                           // 0x0768 (size: 0x8)
    class UParticleSystem* PS_Impact_Plow;                                            // 0x0770 (size: 0x8)
    class UParticleSystem* PS_Impact_PloughHeavy;                                     // 0x0778 (size: 0x8)
    class UParticleSystem* PS_Impact_Sow;                                             // 0x0780 (size: 0x8)
    class UParticleSystem* PS_fireBig;                                                // 0x0788 (size: 0x8)
    class UParticleSystem* PS_fireGrid;                                               // 0x0790 (size: 0x8)
    class UParticleSystem* PS_fireplaceSmoke;                                         // 0x0798 (size: 0x8)
    class UParticleSystem* PS_chimneySmoke;                                           // 0x07A0 (size: 0x8)
    class UParticleSystem* PS_malthouseSmoke;                                         // 0x07A8 (size: 0x8)
    class UParticleSystem* PS_Splash;                                                 // 0x07B0 (size: 0x8)
    class UParticleSystem* PS_BucketSplash;                                           // 0x07B8 (size: 0x8)
    class UParticleSystem* PS_FlourPuff;                                              // 0x07C0 (size: 0x8)
    class UParticleSystem* PS_ThunderHit;                                             // 0x07C8 (size: 0x8)
    class UParticleSystem* PS_FieryHit;                                               // 0x07D0 (size: 0x8)
    class UParticleSystem* PS_Bees;                                                   // 0x07D8 (size: 0x8)
    class UParticleSystem* PS_TorchImpact;                                            // 0x07E0 (size: 0x8)
    class UParticleSystem* PS_fallingLeaves;                                          // 0x07E8 (size: 0x8)
    TArray<FUpgrade> upgrades;                                                        // 0x07F0 (size: 0x10)
    int32 predictionCalculationDays;                                                  // 0x0800 (size: 0x4)
    float locationUpdateCounter;                                                      // 0x0804 (size: 0x4)
    TArray<class ASMBuildingMaster*> fieldArr;                                        // 0x0808 (size: 0x10)
    class UMaterialInterface* fieldRTmat;                                             // 0x0818 (size: 0x8)
    class UMaterialInterface* M_marketDecalMat;                                       // 0x0820 (size: 0x8)
    class UMaterialInterface* workDecalMat;                                           // 0x0828 (size: 0x8)
    class UMaterialInterface* moduleMaskMaterial;                                     // 0x0830 (size: 0x8)
    class UMaterialInterface* M_overlay_moduleMasks;                                  // 0x0838 (size: 0x8)
    class UMaterialInterface* M_overlay_fertility;                                    // 0x0840 (size: 0x8)
    int32 updatePosLag;                                                               // 0x0848 (size: 0x4)
    int32 lastUniqueID;                                                               // 0x084C (size: 0x4)
    TArray<int32> tradeableGoods;                                                     // 0x0850 (size: 0x10)
    TArray<int32> foodTypes;                                                          // 0x0860 (size: 0x10)
    TArray<int32> spoilingGoodTypes;                                                  // 0x0870 (size: 0x10)
    TArray<int32> granaryCollectionTypes;                                             // 0x0880 (size: 0x10)
    TArray<class UStaticMesh*> treeMeshes;                                            // 0x0890 (size: 0x10)
    TArray<class UStaticMesh*> shrubMeshes;                                           // 0x08A0 (size: 0x10)
    TArray<class UStaticMesh*> oreMeshes;                                             // 0x08B0 (size: 0x10)
    TArray<class ADepositDecal*> deposits;                                            // 0x08C0 (size: 0x10)
    class UTexture2D* depositMask;                                                    // 0x08D0 (size: 0x8)
    class UMaterialInterface* depositMaterial;                                        // 0x08D8 (size: 0x8)
    class UMaterialInterface* depositMaterial_Salt;                                   // 0x08E0 (size: 0x8)
    class UMaterialInterface* depositMaterial_Clay;                                   // 0x08E8 (size: 0x8)
    TArray<FName> recruitmentPool;                                                    // 0x08F0 (size: 0x10)
    TArray<class ASMBuildingMaster*> tradepoints;                                     // 0x0900 (size: 0x10)
    float basePrice;                                                                  // 0x0910 (size: 0x4)
    class UDataTable* DT_units;                                                       // 0x0918 (size: 0x8)
    float roadRadius;                                                                 // 0x0920 (size: 0x4)
    bool fogOfWar;                                                                    // 0x0924 (size: 0x1)
    TArray<FProximityCache> ProximityCache;                                           // 0x0928 (size: 0x10)
    int32 proximityCacheIterationID;                                                  // 0x0938 (size: 0x4)
    FTimerHandle ambientVoiceHandle;                                                  // 0x0940 (size: 0x8)
    FTimerHandle taskUpdateHandle;                                                    // 0x0948 (size: 0x8)
    int32 taskIteratorID;                                                             // 0x0950 (size: 0x4)
    FTimerHandle projUpdateHandle;                                                    // 0x0958 (size: 0x8)
    class UDataTable* DT_paragraphs;                                                  // 0x0960 (size: 0x8)
    TArray<FRelation> relations;                                                      // 0x0968 (size: 0x10)
    float mapSize;                                                                    // 0x0978 (size: 0x4)
    TSubclassOf<class UBannerAnimInstance> bannerAnimBP;                              // 0x0980 (size: 0x8)
    TSubclassOf<class ASMBanner> bannerBP;                                            // 0x0990 (size: 0x8)
    TArray<FOpenClaim> openClaims;                                                    // 0x0998 (size: 0x10)
    int32 kingsFavour_daysLeft;                                                       // 0x09A8 (size: 0x4)
    TArray<class APawnCPP*> kingsFavourite;                                           // 0x09B0 (size: 0x10)
    class UMaterialInterface* ghostMaterial;                                          // 0x09C0 (size: 0x8)
    class UDataTable* DT_MercenaryCompanies;                                          // 0x09C8 (size: 0x8)
    TArray<FMercenaryCompany> availableMercs;                                         // 0x09D0 (size: 0x10)
    TArray<FMercenaryCompany> hiredMercs;                                             // 0x09E0 (size: 0x10)
    TArray<class UTexture2D*> availableLordPortraits;                                 // 0x09F0 (size: 0x10)
    TArray<class UTexture2D*> availableBanditPortraits;                               // 0x0A00 (size: 0x10)
    bool prepareRoadsForEditor;                                                       // 0x0A10 (size: 0x1)
    bool enableFertilityGrid;                                                         // 0x0A11 (size: 0x1)
    TArray<FLinearColor> fertilityGrid;                                               // 0x0A18 (size: 0x10)
    TArray<FLinearColor> fertilityGridLimits;                                         // 0x0A28 (size: 0x10)
    bool instancePositionUpdate;                                                      // 0x0A58 (size: 0x1)
    float deltaDiff;                                                                  // 0x0A5C (size: 0x4)
    TArray<int32> AI_buildingTypes;                                                   // 0x0A60 (size: 0x10)
    TArray<class ASMUnit*> livestockMerchants;                                        // 0x0A70 (size: 0x10)
    TArray<class ASMUnit*> freeMerchants;                                             // 0x0A80 (size: 0x10)
    int32 traderTimer;                                                                // 0x0A90 (size: 0x4)
    bool isConstructionAllowed;                                                       // 0x0A94 (size: 0x1)
    bool dustyMap;                                                                    // 0x0A95 (size: 0x1)
    bool spawnMerchants;                                                              // 0x0A96 (size: 0x1)
    bool canRain;                                                                     // 0x0A97 (size: 0x1)
    bool canSnow;                                                                     // 0x0A98 (size: 0x1)
    FTimerHandle updateArmiesHandle;                                                  // 0x0AA0 (size: 0x8)
    TArray<class ASmoothForce*> smoothForces;                                         // 0x0AA8 (size: 0x10)
    TSubclassOf<class ADecalActor> bloodDecalBP;                                      // 0x0AB8 (size: 0x8)
    TArray<int32> heads_combat;                                                       // 0x0AC0 (size: 0x10)
    bool drawBattleDebug;                                                             // 0x0AD8 (size: 0x1)
    bool drawImportantDebug;                                                          // 0x0AD9 (size: 0x1)
    bool drawPathfindingDebug;                                                        // 0x0ADA (size: 0x1)
    bool drawDebg_roadGuidePoints;                                                    // 0x0ADB (size: 0x1)
    class UMaterialInterface* plagueDecalMat;                                         // 0x0AE0 (size: 0x8)
    TArray<FString> maleNames;                                                        // 0x0AE8 (size: 0x10)
    bool spawnAIPlayers;                                                              // 0x0AF8 (size: 0x1)
    bool declareWarInstant;                                                           // 0x0AF9 (size: 0x1)
    bool AI_canBuild;                                                                 // 0x0AFA (size: 0x1)
    bool unitJustSpawned;                                                             // 0x0AFB (size: 0x1)
    TArray<FVein> veins;                                                              // 0x0B00 (size: 0x10)
    class UMaterialInterface* boundsDecalMatRoadsOK;                                  // 0x0B10 (size: 0x8)
    class UStaticMesh* sidewalkMesh;                                                  // 0x0B18 (size: 0x8)
    class UStaticMesh* SM_fence;                                                      // 0x0B20 (size: 0x8)
    class UStaticMesh* SM_fence_B;                                                    // 0x0B28 (size: 0x8)
    class UStaticMesh* SM_plankFence;                                                 // 0x0B30 (size: 0x8)
    class UStaticMesh* townwallMesh;                                                  // 0x0B38 (size: 0x8)
    class UStaticMesh* SM_palisade;                                                   // 0x0B40 (size: 0x8)
    class UStaticMesh* SM_stoneWall;                                                  // 0x0B48 (size: 0x8)
    TArray<class UStaticMesh*> SM_stoneWall_pieces;                                   // 0x0B50 (size: 0x10)
    TArray<class UStaticMesh*> SM_stoneWall_platforms;                                // 0x0B60 (size: 0x10)
    TArray<class UStaticMesh*> doorMeshes;                                            // 0x0B70 (size: 0x10)
    TArray<class UStaticMesh*> stairMeshesWooden;                                     // 0x0B80 (size: 0x10)
    TArray<class UStaticMesh*> stairMeshesStone;                                      // 0x0B90 (size: 0x10)
    class UStaticMesh* SM_storage_log;                                                // 0x0BA0 (size: 0x8)
    class USkeletalMesh* SM_banner;                                                   // 0x0BA8 (size: 0x8)
    class UDataTable* DT_Upgrades;                                                    // 0x0BB0 (size: 0x8)
    class UStaticMesh* borderSegmentMesh;                                             // 0x0BB8 (size: 0x8)
    class UStaticMesh* SM_FatRoad;                                                    // 0x0BC0 (size: 0x8)
    class UStaticMesh* SM_shrubbyMesh;                                                // 0x0BC8 (size: 0x8)
    TArray<int32> snapPointsToVerify;                                                 // 0x0BD0 (size: 0x10)
    TArray<int32> snapPointsToBeingVerifiedAsync;                                     // 0x0BE0 (size: 0x10)
    TArray<FFieldSnapPoint> fieldSnapPoints;                                          // 0x0BF0 (size: 0x10)
    TArray<class UHierarchicalInstancedStaticMeshComponent*> hismPtrCache;            // 0x0C00 (size: 0x10)
    float lastVeloUpdTime;                                                            // 0x0C10 (size: 0x4)
    FTimerHandle propagationHandle;                                                   // 0x0C18 (size: 0x8)
    TArray<class UParticleSystemComponent*> spawnedVfx;                               // 0x0C20 (size: 0x10)
    TArray<FDefferedMeshLoadItem> deferredMeshLoadList;                               // 0x0C30 (size: 0x10)
    TArray<FObstacle2D> obstacles;                                                    // 0x0C50 (size: 0x10)
    TArray<FObstacle2D> cachedBuildingBorderRoadObstacles;                            // 0x0C60 (size: 0x10)
    class URuntimeVirtualTexture* RVT_Landscape;                                      // 0x0C70 (size: 0x8)
    class URuntimeVirtualTexture* RVT_RoadMask;                                       // 0x0C78 (size: 0x8)
    class URuntimeVirtualTexture* RVT_Heightmap;                                      // 0x0C80 (size: 0x8)
    class URuntimeVirtualTexture* RVT_ModuleMask;                                     // 0x0C88 (size: 0x8)
    class URuntimeVirtualTexture* RVT_SnowDisplacementMask;                           // 0x0C90 (size: 0x8)
    class UMaterialInterface* fieldMaskMaterial;                                      // 0x0C98 (size: 0x8)
    class UMaterialInterface* marketMaskMaterial;                                     // 0x0CA0 (size: 0x8)
    class UMaterialInterface* vegetableFieldMat;                                      // 0x0CA8 (size: 0x8)
    TArray<int32> cliffObstacles;                                                     // 0x0CB0 (size: 0x10)
    TArray<FRoadGuidePoint> roadGuidePoints;                                          // 0x0CC0 (size: 0x10)
    TArray<int32> roadGuidePointsToVerify;                                            // 0x0CD0 (size: 0x10)
    class UDataTable* DT_BuildingPartAssemblies;                                      // 0x0CE0 (size: 0x8)
    class UDataTable* DT_BuildingPartMeshes;                                          // 0x0CE8 (size: 0x8)
    class UDataTable* DT_gameplayStaticMeshes;                                        // 0x0CF0 (size: 0x8)
    TMap<class FName, class FSoftClassPath> independentBuildingAssemblies;            // 0x0CF8 (size: 0x50)
    TMap<class FName, class FSoftClassPath> animatedBuildingBlueprints;               // 0x0D48 (size: 0x50)
    TArray<class UStaticMesh*> plantMeshes;                                           // 0x0D98 (size: 0x10)
    TArray<class UStaticMesh*> lazyBuildings;                                         // 0x0DA8 (size: 0x10)
    class UStaticMesh* SM_wheat;                                                      // 0x0DB8 (size: 0x8)
    class UStaticMesh* SM_flax;                                                       // 0x0DC0 (size: 0x8)
    class UStaticMesh* SM_willowBranches;                                             // 0x0DC8 (size: 0x8)
    class UStaticMesh* SM_herbs;                                                      // 0x0DD0 (size: 0x8)
    class UStaticMesh* SM_appleTree;                                                  // 0x0DD8 (size: 0x8)
    class UStaticMesh* SM_appleTree_old;                                              // 0x0DE0 (size: 0x8)
    int32 newChallengeID;                                                             // 0x0DE8 (size: 0x4)
    TArray<FChallenge> challenges;                                                    // 0x0DF0 (size: 0x10)
    TArray<class ASMBuildingMaster*> retinueSpawnRequests;                            // 0x0E00 (size: 0x10)
    TArray<class UTexture2D*> regimentSymbols;                                        // 0x0E30 (size: 0x10)
    class UStaticMesh* empty_instance;                                                // 0x0E40 (size: 0x8)
    class UStaticMesh* SM_dirtPlane;                                                  // 0x0E48 (size: 0x8)
    TArray<class UStaticMesh*> SM_AnimalTraps;                                        // 0x0E50 (size: 0x10)
    TArray<class UStaticMesh*> wallMeshes;                                            // 0x0E60 (size: 0x10)
    uint8 numSpawnedGenericAIs;                                                       // 0x0E70 (size: 0x1)
    class ADirector* questDirector;                                                   // 0x0E78 (size: 0x8)
    float lastObstructionYaw;                                                         // 0x0E80 (size: 0x4)
    float ppAbsoluteMaxConnectionDist;                                                // 0x0E84 (size: 0x4)
    float ppAbsoluteMaxConnectionDistSq;                                              // 0x0E88 (size: 0x4)
    float ppGridDensity;                                                              // 0x0E8C (size: 0x4)
    TArray<int32> edgePPGridPointIDs;                                                 // 0x0E90 (size: 0x10)
    FTimerHandle fertilityRedrawHandle;                                               // 0x0EA0 (size: 0x8)
    TArray<int32> fertilityGridUpdateRequests;                                        // 0x0EA8 (size: 0x10)
    TArray<FConnectionCache> roadConnectionCache;                                     // 0x0EB8 (size: 0x10)
    class UStaticMesh* workAreaMesh;                                                  // 0x0EC8 (size: 0x8)
    class UAnimSequenceBase* testAnimClip;                                            // 0x0ED0 (size: 0x8)
    class USkeletalMesh* testSzkeletalMesh;                                           // 0x0ED8 (size: 0x8)
    class UMaterialInterface* marketfieldMat;                                         // 0x0EE0 (size: 0x8)
    class UMaterialInterface* roadConnectionMat;                                      // 0x0EE8 (size: 0x8)
    TArray<class ASMBuilding*> spawnAsyncConstrBpQueue;                               // 0x0EF0 (size: 0x10)
    FTimerHandle spawnAsyncConstrBPHandle;                                            // 0x0F00 (size: 0x8)
    class UStaticMesh* wallMarker;                                                    // 0x0F08 (size: 0x8)
    class UStaticMesh* gatehousePreviewMesh;                                          // 0x0F10 (size: 0x8)
    class UStaticMesh* randomFormationSocketMesh;                                     // 0x0F18 (size: 0x8)
    TArray<FVector> randomFormationPositions;                                         // 0x0F20 (size: 0x10)
    bool writeUnitDebugLogs;                                                          // 0x0F30 (size: 0x1)
    TArray<FName> drawDebugFlags;                                                     // 0x0F38 (size: 0x10)
    TArray<int32> disableJobIDs;                                                      // 0x0F48 (size: 0x10)
    bool writeDebugLogs;                                                              // 0x0F58 (size: 0x1)
    TArray<FString> debugLog_AI_general;                                              // 0x0F60 (size: 0x10)
    TArray<FString> debugLog_AI_tactics;                                              // 0x0F70 (size: 0x10)
    bool shouldUpdateDebugLog_generalAI;                                              // 0x0F80 (size: 0x1)
    bool shouldUpdateDebugLog_tacticsAI;                                              // 0x0F81 (size: 0x1)
    float gameSpeedScheduled;                                                         // 0x0F84 (size: 0x4)
    float gameSpeedBeforePause;                                                       // 0x0F88 (size: 0x4)
    bool isGameSpeedScheduled;                                                        // 0x0F8C (size: 0x1)
    float locomotionTicksAdjusted;                                                    // 0x0FA0 (size: 0x4)
    float locomotionTicksAdjustedPrevious;                                            // 0x0FA4 (size: 0x4)
    bool useLegacyVATM;                                                               // 0x0FA8 (size: 0x1)
    TMap<class EUnitRole, class FSoftClassPath> unitBlueprints;                       // 0x0FB0 (size: 0x50)
    TArray<FPopupCache> PopupCache;                                                   // 0x1050 (size: 0x10)
    FSessionAchievementData SessionAchievementData;                                   // 0x1060 (size: 0x30)
    TArray<FSpatialCell> SpatialGrid;                                                 // 0x1090 (size: 0x10)
    TArray<FPathRequest> asyncPathRequestsPending;                                    // 0x10B8 (size: 0x10)
    bool asyncLinkerCreated;                                                          // 0x1140 (size: 0x1)
    TArray<FQueuedLinkerDataEdit> queuedLinkerDataEdits;                              // 0x1148 (size: 0x10)
    TArray<FQueuedPathfinderDataEditCollection> pathfinerEditCollections;             // 0x1158 (size: 0x10)
    bool isNightAndAffectsGameplay;                                                   // 0x1168 (size: 0x1)
    TArray<FProceduralGroundCoverData> proceduralGroundCoverTypes;                    // 0x1170 (size: 0x10)
    TArray<class UInstancedStaticMeshComponent*> proceduralGroundCover;               // 0x1180 (size: 0x10)
    int32 numberOfCameraGroundCoverCellColumnsHalf;                                   // 0x1190 (size: 0x4)
    float cameraBasedGroundCoverCellSize;                                             // 0x1194 (size: 0x4)
    FTimerHandle cameraBasedGroundCoverHandle;                                        // 0x1198 (size: 0x8)
    TMap<class FVector, class EGroundCoverCategory> biomeCache;                       // 0x11A0 (size: 0x50)
    int32 cameraBasedGroundCoverComponentIterator;                                    // 0x11F0 (size: 0x4)
    bool cameraBasedGroundCoverComponentFlipFlop;                                     // 0x11F4 (size: 0x1)
    TArray<FBox2D> groundCoverOcclusionBoxes;                                         // 0x11F8 (size: 0x10)
    class UStaticMesh* groundCoverDistributionSocketMesh;                             // 0x1208 (size: 0x8)
    TArray<FVector> groundCoverDistributionSocketLocations;                           // 0x1210 (size: 0x10)
    TArray<EGroundCoverCategory> biomeCacheGrid;                                      // 0x1220 (size: 0x10)
    TArray<int32> biomeCacheUpdateRequests;                                           // 0x1230 (size: 0x10)
    FTimerHandle biomeCacheUpdateSlowHandle;                                          // 0x1240 (size: 0x8)
    FVector lastGroundCoverUpdateCameraLocation;                                      // 0x1248 (size: 0x18)
    TMap<FVector, float> groundCoverLandscapeHeightCache;                             // 0x1260 (size: 0x50)
    TArray<FTransformPairCollection> groundCoverLandscapeTransformCacheGrid;          // 0x12B0 (size: 0x10)
    class UStaticMesh* unitBannerMesh;                                                // 0x12C0 (size: 0x8)
    class UMaterialInterface* bouncedLightMaterial;                                   // 0x12D0 (size: 0x8)
    TArray<FCollisionCluster> collisionClusters;                                      // 0x12E8 (size: 0x10)
    TArray<class UVARuntimeComponent*> birdFlockVARuntimeComponents;                  // 0x1308 (size: 0x10)
    TArray<FName> tutorialsLeftToShow;                                                // 0x1320 (size: 0x10)
    TArray<FGood> foreignMarketSupply;                                                // 0x1330 (size: 0x10)
    TArray<class ASMBuildingMaster*> landscapeDeformationBuildings;                   // 0x1360 (size: 0x10)
    TArray<FTradeLogEntry> tradeLog;                                                  // 0x1370 (size: 0x10)
    TMap<class ASMBuildingMaster*, class USphereReflectionCaptureComponent*> reflectionSpheres; // 0x13A0 (size: 0x50)
...
class ARegion : public AActor
{
    ...
    TArray<class UInstancedStaticMeshComponent*> regionalFoliage;                     // 0x07E0 (size: 0x10)
    TArray<class UInstancedStaticMeshComponent*> treeComponents;                      // 0x07F0 (size: 0x10)
    TArray<class UInstancedStaticMeshComponent*> fieldstoneComponents;                // 0x0800 (size: 0x10)
