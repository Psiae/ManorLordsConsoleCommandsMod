...
class UstorageFilterGood_C : public UUserWidget
{
    ...
    class UImage* checkmark;                                                          // 0x02F0 (size: 0x8)
    class UImage* goodIcon;                                                           // 0x02F8 (size: 0x8)
    int32 ItemId;                                                                     // 0x0300 (size: 0x4)
    class ASMBuildingMaster* building;                                                // 0x0308 (size: 0x8)
    int32 marketNumStallsForThisGood;                                                 // 0x0310 (size: 0x4)
    int32 numAvailableGoodsForSale;                                                   // 0x0314 (size: 0x4)
