...
struct FALoadingScreenSettings
{
    ...
    FLoadingWidgetSettings LoadingWidget;                                             // 0x01F0 (size: 0x2F0)
    EAsyncLoadingScreenLayout Layout;                                                 // 0x04E0 (size: 0x1)
...
struct FCenterLayoutSettings
{
    ...
    FSlateBrush BorderBackground;                                                     // 0x0020 (size: 0xD0)
...
struct FDualSidebarLayoutSettings
{
    ...
    FSlateBrush LeftBorderBackground;                                                 // 0x0030 (size: 0xD0)
    FSlateBrush RightBorderBackground;                                                // 0x0100 (size: 0xD0)
...
struct FLetterboxLayoutSettings
{
    ...
    FSlateBrush TopBorderBackground;                                                  // 0x0030 (size: 0xD0)
    FSlateBrush BottomBorderBackground;                                               // 0x0100 (size: 0xD0)
...
struct FLoadingWidgetSettings
{
    ...
    FThrobberSettings ThrobberSettings;                                               // 0x00F0 (size: 0xE0)
    FCircularThrobberSettings CircularThrobberSettings;                               // 0x01D0 (size: 0xE0)
    FImageSequenceSettings ImageSequenceSettings;                                     // 0x02B0 (size: 0x28)
    FWidgetAlignment TextAlignment;                                                   // 0x02D8 (size: 0x2)
    FWidgetAlignment LoadingIconAlignment;                                            // 0x02DA (size: 0x2)
    float Space;                                                                      // 0x02DC (size: 0x4)
    bool bHideLoadingWidgetWhenCompletes;                                             // 0x02E0 (size: 0x1)
...
struct FSidebarLayoutSettings
{
    ...
    FSlateBrush BorderBackground;                                                     // 0x0030 (size: 0xD0)
...
class ULoadingScreenSettings : public UDeveloperSettings
{
    ...
    FALoadingScreenSettings StartupLoadingScreen;                                     // 0x0040 (size: 0x4F0)
    FALoadingScreenSettings DefaultLoadingScreen;                                     // 0x0530 (size: 0x4F0)
    FClassicLayoutSettings Classic;                                                   // 0x0A20 (size: 0xF0)
    FCenterLayoutSettings Center;                                                     // 0x0B10 (size: 0xF0)
    FLetterboxLayoutSettings Letterbox;                                               // 0x0C00 (size: 0x1D0)
    FSidebarLayoutSettings Sidebar;                                                   // 0x0DD0 (size: 0x100)
    FDualSidebarLayoutSettings DualSidebar;                                           // 0x0ED0 (size: 0x1D0)
