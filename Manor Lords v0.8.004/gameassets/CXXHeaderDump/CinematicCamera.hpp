...
{
    FCameraLookatTrackingSettings LookatTrackingSettings;                             // 0x09B0 (size: 0x68)
...
{
    FCameraFilmbackSettings FilmbackSettings;                                         // 0x09E0 (size: 0xC)
    FCameraFilmbackSettings Filmback;                                                 // 0x09EC (size: 0xC)
    FCameraLensSettings LensSettings;                                                 // 0x09F8 (size: 0x1C)
    FCameraFocusSettings FocusSettings;                                               // 0x0A18 (size: 0x60)
    FPlateCropSettings CropSettings;                                                  // 0x0A78 (size: 0x4)
    float CurrentFocalLength;                                                         // 0x0A7C (size: 0x4)
    float CurrentAperture;                                                            // 0x0A80 (size: 0x4)
    float CurrentFocusDistance;                                                       // 0x0A84 (size: 0x4)
    uint8 bOverride_CustomNearClippingPlane;                                          // 0x0A88 (size: 0x1)
    float CustomNearClippingPlane;                                                    // 0x0A8C (size: 0x4)
    TArray<FNamedFilmbackPreset> FilmbackPresets;                                     // 0x0A98 (size: 0x10)
    TArray<FNamedLensPreset> LensPresets;                                             // 0x0AA8 (size: 0x10)
    FString DefaultFilmbackPresetName;                                                // 0x0AB8 (size: 0x10)
    FString DefaultFilmbackPreset;                                                    // 0x0AC8 (size: 0x10)
    FString DefaultLensPresetName;                                                    // 0x0AD8 (size: 0x10)
    float DefaultLensFocalLength;                                                     // 0x0AE8 (size: 0x4)
    float DefaultLensFStop;                                                           // 0x0AEC (size: 0x4)
