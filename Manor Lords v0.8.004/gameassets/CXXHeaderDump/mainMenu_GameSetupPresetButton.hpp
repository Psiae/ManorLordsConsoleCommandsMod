...
class UmainMenu_GameSetupPresetButton_C : public UNaviUi
{
    ...
    class UButton* modeButton;                                                        // 0x0358 (size: 0x8)
    class UImage* selectedHighlight;                                                  // 0x0360 (size: 0x8)
    class UImage* Thumbnail;                                                          // 0x0368 (size: 0x8)
    FGameSetupPreset setupPreset;                                                     // 0x0370 (size: 0xD0)
    FmainMenu_GameSetupPresetButton_CGamePresetSelected gamePresetSelected;           // 0x0440 (size: 0x10)
    void gamePresetSelected(bool reselectDifficulty);
    FmainMenu_GameSetupPresetButton_CChangeDifficulty changeDifficulty;               // 0x0450 (size: 0x10)
    void changeDifficulty(EGameDifficulty newDifficulty);
    FName presetRowName;                                                              // 0x0460 (size: 0x8)
