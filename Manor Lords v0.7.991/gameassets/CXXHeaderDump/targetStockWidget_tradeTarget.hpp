...
class UtargetStockWidget_tradeTarget_C : public UUserWidget
{
    ...
    class UComboBoxString* ComboBox_TradeRule;                                        // 0x02F8 (size: 0x8)
    class UEditableTextBox* EditableTextBox_TARGET_STOCK;                             // 0x0300 (size: 0x8)
    class UCheckBox* globalTradeCheckbox;                                             // 0x0308 (size: 0x8)
    ...
    class UTextBlock* priceTxt;                                                       // 0x0398 (size: 0x8)
    class UButton* Remove;                                                            // 0x03A0 (size: 0x8)
    class UImage* RightArrow;                                                         // 0x03A8 (size: 0x8)
    class USizeBox* SizeBox_3;                                                        // 0x03B0 (size: 0x8)
    class USizeBox* SizeBox_currentStock;                                             // 0x03B8 (size: 0x8)
    class USizeBox* SizeBox_demand;                                                   // 0x03C0 (size: 0x8)
    class USizeBox* SizeBox_goodType;                                                 // 0x03C8 (size: 0x8)
    class USlider* Slider_21;                                                         // 0x03D0 (size: 0x8)
    class UTextBlock* stock_txt;                                                      // 0x03D8 (size: 0x8)
    class UHorizontalBox* target_inv_hb;                                              // 0x03E0 (size: 0x8)
    class UTextBlock* TextBlock_17;                                                   // 0x03E8 (size: 0x8)
    class UHorizontalBox* tradeOptions_HB;                                            // 0x03F0 (size: 0x8)
    class UHorizontalBox* tradeRoute_HB;                                              // 0x03F8 (size: 0x8)
    class UHorizontalBox* tradeRoute_unlock_hb;                                       // 0x0400 (size: 0x8)
    class UHorizontalBox* tradeRoute_unlocked_hb;                                     // 0x0408 (size: 0x8)
    class USizeBox* tradeRouteConnection_SB;                                          // 0x0410 (size: 0x8)
    class UImage* tradeRouteIcon;                                                     // 0x0418 (size: 0x8)
    class UTextBlock* tradeRouteUnlockPrice;                                          // 0x0420 (size: 0x8)
    class UButton* unlock_tade_route_button;                                          // 0x0428 (size: 0x8)
    class UButton* unlock_tade_route_button_show_merchant;                            // 0x0430 (size: 0x8)
    class UVerticalBox* VerticalBox_0;                                                // 0x0438 (size: 0x8)
    int32 animalRole;                                                                 // 0x0440 (size: 0x4)
    class ASMBuildingMaster* building;                                                // 0x0448 (size: 0x8)
    class UTexture2D* iconTexture;                                                    // 0x0450 (size: 0x8)
    int32 ItemId;                                                                     // 0x0458 (size: 0x4)
    int32 targetInventoryAmt;                                                         // 0x045C (size: 0x4)
    ETradeRule tradeRule;                                                             // 0x0460 (size: 0x1)
    int32 stock;                                                                      // 0x0464 (size: 0x4)
    EItemCategory Category;                                                           // 0x0468 (size: 0x1)
    bool contentsUpdatedAtLeastOnce;                                                  // 0x0469 (size: 0x1)
