...
class UPlusMinus_C : public UUserWidget
{
    ...
    class UMD_NaviAutoButton_C* MD_NaviAutoButton_116;                                // 0x0310 (size: 0x8)
    class UTextBlock* priorityNum_txt;                                                // 0x0318 (size: 0x8)
    int32 Var;                                                                        // 0x0320 (size: 0x4)
    class UInventory_C* inventoryRef;                                                 // 0x0328 (size: 0x8)
    FPlusMinus_CPriorityChanged priorityChanged;                                      // 0x0330 (size: 0x10)
