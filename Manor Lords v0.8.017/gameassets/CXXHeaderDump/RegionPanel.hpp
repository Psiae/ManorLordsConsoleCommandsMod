...
class URegionPanel_C : public UNaviSubGrid
{
    ...
    class UWidgetAnimation* changeRegionAnim;                                         // 0x0358 (size: 0x8)
    class UBorder* approval_border;                                                   // 0x0360 (size: 0x8)
    class UOverlay* approval_parent;                                                  // 0x0368 (size: 0x8)
    class UOverlay* assigned_parent;                                                  // 0x0370 (size: 0x8)
    class UHorizontalBox* center_hb;                                                  // 0x0378 (size: 0x8)
    class UHorizontalBox* constructionResources_HB;                                   // 0x0380 (size: 0x8)
    class UButton* dev_button;                                                        // 0x0388 (size: 0x8)
    class UBorder* dev_point_border;                                                  // 0x0390 (size: 0x8)
    class UImage* dev_point_highlight;                                                // 0x0398 (size: 0x8)
    class UTextBlock* expenses_txt;                                                   // 0x03A0 (size: 0x8)
    class UgoodStat_C* goodStat;                                                      // 0x03A8 (size: 0x8)
    class UgoodStat_C* goodStat_1;                                                    // 0x03B0 (size: 0x8)
    class UgoodStat_C* goodStat_2;                                                    // 0x03B8 (size: 0x8)
    class UgoodStat_C* goodStat_3;                                                    // 0x03C0 (size: 0x8)
    class UgoodStat_C* goodStat_4;                                                    // 0x03C8 (size: 0x8)
    class UgoodStat_C* goodStat_5;                                                    // 0x03D0 (size: 0x8)
    class UgoodStat_C* goodStat_6;                                                    // 0x03D8 (size: 0x8)
    class UgoodStat_C* goodStat_7;                                                    // 0x03E0 (size: 0x8)
    class UgoodStat_C* goodStat_8;                                                    // 0x03E8 (size: 0x8)
    class UgoodStat_C* goodStat_9;                                                    // 0x03F0 (size: 0x8)
    class UgoodStat_C* goodStat_10;                                                   // 0x03F8 (size: 0x8)
    class UgoodStat_C* goodStat_11;                                                   // 0x0400 (size: 0x8)
    class UgoodStat_C* goodStat_12;                                                   // 0x0408 (size: 0x8)
    class UgoodStat_C* goodStat_13;                                                   // 0x0410 (size: 0x8)
    class UgoodStat_C* goodStat_14;                                                   // 0x0418 (size: 0x8)
    class UgoodStat_C* goodStat_15;                                                   // 0x0420 (size: 0x8)
    class UHorizontalBox* housing_hb_1;                                               // 0x0428 (size: 0x8)
    class UImage* Image;                                                              // 0x0430 (size: 0x8)
    class UImage* Image_4;                                                            // 0x0438 (size: 0x8)
    class UImage* Image_6;                                                            // 0x0440 (size: 0x8)
    class UImage* Image_10;                                                           // 0x0448 (size: 0x8)
    class UImage* Image_12;                                                           // 0x0450 (size: 0x8)
    class UImage* Image_15;                                                           // 0x0458 (size: 0x8)
    class UImage* Image_21;                                                           // 0x0460 (size: 0x8)
    class UImage* Image_89;                                                           // 0x0468 (size: 0x8)
    class UImage* Image_111;                                                          // 0x0470 (size: 0x8)
    class UImage* Image_121;                                                          // 0x0478 (size: 0x8)
    class UImage* leftDecor_regionname;                                               // 0x0480 (size: 0x8)
    class UImage* loyalty_arrow;                                                      // 0x0488 (size: 0x8)
    class UMD_NaviAutoButton_C* MD_NaviAutoButton;                                    // 0x0490 (size: 0x8)
    class UMD_NaviAutoButton_C* MD_NaviAutoButton_163;                                // 0x0498 (size: 0x8)
    class UMD_NaviAutoTooltip_C* MD_NaviAutoTooltip;                                  // 0x04A0 (size: 0x8)
    class UMD_NaviAutoTooltip_C* MD_NaviAutoTooltip_1;                                // 0x04A8 (size: 0x8)
    class UMD_NaviAutoTooltip_C* MD_NaviAutoTooltip_162;                              // 0x04B0 (size: 0x8)
    class UMD_NaviAutoTooltip_C* MD_NaviAutoTooltip_176;                              // 0x04B8 (size: 0x8)
    class UMD_NaviAutoTooltip_C* MD_NaviAutoTooltip_304;                              // 0x04C0 (size: 0x8)
    class UMD_NaviAutoTooltip_C* MD_NaviAutoTooltip_492;                              // 0x04C8 (size: 0x8)
    class UMD_NaviAutoTooltip_C* MD_NaviAutoTooltip_637;                              // 0x04D0 (size: 0x8)
    class UMD_NaviAutoTooltip_C* MD_NaviAutoTooltip_779;                              // 0x04D8 (size: 0x8)
    class UMD_NaviAutoTooltip_C* MD_NaviAutoTooltip_931;                              // 0x04E0 (size: 0x8)
    class UMD_NaviAutoTooltip_C* MD_NaviAutoTooltip_1066;                             // 0x04E8 (size: 0x8)
    ...
    class UHorizontalBox* plots_hb;                                                   // 0x0508 (size: 0x8)
    class UHorizontalBox* pop_hb;                                                     // 0x0510 (size: 0x8)
    class UHorizontalBox* pop_housing_HB;                                             // 0x0518 (size: 0x8)
    class UImage* popIcon;                                                            // 0x0520 (size: 0x8)
    class UImage* popIcon_1;                                                          // 0x0528 (size: 0x8)
    ...
    class UImage* ribbonLeft;                                                         // 0x0548 (size: 0x8)
    class UImage* ribbonRight;                                                        // 0x0550 (size: 0x8)
    class UHorizontalBox* right_hb;                                                   // 0x0558 (size: 0x8)
    class UImage* rightDecor_regionName;                                              // 0x0560 (size: 0x8)
    class UImage* settlement_lv;                                                      // 0x0568 (size: 0x8)
    class UImage* settlement_lv_1;                                                    // 0x0570 (size: 0x8)
    class UButton* show_census_button;                                                // 0x0578 (size: 0x8)
