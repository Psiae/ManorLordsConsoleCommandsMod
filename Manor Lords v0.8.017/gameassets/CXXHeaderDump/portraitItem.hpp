...
class UportraitItem_C : public UNaviUi
{
    ...
    class UImage* Image_3;                                                            // 0x0358 (size: 0x8)
    class UMD_NaviAutoFocusHighlight_C* MD_NaviAutoFocusHighlight;                    // 0x0360 (size: 0x8)
    class UTexture2D* Texture;                                                        // 0x0368 (size: 0x8)
    FportraitItem_CPortraitChanged portraitChanged;                                   // 0x0370 (size: 0x10)
    void portraitChanged(class UTexture2D* newTexture, bool isFemale);
    bool isFemale;                                                                    // 0x0380 (size: 0x1)
