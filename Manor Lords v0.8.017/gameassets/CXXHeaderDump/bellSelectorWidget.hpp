...
class UbellSelectorWidget_C : public UUserWidget
{
    ...
    class UMD_NaviAutoButton_C* MD_NaviAutoButton_42;                                 // 0x0310 (size: 0x8)
    class UMD_NaviAutoButton_C* MD_NaviAutoButton_77;                                 // 0x0318 (size: 0x8)
    class UButton* nextBell;                                                          // 0x0320 (size: 0x8)
    class UButton* playBell;                                                          // 0x0328 (size: 0x8)
    class UButton* prevBell;                                                          // 0x0330 (size: 0x8)
