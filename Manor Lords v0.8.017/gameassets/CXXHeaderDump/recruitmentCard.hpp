...
class UrecruitmentCard_C : public UUserWidget
{
    ...
    class UButton* unitButton;                                                        // 0x0300 (size: 0x8)
    bool Selected;                                                                    // 0x0308 (size: 0x1)
    FName Template;                                                                   // 0x030C (size: 0x8)
    bool available;                                                                   // 0x0314 (size: 0x1)
    double cost;                                                                      // 0x0318 (size: 0x8)
    bool isMilitia;                                                                   // 0x0320 (size: 0x1)
