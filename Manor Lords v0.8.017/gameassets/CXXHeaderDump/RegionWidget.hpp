...
class URegionWidget_C : public UUserWidget
{
    ...
    class UImage* Image_4;                                                            // 0x0300 (size: 0x8)
    class UTextBlock* region_name;                                                    // 0x0308 (size: 0x8)
    class UImage* RegionIcon;                                                         // 0x0310 (size: 0x8)
    class UHorizontalBox* willingToExport;                                            // 0x0318 (size: 0x8)
    class UHorizontalBox* willingToImport_HB;                                         // 0x0320 (size: 0x8)
    class ARegion* Region;                                                            // 0x0328 (size: 0x8)
    class UBigMap3d_C* father;                                                        // 0x0330 (size: 0x8)
    TArray<class UInventory_Item_C*> Items;                                           // 0x0338 (size: 0x10)
    class ASMBuildingMaster* building;                                                // 0x0348 (size: 0x8)
    class UObject* tradeRoutePlanner;                                                 // 0x0350 (size: 0x8)
