...
{
    TArray<TSoftObjectPtr<ULandscapePatchComponent>> PatchComponents;                 // 0x0290 (size: 0x10)
    FTransform HeightmapCoordsToWorld;                                                // 0x02A0 (size: 0x60)
...
{
    FLandscapeHeightPatchConvertToNativeParams ConversionParams;                      // 0x0050 (size: 0xC)
    TEnumAsByte<ETextureRenderTargetFormat> RenderTargetFormat;                       // 0x005C (size: 0x1)

}; // Size: 0x60

class ULandscapePatchComponent : public USceneComponent
{
    TSoftObjectPtr<ALandscape> Landscape;                                             // 0x0230 (size: 0x28)
    TSoftObjectPtr<ALandscapePatchManager> PatchManager;                              // 0x0258 (size: 0x28)
    bool bIsEnabled;                                                                  // 0x0280 (size: 0x1)
    bool bPropertiesCopiedIndicator;                                                  // 0x0283 (size: 0x1)
    TSoftObjectPtr<ALandscapePatchManager> PreviousPatchManager;                      // 0x0288 (size: 0x28)
...
{
    class UTextureRenderTarget2D* PostLoadRT;                                         // 0x0028 (size: 0x8)
    class UTexture2D* InternalTexture;                                                // 0x0030 (size: 0x8)
    class UTextureRenderTarget2D* RenderTarget;                                       // 0x0038 (size: 0x8)
    int32 SizeX;                                                                      // 0x0040 (size: 0x4)
    int32 SizeY;                                                                      // 0x0044 (size: 0x4)
    bool bUseInternalTextureOnly;                                                     // 0x0048 (size: 0x1)
...
class ULandscapeTexturePatch : public ULandscapePatchComponent
{
    ...
    int32 NumWeightPatches;                                                           // 0x0318 (size: 0x4)
    bool bBaseResolutionOffLandscape;                                                 // 0x031D (size: 0x1)
    float ResolutionMultiplier;                                                       // 0x0320 (size: 0x4)
    int32 InitTextureSizeX;                                                           // 0x0324 (size: 0x4)
    int32 InitTextureSizeY;                                                           // 0x0328 (size: 0x4)
    TEnumAsByte<ETextureRenderTargetFormat> HeightRenderTargetFormat;                 // 0x032C (size: 0x1)
    ...
    class UTextureRenderTarget2D* GetWeightPatchRenderTarget(const FName& InWeightmapLayerName);
...
class ULandscapeWeightPatchTextureInfo : public UObject
{
    ...
    TWeakObjectPtr<class ULandscapeTexturePatch> OwningPatch;                         // 0x0050 (size: 0x8)

}; // Size: 0x60

class ULandscapeWeightTextureBackedRenderTarget : public ULandscapeTextureBackedRenderTargetBase
{
    bool bUseAlphaChannel;                                                            // 0x0050 (size: 0x1)
