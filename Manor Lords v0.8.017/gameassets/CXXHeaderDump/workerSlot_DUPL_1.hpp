...
class UworkerSlot_C : public UUserWidget
{
    ...
    class UButton* stallButton;                                                       // 0x0308 (size: 0x8)
    class ASMUnit* worker;                                                            // 0x0310 (size: 0x8)
    class UHorizontalBox* daddy_HB;                                                   // 0x0318 (size: 0x8)
    int32 ID;                                                                         // 0x0320 (size: 0x4)
    class UInventory_C* daddy_inventory;                                              // 0x0328 (size: 0x8)
    bool isLivestockAssignment;                                                       // 0x0330 (size: 0x1)
    FWorkerFamily WorkerFamily;                                                       // 0x0338 (size: 0x28)
