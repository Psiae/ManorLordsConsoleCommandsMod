...
class UStyledRadioButton_Icons_C : public URadioButton
{
    ...
    class UImage* iconImg;                                                            // 0x0328 (size: 0x8)
    class UImage* Image_1;                                                            // 0x0330 (size: 0x8)
    class UImage* Image_23;                                                           // 0x0338 (size: 0x8)
    class UTextBlock* LabelText;                                                      // 0x0340 (size: 0x8)
    class UButton* MainButton;                                                        // 0x0348 (size: 0x8)
    class UMD_NaviAutoButton_C* MD_NaviAutoButton;                                    // 0x0350 (size: 0x8)
