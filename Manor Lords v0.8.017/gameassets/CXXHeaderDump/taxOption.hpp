...
class UtaxOption_C : public UUserWidget
{
    ...
    class UMD_NaviAutoButton_C* MD_NaviAutoButton_129;                                // 0x0318 (size: 0x8)
    class USizeBox* SizeBox_150;                                                      // 0x0320 (size: 0x8)
    class UButton* tax_decr;                                                          // 0x0328 (size: 0x8)
    class UButton* tax_incr;                                                          // 0x0330 (size: 0x8)
    class UImage* taxIcon;                                                            // 0x0338 (size: 0x8)
    class USizeBox* taxName_sb;                                                       // 0x0340 (size: 0x8)
    class UTextBlock* taxName_txt;                                                    // 0x0348 (size: 0x8)
    class USlider* taxSlider;                                                         // 0x0350 (size: 0x8)
    class UTexture2D* taxIconTexture;                                                 // 0x0358 (size: 0x8)
    class ARegion* Region;                                                            // 0x0360 (size: 0x8)
    class UInventory_C* Inventory;                                                    // 0x0368 (size: 0x8)
    FName taxType;                                                                    // 0x0370 (size: 0x8)
    FName taxedInKey;                                                                 // 0x0378 (size: 0x8)
    int32 taxMin;                                                                     // 0x0380 (size: 0x4)
    int32 taxMax;                                                                     // 0x0384 (size: 0x4)
    FtaxOption_CTaxChanged taxChanged;                                                // 0x0388 (size: 0x10)
    void taxChanged();
    int32 taxButtonMul;                                                               // 0x0398 (size: 0x4)
