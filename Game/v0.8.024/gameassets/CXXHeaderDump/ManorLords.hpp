...
class ARTSMultiEngineCPP : public AActor
{
    ...
    FTimerHandle fertilityRedrawHandle;                                               // 0x0EE8 (size: 0x8)
    TArray<int32> fertilityGridUpdateRequests;                                        // 0x0EF0 (size: 0x10)
    TArray<FConnectionCache> roadConnectionCache;                                     // 0x0F00 (size: 0x10)
    class UStaticMesh* workAreaMesh;                                                  // 0x0F10 (size: 0x8)
    class UAnimSequenceBase* testAnimClip;                                            // 0x0F18 (size: 0x8)
    class USkeletalMesh* testSzkeletalMesh;                                           // 0x0F20 (size: 0x8)
    class UMaterialInterface* marketfieldMat;                                         // 0x0F28 (size: 0x8)
    class UMaterialInterface* roadConnectionMat;                                      // 0x0F30 (size: 0x8)
    TArray<class ASMBuilding*> spawnAsyncConstrBpQueue;                               // 0x0F38 (size: 0x10)
    FTimerHandle spawnAsyncConstrBPHandle;                                            // 0x0F48 (size: 0x8)
    class UStaticMesh* wallMarker;                                                    // 0x0F50 (size: 0x8)
    class UStaticMesh* gatehousePreviewMesh;                                          // 0x0F58 (size: 0x8)
    class UStaticMesh* randomFormationSocketMesh;                                     // 0x0F60 (size: 0x8)
    TArray<FVector> randomFormationPositions;                                         // 0x0F68 (size: 0x10)
    bool writeUnitDebugLogs;                                                          // 0x0F78 (size: 0x1)
    TArray<FName> drawDebugFlags;                                                     // 0x0F80 (size: 0x10)
    TArray<int32> disableJobIDs;                                                      // 0x0F90 (size: 0x10)
    bool writeDebugLogs;                                                              // 0x0FA0 (size: 0x1)
    TArray<FString> debugLog_AI_general;                                              // 0x0FA8 (size: 0x10)
    TArray<FString> debugLog_AI_tactics;                                              // 0x0FB8 (size: 0x10)
    bool shouldUpdateDebugLog_generalAI;                                              // 0x0FC8 (size: 0x1)
    bool shouldUpdateDebugLog_tacticsAI;                                              // 0x0FC9 (size: 0x1)
    float gameSpeedScheduled;                                                         // 0x0FCC (size: 0x4)
    float gameSpeedBeforePause;                                                       // 0x0FD0 (size: 0x4)
    bool isGameSpeedScheduled;                                                        // 0x0FD4 (size: 0x1)
    float locomotionTicksAdjusted;                                                    // 0x0FE8 (size: 0x4)
    float locomotionTicksAdjustedPrevious;                                            // 0x0FEC (size: 0x4)
    bool useLegacyVATM;                                                               // 0x0FF0 (size: 0x1)
    TMap<class EUnitRole, class FSoftClassPath> unitBlueprints;                       // 0x0FF8 (size: 0x50)
    TArray<FPopupCache> PopupCache;                                                   // 0x1098 (size: 0x10)
    FSessionAchievementData SessionAchievementData;                                   // 0x10A8 (size: 0x30)
    TArray<FSpatialCell> SpatialGrid;                                                 // 0x10D8 (size: 0x10)
    TArray<FPathRequest> asyncPathRequestsPending;                                    // 0x1108 (size: 0x10)
    bool asyncLinkerCreated;                                                          // 0x1190 (size: 0x1)
    TArray<FQueuedLinkerDataEdit> queuedLinkerDataEdits;                              // 0x1198 (size: 0x10)
    TArray<FQueuedPathfinderDataEditCollection> pathfinerEditCollections;             // 0x11A8 (size: 0x10)
    bool isNightAndAffectsGameplay;                                                   // 0x11B8 (size: 0x1)
    TArray<FProceduralGroundCoverData> proceduralGroundCoverTypes;                    // 0x11C0 (size: 0x10)
    TArray<class UInstancedStaticMeshComponent*> proceduralGroundCover;               // 0x11D0 (size: 0x10)
    int32 numberOfCameraGroundCoverCellColumnsHalf;                                   // 0x11E0 (size: 0x4)
    float cameraBasedGroundCoverCellSize;                                             // 0x11E4 (size: 0x4)
    FTimerHandle cameraBasedGroundCoverHandle;                                        // 0x11E8 (size: 0x8)
    TMap<class FVector, class EGroundCoverCategory> biomeCache;                       // 0x11F0 (size: 0x50)
    int32 cameraBasedGroundCoverComponentIterator;                                    // 0x1240 (size: 0x4)
    bool cameraBasedGroundCoverComponentFlipFlop;                                     // 0x1244 (size: 0x1)
    TArray<FBox2D> groundCoverOcclusionBoxes;                                         // 0x1248 (size: 0x10)
    class UStaticMesh* groundCoverDistributionSocketMesh;                             // 0x1258 (size: 0x8)
    TArray<FVector> groundCoverDistributionSocketLocations;                           // 0x1260 (size: 0x10)
    TArray<EGroundCoverCategory> biomeCacheGrid;                                      // 0x1270 (size: 0x10)
    TArray<int32> biomeCacheUpdateRequests;                                           // 0x1280 (size: 0x10)
    FTimerHandle biomeCacheUpdateSlowHandle;                                          // 0x1290 (size: 0x8)
    FVector lastGroundCoverUpdateCameraLocation;                                      // 0x1298 (size: 0x18)
    TMap<FVector, float> groundCoverLandscapeHeightCache;                             // 0x12B0 (size: 0x50)
    TArray<FTransformPairCollection> groundCoverLandscapeTransformCacheGrid;          // 0x1300 (size: 0x10)
    class UStaticMesh* unitBannerMesh;                                                // 0x1310 (size: 0x8)
    class UMaterialInterface* bouncedLightMaterial;                                   // 0x1320 (size: 0x8)
    TArray<FCollisionCluster> collisionClusters;                                      // 0x1338 (size: 0x10)
    TArray<class UVARuntimeComponent*> birdFlockVARuntimeComponents;                  // 0x1358 (size: 0x10)
    TArray<FName> tutorialsLeftToShow;                                                // 0x1370 (size: 0x10)
    TArray<FGood> foreignMarketSupply;                                                // 0x1380 (size: 0x10)
    TArray<class ASMBuildingMaster*> landscapeDeformationBuildings;                   // 0x13B0 (size: 0x10)
    TArray<FTradeLogEntry> tradeLog;                                                  // 0x13C0 (size: 0x10)
    TMap<class ASMBuildingMaster*, class USphereReflectionCaptureComponent*> reflectionSpheres; // 0x13F0 (size: 0x50)
...
{
    class ARTSMultiEngineCPP* masterPtr;                                              // 0x0290 (size: 0x8)
    FTimerHandle proximityUpdateHandle;                                               // 0x0298 (size: 0x8)
    class UAudioComponent* ambience_wind_close;                                       // 0x02B0 (size: 0x8)
    class UAudioComponent* ambience_wind_far;                                         // 0x02B8 (size: 0x8)
    class UAudioComponent* ambience_rain_close;                                       // 0x02C0 (size: 0x8)
    TArray<class USoundBase*> weather_thunder;                                        // 0x02C8 (size: 0x10)
