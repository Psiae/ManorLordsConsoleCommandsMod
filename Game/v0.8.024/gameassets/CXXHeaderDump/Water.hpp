...
struct FUnderwaterPostProcessSettings
{
    ...
    FPostProcessSettings PostProcessSettings;                                         // 0x0010 (size: 0x6F0)
    class UMaterialInterface* UnderwaterPostProcessMaterial;                          // 0x0700 (size: 0x8)
...
{
    class UWaterSplineComponent* SplineComp;                                          // 0x0298 (size: 0x8)
    class UWaterSplineMetadata* WaterSplineMetadata;                                  // 0x02A0 (size: 0x8)
    class UWaterBodyComponent* WaterBodyComponent;                                    // 0x02A8 (size: 0x8)
    int32 WaterBodyIndex;                                                             // 0x02B0 (size: 0x4)
    EWaterBodyType WaterBodyType;                                                     // 0x02B4 (size: 0x1)
    class UWaterWavesBase* WaterWaves;                                                // 0x02B8 (size: 0x8)
    class UWaterBodyInfoMeshComponent* WaterInfoMeshComponent;                        // 0x02C0 (size: 0x8)
    class UWaterBodyInfoMeshComponent* DilatedWaterInfoMeshComponent;                 // 0x02C8 (size: 0x8)
    TArray<class UWaterBodyStaticMeshComponent*> WaterBodyStaticMeshComponents;       // 0x02D0 (size: 0x10)
    TSubclassOf<class UWaterBodyRiverComponent> WaterBodyRiverComponentClass;         // 0x02E0 (size: 0x8)
    TSubclassOf<class UWaterBodyLakeComponent> WaterBodyLakeComponentClass;           // 0x02E8 (size: 0x8)
    TSubclassOf<class UWaterBodyOceanComponent> WaterBodyOceanComponentClass;         // 0x02F0 (size: 0x8)
    TSubclassOf<class UWaterBodyCustomComponent> WaterBodyCustomComponentClass;       // 0x02F8 (size: 0x8)
...
{
    EWaterExclusionMode ExclusionMode;                                                // 0x02D8 (size: 0x4)
    TArray<TSoftObjectPtr<AWaterBody>> WaterBodies;                                   // 0x02E0 (size: 0x10)
...
class AWaterZone : public AActor
{
    ...
    float CaptureZOffset;                                                             // 0x02C8 (size: 0x4)
    bool bHalfPrecisionTexture;                                                       // 0x02CC (size: 0x1)
    int32 VelocityBlurRadius;                                                         // 0x02D0 (size: 0x4)
    int32 OverlapPriority;                                                            // 0x02D4 (size: 0x4)
    bool bEnableLocalOnlyTessellation;                                                // 0x02D8 (size: 0x1)
    FVector LocalTessellationExtent;                                                  // 0x02E0 (size: 0x18)
    int32 WaterZoneIndex;                                                             // 0x0320 (size: 0x4)
    FWaterZoneOnWaterInfoTextureCreated OnWaterInfoTextureCreated;                    // 0x0328 (size: 0x10)
    void OnWaterInfoTextureCreated(const class UTextureRenderTarget2D* WaterInfoTexture);
...
{
    class UBodySetup* CachedBodySetup;                                                // 0x0518 (size: 0x8)
    FVector BoxExtent;                                                                // 0x0520 (size: 0x18)
...
{
    class UPhysicalMaterial* PhysicalMaterial;                                        // 0x0518 (size: 0x8)
    float TargetWaveMaskDepth;                                                        // 0x0520 (size: 0x4)
    float MaxWaveHeightOffset;                                                        // 0x0524 (size: 0x4)
    FUnderwaterPostProcessSettings UnderwaterPostProcessSettings;                     // 0x0530 (size: 0x710)
    FWaterCurveSettings CurveSettings;                                                // 0x0C40 (size: 0x20)
    class UMaterialInterface* WaterMaterial;                                          // 0x0C60 (size: 0x8)
    class UMaterialInterface* WaterHLODMaterial;                                      // 0x0C68 (size: 0x8)
    class UMaterialInterface* WaterStaticMeshMaterial;                                // 0x0C70 (size: 0x8)
    class UMaterialInterface* UnderwaterPostProcessMaterial;                          // 0x0C78 (size: 0x8)
    class UMaterialInterface* WaterInfoMaterial;                                      // 0x0C80 (size: 0x8)
    FWaterBodyHeightmapSettings WaterHeightmapSettings;                               // 0x0C88 (size: 0x80)
    float ShapeDilation;                                                              // 0x0D08 (size: 0x4)
    float CollisionHeightOffset;                                                      // 0x0D0C (size: 0x4)
    bool bAffectsLandscape;                                                           // 0x0D10 (size: 0x1)
    FWaterBodyStaticMeshSettings StaticMeshSettings;                                  // 0x0D18 (size: 0x10)
    int32 WaterBodyIndex;                                                             // 0x0D28 (size: 0x4)
    class UStaticMesh* WaterMeshOverride;                                             // 0x0D30 (size: 0x8)
    bool bAlwaysGenerateWaterMeshTiles;                                               // 0x0D38 (size: 0x1)
    int32 OverlapMaterialPriority;                                                    // 0x0D3C (size: 0x4)
    class UWaterSplineMetadata* WaterSplineMetadata;                                  // 0x0D40 (size: 0x8)
    class UMaterialInstanceDynamic* WaterMID;                                         // 0x0D48 (size: 0x8)
    class UMaterialInstanceDynamic* WaterStaticMeshMID;                               // 0x0D50 (size: 0x8)
    class UMaterialInstanceDynamic* UnderwaterPostProcessMID;                         // 0x0D58 (size: 0x8)
    class UMaterialInstanceDynamic* WaterInfoMID;                                     // 0x0D60 (size: 0x8)
    TArray<TSoftObjectPtr<AWaterBodyIsland>> WaterBodyIslands;                        // 0x0D68 (size: 0x10)
    TArray<TSoftObjectPtr<AWaterBodyExclusionVolume>> WaterBodyExclusionVolumes;      // 0x0D78 (size: 0x10)
    TWeakObjectPtr<class ALandscapeProxy> Landscape;                                  // 0x0D88 (size: 0x8)
    TSoftObjectPtr<AWaterZone> OwningWaterZone;                                       // 0x0D90 (size: 0x28)
    TSoftObjectPtr<AWaterZone> WaterZoneOverride;                                     // 0x0DB8 (size: 0x28)
    FPostProcessSettings CurrentPostProcessSettings;                                  // 0x0DE0 (size: 0x6F0)
    TSubclassOf<class UNavAreaBase> WaterNavAreaClass;                                // 0x14D0 (size: 0x8)
    double FixedWaterDepth;                                                           // 0x14D8 (size: 0x8)
...
{
    class UStaticMeshComponent* MeshComp;                                             // 0x14E0 (size: 0x8)
...
{
    bool bIsDilatedMesh;                                                              // 0x05D8 (size: 0x1)
    bool bIsConservativeRasterCompatible;                                             // 0x05D9 (size: 0x1)

}; // Size: 0x5E0

class UWaterBodyLakeComponent : public UWaterBodyComponent
{
    class UStaticMeshComponent* LakeMeshComp;                                         // 0x14E0 (size: 0x8)
    class ULakeCollisionComponent* LakeCollision;                                     // 0x14E8 (size: 0x8)
...
{
    TArray<class UOceanBoxCollisionComponent*> CollisionBoxes;                        // 0x14E0 (size: 0x10)
    TArray<class UOceanCollisionComponent*> CollisionHullSets;                        // 0x14F0 (size: 0x10)
    FVector CollisionExtents;                                                         // 0x1500 (size: 0x18)
    FVector2D OceanExtents;                                                           // 0x1518 (size: 0x10)
    FVector2D SavedZoneLocation;                                                      // 0x1528 (size: 0x10)
    bool bCenterOnWaterZone;                                                          // 0x1538 (size: 0x1)
    float HeightOffset;                                                               // 0x153C (size: 0x4)

}; // Size: 0x1540

class UWaterBodyRiverComponent : public UWaterBodyComponent
{
    TArray<class USplineMeshComponent*> SplineMeshComponents;                         // 0x14E0 (size: 0x10)
    class UMaterialInterface* LakeTransitionMaterial;                                 // 0x14F0 (size: 0x8)
    class UMaterialInstanceDynamic* LakeTransitionMID;                                // 0x14F8 (size: 0x8)
    class UMaterialInterface* OceanTransitionMaterial;                                // 0x1500 (size: 0x8)
    class UMaterialInstanceDynamic* OceanTransitionMID;                               // 0x1508 (size: 0x8)
...
{
    int32 ForceCollapseDensityLevel;                                                  // 0x0550 (size: 0x4)
    class UMaterialInterface* FarDistanceMaterial;                                    // 0x0558 (size: 0x8)
    float FarDistanceMeshExtent;                                                      // 0x0560 (size: 0x4)
    float TileSize;                                                                   // 0x0564 (size: 0x4)
    FIntPoint QuadTreeResolution;                                                     // 0x0568 (size: 0x8)
    TSet<UMaterialInterface*> UsedMaterials;                                          // 0x0670 (size: 0x50)
    TMap<class UMaterialInterface*, class UMaterialInstanceDynamic*> MaterialToMID;   // 0x06C0 (size: 0x50)
    bool bUseFarMeshWithoutOcean;                                                     // 0x0710 (size: 0x1)
    int32 TessellationFactor;                                                         // 0x0720 (size: 0x4)
    float LODScale;                                                                   // 0x0724 (size: 0x4)
...
{
    FWaterSplineCurveDefaults WaterSplineDefaults;                                    // 0x0618 (size: 0x10)
    FWaterSplineCurveDefaults PreviousWaterSplineDefaults;                            // 0x0628 (size: 0x10)
