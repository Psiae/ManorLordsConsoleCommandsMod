...
class UmercenaryCompanyCard_C : public UUserWidget
{
    ...
    class UMD_NaviAutoButton_C* MD_NaviAutoButton_80;                                 // 0x0360 (size: 0x8)
    class UrecruitmentCard_C* recruitmentCard;                                        // 0x0368 (size: 0x8)
    class UrecruitmentCard_C* recruitmentCard_1;                                      // 0x0370 (size: 0x8)
    class UrecruitmentCard_C* recruitmentCard_2;                                      // 0x0378 (size: 0x8)
    class UTextBlock* traits_txt;                                                     // 0x0380 (size: 0x8)
    class UWrapBox* traits_WrapBox_1;                                                 // 0x0388 (size: 0x8)
    class UHorizontalBox* units_hb;                                                   // 0x0390 (size: 0x8)
    class UVerticalBox* VB_Traits;                                                    // 0x0398 (size: 0x8)
    FMercenaryCompany MercenaryCompany;                                               // 0x03A0 (size: 0x60)
    int32 Index;                                                                      // 0x0400 (size: 0x4)
