...
class AMyPawnCPP_BP3_C : public APawnCPP
{
    ...
    TArray<class AActor*> landscapeMeshActors;                                        // 0x1728 (size: 0x10)
    class ASkyAtmosphereClouds_Blueprint_C* SkyAtmosphereCloudBP;                     // 0x1738 (size: 0x8)
    class UMaterialInstanceDynamic* paperMapMaterialinstance;                         // 0x1740 (size: 0x8)
    TArray<class AStaticMeshActor*> fogPlanes;                                        // 0x1748 (size: 0x10)
