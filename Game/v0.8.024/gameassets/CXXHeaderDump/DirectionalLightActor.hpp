...
class ADirectionalLightActor_C : public AActor
{
    ...
    TArray<class UFoliageInstancedStaticMeshComponent*> independentFoliageComponents; // 0x0368 (size: 0x10)
    class ARTSMultiEngineCPP* masterPtr;                                              // 0x0378 (size: 0x8)
    double shadowDistanceSquared_Near;                                                // 0x0380 (size: 0x8)
