...
class AMyRTSMultiEngineCPP_BP_C : public ARTSMultiEngineCPP
{
    ...
    class UInstancedStaticMeshComponent* InstanceSnowTrails;                          // 0x1450 (size: 0x8)
    double buildingCullDistance;                                                      // 0x1458 (size: 0x8)
    double unitCullDistance;                                                          // 0x1460 (size: 0x8)
