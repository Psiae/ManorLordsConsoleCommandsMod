...
class UconstructionFeedbackWidget_C : public UUserWidget
{
    ...
    class URichTextBlock* RichTextBlock_0;                                            // 0x02F0 (size: 0x8)
    FText textToPrint;                                                                // 0x02F8 (size: 0x10)
    FVector Pos;                                                                      // 0x0308 (size: 0x18)
    double PlaybackSpeed;                                                             // 0x0320 (size: 0x8)
