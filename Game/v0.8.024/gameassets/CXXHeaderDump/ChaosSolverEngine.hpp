...
{
    FChaosSolverConfiguration Properties;                                             // 0x0290 (size: 0x6C)
    float TimeStepMultiplier;                                                         // 0x02FC (size: 0x4)
    int32 CollisionIterations;                                                        // 0x0300 (size: 0x4)
    int32 PushOutIterations;                                                          // 0x0304 (size: 0x4)
    int32 PushOutPairIterations;                                                      // 0x0308 (size: 0x4)
    float ClusterConnectionFactor;                                                    // 0x030C (size: 0x4)
    EClusterConnectionTypeEnum ClusterUnionConnectionType;                            // 0x0310 (size: 0x1)
    bool DoGenerateCollisionData;                                                     // 0x0311 (size: 0x1)
    FSolverCollisionFilterSettings CollisionFilterSettings;                           // 0x0314 (size: 0x10)
    bool DoGenerateBreakingData;                                                      // 0x0324 (size: 0x1)
    FSolverBreakingFilterSettings BreakingFilterSettings;                             // 0x0328 (size: 0x10)
    bool DoGenerateTrailingData;                                                      // 0x0338 (size: 0x1)
    FSolverTrailingFilterSettings TrailingFilterSettings;                             // 0x033C (size: 0x10)
    float MassScale;                                                                  // 0x034C (size: 0x4)
    bool bHasFloor;                                                                   // 0x0350 (size: 0x1)
    float FloorHeight;                                                                // 0x0354 (size: 0x4)
    FChaosDebugSubstepControl ChaosDebugSubstepControl;                               // 0x0358 (size: 0x3)
