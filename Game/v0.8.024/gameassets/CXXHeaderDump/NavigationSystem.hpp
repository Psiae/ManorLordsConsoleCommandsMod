...
class ANavModifierVolume : public AVolume
{
    ...
    ENavigationDataResolution NavMeshResolution;                                      // 0x02D9 (size: 0x1)
...
class ANavigationData : public AActor
{
    ...
    FNavDataConfig NavDataConfig;                                                     // 0x02A0 (size: 0x88)
    uint8 bEnableDrawing;                                                             // 0x0328 (size: 0x1)
    uint8 bForceRebuildOnLoad;                                                        // 0x0328 (size: 0x1)
    uint8 bAutoDestroyWhenNoNavigation;                                               // 0x0328 (size: 0x1)
    uint8 bCanBeMainNavData;                                                          // 0x0328 (size: 0x1)
    uint8 bCanSpawnOnRebuild;                                                         // 0x0328 (size: 0x1)
    uint8 bRebuildAtRuntime;                                                          // 0x0328 (size: 0x1)
    ERuntimeGenerationType RuntimeGeneration;                                         // 0x032C (size: 0x1)
    float ObservedPathsTickInterval;                                                  // 0x0330 (size: 0x4)
    uint32 DataVersion;                                                               // 0x0334 (size: 0x4)
    TArray<FSupportedAreaData> SupportedAreas;                                        // 0x0440 (size: 0x10)
...
class ANavigationTestingActor : public AActor
{
    ...
    uint8 bRequireNavigableEndLocation;                                               // 0x0334 (size: 0x1)
    uint8 bDrawDistanceToWall;                                                        // 0x0334 (size: 0x1)
    uint8 bDrawIfNavDataIsReadyInRadius;                                              // 0x0334 (size: 0x1)
    uint8 bShowNodePool;                                                              // 0x0334 (size: 0x1)
    uint8 bShowBestPath;                                                              // 0x0334 (size: 0x1)
    uint8 bShowDiffWithPreviousStep;                                                  // 0x0335 (size: 0x1)
    uint8 bShouldBeVisibleInGame;                                                     // 0x0335 (size: 0x1)
    float RadiusUsedToValidateNavData;                                                // 0x0338 (size: 0x4)
    TEnumAsByte<ENavCostDisplay::Type> CostDisplayMode;                               // 0x033C (size: 0x1)
    ...
    double PathCost;                                                                  // 0x0358 (size: 0x8)
    int32 PathfindingSteps;                                                           // 0x0360 (size: 0x4)
    class ANavigationTestingActor* OtherActor;                                        // 0x0368 (size: 0x8)
    TSubclassOf<class UNavigationQueryFilter> FilterClass;                            // 0x0370 (size: 0x8)
    int32 ShowStepIndex;                                                              // 0x0378 (size: 0x4)
    float OffsetFromCornersDistance;                                                  // 0x037C (size: 0x4)

}; // Size: 0x3C0

class ARecastNavMesh : public ANavigationData
{
    uint8 bDrawTriangleEdges;                                                         // 0x04A8 (size: 0x1)
    uint8 bDrawPolyEdges;                                                             // 0x04A8 (size: 0x1)
    uint8 bDrawFilledPolys;                                                           // 0x04A8 (size: 0x1)
    uint8 bDrawNavMeshEdges;                                                          // 0x04A8 (size: 0x1)
    uint8 bDrawTileBounds;                                                            // 0x04A8 (size: 0x1)
    uint8 bDrawTileResolutions;                                                       // 0x04A8 (size: 0x1)
    uint8 bDrawPathCollidingGeometry;                                                 // 0x04A8 (size: 0x1)
    uint8 bDrawTileLabels;                                                            // 0x04A8 (size: 0x1)
    uint8 bDrawTileBuildTimes;                                                        // 0x04A9 (size: 0x1)
    uint8 bDrawTileBuildTimesHeatMap;                                                 // 0x04A9 (size: 0x1)
    uint8 bDrawPolygonLabels;                                                         // 0x04A9 (size: 0x1)
    uint8 bDrawDefaultPolygonCost;                                                    // 0x04A9 (size: 0x1)
    uint8 bDrawPolygonFlags;                                                          // 0x04A9 (size: 0x1)
    uint8 bDrawLabelsOnPathNodes;                                                     // 0x04A9 (size: 0x1)
    uint8 bDrawNavLinks;                                                              // 0x04A9 (size: 0x1)
    uint8 bDrawFailedNavLinks;                                                        // 0x04A9 (size: 0x1)
    uint8 bDrawClusters;                                                              // 0x04AA (size: 0x1)
    uint8 bDrawOctree;                                                                // 0x04AA (size: 0x1)
    uint8 bDrawOctreeDetails;                                                         // 0x04AA (size: 0x1)
    uint8 bDrawMarkedForbiddenPolys;                                                  // 0x04AA (size: 0x1)
    uint8 bDistinctlyDrawTilesBeingBuilt;                                             // 0x04AA (size: 0x1)
    float DrawOffset;                                                                 // 0x04AC (size: 0x4)
    FRecastNavMeshTileGenerationDebug TileGenerationDebug;                            // 0x04B0 (size: 0x1C)
    uint8 bFixedTilePoolSize;                                                         // 0x04CC (size: 0x1)
    int32 TilePoolSize;                                                               // 0x04D0 (size: 0x4)
    float TileSizeUU;                                                                 // 0x04D4 (size: 0x4)
    float CellSize;                                                                   // 0x04D8 (size: 0x4)
    float CellHeight;                                                                 // 0x04DC (size: 0x4)
    FNavMeshResolutionParam NavMeshResolutionParams;                                  // 0x04E0 (size: 0x24)
    float AgentRadius;                                                                // 0x0504 (size: 0x4)
    float AgentHeight;                                                                // 0x0508 (size: 0x4)
    float AgentMaxSlope;                                                              // 0x050C (size: 0x4)
    float AgentMaxStepHeight;                                                         // 0x0510 (size: 0x4)
    float MinRegionArea;                                                              // 0x0514 (size: 0x4)
    float MergeRegionSize;                                                            // 0x0518 (size: 0x4)
    int32 MaxVerticalMergeError;                                                      // 0x051C (size: 0x4)
    float MaxSimplificationError;                                                     // 0x0520 (size: 0x4)
    float SimplificationElevationRatio;                                               // 0x0524 (size: 0x4)
    ...
    ENavigationLedgeSlopeFilterMode LedgeSlopeFilterMode;                             // 0x0564 (size: 0x1)
    TEnumAsByte<ERecastPartitioning::Type> RegionPartitioning;                        // 0x0565 (size: 0x1)
    TEnumAsByte<ERecastPartitioning::Type> LayerPartitioning;                         // 0x0566 (size: 0x1)
...
{
    double SplineExtent;                                                              // 0x0190 (size: 0x8)
    int32 NumSplineSamples;                                                           // 0x0198 (size: 0x4)
