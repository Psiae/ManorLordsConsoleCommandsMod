...
{
    class UTexture2D* Destination;                                                    // 0x0290 (size: 0x8)
    class UTexture2D* Source;                                                         // 0x0298 (size: 0x8)
    class UMaterialParameterCollection* Parameters;                                   // 0x02A0 (size: 0x8)
    FLinearColor LandscapePosition;                                                   // 0x02A8 (size: 0x10)
    FLinearColor LandscapeScale;                                                      // 0x02B8 (size: 0x10)
...
{
    float Radius;                                                                     // 0x0290 (size: 0x4)
    int32 SampleCount;                                                                // 0x0294 (size: 0x4)
    float Randomness;                                                                 // 0x0298 (size: 0x4)
    int32 ExpansionSamples;                                                           // 0x029C (size: 0x4)
    class UStaticMesh* Mesh;                                                          // 0x02A0 (size: 0x8)
    class UInstancedStaticMeshComponent* InstancedMeshes;                             // 0x02A8 (size: 0x8)
...
{
    FName InputFolder;                                                                // 0x0290 (size: 0x8)
    FString OutputFolder;                                                             // 0x0298 (size: 0x10)
    double DownscalingFactor;                                                         // 0x02A8 (size: 0x8)
...
{
    FNaviGridState gridState;                                                         // 0x0348 (size: 0x110)
    FNaviGridConfig gridConfig;                                                       // 0x0458 (size: 0xC)
...
{
    class UNaviGrid* hostGrid;                                                        // 0x0348 (size: 0x8)
...
{
    FNaviUiOnResultOccuredDelegate OnResultOccuredDelegate;                           // 0x02E0 (size: 0x10)
    void OnResultOccured(FNaviUiResult Result);
    FNaviUiOnFocusChangeDelegate OnFocusChangeDelegate;                               // 0x02F0 (size: 0x10)
    void OnFocusChange(bool HasFocus);
    class UNaviUi* Parent;                                                            // 0x0300 (size: 0x8)
    TArray<class UNaviUi*> Children;                                                  // 0x0308 (size: 0x10)
    FString internal_id;                                                              // 0x0318 (size: 0x10)
    bool internal_hasFocus;                                                           // 0x0328 (size: 0x1)
    class UNaviUi* internal_priorityChild;                                            // 0x0330 (size: 0x8)
    float timeOfLastMovement;                                                         // 0x0338 (size: 0x4)
    ...
    FString GetId();
    bool ForceTooltipShown(class UNaviUi* searchRoot, bool showTooltip, int32 searchDepth);
...
class USpecialFlags : public UBlueprintFunctionLibrary
{
    ...
    void ApplyTextInputLimits(FString rawText, FString& cleanText, bool& atLengthLimit);
}; // Size: 0x28
