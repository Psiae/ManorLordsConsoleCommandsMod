...
class AMyRTSMultiEngineCPP_BP_C : public ARTSMultiEngineCPP
{
    ...
    class UInstancedStaticMeshComponent* InstanceSnowTrails;                          // 0x1400 (size: 0x8)
    double buildingCullDistance;                                                      // 0x1408 (size: 0x8)
    double unitCullDistance;                                                          // 0x1410 (size: 0x8)
