...
class UABP_MGG_Banner_C : public UBannerAnimInstance
{
    ...
    FAnimBlueprintGeneratedMutableData __AnimBlueprintMutables;                       // 0x0398 (size: 0x18)
    ...
    FAnimNode_TwoWayBlend AnimGraphNode_TwoWayBlend;                                  // 0x03C0 (size: 0xC8)
    FAnimNode_SequenceEvaluator AnimGraphNode_SequenceEvaluator_2;                    // 0x0488 (size: 0x40)
    FAnimNode_SequenceEvaluator AnimGraphNode_SequenceEvaluator_1;                    // 0x04C8 (size: 0x40)
    FAnimNode_BlendListByBool AnimGraphNode_BlendListByBool;                          // 0x0508 (size: 0x48)
    FAnimNode_Root AnimGraphNode_Root;                                                // 0x0550 (size: 0x20)
    FAnimNode_SequenceEvaluator AnimGraphNode_SequenceEvaluator;                      // 0x0570 (size: 0x40)
    class UPoseAsset* animPose;                                                       // 0x05B0 (size: 0x8)
