...
class UFFXFSR3Settings : public UDeveloperSettings
{
    ...
    bool bD3D12AsyncInterpolation;                                                    // 0x0048 (size: 0x1)
    bool bD3D12AsyncPresent;                                                          // 0x0049 (size: 0x1)
    ...
    bool bReactiveMask;                                                               // 0x0068 (size: 0x1)
    float ReflectionScale;                                                            // 0x006C (size: 0x4)
    float ReflectionLuminanceBias;                                                    // 0x0070 (size: 0x4)
    float RoughnessScale;                                                             // 0x0074 (size: 0x4)
    float RoughnessBias;                                                              // 0x0078 (size: 0x4)
    float RoughnessMaxDistance;                                                       // 0x007C (size: 0x4)
    bool bReactiveMaskRoughnessForceMaxDistance;                                      // 0x0080 (size: 0x1)
    float TranslucencyBias;                                                           // 0x0084 (size: 0x4)
    float TranslucencyLuminanceBias;                                                  // 0x0088 (size: 0x4)
    float TranslucencyMaxDistance;                                                    // 0x008C (size: 0x4)
    TEnumAsByte<EMaterialShadingModel> ReactiveShadingModelID;                        // 0x0090 (size: 0x1)
    float ForceReactiveMaterialValue;                                                 // 0x0094 (size: 0x4)
    float ReactiveHistoryTranslucencyBias;                                            // 0x0098 (size: 0x4)
    float ReactiveHistoryTranslucencyLumaBias;                                        // 0x009C (size: 0x4)
    float PreDOFTranslucencyScale;                                                    // 0x00A0 (size: 0x4)
    bool bPreDOFTranslucencyMax;                                                      // 0x00A4 (size: 0x1)
