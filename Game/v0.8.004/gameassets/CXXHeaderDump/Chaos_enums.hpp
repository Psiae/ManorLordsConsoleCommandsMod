...
enum class EAllowConvexMergeMethod {
    ByProximity = 0,
    Any = 1,
...
enum class EConnectionContactMethod {
    None = 0,
...
enum class EDamageModelTypeEnum {
...
enum class EGenerateConvexMethod {
    ExternalCollision = 0,
...
enum class EProximityContactMethod {
