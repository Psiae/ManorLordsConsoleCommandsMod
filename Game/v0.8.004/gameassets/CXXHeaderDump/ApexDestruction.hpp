...
{
    uint8 bFractureEffectOverride;                                                    // 0x08C0 (size: 0x1)
    TArray<FFractureEffect> FractureEffects;                                          // 0x08C8 (size: 0x10)
    bool bEnableHardSleeping;                                                         // 0x08D8 (size: 0x1)
    float LargeChunkThreshold;                                                        // 0x08DC (size: 0x4)
    FDestructibleComponentOnComponentFracture OnComponentFracture;                    // 0x08E0 (size: 0x10)
...
{
    FDestructibleParameters DefaultDestructibleParameters;                            // 0x04D8 (size: 0xA8)
    TArray<FFractureEffect> FractureEffects;                                          // 0x0580 (size: 0x10)
