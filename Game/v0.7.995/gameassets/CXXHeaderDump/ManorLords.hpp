...
struct FControlHookState
{
    ...
    class APawnCPP* inputDestination;                                                 // 0x0018 (size: 0x8)
    bool ignoreInputModeChanges;                                                      // 0x0020 (size: 0x1)
    bool forceGamepad;                                                                // 0x0021 (size: 0x1)
    bool analogRightIsOrbit;                                                          // 0x0022 (size: 0x1)
    bool didAcceptGotoUi;                                                             // 0x0023 (size: 0x1)
...
{
    FVector Pos;                                                                      // 0x0000 (size: 0x18)
    float roadDist;                                                                   // 0x0018 (size: 0x4)
    class ARoad* nearestRoad;                                                         // 0x0020 (size: 0x8)
    TArray<FOption> Options;                                                          // 0x0028 (size: 0x10)
    bool inRegion;                                                                    // 0x0038 (size: 0x1)
    FRotator roadAngle;                                                               // 0x0040 (size: 0x18)
...
class APawnCPP : public APawn
{
    ...
    TArray<FArmy> commandedArmies;                                                    // 0x0D18 (size: 0x10)
    TArray<FVector> squadWaypoints;                                                   // 0x0D28 (size: 0x10)
    bool shouldUpdateArmyUI;                                                          // 0x0D38 (size: 0x1)
    bool shouldUpdateStatUI;                                                          // 0x0D39 (size: 0x1)
    bool shouldUpdateProblemUI;                                                       // 0x0D3A (size: 0x1)
    bool shouldUpdateClaimUI;                                                         // 0x0D3B (size: 0x1)
    bool shouldUpdateApprovalUI;                                                      // 0x0D3C (size: 0x1)
    bool shouldUpdateInventoryStorageUI;                                              // 0x0D3D (size: 0x1)
    bool shouldUpdateResidentsUI;                                                     // 0x0D3E (size: 0x1)
    ...
    TArray<FTransform> marketTransforms;                                              // 0x0DC8 (size: 0x10)
    TArray<FTransform> extensionTransforms;                                           // 0x0DD8 (size: 0x10)
    FFieldPoint cursorFieldPoint;                                                     // 0x0DE8 (size: 0x30)
    TArray<FExtractedPlot> extractedPlots;                                            // 0x0E18 (size: 0x10)
    TArray<FVector> residentialSlicesA;                                               // 0x0E28 (size: 0x10)
    TArray<FVector> residentialSlicesB;                                               // 0x0E38 (size: 0x10)
    int32 hoverProblem;                                                               // 0x0E48 (size: 0x4)
    TArray<class UDecalComponent*> previewRoadDecals;                                 // 0x0E50 (size: 0x10)
    class UStaticMesh* buildingPreviewPlane;                                          // 0x0E60 (size: 0x8)
    TArray<class UStaticMeshComponent*> previewBuildingDecals;                        // 0x0E68 (size: 0x10)
    TArray<class UStaticMeshComponent*> previewExtensionDecals;                       // 0x0E78 (size: 0x10)
    TArray<class ARoad*> prevSnappedToRoads;                                          // 0x0E88 (size: 0x10)
    bool fieldPointsChanged;                                                          // 0x0E98 (size: 0x1)
    int32 slicingAngle;                                                               // 0x0E9C (size: 0x4)
    int32 numPlotOffset;                                                              // 0x0EA0 (size: 0x4)
    int32 expectedNumPlots;                                                           // 0x0EA4 (size: 0x4)
    int32 maxDivisionsForThisPlot;                                                    // 0x0EA8 (size: 0x4)
    class ARegion* fieldRegion;                                                       // 0x0EB0 (size: 0x8)
    ...
    class UTextureRenderTarget2D* RT_modulePlanner;                                   // 0x10F0 (size: 0x8)
    bool shouldUpdateMarketStats;                                                     // 0x10F8 (size: 0x1)
    ERTSTool activeRTSTool;                                                           // 0x10F9 (size: 0x1)
    class AActor* RTSToolActor;                                                       // 0x1100 (size: 0x8)
    FName activeRTSToolVariety;                                                       // 0x1108 (size: 0x8)
    TArray<int32> placebuilding_missingTech;                                          // 0x1110 (size: 0x10)
    TMap<FName, int32> tagAdditionDay;                                                // 0x1120 (size: 0x50)
    class UStaticMesh* squadPathArrowMesh;                                            // 0x1178 (size: 0x8)
...
{
    FTimerHandle AICommandHandle;                                                     // 0x11D8 (size: 0x8)
    FTimerHandle aiActionHandle;                                                      // 0x11E0 (size: 0x8)
    FTimerHandle AILetterwritingHandle;                                               // 0x11E8 (size: 0x8)
    bool bDrawDebug;                                                                  // 0x11F0 (size: 0x1)
    TArray<FBattle> battles;                                                          // 0x1238 (size: 0x10)
    float generalRetreatDistSq;                                                       // 0x1248 (size: 0x4)
    TArray<FSegment> failedRoads;                                                     // 0x1250 (size: 0x10)
    int32 AI_general_cycles;                                                          // 0x1260 (size: 0x4)
    int32 AI_tactics_cycles;                                                          // 0x1264 (size: 0x4)
...
class ARTSMultiEngineCPP : public AActor
{
    ...
    TArray<class ASMUnit*> unitArr;                                                   // 0x02A0 (size: 0x10)
    TArray<FSquad> squads;                                                            // 0x02B0 (size: 0x10)
    TArray<FTransform> spawnPositions;                                                // 0x02C0 (size: 0x10)
    TArray<FTransform> takenSpawnPos;                                                 // 0x02D0 (size: 0x10)
    float gameSpeed;                                                                  // 0x02E0 (size: 0x4)
    TArray<FPPStruct> roadLinks;                                                      // 0x02F0 (size: 0x10)
    FTimerHandle interpRealPosUpdateHandle;                                           // 0x0300 (size: 0x8)
    FTimerHandle realposUpdateHandle;                                                 // 0x0308 (size: 0x8)
    FTimerHandle textureUpdateHandle;                                                 // 0x0310 (size: 0x8)
    FTimerHandle asyncCleanupTimer;                                                   // 0x0318 (size: 0x8)
    FTimerHandle challengeUpdateTimer;                                                // 0x0320 (size: 0x8)
    uint8 interpolationStaggerTimer;                                                  // 0x0334 (size: 0x1)
    float currAnimUpdateTime;                                                         // 0x0338 (size: 0x4)
    float lastAnimUpdateTime;                                                         // 0x033C (size: 0x4)
    float updateInterpRealPosLag;                                                     // 0x0340 (size: 0x4)
    class UStaticMesh* SM_WindmillShaft;                                              // 0x0348 (size: 0x8)
    float CullDistance;                                                               // 0x0350 (size: 0x4)
    float cullDistanceFar;                                                            // 0x0354 (size: 0x4)
    float cullDistanceMid;                                                            // 0x0358 (size: 0x4)
    float cullDistanceClose;                                                          // 0x035C (size: 0x4)
    float cullDistanceBuildings;                                                      // 0x0360 (size: 0x4)
    class UStaticMesh* SM_arrow;                                                      // 0x0368 (size: 0x8)
    class UStaticMesh* SM_torch;                                                      // 0x0370 (size: 0x8)
    class UDataTable* DT_ConstructionBPs;                                             // 0x0378 (size: 0x8)
    class UDataTable* DT_AnimsetCombat;                                               // 0x0380 (size: 0x8)
    class UDataTable* DT_AnimsetWork;                                                 // 0x0388 (size: 0x8)
    class UDataTable* DT_AnimsetGoat;                                                 // 0x0390 (size: 0x8)
    class UDataTable* DT_AnimsetChicken;                                              // 0x0398 (size: 0x8)
    class UDataTable* DT_AnimsetSheep;                                                // 0x03A0 (size: 0x8)
    class UDataTable* DT_AnimsetDeer;                                                 // 0x03A8 (size: 0x8)
    class UDataTable* DT_AnimsetHorse;                                                // 0x03B0 (size: 0x8)
    class UDataTable* DT_AnimsetBird;                                                 // 0x03B8 (size: 0x8)
    class UDataTable* DT_AnimsetOx;                                                   // 0x03C0 (size: 0x8)
    class UDataTable* DT_AnimsetHound;                                                // 0x03C8 (size: 0x8)
    class UDataTable* DT_AnimsetPig;                                                  // 0x03D0 (size: 0x8)
    class UDataTable* DT_AnimsetCombined;                                             // 0x03D8 (size: 0x8)
    class UMaterialParameterCollection* buildingMPC;                                  // 0x03E0 (size: 0x8)
    class UMaterialParameterCollection* MPC_Overlays;                                 // 0x03E8 (size: 0x8)
    TSubclassOf<class AObstacle> ObstacleBP;                                          // 0x03F0 (size: 0x8)
    class ALandscapeProxy* LandscapeProxy;                                            // 0x03F8 (size: 0x8)
    TArray<class ASMBuildingMaster*> buildingArr;                                     // 0x0400 (size: 0x10)
    TArray<class ASMBuildingMaster*> independentBuildings;                            // 0x0410 (size: 0x10)
    TArray<class AConstruction*> collapsingConstructions;                             // 0x0420 (size: 0x10)
    TArray<class ASMUnit*> deerArr;                                                   // 0x0430 (size: 0x10)
    TArray<class ASMUnit*> birdArr;                                                   // 0x0440 (size: 0x10)
    TArray<class ARegion*> Regions;                                                   // 0x0450 (size: 0x10)
    TArray<class ARoad*> borders;                                                     // 0x0460 (size: 0x10)
    TArray<class ARoad*> roads;                                                       // 0x0470 (size: 0x10)
    TArray<class ARoad*> streams;                                                     // 0x0480 (size: 0x10)
    TArray<class AResource*> resources;                                               // 0x0490 (size: 0x10)
    TArray<class UMaterialInstanceDynamic*> MaterialInstances;                        // 0x04A0 (size: 0x10)
    TArray<class APawnCPP*> pawns;                                                    // 0x04B0 (size: 0x10)
    class UTextureRenderTarget2D* RT_fields;                                          // 0x04C0 (size: 0x8)
    class UTextureRenderTarget2D* RT_plowing;                                         // 0x04C8 (size: 0x8)
    class UTextureRenderTarget2D* RT_Fertility;                                       // 0x04D0 (size: 0x8)
    class UTextureRenderTarget2D* RT_ForestMask;                                      // 0x04D8 (size: 0x8)
    class UTextureRenderTarget2D* RT_Desirability;                                    // 0x04E0 (size: 0x8)
    class UCanvas* Canvas;                                                            // 0x04E8 (size: 0x8)
    class UTextureRenderTarget2D* RT_RegionMask;                                      // 0x04F0 (size: 0x8)
    class UTextureRenderTarget2D* RT_roads;                                           // 0x04F8 (size: 0x8)
    class UTextureRenderTarget2D* RT_holes;                                           // 0x0500 (size: 0x8)
    class UTextureRenderTarget2D* RT_veins;                                           // 0x0508 (size: 0x8)
    class UTexture2D* dirtPattern01;                                                  // 0x0510 (size: 0x8)
    class UTexture2D* marketPattern;                                                  // 0x0518 (size: 0x8)
    class UTexture2D* softMask;                                                       // 0x0520 (size: 0x8)
    class UTexture2D* pitMaskTexture;                                                 // 0x0528 (size: 0x8)
    class UTexture2D* pitMaskDirt;                                                    // 0x0530 (size: 0x8)
    class UTexture2D* pitMaskNew;                                                     // 0x0538 (size: 0x8)
    class UDataTable* DT_socketMeshes;                                                // 0x0540 (size: 0x8)
    class UDataTable* techStats;                                                      // 0x05A0 (size: 0x8)
    class UDataTable* itemStats;                                                      // 0x05A8 (size: 0x8)
    TSubclassOf<class UFoliageInstancedStaticMeshComponent> foliageCustomDataBP;      // 0x0608 (size: 0x8)
    TArray<class UStaticMesh*> youngTreeMeshes;                                       // 0x0610 (size: 0x10)
    TArray<class UStaticMesh*> treeMeshesTriggeringForestBiome;                       // 0x0620 (size: 0x10)
    TArray<class UStaticMesh*> fieldBorderMeshes;                                     // 0x0630 (size: 0x10)
    TArray<class UStaticMesh*> fieldstoneMeshes;                                      // 0x0640 (size: 0x10)
    TSubclassOf<class AResource> treeBP;                                              // 0x0650 (size: 0x8)
    TSubclassOf<class AResource> ironResourceBP;                                      // 0x0658 (size: 0x8)
    TSubclassOf<class AResource> stoneResourceBP;                                     // 0x0660 (size: 0x8)
    TSubclassOf<class AResource> beeResourceBP;                                       // 0x0668 (size: 0x8)
    TSubclassOf<class AResource> shrubResourceBP;                                     // 0x0670 (size: 0x8)
    TSubclassOf<class AResource> shroomResourceBP;                                    // 0x0678 (size: 0x8)
    TSubclassOf<class AResource> handcartResourceBP;                                  // 0x0680 (size: 0x8)
    TSubclassOf<class AResource> bigcartResourceBP;                                   // 0x0688 (size: 0x8)
    TSubclassOf<class AResource> fishResourceBP;                                      // 0x0690 (size: 0x8)
    class AWeatherMaster* WMaster;                                                    // 0x0698 (size: 0x8)
    TSubclassOf<class AActor> ThunderLightBP;                                         // 0x06A0 (size: 0x8)
    class APMaster* PMaster;                                                          // 0x06A8 (size: 0x8)
    class APawnCPP* playerRef;                                                        // 0x06B0 (size: 0x8)
    TArray<FPPStruct> PPoints;                                                        // 0x06B8 (size: 0x10)
    class USnapDebris* SnapDebris;                                                    // 0x06E8 (size: 0x8)
    float startleDist;                                                                // 0x06F0 (size: 0x4)
    float startleDistSq;                                                              // 0x06F4 (size: 0x4)
    class ASoundBuddy* SoundBuddy;                                                    // 0x06F8 (size: 0x8)
    class UDataTable* DT_resourceSounds;                                              // 0x0700 (size: 0x8)
    TArray<class ASMUnit*> unitsMarkedForDestruction;                                 // 0x0708 (size: 0x10)
    class UParticleSystem* PS_dustPuff;                                               // 0x0718 (size: 0x8)
    class UParticleSystem* PS_BLoodSplatter;                                          // 0x0720 (size: 0x8)
    class UParticleSystem* PS_Thunder;                                                // 0x0728 (size: 0x8)
    class UParticleSystem* PS_dragDust;                                               // 0x0730 (size: 0x8)
    class UParticleSystem* PS_Impact_Smithing;                                        // 0x0738 (size: 0x8)
    class UParticleSystem* PS_Impact_Leaves;                                          // 0x0740 (size: 0x8)
    class UParticleSystem* PS_Impact_Wood;                                            // 0x0748 (size: 0x8)
    class UParticleSystem* PS_Impact_WoodDry;                                         // 0x0750 (size: 0x8)
    class UParticleSystem* PS_Impact_Stone;                                           // 0x0758 (size: 0x8)
    class UParticleSystem* PS_Impact_Plow;                                            // 0x0760 (size: 0x8)
    class UParticleSystem* PS_Impact_PloughHeavy;                                     // 0x0768 (size: 0x8)
    class UParticleSystem* PS_Impact_Sow;                                             // 0x0770 (size: 0x8)
    class UParticleSystem* PS_fireBig;                                                // 0x0778 (size: 0x8)
    class UParticleSystem* PS_fireGrid;                                               // 0x0780 (size: 0x8)
    class UParticleSystem* PS_fireplaceSmoke;                                         // 0x0788 (size: 0x8)
    class UParticleSystem* PS_chimneySmoke;                                           // 0x0790 (size: 0x8)
    class UParticleSystem* PS_malthouseSmoke;                                         // 0x0798 (size: 0x8)
    class UParticleSystem* PS_Splash;                                                 // 0x07A0 (size: 0x8)
    class UParticleSystem* PS_BucketSplash;                                           // 0x07A8 (size: 0x8)
    class UParticleSystem* PS_FlourPuff;                                              // 0x07B0 (size: 0x8)
    class UParticleSystem* PS_ThunderHit;                                             // 0x07B8 (size: 0x8)
    class UParticleSystem* PS_FieryHit;                                               // 0x07C0 (size: 0x8)
    class UParticleSystem* PS_Bees;                                                   // 0x07C8 (size: 0x8)
    class UParticleSystem* PS_TorchImpact;                                            // 0x07D0 (size: 0x8)
    class UParticleSystem* PS_fallingLeaves;                                          // 0x07D8 (size: 0x8)
    TArray<FUpgrade> upgrades;                                                        // 0x07E0 (size: 0x10)
    int32 predictionCalculationDays;                                                  // 0x07F0 (size: 0x4)
    float locationUpdateCounter;                                                      // 0x07F4 (size: 0x4)
    TArray<class ASMBuildingMaster*> fieldArr;                                        // 0x07F8 (size: 0x10)
    class UMaterialInterface* fieldRTmat;                                             // 0x0808 (size: 0x8)
    class UMaterialInterface* M_marketDecalMat;                                       // 0x0810 (size: 0x8)
    class UMaterialInterface* workDecalMat;                                           // 0x0818 (size: 0x8)
    class UMaterialInterface* moduleMaskMaterial;                                     // 0x0820 (size: 0x8)
    class UMaterialInterface* M_overlay_moduleMasks;                                  // 0x0828 (size: 0x8)
    class UMaterialInterface* M_overlay_fertility;                                    // 0x0830 (size: 0x8)
    int32 updatePosLag;                                                               // 0x0838 (size: 0x4)
    int32 lastUniqueID;                                                               // 0x083C (size: 0x4)
    TArray<int32> tradeableGoods;                                                     // 0x0840 (size: 0x10)
    TArray<int32> foodTypes;                                                          // 0x0850 (size: 0x10)
    TArray<int32> spoilingGoodTypes;                                                  // 0x0860 (size: 0x10)
    TArray<int32> granaryCollectionTypes;                                             // 0x0870 (size: 0x10)
    TArray<class UStaticMesh*> treeMeshes;                                            // 0x0880 (size: 0x10)
    TArray<class UStaticMesh*> shrubMeshes;                                           // 0x0890 (size: 0x10)
    TArray<class UStaticMesh*> oreMeshes;                                             // 0x08A0 (size: 0x10)
    TArray<class ADepositDecal*> deposits;                                            // 0x08B0 (size: 0x10)
    class UTexture2D* depositMask;                                                    // 0x08C0 (size: 0x8)
    class UMaterialInterface* depositMaterial;                                        // 0x08C8 (size: 0x8)
    class UMaterialInterface* depositMaterial_Salt;                                   // 0x08D0 (size: 0x8)
    class UMaterialInterface* depositMaterial_Clay;                                   // 0x08D8 (size: 0x8)
    TArray<FName> recruitmentPool;                                                    // 0x08E0 (size: 0x10)
    TArray<class ASMBuildingMaster*> tradepoints;                                     // 0x08F0 (size: 0x10)
    float basePrice;                                                                  // 0x0900 (size: 0x4)
    class UDataTable* DT_units;                                                       // 0x0908 (size: 0x8)
    float roadRadius;                                                                 // 0x0910 (size: 0x4)
    bool fogOfWar;                                                                    // 0x0914 (size: 0x1)
    TArray<FProximityCache> ProximityCache;                                           // 0x0918 (size: 0x10)
    int32 proximityCacheIterationID;                                                  // 0x0928 (size: 0x4)
    FTimerHandle ambientVoiceHandle;                                                  // 0x0930 (size: 0x8)
    FTimerHandle taskUpdateHandle;                                                    // 0x0938 (size: 0x8)
    int32 taskIteratorID;                                                             // 0x0940 (size: 0x4)
    FTimerHandle projUpdateHandle;                                                    // 0x0948 (size: 0x8)
    class UDataTable* DT_paragraphs;                                                  // 0x0950 (size: 0x8)
    TArray<FRelation> relations;                                                      // 0x0958 (size: 0x10)
    float mapSize;                                                                    // 0x0968 (size: 0x4)
    TSubclassOf<class UBannerAnimInstance> bannerAnimBP;                              // 0x0970 (size: 0x8)
    TSubclassOf<class ASMBanner> bannerBP;                                            // 0x0980 (size: 0x8)
    TArray<FOpenClaim> openClaims;                                                    // 0x0988 (size: 0x10)
    int32 kingsFavour_daysLeft;                                                       // 0x0998 (size: 0x4)
    TArray<class APawnCPP*> kingsFavourite;                                           // 0x09A0 (size: 0x10)
    class UMaterialInterface* ghostMaterial;                                          // 0x09B0 (size: 0x8)
    class UDataTable* DT_MercenaryCompanies;                                          // 0x09B8 (size: 0x8)
    TArray<FMercenaryCompany> availableMercs;                                         // 0x09C0 (size: 0x10)
    TArray<FMercenaryCompany> hiredMercs;                                             // 0x09D0 (size: 0x10)
    TArray<class UTexture2D*> availableLordPortraits;                                 // 0x09E0 (size: 0x10)
    TArray<class UTexture2D*> availableBanditPortraits;                               // 0x09F0 (size: 0x10)
    bool prepareRoadsForEditor;                                                       // 0x0A00 (size: 0x1)
    bool enableFertilityGrid;                                                         // 0x0A01 (size: 0x1)
    TArray<FLinearColor> fertilityGrid;                                               // 0x0A08 (size: 0x10)
    TArray<FLinearColor> fertilityGridLimits;                                         // 0x0A18 (size: 0x10)
    bool instancePositionUpdate;                                                      // 0x0A48 (size: 0x1)
    float deltaDiff;                                                                  // 0x0A4C (size: 0x4)
    TArray<int32> AI_buildingTypes;                                                   // 0x0A50 (size: 0x10)
    TArray<class ASMUnit*> livestockMerchants;                                        // 0x0A60 (size: 0x10)
    TArray<class ASMUnit*> freeMerchants;                                             // 0x0A70 (size: 0x10)
    int32 traderTimer;                                                                // 0x0A80 (size: 0x4)
    bool isConstructionAllowed;                                                       // 0x0A84 (size: 0x1)
    bool dustyMap;                                                                    // 0x0A85 (size: 0x1)
    bool spawnMerchants;                                                              // 0x0A86 (size: 0x1)
    bool canRain;                                                                     // 0x0A87 (size: 0x1)
    bool canSnow;                                                                     // 0x0A88 (size: 0x1)
    FTimerHandle updateArmiesHandle;                                                  // 0x0A90 (size: 0x8)
    TArray<class ASmoothForce*> smoothForces;                                         // 0x0A98 (size: 0x10)
    TSubclassOf<class ADecalActor> bloodDecalBP;                                      // 0x0AA8 (size: 0x8)
    TArray<int32> heads_combat;                                                       // 0x0AB0 (size: 0x10)
    bool drawBattleDebug;                                                             // 0x0AC8 (size: 0x1)
    bool drawImportantDebug;                                                          // 0x0AC9 (size: 0x1)
    bool drawPathfindingDebug;                                                        // 0x0ACA (size: 0x1)
    bool drawDebg_roadGuidePoints;                                                    // 0x0ACB (size: 0x1)
    class UMaterialInterface* plagueDecalMat;                                         // 0x0AD0 (size: 0x8)
    TArray<FString> maleNames;                                                        // 0x0AD8 (size: 0x10)
    bool spawnAIPlayers;                                                              // 0x0AE8 (size: 0x1)
    bool declareWarInstant;                                                           // 0x0AE9 (size: 0x1)
    bool AI_canBuild;                                                                 // 0x0AEA (size: 0x1)
    bool unitJustSpawned;                                                             // 0x0AEB (size: 0x1)
    TArray<FVein> veins;                                                              // 0x0AF0 (size: 0x10)
    class UMaterialInterface* boundsDecalMatRoadsOK;                                  // 0x0B00 (size: 0x8)
    class UStaticMesh* sidewalkMesh;                                                  // 0x0B08 (size: 0x8)
    class UStaticMesh* SM_fence;                                                      // 0x0B10 (size: 0x8)
    class UStaticMesh* SM_fence_B;                                                    // 0x0B18 (size: 0x8)
    class UStaticMesh* SM_plankFence;                                                 // 0x0B20 (size: 0x8)
    class UStaticMesh* townwallMesh;                                                  // 0x0B28 (size: 0x8)
    class UStaticMesh* SM_palisade;                                                   // 0x0B30 (size: 0x8)
    class UStaticMesh* SM_stoneWall;                                                  // 0x0B38 (size: 0x8)
    TArray<class UStaticMesh*> SM_stoneWall_pieces;                                   // 0x0B40 (size: 0x10)
    TArray<class UStaticMesh*> SM_stoneWall_platforms;                                // 0x0B50 (size: 0x10)
    TArray<class UStaticMesh*> doorMeshes;                                            // 0x0B60 (size: 0x10)
    TArray<class UStaticMesh*> stairMeshesWooden;                                     // 0x0B70 (size: 0x10)
    TArray<class UStaticMesh*> stairMeshesStone;                                      // 0x0B80 (size: 0x10)
    class UStaticMesh* SM_storage_log;                                                // 0x0B90 (size: 0x8)
    class USkeletalMesh* SM_banner;                                                   // 0x0B98 (size: 0x8)
    class UDataTable* DT_Upgrades;                                                    // 0x0BA0 (size: 0x8)
    class UStaticMesh* borderSegmentMesh;                                             // 0x0BA8 (size: 0x8)
    class UStaticMesh* SM_FatRoad;                                                    // 0x0BB0 (size: 0x8)
    class UStaticMesh* SM_shrubbyMesh;                                                // 0x0BB8 (size: 0x8)
    TArray<int32> snapPointsToVerify;                                                 // 0x0BC0 (size: 0x10)
    TArray<int32> snapPointsToBeingVerifiedAsync;                                     // 0x0BD0 (size: 0x10)
    TArray<FFieldSnapPoint> fieldSnapPoints;                                          // 0x0BE0 (size: 0x10)
    TArray<class UHierarchicalInstancedStaticMeshComponent*> hismPtrCache;            // 0x0BF0 (size: 0x10)
    float lastVeloUpdTime;                                                            // 0x0C00 (size: 0x4)
    FTimerHandle propagationHandle;                                                   // 0x0C08 (size: 0x8)
    TArray<class UParticleSystemComponent*> spawnedVfx;                               // 0x0C10 (size: 0x10)
    TArray<FDefferedMeshLoadItem> deferredMeshLoadList;                               // 0x0C20 (size: 0x10)
    TArray<FObstacle2D> obstacles;                                                    // 0x0C40 (size: 0x10)
    TArray<FObstacle2D> cachedBuildingBorderRoadObstacles;                            // 0x0C50 (size: 0x10)
    class URuntimeVirtualTexture* RVT_Landscape;                                      // 0x0C60 (size: 0x8)
    class URuntimeVirtualTexture* RVT_RoadMask;                                       // 0x0C68 (size: 0x8)
    class URuntimeVirtualTexture* RVT_Heightmap;                                      // 0x0C70 (size: 0x8)
    class URuntimeVirtualTexture* RVT_ModuleMask;                                     // 0x0C78 (size: 0x8)
    class URuntimeVirtualTexture* RVT_SnowDisplacementMask;                           // 0x0C80 (size: 0x8)
    class UMaterialInterface* fieldMaskMaterial;                                      // 0x0C88 (size: 0x8)
    class UMaterialInterface* marketMaskMaterial;                                     // 0x0C90 (size: 0x8)
    class UMaterialInterface* vegetableFieldMat;                                      // 0x0C98 (size: 0x8)
    TArray<int32> cliffObstacles;                                                     // 0x0CA0 (size: 0x10)
    TArray<FRoadGuidePoint> roadGuidePoints;                                          // 0x0CB0 (size: 0x10)
    TArray<int32> roadGuidePointsToVerify;                                            // 0x0CC0 (size: 0x10)
    class UDataTable* DT_BuildingPartAssemblies;                                      // 0x0CD0 (size: 0x8)
    class UDataTable* DT_BuildingPartMeshes;                                          // 0x0CD8 (size: 0x8)
    class UDataTable* DT_gameplayStaticMeshes;                                        // 0x0CE0 (size: 0x8)
    TMap<class FName, class FSoftClassPath> independentBuildingAssemblies;            // 0x0CE8 (size: 0x50)
    TMap<class FName, class FSoftClassPath> animatedBuildingBlueprints;               // 0x0D38 (size: 0x50)
    TArray<class UStaticMesh*> plantMeshes;                                           // 0x0D88 (size: 0x10)
    TArray<class UStaticMesh*> lazyBuildings;                                         // 0x0D98 (size: 0x10)
    class UStaticMesh* SM_wheat;                                                      // 0x0DA8 (size: 0x8)
    class UStaticMesh* SM_flax;                                                       // 0x0DB0 (size: 0x8)
    class UStaticMesh* SM_willowBranches;                                             // 0x0DB8 (size: 0x8)
    class UStaticMesh* SM_herbs;                                                      // 0x0DC0 (size: 0x8)
    class UStaticMesh* SM_appleTree;                                                  // 0x0DC8 (size: 0x8)
    class UStaticMesh* SM_appleTree_old;                                              // 0x0DD0 (size: 0x8)
    int32 newChallengeID;                                                             // 0x0DD8 (size: 0x4)
    TArray<FChallenge> challenges;                                                    // 0x0DE0 (size: 0x10)
    TArray<class ASMBuildingMaster*> retinueSpawnRequests;                            // 0x0DF0 (size: 0x10)
    TArray<class UTexture2D*> regimentSymbols;                                        // 0x0E20 (size: 0x10)
    class UStaticMesh* empty_instance;                                                // 0x0E30 (size: 0x8)
    class UStaticMesh* SM_dirtPlane;                                                  // 0x0E38 (size: 0x8)
    TArray<class UStaticMesh*> SM_AnimalTraps;                                        // 0x0E40 (size: 0x10)
    TArray<class UStaticMesh*> wallMeshes;                                            // 0x0E50 (size: 0x10)
    uint8 numSpawnedGenericAIs;                                                       // 0x0E60 (size: 0x1)
    class ADirector* questDirector;                                                   // 0x0E68 (size: 0x8)
    float lastObstructionYaw;                                                         // 0x0E70 (size: 0x4)
    float ppAbsoluteMaxConnectionDist;                                                // 0x0E74 (size: 0x4)
    float ppAbsoluteMaxConnectionDistSq;                                              // 0x0E78 (size: 0x4)
    float ppGridDensity;                                                              // 0x0E7C (size: 0x4)
    TArray<int32> edgePPGridPointIDs;                                                 // 0x0E80 (size: 0x10)
    FTimerHandle fertilityRedrawHandle;                                               // 0x0E90 (size: 0x8)
    TArray<int32> fertilityGridUpdateRequests;                                        // 0x0E98 (size: 0x10)
    TArray<FConnectionCache> roadConnectionCache;                                     // 0x0EA8 (size: 0x10)
    class UStaticMesh* workAreaMesh;                                                  // 0x0EB8 (size: 0x8)
    class UAnimSequenceBase* testAnimClip;                                            // 0x0EC0 (size: 0x8)
    class USkeletalMesh* testSzkeletalMesh;                                           // 0x0EC8 (size: 0x8)
    class UMaterialInterface* marketfieldMat;                                         // 0x0ED0 (size: 0x8)
    class UMaterialInterface* roadConnectionMat;                                      // 0x0ED8 (size: 0x8)
    TArray<class ASMBuilding*> spawnAsyncConstrBpQueue;                               // 0x0EE0 (size: 0x10)
    FTimerHandle spawnAsyncConstrBPHandle;                                            // 0x0EF0 (size: 0x8)
    class UStaticMesh* wallMarker;                                                    // 0x0EF8 (size: 0x8)
    class UStaticMesh* gatehousePreviewMesh;                                          // 0x0F00 (size: 0x8)
    class UStaticMesh* randomFormationSocketMesh;                                     // 0x0F08 (size: 0x8)
    TArray<FVector> randomFormationPositions;                                         // 0x0F10 (size: 0x10)
    bool writeUnitDebugLogs;                                                          // 0x0F20 (size: 0x1)
    TArray<FName> drawDebugFlags;                                                     // 0x0F28 (size: 0x10)
    TArray<int32> disableJobIDs;                                                      // 0x0F38 (size: 0x10)
    bool writeDebugLogs;                                                              // 0x0F48 (size: 0x1)
    TArray<FString> debugLog_AI_general;                                              // 0x0F50 (size: 0x10)
    TArray<FString> debugLog_AI_tactics;                                              // 0x0F60 (size: 0x10)
    bool shouldUpdateDebugLog_generalAI;                                              // 0x0F70 (size: 0x1)
    bool shouldUpdateDebugLog_tacticsAI;                                              // 0x0F71 (size: 0x1)
    float gameSpeedScheduled;                                                         // 0x0F74 (size: 0x4)
    float gameSpeedBeforePause;                                                       // 0x0F78 (size: 0x4)
    bool isGameSpeedScheduled;                                                        // 0x0F7C (size: 0x1)
    float locomotionTicksAdjusted;                                                    // 0x0F90 (size: 0x4)
    float locomotionTicksAdjustedPrevious;                                            // 0x0F94 (size: 0x4)
    bool useLegacyVATM;                                                               // 0x0F98 (size: 0x1)
    TMap<class EUnitRole, class FSoftClassPath> unitBlueprints;                       // 0x0FA0 (size: 0x50)
    TArray<FPopupCache> PopupCache;                                                   // 0x1040 (size: 0x10)
    FSessionAchievementData SessionAchievementData;                                   // 0x1050 (size: 0x30)
    TArray<FSpatialCell> SpatialGrid;                                                 // 0x1080 (size: 0x10)
    TArray<FPathRequest> asyncPathRequestsPending;                                    // 0x10A8 (size: 0x10)
    bool asyncLinkerCreated;                                                          // 0x1130 (size: 0x1)
    TArray<FQueuedLinkerDataEdit> queuedLinkerDataEdits;                              // 0x1138 (size: 0x10)
    TArray<FQueuedPathfinderDataEditCollection> pathfinerEditCollections;             // 0x1148 (size: 0x10)
    bool isNightAndAffectsGameplay;                                                   // 0x1158 (size: 0x1)
    TArray<FProceduralGroundCoverData> proceduralGroundCoverTypes;                    // 0x1160 (size: 0x10)
    TArray<class UInstancedStaticMeshComponent*> proceduralGroundCover;               // 0x1170 (size: 0x10)
    int32 numberOfCameraGroundCoverCellColumnsHalf;                                   // 0x1180 (size: 0x4)
    float cameraBasedGroundCoverCellSize;                                             // 0x1184 (size: 0x4)
    FTimerHandle cameraBasedGroundCoverHandle;                                        // 0x1188 (size: 0x8)
    TMap<class FVector, class EGroundCoverCategory> biomeCache;                       // 0x1190 (size: 0x50)
    int32 cameraBasedGroundCoverComponentIterator;                                    // 0x11E0 (size: 0x4)
    bool cameraBasedGroundCoverComponentFlipFlop;                                     // 0x11E4 (size: 0x1)
    TArray<FBox2D> groundCoverOcclusionBoxes;                                         // 0x11E8 (size: 0x10)
    class UStaticMesh* groundCoverDistributionSocketMesh;                             // 0x11F8 (size: 0x8)
    TArray<FVector> groundCoverDistributionSocketLocations;                           // 0x1200 (size: 0x10)
    TArray<EGroundCoverCategory> biomeCacheGrid;                                      // 0x1210 (size: 0x10)
    TArray<int32> biomeCacheUpdateRequests;                                           // 0x1220 (size: 0x10)
    FTimerHandle biomeCacheUpdateSlowHandle;                                          // 0x1230 (size: 0x8)
    FVector lastGroundCoverUpdateCameraLocation;                                      // 0x1238 (size: 0x18)
    TMap<FVector, float> groundCoverLandscapeHeightCache;                             // 0x1250 (size: 0x50)
    TArray<FTransformPairCollection> groundCoverLandscapeTransformCacheGrid;          // 0x12A0 (size: 0x10)
    class UStaticMesh* unitBannerMesh;                                                // 0x12B0 (size: 0x8)
    class UMaterialInterface* bouncedLightMaterial;                                   // 0x12C0 (size: 0x8)
    TArray<FCollisionCluster> collisionClusters;                                      // 0x12D8 (size: 0x10)
    TArray<class UVARuntimeComponent*> birdFlockVARuntimeComponents;                  // 0x12F8 (size: 0x10)
    TArray<FName> tutorialsLeftToShow;                                                // 0x1310 (size: 0x10)
    TArray<FGood> foreignMarketSupply;                                                // 0x1320 (size: 0x10)
    TArray<class ASMBuildingMaster*> landscapeDeformationBuildings;                   // 0x1350 (size: 0x10)
    TArray<FTradeLogEntry> tradeLog;                                                  // 0x1360 (size: 0x10)
    TMap<class ASMBuildingMaster*, class USphereReflectionCaptureComponent*> reflectionSpheres; // 0x1390 (size: 0x50)
...
class ARegion : public AActor
{
    ...
    TArray<int32> squadsPresent;                                                      // 0x0520 (size: 0x10)
    TArray<FName> aiTags;                                                             // 0x0530 (size: 0x10)
    TArray<FGood> averageProduction;                                                  // 0x0540 (size: 0x10)
    TArray<FGood> averageConsumption;                                                 // 0x0550 (size: 0x10)
    TArray<int32> cantFitBuildings;                                                   // 0x0560 (size: 0x10)
    int32 tier;                                                                       // 0x0570 (size: 0x4)
    int32 marketAtt;                                                                  // 0x0574 (size: 0x4)
    int32 expenses;                                                                   // 0x0578 (size: 0x4)
    float supplies_food;                                                              // 0x057C (size: 0x4)
    float supplies_wood;                                                              // 0x0580 (size: 0x4)
    float lastLoyaltyChangeMessageTime;                                               // 0x0584 (size: 0x4)
    TMap<class ASMBuildingMaster*, class FHarvest> harvestData;                       // 0x0588 (size: 0x50)
    bool isSettled;                                                                   // 0x05D8 (size: 0x1)
    int32 settlementLevel;                                                            // 0x05DC (size: 0x4)
    TArray<int32> targetInventory;                                                    // 0x05E0 (size: 0x10)
    bool isUnderAttack;                                                               // 0x0690 (size: 0x1)
    TArray<FProblem> problems;                                                        // 0x0698 (size: 0x10)
    TArray<class ASMUnit*> residents;                                                 // 0x06A8 (size: 0x10)
    TArray<class ASMUnit*> corpses;                                                   // 0x06B8 (size: 0x10)
    FBox2D regionBounds;                                                              // 0x06C8 (size: 0x28)
    TArray<FBuildingLookup> BuildingLookup;                                           // 0x06F0 (size: 0x10)
    TArray<FOption> AI_failedBuilds;                                                  // 0x0700 (size: 0x10)
    FString retinueName;                                                              // 0x0710 (size: 0x10)
    TArray<ETradeRule> tradeRules;                                                    // 0x0720 (size: 0x10)
    TArray<int32> forbidGlobalTradeGoodTypes;                                         // 0x0760 (size: 0x10)
    TArray<ETradePartnerLimit> tradePartnerLimits;                                    // 0x0770 (size: 0x10)
    TMap<int32, uint8> tradeRouteLevels;                                              // 0x0780 (size: 0x50)
    TArray<class ASMUnit*> tradeRouteMerchants;                                       // 0x07D0 (size: 0x10)
    TArray<class UFoliageInstancedStaticMeshComponent*> regionalFoliage;              // 0x07E0 (size: 0x10)
    TArray<class UFoliageInstancedStaticMeshComponent*> treeComponents;               // 0x07F0 (size: 0x10)
    TArray<class UFoliageInstancedStaticMeshComponent*> fieldstoneComponents;         // 0x0800 (size: 0x10)
    TArray<FVector> regionBorder;                                                     // 0x0810 (size: 0x10)
    TArray<FVector> triangulatedRegion;                                               // 0x0820 (size: 0x10)
    TArray<FVector> triangulatedRegionShrunk;                                         // 0x0830 (size: 0x10)
    class ASMBuildingMaster* townCenter;                                              // 0x0840 (size: 0x8)
    bool autoBuyCommodities;                                                          // 0x0848 (size: 0x1)
    bool startedPollarding;                                                           // 0x0849 (size: 0x1)
    TArray<FFoliageReference> growingFoliage;                                         // 0x0850 (size: 0x10)
    bool hasWell;                                                                     // 0x0860 (size: 0x1)
    int32 approval;                                                                   // 0x0864 (size: 0x4)
    TArray<FApprovalMemory> summedApprovalFactors;                                    // 0x0868 (size: 0x10)
    int32 publicOrder;                                                                // 0x0878 (size: 0x4)
    TArray<FApprovalMemory> publicOrderMemory;                                        // 0x0880 (size: 0x10)
    TArray<FApprovalMemory> summedPublicOrderFactors;                                 // 0x0890 (size: 0x10)
    int32 numMouthsToFeed;                                                            // 0x08A0 (size: 0x4)
    bool bAnyBuildingOnFire;                                                          // 0x08A4 (size: 0x1)
    TArray<class ASMBuildingMaster*> buildingsNeedingRefueling;                       // 0x08A8 (size: 0x10)
    TMap<int32, int32> constructionReserve;                                           // 0x08B8 (size: 0x50)
    int32 nextLivestockOrderIn;                                                       // 0x0908 (size: 0x4)
    TArray<class ARoad*> roadBlueprints;                                              // 0x0910 (size: 0x10)
    TArray<class AActor*> resourceNodes_earlyFood;                                    // 0x0920 (size: 0x10)
    TArray<class AActor*> resourceNodes_forest;                                       // 0x0930 (size: 0x10)
    TArray<class AActor*> resourceNodes_open;                                         // 0x0940 (size: 0x10)
    int32 retinueSquadID;                                                             // 0x0950 (size: 0x4)
    TArray<int32> policiesSigned;                                                     // 0x0958 (size: 0x10)
    FName regionUniqueTag;                                                            // 0x0968 (size: 0x8)
    TArray<FWorkerFamily> workerFamilies;                                             // 0x0970 (size: 0x10)
    ESettlementType settlementType;                                                   // 0x0980 (size: 0x1)
    class ARegion* outpostToRegion;                                                   // 0x0988 (size: 0x8)
    TMap<FName, int32> taxRates;                                                      // 0x0990 (size: 0x50)
...
class ARoad : public AActor
{
    ...
    TArray<class USplineMeshComponent*> Meshes;                                       // 0x02A0 (size: 0x10)
    ...
    class UStaticMesh* fieldMesh;                                                     // 0x02D8 (size: 0x8)
    class UMaterialInterface* roadMat_start;                                          // 0x02E0 (size: 0x8)
    class UMaterialInterface* roadMat_end;                                            // 0x02E8 (size: 0x8)
    class UMaterialInterface* roadMat_short;                                          // 0x02F0 (size: 0x8)
    class UMaterialInterface* borderMat;                                              // 0x02F8 (size: 0x8)
    class UMaterialInterface* MaterialOverride;                                       // 0x0300 (size: 0x8)
    class UTexture2D* roadMask;                                                       // 0x0308 (size: 0x8)
    bool commit;                                                                      // 0x0310 (size: 0x1)
    class UMaterialInterface* guideMat;                                               // 0x0318 (size: 0x8)
    class UMaterialInterface* guideMatBorder;                                         // 0x0320 (size: 0x8)
    float spacing;                                                                    // 0x0328 (size: 0x4)
    float pieceLength;                                                                // 0x032C (size: 0x4)
    TArray<class ASMBuildingMaster*> connectedMarkets;                                // 0x0330 (size: 0x10)
    bool marketRoad;                                                                  // 0x0340 (size: 0x1)
    TArray<FRoadFork> forks;                                                          // 0x0348 (size: 0x10)
    TArray<FVector> envelopmentPoints;                                                // 0x0358 (size: 0x10)
    TArray<FVector> cachedLocations;                                                  // 0x0368 (size: 0x10)
    TArray<FVector> cachedEdgeA;                                                      // 0x0378 (size: 0x10)
    TArray<FVector> cachedEdgeB;                                                      // 0x0388 (size: 0x10)
    TArray<FRotator> cachedRotations;                                                 // 0x0398 (size: 0x10)
    TArray<FVector> cachedEdgeCollisionA;                                             // 0x03A8 (size: 0x10)
    TArray<FVector> cachedEdgeCollisionB;                                             // 0x03B8 (size: 0x10)
    class ARegion* regionA;                                                           // 0x03C8 (size: 0x8)
    class ARegion* regionB;                                                           // 0x03D0 (size: 0x8)
    class UMaterialInstanceDynamic* MI_Border;                                        // 0x03D8 (size: 0x8)
    int32 numTraversedByMerchants;                                                    // 0x03E0 (size: 0x4)
    bool isBorder;                                                                    // 0x03E4 (size: 0x1)
    bool isGuide;                                                                     // 0x03E5 (size: 0x1)
    TArray<FVector> forkSnapPoints;                                                   // 0x03E8 (size: 0x10)
    TArray<class ARoad*> forkSnapRoads;                                               // 0x03F8 (size: 0x10)
    bool kingsRoad;                                                                   // 0x0408 (size: 0x1)
    float roadWidth;                                                                  // 0x040C (size: 0x4)
    TArray<FVector> fatPositions;                                                     // 0x0410 (size: 0x10)
    TArray<int32> fatPositionID;                                                      // 0x0420 (size: 0x10)
    TArray<FVector> forkSnapDirs;                                                     // 0x0430 (size: 0x10)
    bool resampled;                                                                   // 0x0440 (size: 0x1)
    FBox2D roadBounds;                                                                // 0x0448 (size: 0x28)
    TArray<class UStaticMeshComponent*> FoliageComponents;                            // 0x0470 (size: 0x10)
    ERoadType roadType;                                                               // 0x0480 (size: 0x1)
    EWallType wallType;                                                               // 0x0481 (size: 0x1)
    bool isBlueprint;                                                                 // 0x0482 (size: 0x1)
    float roadTangentScale;                                                           // 0x0484 (size: 0x4)
    TArray<FTransform> gateTransforms;                                                // 0x0488 (size: 0x10)
    TArray<int32> cullSplinePointIDs;                                                 // 0x0498 (size: 0x10)
    bool fieldSnapPointsCreated;                                                      // 0x04A8 (size: 0x1)
    bool flipSplineOrderForTriangulation;                                             // 0x04A9 (size: 0x1)
...
class ASMBuilding : public AStaticMeshActor
{
    ...
    TArray<FVector> bpoints;                                                          // 0x03A0 (size: 0x10)
    float highestObstacleSocket;                                                      // 0x03B0 (size: 0x4)
...
class ASMBuildingMaster : public AStaticMeshActor
{
    ...
    bool shouldUpdateCarts;                                                           // 0x0BB8 (size: 0x1)
    TArray<class AResource*> handcarts;                                               // 0x0BC0 (size: 0x10)
    TArray<FSegment> wallConnectionSegments;                                          // 0x0BD0 (size: 0x10)
    ...
    TArray<class AActor*> blueprints;                                                 // 0x0C18 (size: 0x10)
    TArray<class AActor*> blueprintGhosts;                                            // 0x0C28 (size: 0x10)
    TArray<FGood> equipmentDistributionReserve;                                       // 0x0C40 (size: 0x10)
    int32 productionFocus;                                                            // 0x0C50 (size: 0x4)
    TArray<int32> storageFilter;                                                      // 0x0C58 (size: 0x10)
    EBuildingFunction buildingFunction;                                               // 0x0C68 (size: 0x1)
    int32 mourningPeriod;                                                             // 0x0C6C (size: 0x4)
    class AActor* VAMP_AnimatedBuildingBP;                                            // 0x0C70 (size: 0x8)
    bool VAMP_isPlaying;                                                              // 0x0C78 (size: 0x1)
    class UInstancedStaticMeshComponent* instancedWallComponent;                      // 0x0C80 (size: 0x8)
    TArray<FSegment2D> instancedWallSegments;                                         // 0x0C88 (size: 0x10)
    TArray<int32> instancedWallSegmentIDsSpawned;                                     // 0x0C98 (size: 0x10)
    TArray<int32> instancedWallSegmentIDsOmittedSpawningDueToOverlap;                 // 0x0CA8 (size: 0x10)
    TArray<class ASMUnit*> unitCache_transportTasks;                                  // 0x0CB8 (size: 0x10)
    TMap<int32, int32> unitCache_transportTasks_distanceGroupCache;                   // 0x0CC8 (size: 0x50)
    float unitCache_transportTasks_lastTimeCached;                                    // 0x0D18 (size: 0x4)
    TArray<class ASMUnit*> unitCache_farmingTasks;                                    // 0x0D20 (size: 0x10)
    TArray<class ASMUnit*> unitCache_craftingTasks;                                   // 0x0D30 (size: 0x10)
    TArray<int32> assignedFamilyIDs;                                                  // 0x0D50 (size: 0x10)
    TArray<int32> occupantFamilyIDs;                                                  // 0x0D60 (size: 0x10)
    class ASMBuildingMaster* trainConnectionSource;                                   // 0x0D70 (size: 0x8)
    class ASMBuildingMaster* trainConnectionTarget;                                   // 0x0D78 (size: 0x8)
    class ARegion* trainConnectionRegion;                                             // 0x0D80 (size: 0x8)
    int32 muleTrain_buyingType;                                                       // 0x0D88 (size: 0x4)
    int32 muleTrain_sellingType;                                                      // 0x0D8C (size: 0x4)
    class UPointLightComponent* fakeBounceLight;                                      // 0x0D90 (size: 0x8)
    bool allowMarketStalls;                                                           // 0x0D98 (size: 0x1)
    TArray<int32> shouldHighlightInventoryTabIDs;                                     // 0x0DA0 (size: 0x10)
...
{
    class ARTSMultiEngineCPP* masterPtr;                                              // 0x0290 (size: 0x8)
    int32 instanceArrayIndex;                                                         // 0x0298 (size: 0x4)
    FVector2D instanceArrayTexturePos2D;                                              // 0x02A0 (size: 0x10)
    FUnitDataStruct Data;                                                             // 0x02B0 (size: 0x88)
    FRotator slowRotation;                                                            // 0x0338 (size: 0x18)
    FVector slowRotationV;                                                            // 0x0350 (size: 0x18)
    FRotator Rotation;                                                                // 0x0368 (size: 0x18)
    FVector rotationV;                                                                // 0x0380 (size: 0x18)
    FVector finishingPos;                                                             // 0x0398 (size: 0x18)
    FVector instanceOffset;                                                           // 0x03B0 (size: 0x18)
    FRotator offsetRot;                                                               // 0x03C8 (size: 0x18)
    int32 pathPoint;                                                                  // 0x03E0 (size: 0x4)
    TArray<FVector> pathArr;                                                          // 0x03E8 (size: 0x10)
    int32 Checkpoint;                                                                 // 0x03F8 (size: 0x4)
    TArray<FVector> checkpoints;                                                      // 0x0400 (size: 0x10)
    TArray<FVector> temporalCheckpoints;                                              // 0x0410 (size: 0x10)
    TArray<FPPStruct> LPath;                                                          // 0x0420 (size: 0x10)
    float LPathSpeedfactorCache;                                                      // 0x0430 (size: 0x4)
    bool isOnBuilding;                                                                // 0x0434 (size: 0x1)
    float moveDelay;                                                                  // 0x0438 (size: 0x4)
    float delayFactor;                                                                // 0x043C (size: 0x4)
    float lastHeightCheck;                                                            // 0x0440 (size: 0x4)
    FVector realPos;                                                                  // 0x0448 (size: 0x18)
    FVector interpolatedMoveVector;                                                   // 0x0460 (size: 0x18)
    FVector obstructionV;                                                             // 0x0478 (size: 0x18)
    FVector Target;                                                                   // 0x0490 (size: 0x18)
    float pathCheckTimer;                                                             // 0x04A8 (size: 0x4)
    FRotator realRot;                                                                 // 0x04B0 (size: 0x18)
    uint8 obstructed;                                                                 // 0x04C8 (size: 0x1)
    bool avoidedObstruction;                                                          // 0x04C9 (size: 0x1)
    FVector pushed;                                                                   // 0x04D0 (size: 0x18)
    float velo;                                                                       // 0x04EC (size: 0x4)
    bool isWaiting;                                                                   // 0x0508 (size: 0x1)
    float waitingTime;                                                                // 0x050C (size: 0x4)
    float Radius;                                                                     // 0x0510 (size: 0x4)
    float Speed;                                                                      // 0x0518 (size: 0x4)
    float realSpeed;                                                                  // 0x051C (size: 0x4)
    FVector interpRealPos;                                                            // 0x0550 (size: 0x18)
    bool closeToFinal;                                                                // 0x059D (size: 0x1)
    bool dead;                                                                        // 0x05A5 (size: 0x1)
    ...
    class ARoad* onRoad;                                                              // 0x0640 (size: 0x8)
    class UStaticMeshComponent* Decal;                                                // 0x0698 (size: 0x8)
    class UStaticMeshComponent* MoveDecal;                                            // 0x06A0 (size: 0x8)
    class UMaterialInterface* decalMat;                                               // 0x06A8 (size: 0x8)
    bool snappedToTarget;                                                             // 0x06B0 (size: 0x1)
    float leftoverSpeed;                                                              // 0x06B4 (size: 0x4)
    FTimerHandle spatialUpdateHandle;                                                 // 0x06B8 (size: 0x8)
    FVector dir;                                                                      // 0x06C8 (size: 0x18)
    TArray<FGood> Inventory;                                                          // 0x06E0 (size: 0x10)
    class APawnCPP* ownerPawn;                                                        // 0x06F0 (size: 0x8)
    FString DisplayName;                                                              // 0x06F8 (size: 0x10)
    TArray<FTask> tasks;                                                              // 0x0708 (size: 0x10)
    int32 Action;                                                                     // 0x0718 (size: 0x4)
    class ASMUnit* actionPartner;                                                     // 0x0720 (size: 0x8)
    uint8 wasIdle;                                                                    // 0x072C (size: 0x1)
    class ASMBuildingMaster* Home;                                                    // 0x0730 (size: 0x8)
    class ASMBuildingMaster* animalAssignedTo;                                        // 0x0738 (size: 0x8)
    FTimerHandle taskUpdateHandle;                                                    // 0x0740 (size: 0x8)
    class ASMUnit* reservedTo;                                                        // 0x0748 (size: 0x8)
    uint8 monthlyConsumptionDay;                                                      // 0x0750 (size: 0x1)
    int32 yearlyConsumptionDay;                                                       // 0x0754 (size: 0x4)
    FConsumptionStatus ConsumptionStatus;                                             // 0x0758 (size: 0x7)
    TArray<FApprovalMemory> ApprovalMemory;                                           // 0x0760 (size: 0x10)
    float approval;                                                                   // 0x0770 (size: 0x4)
    float disease;                                                                    // 0x0774 (size: 0x4)
    float woolYield;                                                                  // 0x0778 (size: 0x4)
    float baseAttack;                                                                 // 0x077C (size: 0x4)
    float baseDefence;                                                                // 0x0780 (size: 0x4)
    float baseRange;                                                                  // 0x0784 (size: 0x4)
    float baseBlock;                                                                  // 0x0788 (size: 0x4)
    float baseCharge;                                                                 // 0x078C (size: 0x4)
    float att;                                                                        // 0x0790 (size: 0x4)
    float rangedAtt;                                                                  // 0x0794 (size: 0x4)
    float def;                                                                        // 0x0798 (size: 0x4)
    float Range;                                                                      // 0x079C (size: 0x4)
    float rangeSq;                                                                    // 0x07A0 (size: 0x4)
    float shootingRange;                                                              // 0x07A4 (size: 0x4)
    float shootingRangeSq;                                                            // 0x07A8 (size: 0x4)
    float bLock;                                                                      // 0x07AC (size: 0x4)
    float charge;                                                                     // 0x07B0 (size: 0x4)
    float chargeStop;                                                                 // 0x07B4 (size: 0x4)
    float armorPierce;                                                                // 0x07B8 (size: 0x4)
    float shieldwallBlock;                                                            // 0x07BC (size: 0x4)
    float morale;                                                                     // 0x07C0 (size: 0x4)
    float stamina;                                                                    // 0x07C4 (size: 0x4)
    bool defenseBroken;                                                               // 0x07C8 (size: 0x1)
    float combatExperience;                                                           // 0x07CC (size: 0x4)
    bool bHoldingLine;                                                                // 0x07D0 (size: 0x1)
    bool bFortified;                                                                  // 0x07D1 (size: 0x1)
    bool bFireAtWill;                                                                 // 0x07D2 (size: 0x1)
    bool bHoldFire;                                                                   // 0x07D3 (size: 0x1)
    FEquipment Equipment;                                                             // 0x07D4 (size: 0x1C)
    FEquipment equipmentOnRally;                                                      // 0x07F0 (size: 0x1C)
    bool performedHit;                                                                // 0x080C (size: 0x1)
    bool animFinished;                                                                // 0x080D (size: 0x1)
    class ASMUnit* closestEnemy;                                                      // 0x0810 (size: 0x8)
    float closestEnemyDist;                                                           // 0x0818 (size: 0x4)
    bool battleStance;                                                                // 0x081C (size: 0x1)
    bool closeProximity;                                                              // 0x081D (size: 0x1)
    bool fightingStance;                                                              // 0x081E (size: 0x1)
    bool inChargeDistance;                                                            // 0x081F (size: 0x1)
    ELocomotionStance locomotionStance;                                               // 0x0820 (size: 0x1)
    bool force1hAttacks;                                                              // 0x0821 (size: 0x1)
    EAttackMethod attackMethod;                                                       // 0x0822 (size: 0x1)
    bool attackVills;                                                                 // 0x0823 (size: 0x1)
    int32 relaxingTime;                                                               // 0x0824 (size: 0x4)
    int32 repetitions;                                                                // 0x0828 (size: 0x4)
    int32 targetRepetitions;                                                          // 0x082C (size: 0x4)
    int32 queuedAction;                                                               // 0x0830 (size: 0x4)
    bool stealthing;                                                                  // 0x0834 (size: 0x1)
    bool sprintMode;                                                                  // 0x0835 (size: 0x1)
    float moveToEnemyRange;                                                           // 0x0838 (size: 0x4)
    class ASMUnit* following;                                                         // 0x0840 (size: 0x8)
    class ASMUnit* follower;                                                          // 0x0848 (size: 0x8)
    int32 babyTime;                                                                   // 0x0850 (size: 0x4)
    bool isAnimal;                                                                    // 0x0854 (size: 0x1)
    TArray<class ASMUnit*> closeUnits;                                                // 0x0858 (size: 0x10)
    int32 queuedItem;                                                                 // 0x0868 (size: 0x4)
    uint8 animRandomVariation;                                                        // 0x086C (size: 0x1)
    uint8 lastPlayedVariation;                                                        // 0x086D (size: 0x1)
    TMap<EEquipmentSlot, uint8> equipmentMeshVariations;                              // 0x0870 (size: 0x50)
    TMap<EEquipmentSlot, uint8> equipmentTextureVariations;                           // 0x08C0 (size: 0x50)
    TMap<class EEquipmentSlot, class FVector> equipmentColorSchemeUVs;                // 0x0910 (size: 0x50)
    float shieldSymbolIndex;                                                          // 0x0960 (size: 0x4)
    float moveDecalAnim;                                                              // 0x0964 (size: 0x4)
    float moveDecalAnimTarget;                                                        // 0x0968 (size: 0x4)
    bool cameraSuperClose;                                                            // 0x096C (size: 0x1)
    bool cameraClose;                                                                 // 0x096D (size: 0x1)
    bool cameraCenterClose;                                                           // 0x096E (size: 0x1)
    bool cameraMid;                                                                   // 0x096F (size: 0x1)
    float distToCameraSq;                                                             // 0x0970 (size: 0x4)
    EUnitRole currentUnitRole;                                                        // 0x0974 (size: 0x1)
    EUnitRole assignedUnitRole;                                                       // 0x0975 (size: 0x1)
    bool startled;                                                                    // 0x0976 (size: 0x1)
    float lastStepFrame;                                                              // 0x0978 (size: 0x4)
    class ASoundBuddy* SoundBuddy;                                                    // 0x0980 (size: 0x8)
    bool hasBasicNeeds;                                                               // 0x0988 (size: 0x1)
    float meleeTraining;                                                              // 0x098C (size: 0x4)
    float archeryTraining;                                                            // 0x0990 (size: 0x4)
    FName unitTemp;                                                                   // 0x0994 (size: 0x8)
    bool squadCenterCalculated;                                                       // 0x099C (size: 0x1)
    int32 surrounded;                                                                 // 0x09A0 (size: 0x4)
    int32 exposed;                                                                    // 0x09A4 (size: 0x4)
    class ASMUnit* lastFiringTarget;                                                  // 0x09A8 (size: 0x8)
    bool spreadOut;                                                                   // 0x09B0 (size: 0x1)
    bool friendlyFirePossible;                                                        // 0x09B1 (size: 0x1)
    bool friendlyFireAllowed;                                                         // 0x09B2 (size: 0x1)
    bool tacticalRetreat;                                                             // 0x09B3 (size: 0x1)
    FVector retreatPosition;                                                          // 0x09B8 (size: 0x18)
    float engagementPercentage;                                                       // 0x09D0 (size: 0x4)
    int32 DrawTime;                                                                   // 0x09D4 (size: 0x4)
    class ARegion* currentRegion;                                                     // 0x09D8 (size: 0x8)
    TArray<FVector2D> targetMemory;                                                   // 0x09E0 (size: 0x10)
    class ASMBuildingMaster* chosenPasture;                                           // 0x09F8 (size: 0x8)
    int32 mountAnimFlavour;                                                           // 0x0A00 (size: 0x4)
    bool isCharging;                                                                  // 0x0A18 (size: 0x1)
    float distToFinalSq;                                                              // 0x0A1C (size: 0x4)
    float distToTargetSq;                                                             // 0x0A20 (size: 0x4)
    FVector lastDifference;                                                           // 0x0A28 (size: 0x18)
    float lastYawDiff;                                                                // 0x0A40 (size: 0x4)
    float lastLocationUpdateTime;                                                     // 0x0A44 (size: 0x4)
    float prevFrameA;                                                                 // 0x0A48 (size: 0x4)
    float prevFrameB;                                                                 // 0x0A4C (size: 0x4)
    float prevBlend;                                                                  // 0x0A50 (size: 0x4)
    float prevWheelRot;                                                               // 0x0A54 (size: 0x4)
    FVector prevActorLocation;                                                        // 0x0A58 (size: 0x18)
    FVector lastWPOIncrement;                                                         // 0x0A70 (size: 0x18)
    float avgDistToCheckpoint;                                                        // 0x0A88 (size: 0x4)
    float personalChargeThreshold;                                                    // 0x0A8C (size: 0x4)
    float personalRunThreshold;                                                       // 0x0A90 (size: 0x4)
    float diseaseResistance;                                                          // 0x0A94 (size: 0x4)
    uint8 squadAI_updateLag;                                                          // 0x0A98 (size: 0x1)
    FVector forcePush;                                                                // 0x0AA0 (size: 0x18)
    int32 pushAuraLag;                                                                // 0x0AB8 (size: 0x4)
    float potential;                                                                  // 0x0ABC (size: 0x4)
    TArray<FPotentialFactor> potentialFactors;                                        // 0x0AC0 (size: 0x10)
    EBehaviourStance behaviourStance;                                                 // 0x0AD0 (size: 0x1)
    EPushStance pushStance;                                                           // 0x0AD1 (size: 0x1)
    EPushStance pushStanceBeforeMoraleDrop;                                           // 0x0AD2 (size: 0x1)
    bool moraleDropChangedStance;                                                     // 0x0AD3 (size: 0x1)
    float idleThreshold;                                                              // 0x0AD4 (size: 0x4)
    float smoothRotationSpeed;                                                        // 0x0AD8 (size: 0x4)
    int32 locomotionAnim;                                                             // 0x0ADC (size: 0x4)
    bool locomotionIsIdle;                                                            // 0x0AE0 (size: 0x1)
    bool altCarryAnim;                                                                // 0x0AE1 (size: 0x1)
    int32 currAnim;                                                                   // 0x0AE4 (size: 0x4)
    int32 targetAnim;                                                                 // 0x0AEC (size: 0x4)
    float lastCharge;                                                                 // 0x0AF0 (size: 0x4)
    int32 lastSoundFrame;                                                             // 0x0AF4 (size: 0x4)
    int32 currAnimMount;                                                              // 0x0AF8 (size: 0x4)
    int32 targetAnimMount;                                                            // 0x0AFC (size: 0x4)
    bool guaranteedAttack;                                                            // 0x0B00 (size: 0x1)
    FVector attackFormationPos;                                                       // 0x0B08 (size: 0x18)
    bool keepingFormationWhileEngaged;                                                // 0x0B20 (size: 0x1)
    class ASMUnit* attackFormationEnemy;                                              // 0x0B28 (size: 0x8)
    float unity;                                                                      // 0x0B30 (size: 0x4)
    float Chaos;                                                                      // 0x0B34 (size: 0x4)
    bool foundCommonLpath;                                                            // 0x0B38 (size: 0x1)
    int32 equipmentLevel_body;                                                        // 0x0B44 (size: 0x4)
    int32 equipmentLevel_helmet;                                                      // 0x0B48 (size: 0x4)
    TArray<float> upgradeTimes;                                                       // 0x0B50 (size: 0x10)
    float lastShootingDrawTimeUpdateTime;                                             // 0x0B60 (size: 0x4)
    float blendedFrames_reference;                                                    // 0x0B64 (size: 0x4)
    float blendReserve_reference;                                                     // 0x0B68 (size: 0x4)
    float blendedFrames;                                                              // 0x0B6C (size: 0x4)
    float blendReserve;                                                               // 0x0B70 (size: 0x4)
    TArray<EUnitTrait> traits;                                                        // 0x0B78 (size: 0x10)
    bool unitsPassingThrough;                                                         // 0x0B88 (size: 0x1)
    bool unitsPassingSameDir;                                                         // 0x0B89 (size: 0x1)
    TArray<class ASMUnit*> possibleTargets;                                           // 0x0B90 (size: 0x10)
    float moveToFaceDot;                                                              // 0x0BA0 (size: 0x4)
    float moveRightDot;                                                               // 0x0BA4 (size: 0x4)
    FVector movingRightV;                                                             // 0x0BA8 (size: 0x18)
    bool forceFacingForward;                                                          // 0x0BC0 (size: 0x1)
    bool movingSideways;                                                              // 0x0BC1 (size: 0x1)
    bool strafeRight;                                                                 // 0x0BC2 (size: 0x1)
    bool strafeLeft;                                                                  // 0x0BC3 (size: 0x1)
    bool walkForward;                                                                 // 0x0BC4 (size: 0x1)
    int32 closeEnemyUpdateLag;                                                        // 0x0BC8 (size: 0x4)
    float nearThresholdSq;                                                            // 0x0BCC (size: 0x4)
    float animSpeedFac;                                                               // 0x0BD0 (size: 0x4)
    bool squadAnyFriendlyFirePossible;                                                // 0x0BD4 (size: 0x1)
    FName currentAnimset;                                                             // 0x0BD8 (size: 0x8)
    EAnimMode animMode;                                                               // 0x0BE0 (size: 0x1)
    int32 instanceUpdateLag;                                                          // 0x0BE4 (size: 0x4)
    FVector lastInstacePosition;                                                      // 0x0BE8 (size: 0x18)
    FVector prevToLastInstacePosition;                                                // 0x0C00 (size: 0x18)
    TArray<int32> roadPathPointIDs;                                                   // 0x0C18 (size: 0x10)
    class ARegion* migratedTo;                                                        // 0x0C28 (size: 0x8)
    class ASMBuildingMaster* dropsTo;                                                 // 0x0C30 (size: 0x8)
    class ARegion* lastTradedWith;                                                    // 0x0C38 (size: 0x8)
    class ARegion* lastSoldTo;                                                        // 0x0C40 (size: 0x8)
    float lastVeloUpdTime;                                                            // 0x0C48 (size: 0x4)
    bool raiding;                                                                     // 0x0C4C (size: 0x1)
    int32 itemsLooted;                                                                // 0x0C50 (size: 0x4)
    uint8 regionUpdateTimer;                                                          // 0x0C54 (size: 0x1)
    bool hasPointOfInterest;                                                          // 0x0C55 (size: 0x1)
    FVector pointOfInterest;                                                          // 0x0C58 (size: 0x18)
    bool realPosUpdated;                                                              // 0x0C70 (size: 0x1)
    bool marked;                                                                      // 0x0C71 (size: 0x1)
    float pregnancy;                                                                  // 0x0C74 (size: 0x4)
    uint8 Age;                                                                        // 0x0C78 (size: 0x1)
    class ASMBuildingMaster* garrisonedIn;                                            // 0x0C80 (size: 0x8)
    uint8 lastTrumpetTargetSquadID;                                                   // 0x0C88 (size: 0x1)
    class USkeletalMeshComponent* banner;                                             // 0x0C90 (size: 0x8)
    class UMaterialInstanceDynamic* bannerMaterialInstance;                           // 0x0C98 (size: 0x8)
    class UTextureRenderTarget2D* RT_banner;                                          // 0x0CA0 (size: 0x8)
    uint8 livestockRunawayTimer;                                                      // 0x0CA8 (size: 0x1)
    TArray<FVector> failedPathfindingTargets;                                         // 0x0CB0 (size: 0x10)
    bool wasFollowingRoads;                                                           // 0x0CC0 (size: 0x1)
    bool stranded;                                                                    // 0x0CC1 (size: 0x1)
    bool shouldVerifyPath;                                                            // 0x0CC2 (size: 0x1)
    float speedFactorWithClimbing;                                                    // 0x0CC4 (size: 0x4)
    float debugDistToSFCheckpoint;                                                    // 0x0CC8 (size: 0x4)
    float debugAvgDistToSFCheckpoint;                                                 // 0x0CCC (size: 0x4)
    bool followsIndividualPath;                                                       // 0x0CD0 (size: 0x1)
    bool shouldFinishTaskOnAnimationEnd;                                              // 0x0CD1 (size: 0x1)
    bool taskFlipFlop;                                                                // 0x0CD2 (size: 0x1)
    FName taskLabelOverride;                                                          // 0x0CD4 (size: 0x8)
    bool pathfindingEmergencyMode;                                                    // 0x0CDC (size: 0x1)
    uint8 intersectionCounter;                                                        // 0x0CDD (size: 0x1)
    TArray<class ARoad*> pathArr_roadCache;                                           // 0x0CE0 (size: 0x10)
    FVector laggingBottomPos;                                                         // 0x0CF0 (size: 0x18)
    bool isBeingRallied;                                                              // 0x0D08 (size: 0x1)
    FTransform rallyingTransform;                                                     // 0x0D10 (size: 0x60)
    int32 currAnimAction;                                                             // 0x0D70 (size: 0x4)
    TArray<FString> unitDebugLog;                                                     // 0x0D78 (size: 0x10)
    uint8 voiceID;                                                                    // 0x0D88 (size: 0x1)
    TWeakObjectPtr<class UVARuntimeComponent> VARuntime;                              // 0x0D8C (size: 0x8)
    TArray<TWeakObjectPtr<UVAISMControllerAbstract>> VAMPControllers;                 // 0x0D98 (size: 0x10)
    class UDataTable* currentAnimsetDT;                                               // 0x0DA8 (size: 0x8)
    float currentAnimSpd;                                                             // 0x0DB0 (size: 0x4)
    float currentAnimSpdDefault;                                                      // 0x0DB4 (size: 0x4)
    float lastTransitionTime;                                                         // 0x0DB8 (size: 0x4)
    float previouslySetTransitionDuration;                                            // 0x0DBC (size: 0x4)
    TArray<FName> quirks;                                                             // 0x0DC0 (size: 0x10)
    int32 UniqueID;                                                                   // 0x0DD0 (size: 0x4)
    int32 assignedSquadID;                                                            // 0x0DD4 (size: 0x4)
    TArray<FGood> assignedMilitaryEquipment;                                          // 0x0DD8 (size: 0x10)
    int32 spatialGridIndex;                                                           // 0x0DE8 (size: 0x4)
    int32 workerFamilyID;                                                             // 0x0DF0 (size: 0x4)
    uint8 waitingOnTransportLimitsCounter;                                            // 0x0DF4 (size: 0x1)
    TArray<class UStaticMeshComponent*> staticMeshGoods;                              // 0x0DF8 (size: 0x10)
    TArray<FTransform> staticMeshGoods_relativeTransforms;                            // 0x0E08 (size: 0x10)
    class ASMUnit* mountActor;                                                        // 0x0E20 (size: 0x8)
    bool isMount;                                                                     // 0x0E28 (size: 0x1)
    TArray<FGood> shoppingList;                                                       // 0x0E30 (size: 0x10)
    TMap<class FName, class FString> customUnitData;                                  // 0x0E40 (size: 0x50)
...
{
    FControlHookConfig config;                                                        // 0x00A0 (size: 0xC)
    FControlHookState State;                                                          // 0x00B0 (size: 0x28)
    FControlHookFlow controlFlow;                                                     // 0x00D8 (size: 0x2)
    FControlHookOnInputModeChange OnInputModeChange;                                  // 0x00E0 (size: 0x10)
    void OnControlHookInputModeChange(EControlInputMode nextInputMode, EControlInputMode lastInputMode);
    FControlHookOnUiHasPriorityChange OnUiHasPriorityChange;                          // 0x00F0 (size: 0x10)
...
class UMLGameInstance : public UGameInstance
{
    ...
    FAudioSliders AudioSliders;                                                       // 0x01D8 (size: 0x24)
    FRTSSettings Settings;                                                            // 0x0200 (size: 0x88)
    float zoomToCameraAmt;                                                            // 0x0288 (size: 0x4)
    FString savefileToLoad;                                                           // 0x0290 (size: 0x10)
    bool startWithCart;                                                               // 0x02A0 (size: 0x1)
    FString Version;                                                                  // 0x02A8 (size: 0x10)
    TArray<FColor> allPlayerColors;                                                   // 0x02B8 (size: 0x10)
    TArray<FPortrait> lordPortraits;                                                  // 0x02C8 (size: 0x10)
    class UTexture2D* playerPortrait;                                                 // 0x02D8 (size: 0x8)
    FString playerLordsName;                                                          // 0x02E0 (size: 0x10)
    TArray<FString> lordNames;                                                        // 0x02F0 (size: 0x10)
    FName scenario;                                                                   // 0x0300 (size: 0x8)
    int32 numGenericAIs;                                                              // 0x0308 (size: 0x4)
    bool aggressive_AI;                                                               // 0x030C (size: 0x1)
    uint8 AI_behaviour;                                                               // 0x030D (size: 0x1)
    bool triggerQuests;                                                               // 0x030E (size: 0x1)
    bool autoIdleJobs;                                                                // 0x030F (size: 0x1)
    ENoticeSquadSetting noticeSquadSetting;                                           // 0x0310 (size: 0x1)
    bool bEnableEdgeScrolling;                                                        // 0x0311 (size: 0x1)
    float GrassDensity;                                                               // 0x0314 (size: 0x4)
    float grassRenderingDistance;                                                     // 0x0318 (size: 0x4)
    class UDataTable* DT_Quirks;                                                      // 0x0320 (size: 0x8)
    TMap<class FName, class UDataTable*> namedTables;                                 // 0x0328 (size: 0x50)
    TSubclassOf<class APawnCPP> MLplayerPawnBP;                                       // 0x0378 (size: 0x8)
    TArray<FPlayerStartingSetup> startingSetup;                                       // 0x0380 (size: 0x10)
    FGameSetupPreset gameSetup;                                                       // 0x0390 (size: 0xD0)
    class UDataTable* DT_GameSetupPresets;                                            // 0x0460 (size: 0x8)
    TArray<class UTextureRenderTarget2D*> lordArms;                                   // 0x0468 (size: 0x10)
    TArray<FCoatOfArmsData> CoatOfArmsData;                                           // 0x0478 (size: 0x10)
    class UDataTable* DT_CoatOfArmsDatabase;                                          // 0x0488 (size: 0x8)
    class UMaterialInterface* simpleCoatGeneratorMaterial;                            // 0x0490 (size: 0x8)
    class UStaticMesh* moveDecalMesh;                                                 // 0x0498 (size: 0x8)
    EVictoryStatus currentGameVictoryStatus;                                          // 0x04A0 (size: 0x1)
    bool alwaysShowResourceIcons;                                                     // 0x04A1 (size: 0x1)
...
class UMLSaveGame : public USaveGame
{
    ...
    float snowLevel;                                                                  // 0x0138 (size: 0x4)
    float gameTimeAdjusted;                                                           // 0x013C (size: 0x4)
    ...
    TArray<FVector2D> toppledTrees2D;                                                 // 0x0160 (size: 0x10)
    FString Version;                                                                  // 0x0170 (size: 0x10)
    FSessionAchievementData SessionAchievementData;                                   // 0x0180 (size: 0x30)
    TArray<FName> issuedStoryQuests;                                                  // 0x01B0 (size: 0x10)
    TArray<FSavedRelationsTag> relationshipTags;                                      // 0x01C0 (size: 0x10)
    FName scenario;                                                                   // 0x01D0 (size: 0x8)
    uint8 AI_behaviour;                                                               // 0x01D8 (size: 0x1)
    bool triggerQuests;                                                               // 0x01D9 (size: 0x1)
    TArray<FSavedMercenaryCompany> availableMercs;                                    // 0x01E0 (size: 0x10)
    TArray<FSavedMercenaryCompany> hiredMercs;                                        // 0x01F0 (size: 0x10)
    bool enableFertilityGrid;                                                         // 0x0200 (size: 0x1)
    TArray<FLinearColor> fertilityGrid;                                               // 0x0208 (size: 0x10)
    TArray<FColor> fertilityGridQuantized;                                            // 0x0218 (size: 0x10)
    TArray<FLinearColor> fertilityGridLimits;                                         // 0x0228 (size: 0x10)
    TArray<FColor> fertilityGridLimitsQuantized;                                      // 0x0238 (size: 0x10)
    FGameSetupPreset gameSetup;                                                       // 0x0248 (size: 0xD0)
    TArray<FSavedChallenge> challenges;                                               // 0x0318 (size: 0x10)
    TMap<int32, FSavedCamera> savedCameraLocations;                                   // 0x0328 (size: 0x50)
    TArray<FName> tutorialsLeftToShow;                                                // 0x0378 (size: 0x10)
    TArray<FSavedGood> foreignMarketSupply;                                           // 0x0388 (size: 0x10)
    EVictoryStatus currentGameVictoryStatus;                                          // 0x0398 (size: 0x1)
    int32 kingsFavour_daysLeft;                                                       // 0x039C (size: 0x4)
    int32 lastBanditCampSpawnedDay;                                                   // 0x03A0 (size: 0x4)
    TArray<FTradeLogEntry> tradeLog;                                                  // 0x03A8 (size: 0x10)
