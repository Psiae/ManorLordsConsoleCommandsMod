...
{
    TSubclassOf<class UControlRig> ControlRigClass;                                   // 0x0248 (size: 0x8)
    TSubclassOf<class UControlRig> DefaultControlRigClass;                            // 0x0250 (size: 0x8)
    class UControlRig* ControlRig;                                                    // 0x0258 (size: 0x8)
    TMap<class UClass*, class UControlRig*> ControlRigPerClass;                       // 0x0260 (size: 0x50)
    float Alpha;                                                                      // 0x02B0 (size: 0x4)
    EAnimAlphaInputType AlphaInputType;                                               // 0x02B4 (size: 0x1)
    uint8 bAlphaBoolEnabled;                                                          // 0x02B5 (size: 0x1)
    uint8 bSetRefPoseFromSkeleton;                                                    // 0x02B5 (size: 0x1)
    FInputScaleBias AlphaScaleBias;                                                   // 0x02B8 (size: 0x8)
    FInputAlphaBoolBlend AlphaBoolBlend;                                              // 0x02C0 (size: 0x48)
    FName AlphaCurveName;                                                             // 0x0308 (size: 0x8)
    FInputScaleBiasClamp AlphaScaleBiasClamp;                                         // 0x0310 (size: 0x30)
    TMap<class FName, class FName> InputMapping;                                      // 0x0340 (size: 0x50)
    TMap<class FName, class FName> OutputMapping;                                     // 0x0390 (size: 0x50)
    int32 LODThreshold;                                                               // 0x0490 (size: 0x4)
...
struct FAnimNode_ControlRigBase : public FAnimNode_CustomProperty
{
    ...
    TWeakObjectPtr<class UNodeMappingContainer> NodeMappingContainer;                 // 0x0210 (size: 0x8)
    FControlRigIOSettings InputSettings;                                              // 0x0218 (size: 0x2)
    FControlRigIOSettings OutputSettings;                                             // 0x021A (size: 0x2)
    bool bExecute;                                                                    // 0x021C (size: 0x1)
    TArray<FControlRigAnimNodeEventName> EventQueue;                                  // 0x0228 (size: 0x10)
...
{
    TWeakObjectPtr<class UControlRig> ControlRig;                                     // 0x0248 (size: 0x8)
...
{
    ERigBoneType BoneType;                                                            // 0x0238 (size: 0x1)
...
struct FRigControlCopy
{
    ...
    ERigControlType ControlType;                                                      // 0x0018 (size: 0x1)
    FRigControlValue Value;                                                           // 0x001C (size: 0x84)
    FRigElementKey ParentKey;                                                         // 0x00A0 (size: 0xC)
    FTransform OffsetTransform;                                                       // 0x00B0 (size: 0x60)
    FTransform ParentTransform;                                                       // 0x0110 (size: 0x60)
    FTransform LocalTransform;                                                        // 0x0170 (size: 0x60)
    FTransform GlobalTransform;                                                       // 0x01D0 (size: 0x60)

}; // Size: 0x230

struct FRigControlElement : public FRigMultiParentElement
{
    FRigControlSettings Settings;                                                     // 0x0330 (size: 0x1B8)
    FRigCurrentAndInitialTransform Offset;                                            // 0x04F0 (size: 0x1A0)
    FRigCurrentAndInitialTransform Shape;                                             // 0x0690 (size: 0x1A0)
    FRigPreferredEulerAngles PreferredEulerAngles;                                    // 0x0830 (size: 0x38)
...
{
    FRigLocalAndGlobalTransform Current;                                              // 0x0000 (size: 0xD0)
    FRigLocalAndGlobalTransform Initial;                                              // 0x00D0 (size: 0xD0)
...
struct FRigHierarchyCopyPasteContentPerElement
{
    ...
    FRigCurrentAndInitialTransform Pose;                                              // 0x0040 (size: 0x1A0)
...
{
    FRigComputedTransform Local;                                                      // 0x0000 (size: 0x60)
    FRigComputedTransform Global;                                                     // 0x0060 (size: 0x60)
...
{
    FRigRigidBodySettings Settings;                                                   // 0x0238 (size: 0x4)
...
{
    FRigCurrentAndInitialTransform Pose;                                              // 0x0050 (size: 0x1A0)
...
{
    FControlRigExecuteContext ExecuteContext;                                         // 0x0010 (size: 0x1C0)

}; // Size: 0x1D0

struct FRigUnit_AddBoneTransform : public FRigUnitMutable
{
    FName bone;                                                                       // 0x01D0 (size: 0x8)
    FTransform Transform;                                                             // 0x01E0 (size: 0x60)
    float Weight;                                                                     // 0x0240 (size: 0x4)
    bool bPostMultiply;                                                               // 0x0244 (size: 0x1)
    bool bPropagateToChildren;                                                        // 0x0245 (size: 0x1)
    FCachedRigElement CachedBone;                                                     // 0x0248 (size: 0x20)

}; // Size: 0x270

struct FRigUnit_AddParent : public FRigUnit_DynamicHierarchyBaseMutable
{
    FRigElementKey Child;                                                             // 0x01D0 (size: 0xC)
    FRigElementKey Parent;                                                            // 0x01DC (size: 0xC)
...
{
    FName bone;                                                                       // 0x01D0 (size: 0x8)
    FRigUnit_AimBone_Target Primary;                                                  // 0x01D8 (size: 0x48)
    FRigUnit_AimBone_Target Secondary;                                                // 0x0220 (size: 0x48)
    float Weight;                                                                     // 0x0268 (size: 0x4)
    bool bPropagateToChildren;                                                        // 0x026C (size: 0x1)
    FRigUnit_AimBone_DebugSettings DebugSettings;                                     // 0x0270 (size: 0x70)
    FCachedRigElement CachedBoneIndex;                                                // 0x02E0 (size: 0x20)
    FCachedRigElement PrimaryCachedSpace;                                             // 0x0300 (size: 0x20)
    FCachedRigElement SecondaryCachedSpace;                                           // 0x0320 (size: 0x20)
    bool bIsInitialized;                                                              // 0x0340 (size: 0x1)
...
{
    FName Joint;                                                                      // 0x01D0 (size: 0x8)
    EAimMode AimMode;                                                                 // 0x01D8 (size: 0x1)
    EAimMode UpMode;                                                                  // 0x01D9 (size: 0x1)
    FVector AimVector;                                                                // 0x01E0 (size: 0x18)
    FVector UpVector;                                                                 // 0x01F8 (size: 0x18)
    TArray<FAimTarget> AimTargets;                                                    // 0x0210 (size: 0x10)
    TArray<FAimTarget> UpTargets;                                                     // 0x0220 (size: 0x10)
    FRigUnit_AimConstraint_WorkData WorkData;                                         // 0x0230 (size: 0x10)
...
{
    FRigElementKey Child;                                                             // 0x01D0 (size: 0xC)
    bool bMaintainOffset;                                                             // 0x01DC (size: 0x1)
    FFilterOptionPerAxis Filter;                                                      // 0x01DD (size: 0x3)
    FVector AimAxis;                                                                  // 0x01E0 (size: 0x18)
    FVector UpAxis;                                                                   // 0x01F8 (size: 0x18)
    FRigUnit_AimConstraint_WorldUp WorldUp;                                           // 0x0210 (size: 0x28)
    TArray<FConstraintParent> Parents;                                                // 0x0238 (size: 0x10)
    FRigUnit_AimConstraint_AdvancedSettings AdvancedSettings;                         // 0x0250 (size: 0x80)
    float Weight;                                                                     // 0x02D0 (size: 0x4)
    FCachedRigElement WorldUpSpaceCache;                                              // 0x02D8 (size: 0x20)
    FCachedRigElement ChildCache;                                                     // 0x02F8 (size: 0x20)
    TArray<FCachedRigElement> ParentCaches;                                           // 0x0318 (size: 0x10)
    bool bIsInitialized;                                                              // 0x0328 (size: 0x1)
...
{
    FRigElementKey Item;                                                              // 0x01D0 (size: 0xC)
    FRigUnit_AimItem_Target Primary;                                                  // 0x01E0 (size: 0x48)
    FRigUnit_AimItem_Target Secondary;                                                // 0x0228 (size: 0x48)
    float Weight;                                                                     // 0x0270 (size: 0x4)
    FRigUnit_AimBone_DebugSettings DebugSettings;                                     // 0x0280 (size: 0x70)
    FCachedRigElement CachedItem;                                                     // 0x02F0 (size: 0x20)
    FCachedRigElement PrimaryCachedSpace;                                             // 0x0310 (size: 0x20)
    FCachedRigElement SecondaryCachedSpace;                                           // 0x0330 (size: 0x20)
    bool bIsInitialized;                                                              // 0x0350 (size: 0x1)
...
struct FRigUnit_ApplyFK : public FRigUnitMutable
{
    FName Joint;                                                                      // 0x01D0 (size: 0x8)
    FTransform Transform;                                                             // 0x01E0 (size: 0x60)
    FTransformFilter Filter;                                                          // 0x0240 (size: 0x9)
    EApplyTransformMode ApplyTransformMode;                                           // 0x0249 (size: 0x1)
    ETransformSpaceMode ApplyTransformSpace;                                          // 0x024A (size: 0x1)
    FTransform BaseTransform;                                                         // 0x0250 (size: 0x60)
    FName BaseJoint;                                                                  // 0x02B0 (size: 0x8)
...
{
    TArray<FRigUnit_BoneHarmonics_BoneTarget> Bones;                                  // 0x01D0 (size: 0x10)
    FVector WaveSpeed;                                                                // 0x01E0 (size: 0x18)
    FVector WaveFrequency;                                                            // 0x01F8 (size: 0x18)
    FVector WaveAmplitude;                                                            // 0x0210 (size: 0x18)
    FVector WaveOffset;                                                               // 0x0228 (size: 0x18)
    FVector WaveNoise;                                                                // 0x0240 (size: 0x18)
    ERigVMAnimEasingType WaveEase;                                                    // 0x0258 (size: 0x1)
    float WaveMinimum;                                                                // 0x025C (size: 0x4)
    float WaveMaximum;                                                                // 0x0260 (size: 0x4)
    EEulerRotationOrder RotationOrder;                                                // 0x0264 (size: 0x1)
    bool bPropagateToChildren;                                                        // 0x0265 (size: 0x1)
    FRigUnit_BoneHarmonics_WorkData WorkData;                                         // 0x0268 (size: 0x28)
...
{
    FName StartBone;                                                                  // 0x01D0 (size: 0x8)
    FName EffectorBone;                                                               // 0x01D8 (size: 0x8)
    FTransform EffectorTransform;                                                     // 0x01E0 (size: 0x60)
    float Precision;                                                                  // 0x0240 (size: 0x4)
    float Weight;                                                                     // 0x0244 (size: 0x4)
    int32 MaxIterations;                                                              // 0x0248 (size: 0x4)
    bool bStartFromTail;                                                              // 0x024C (size: 0x1)
    float BaseRotationLimit;                                                          // 0x0250 (size: 0x4)
    TArray<FRigUnit_CCDIK_RotationLimit> RotationLimits;                              // 0x0258 (size: 0x10)
    bool bPropagateToChildren;                                                        // 0x0268 (size: 0x1)
    FRigUnit_CCDIK_WorkData WorkData;                                                 // 0x0270 (size: 0x60)
...
struct FRigUnit_CCDIKItemArray : public FRigUnit_HighlevelBaseMutable
{
    ...
    bool bStartFromTail;                                                              // 0x024C (size: 0x1)
    float BaseRotationLimit;                                                          // 0x0250 (size: 0x4)
    TArray<FRigUnit_CCDIK_RotationLimitPerItem> RotationLimits;                       // 0x0258 (size: 0x10)
    bool bPropagateToChildren;                                                        // 0x0268 (size: 0x1)
    FRigUnit_CCDIK_WorkData WorkData;                                                 // 0x0270 (size: 0x60)
...
{
    FName ChainRoot;                                                                  // 0x01D0 (size: 0x8)
    FVector Speed;                                                                    // 0x01D8 (size: 0x18)
    FRigUnit_ChainHarmonics_Reach Reach;                                              // 0x01F0 (size: 0x48)
    FRigUnit_ChainHarmonics_Wave Wave;                                                // 0x0238 (size: 0x78)
    FRuntimeFloatCurve WaveCurve;                                                     // 0x02B0 (size: 0x88)
    FRigUnit_ChainHarmonics_Pendulum Pendulum;                                        // 0x0338 (size: 0x58)
    bool bDrawDebug;                                                                  // 0x0390 (size: 0x1)
    FTransform DrawWorldOffset;                                                       // 0x03A0 (size: 0x60)
    FRigUnit_ChainHarmonics_WorkData WorkData;                                        // 0x0400 (size: 0x98)

}; // Size: 0x4A0

struct FRigUnit_ChainHarmonicsPerItem : public FRigUnit_HighlevelBaseMutable
{
    FRigElementKey ChainRoot;                                                         // 0x01D0 (size: 0xC)
    FVector Speed;                                                                    // 0x01E0 (size: 0x18)
    FRigUnit_ChainHarmonics_Reach Reach;                                              // 0x01F8 (size: 0x48)
    FRigUnit_ChainHarmonics_Wave Wave;                                                // 0x0240 (size: 0x78)
    FRuntimeFloatCurve WaveCurve;                                                     // 0x02B8 (size: 0x88)
    FRigUnit_ChainHarmonics_Pendulum Pendulum;                                        // 0x0340 (size: 0x58)
    bool bDrawDebug;                                                                  // 0x0398 (size: 0x1)
    FTransform DrawWorldOffset;                                                       // 0x03A0 (size: 0x60)
    FRigUnit_ChainHarmonics_WorkData WorkData;                                        // 0x0400 (size: 0x98)
...
{
    FName BlockToRun;                                                                 // 0x01D0 (size: 0x8)
    FRigElementKeyCollection Collection;                                              // 0x01D8 (size: 0x10)
    FRigElementKey Item;                                                              // 0x01E8 (size: 0xC)
    int32 Index;                                                                      // 0x01F4 (size: 0x4)
    int32 Count;                                                                      // 0x01F8 (size: 0x4)
    float Ratio;                                                                      // 0x01FC (size: 0x4)
    FControlRigExecuteContext Completed;                                              // 0x0200 (size: 0x1C0)
...
struct FRigUnit_DebugArc : public FRigUnit_DebugBaseMutable
{
    ...
    FLinearColor Color;                                                               // 0x0230 (size: 0x10)
    float Radius;                                                                     // 0x0240 (size: 0x4)
    float MinimumDegrees;                                                             // 0x0244 (size: 0x4)
    float MaximumDegrees;                                                             // 0x0248 (size: 0x4)
    float Thickness;                                                                  // 0x024C (size: 0x4)
    int32 Detail;                                                                     // 0x0250 (size: 0x4)
    FName Space;                                                                      // 0x0254 (size: 0x8)
    FTransform WorldOffset;                                                           // 0x0260 (size: 0x60)
    bool bEnabled;                                                                    // 0x02C0 (size: 0x1)
...
struct FRigUnit_DebugArcItemSpace : public FRigUnit_DebugBaseMutable
{
    ...
    float Thickness;                                                                  // 0x024C (size: 0x4)
    int32 Detail;                                                                     // 0x0250 (size: 0x4)
    FRigElementKey Space;                                                             // 0x0254 (size: 0xC)
    FTransform WorldOffset;                                                           // 0x0260 (size: 0x60)
    bool bEnabled;                                                                    // 0x02C0 (size: 0x1)
...
{
    FRigVMFourPointBezier Bezier;                                                     // 0x0100 (size: 0x60)
    float MinimumU;                                                                   // 0x0160 (size: 0x4)
    float MaximumU;                                                                   // 0x0164 (size: 0x4)
    FLinearColor Color;                                                               // 0x0168 (size: 0x10)
    float Thickness;                                                                  // 0x0178 (size: 0x4)
    int32 Detail;                                                                     // 0x017C (size: 0x4)
    FName Space;                                                                      // 0x0180 (size: 0x8)
...
struct FRigUnit_DebugBezierItemSpace : public FRigVMFunction_DebugBaseMutable
{
    ...
    float Thickness;                                                                  // 0x0178 (size: 0x4)
    int32 Detail;                                                                     // 0x017C (size: 0x4)
    FRigElementKey Space;                                                             // 0x0180 (size: 0xC)
    FTransform WorldOffset;                                                           // 0x0190 (size: 0x60)
    bool bEnabled;                                                                    // 0x01F0 (size: 0x1)
...
{
    FControlRigExecuteContext ExecuteContext;                                         // 0x0010 (size: 0x1C0)
    float Scale;                                                                      // 0x01D0 (size: 0x4)
    FLinearColor Color;                                                               // 0x01D4 (size: 0x10)
    float Thickness;                                                                  // 0x01E4 (size: 0x4)
    FTransform WorldOffset;                                                           // 0x01F0 (size: 0x60)
    bool bEnabled;                                                                    // 0x0250 (size: 0x1)

}; // Size: 0x260

struct FRigUnit_DebugLine : public FRigUnit_DebugBaseMutable
{
    FVector A;                                                                        // 0x01D0 (size: 0x18)
    FVector B;                                                                        // 0x01E8 (size: 0x18)
...
struct FRigUnit_DebugLineStrip : public FRigUnit_DebugBaseMutable
{
    ...
    FLinearColor Color;                                                               // 0x01E0 (size: 0x10)
    float Thickness;                                                                  // 0x01F0 (size: 0x4)
    FName Space;                                                                      // 0x01F4 (size: 0x8)
    FTransform WorldOffset;                                                           // 0x0200 (size: 0x60)
    bool bEnabled;                                                                    // 0x0260 (size: 0x1)
...
struct FRigUnit_DebugLineStripItemSpace : public FRigUnit_DebugBaseMutable
{
    ...
    FLinearColor Color;                                                               // 0x01E0 (size: 0x10)
    float Thickness;                                                                  // 0x01F0 (size: 0x4)
    FRigElementKey Space;                                                             // 0x01F4 (size: 0xC)
    FTransform WorldOffset;                                                           // 0x0200 (size: 0x60)
    bool bEnabled;                                                                    // 0x0260 (size: 0x1)
...
{
    FControlRigExecuteContext ExecuteContext;                                         // 0x0010 (size: 0x1C0)
    FRigPose Pose;                                                                    // 0x01D0 (size: 0x70)
    float Scale;                                                                      // 0x0240 (size: 0x4)
    FLinearColor Color;                                                               // 0x0244 (size: 0x10)
    float Thickness;                                                                  // 0x0254 (size: 0x4)
    FTransform WorldOffset;                                                           // 0x0260 (size: 0x60)
    bool bEnabled;                                                                    // 0x02C0 (size: 0x1)
...
struct FRigUnit_DebugRectangle : public FRigUnit_DebugBaseMutable
{
    ...
    FLinearColor Color;                                                               // 0x0230 (size: 0x10)
    float Scale;                                                                      // 0x0240 (size: 0x4)
    float Thickness;                                                                  // 0x0244 (size: 0x4)
    FName Space;                                                                      // 0x0248 (size: 0x8)
    FTransform WorldOffset;                                                           // 0x0250 (size: 0x60)
...
struct FRigUnit_DebugRectangleItemSpace : public FRigUnit_DebugBaseMutable
{
    ...
    float Scale;                                                                      // 0x0240 (size: 0x4)
    float Thickness;                                                                  // 0x0244 (size: 0x4)
    FRigElementKey Space;                                                             // 0x0248 (size: 0xC)
    FTransform WorldOffset;                                                           // 0x0260 (size: 0x60)
    bool bEnabled;                                                                    // 0x02C0 (size: 0x1)
...
struct FRigUnit_DebugTransformArrayMutable : public FRigUnit_DebugBaseMutable
{
    ...
    ERigUnitDebugTransformMode Mode;                                                  // 0x01E0 (size: 0x1)
    FLinearColor Color;                                                               // 0x01E4 (size: 0x10)
    float Thickness;                                                                  // 0x01F4 (size: 0x4)
    float Scale;                                                                      // 0x01F8 (size: 0x4)
    FName Space;                                                                      // 0x01FC (size: 0x8)
    FTransform WorldOffset;                                                           // 0x0210 (size: 0x60)
    bool bEnabled;                                                                    // 0x0270 (size: 0x1)
    FRigUnit_DebugTransformArrayMutable_WorkData WorkData;                            // 0x0278 (size: 0x10)
...
{
    TArray<FTransform> Transforms;                                                    // 0x01D0 (size: 0x10)
    TArray<int32> ParentIndices;                                                      // 0x01E0 (size: 0x10)
    ERigUnitDebugTransformMode Mode;                                                  // 0x01F0 (size: 0x1)
    FLinearColor Color;                                                               // 0x01F4 (size: 0x10)
    float Thickness;                                                                  // 0x0204 (size: 0x4)
    float Scale;                                                                      // 0x0208 (size: 0x4)
    FRigElementKey Space;                                                             // 0x020C (size: 0xC)
    FTransform WorldOffset;                                                           // 0x0220 (size: 0x60)
    bool bEnabled;                                                                    // 0x0280 (size: 0x1)
...
{
    FTransform Transform;                                                             // 0x01D0 (size: 0x60)
    ERigUnitDebugTransformMode Mode;                                                  // 0x0230 (size: 0x1)
    FLinearColor Color;                                                               // 0x0234 (size: 0x10)
    float Thickness;                                                                  // 0x0244 (size: 0x4)
    float Scale;                                                                      // 0x0248 (size: 0x4)
    FName Space;                                                                      // 0x024C (size: 0x8)
    FTransform WorldOffset;                                                           // 0x0260 (size: 0x60)
    bool bEnabled;                                                                    // 0x02C0 (size: 0x1)
...
struct FRigUnit_DebugTransformMutableItemSpace : public FRigUnit_DebugBaseMutable
{
    ...
    float Thickness;                                                                  // 0x0244 (size: 0x4)
    float Scale;                                                                      // 0x0248 (size: 0x4)
    FRigElementKey Space;                                                             // 0x024C (size: 0xC)
    FTransform WorldOffset;                                                           // 0x0260 (size: 0x60)
    bool bEnabled;                                                                    // 0x02C0 (size: 0x1)
...
{
    TArray<FRigElementKey> Excluded;                                                  // 0x01D0 (size: 0x10)
    FString Message;                                                                  // 0x01E0 (size: 0x10)
...
{
    FName StartBone;                                                                  // 0x01D0 (size: 0x8)
    FName EndBone;                                                                    // 0x01D8 (size: 0x8)
    TArray<FRigUnit_DistributeRotation_Rotation> Rotations;                           // 0x01E0 (size: 0x10)
    ...
    FRigUnit_DistributeRotation_WorkData WorkData;                                    // 0x0200 (size: 0x50)
...
struct FRigUnit_DistributeRotationForCollection : public FRigUnit_HighlevelBaseMutable
{
    ...
    ERigVMAnimEasingType RotationEaseType;                                            // 0x01F0 (size: 0x1)
    float Weight;                                                                     // 0x01F4 (size: 0x4)
    FRigUnit_DistributeRotation_WorkData WorkData;                                    // 0x01F8 (size: 0x50)
...
{
    FName InstructionName;                                                            // 0x01D0 (size: 0x8)
    FLinearColor Color;                                                               // 0x01D8 (size: 0x10)
...
{
    FName InstructionName;                                                            // 0x01D0 (size: 0x8)
    float Thickness;                                                                  // 0x01D8 (size: 0x4)
...
{
    int32 NumberOfMeasurements;                                                       // 0x0100 (size: 0x4)
    FString Prefix;                                                                   // 0x0108 (size: 0x10)
    float AccumulatedTime;                                                            // 0x0118 (size: 0x4)
    int32 MeasurementsLeft;                                                           // 0x011C (size: 0x4)
    bool bIsInitialized;                                                              // 0x0120 (size: 0x1)
...
struct FRigUnit_FABRIK : public FRigUnit_HighlevelBaseMutable
{
    ...
    float Precision;                                                                  // 0x0240 (size: 0x4)
    float Weight;                                                                     // 0x0244 (size: 0x4)
    bool bPropagateToChildren;                                                        // 0x0248 (size: 0x1)
    int32 MaxIterations;                                                              // 0x024C (size: 0x4)
    FRigUnit_FABRIK_WorkData WorkData;                                                // 0x0250 (size: 0x40)
    bool bSetEffectorTransform;                                                       // 0x0290 (size: 0x1)
...
struct FRigUnit_FitChainToCurve : public FRigUnit_HighlevelBaseMutable
{
    FName StartBone;                                                                  // 0x01D0 (size: 0x8)
    FName EndBone;                                                                    // 0x01D8 (size: 0x8)
    FRigVMFourPointBezier Bezier;                                                     // 0x01E0 (size: 0x60)
    EControlRigCurveAlignment Alignment;                                              // 0x0240 (size: 0x1)
    float Minimum;                                                                    // 0x0244 (size: 0x4)
    float Maximum;                                                                    // 0x0248 (size: 0x4)
    int32 SamplingPrecision;                                                          // 0x024C (size: 0x4)
    FVector PrimaryAxis;                                                              // 0x0250 (size: 0x18)
    FVector SecondaryAxis;                                                            // 0x0268 (size: 0x18)
    FVector PoleVectorPosition;                                                       // 0x0280 (size: 0x18)
    TArray<FRigUnit_FitChainToCurve_Rotation> Rotations;                              // 0x0298 (size: 0x10)
    ERigVMAnimEasingType RotationEaseType;                                            // 0x02A8 (size: 0x1)
    float Weight;                                                                     // 0x02AC (size: 0x4)
    bool bPropagateToChildren;                                                        // 0x02B0 (size: 0x1)
    FRigUnit_FitChainToCurve_DebugSettings DebugSettings;                             // 0x02C0 (size: 0x90)
    FRigUnit_FitChainToCurve_WorkData WorkData;                                       // 0x0350 (size: 0x98)
...
{
    FName Joint;                                                                      // 0x01D0 (size: 0x8)
    ETransformGetterType Type;                                                        // 0x01D8 (size: 0x1)
    ETransformSpaceMode TransformSpace;                                               // 0x01D9 (size: 0x1)
    FTransform BaseTransform;                                                         // 0x01E0 (size: 0x60)
    FName BaseJoint;                                                                  // 0x0240 (size: 0x8)
    FTransform Output;                                                                // 0x0250 (size: 0x60)
...
{
    bool InitialValue;                                                                // 0x01F0 (size: 0x1)
    bool MinimumValue;                                                                // 0x01F1 (size: 0x1)
    bool MaximumValue;                                                                // 0x01F2 (size: 0x1)
    FRigUnit_HierarchyAddAnimationChannelEmptyLimitSettings LimitsEnabled;            // 0x01F3 (size: 0x1)
...
{
    float InitialValue;                                                               // 0x01F0 (size: 0x4)
    float MinimumValue;                                                               // 0x01F4 (size: 0x4)
    float MaximumValue;                                                               // 0x01F8 (size: 0x4)
    FRigUnit_HierarchyAddAnimationChannelSingleLimitSettings LimitsEnabled;           // 0x01FC (size: 0x2)

}; // Size: 0x200

struct FRigUnit_HierarchyAddAnimationChannelInteger : public FRigUnit_HierarchyAddElement
{
    int32 InitialValue;                                                               // 0x01F0 (size: 0x4)
    int32 MinimumValue;                                                               // 0x01F4 (size: 0x4)
    int32 MaximumValue;                                                               // 0x01F8 (size: 0x4)
    FRigUnit_HierarchyAddAnimationChannelSingleLimitSettings LimitsEnabled;           // 0x01FC (size: 0x2)
    class UEnum* ControlEnum;                                                         // 0x0200 (size: 0x8)

}; // Size: 0x210

struct FRigUnit_HierarchyAddAnimationChannelRotator : public FRigUnit_HierarchyAddElement
{
    FRotator InitialValue;                                                            // 0x01F0 (size: 0x18)
    FRotator MinimumValue;                                                            // 0x0208 (size: 0x18)
    FRotator MaximumValue;                                                            // 0x0220 (size: 0x18)
    FRigUnit_HierarchyAddAnimationChannelRotatorLimitSettings LimitsEnabled;          // 0x0238 (size: 0x6)
...
{
    FVector InitialValue;                                                             // 0x01F0 (size: 0x18)
    FVector MinimumValue;                                                             // 0x0208 (size: 0x18)
    FVector MaximumValue;                                                             // 0x0220 (size: 0x18)
    FRigUnit_HierarchyAddAnimationChannelVectorLimitSettings LimitsEnabled;           // 0x0238 (size: 0x6)
...
{
    FVector2D InitialValue;                                                           // 0x01F0 (size: 0x10)
    FVector2D MinimumValue;                                                           // 0x0200 (size: 0x10)
    FVector2D MaximumValue;                                                           // 0x0210 (size: 0x10)
    FRigUnit_HierarchyAddAnimationChannel2DLimitSettings LimitsEnabled;               // 0x0220 (size: 0x4)
...
struct FRigUnit_HierarchyAddBone : public FRigUnit_HierarchyAddElement
{
    ...
    ERigVMTransformSpace Space;                                                       // 0x0250 (size: 0x1)

}; // Size: 0x260

struct FRigUnit_HierarchyAddControlElement : public FRigUnit_HierarchyAddElement
{
    FTransform OffsetTransform;                                                       // 0x01F0 (size: 0x60)
    ERigVMTransformSpace OffsetSpace;                                                 // 0x0250 (size: 0x1)

}; // Size: 0x260

struct FRigUnit_HierarchyAddControlFloat : public FRigUnit_HierarchyAddControlElement
{
    float InitialValue;                                                               // 0x0258 (size: 0x4)
    FRigUnit_HierarchyAddControlFloat_Settings Settings;                              // 0x0260 (size: 0xD0)
...
{
    int32 InitialValue;                                                               // 0x0258 (size: 0x4)
    FRigUnit_HierarchyAddControlInteger_Settings Settings;                            // 0x0260 (size: 0xD0)
...
{
    FRotator InitialValue;                                                            // 0x0258 (size: 0x18)
    FRigUnit_HierarchyAddControlRotator_Settings Settings;                            // 0x0270 (size: 0x110)
...
{
    FTransform InitialValue;                                                          // 0x0260 (size: 0x60)
    FRigUnit_HierarchyAddControlTransform_Settings Settings;                          // 0x02C0 (size: 0x180)
...
{
    FVector InitialValue;                                                             // 0x0258 (size: 0x18)
    FRigUnit_HierarchyAddControlVector_Settings Settings;                             // 0x0270 (size: 0x110)

}; // Size: 0x380

struct FRigUnit_HierarchyAddControlVector2D : public FRigUnit_HierarchyAddControlElement
{
    FVector2D InitialValue;                                                           // 0x0258 (size: 0x10)
    FRigUnit_HierarchyAddControlVector2D_Settings Settings;                           // 0x0270 (size: 0x100)
...
{
    FRigElementKey Parent;                                                            // 0x01D0 (size: 0xC)
    FName Name;                                                                       // 0x01DC (size: 0x8)
    FRigElementKey Item;                                                              // 0x01E4 (size: 0xC)
...
struct FRigUnit_HierarchyAddSocket : public FRigUnit_HierarchyAddElement
{
    ...
    FString Description;                                                              // 0x0268 (size: 0x10)
...
{
    FName NameSpace;                                                                  // 0x01D0 (size: 0x8)
    bool bIncludeCurves;                                                              // 0x01D8 (size: 0x1)
    TArray<FRigElementKey> Items;                                                     // 0x01E0 (size: 0x10)
...
{
    FRigElementKey Child;                                                             // 0x01D0 (size: 0xC)
    TArray<FRigElementWeight> Weights;                                                // 0x01E0 (size: 0x10)
...
{
    FRigPose Pose;                                                                    // 0x01D0 (size: 0x70)
    ERigElementType ElementType;                                                      // 0x0240 (size: 0x1)
    ERigVMTransformSpace Space;                                                       // 0x0241 (size: 0x1)
    FRigElementKeyCollection ItemsToSet;                                              // 0x0248 (size: 0x10)
    float Weight;                                                                     // 0x0258 (size: 0x4)
...
struct FRigUnit_HierarchySetPoseItemArray : public FRigUnit_HierarchyBaseMutable
{
    ...
    ERigElementType ElementType;                                                      // 0x0240 (size: 0x1)
    ERigVMTransformSpace Space;                                                       // 0x0241 (size: 0x1)
    TArray<FRigElementKey> ItemsToSet;                                                // 0x0248 (size: 0x10)
    float Weight;                                                                     // 0x0258 (size: 0x4)
...
{
    FRigElementKey Item;                                                              // 0x01D0 (size: 0xC)
    FRigUnit_HierarchyAddControl_ShapeSettings Settings;                              // 0x01E0 (size: 0x80)
...
{
    TArray<FRigUnit_Harmonics_TargetItem> Targets;                                    // 0x01D0 (size: 0x10)
    FVector WaveSpeed;                                                                // 0x01E0 (size: 0x18)
    FVector WaveFrequency;                                                            // 0x01F8 (size: 0x18)
    FVector WaveAmplitude;                                                            // 0x0210 (size: 0x18)
    FVector WaveOffset;                                                               // 0x0228 (size: 0x18)
...
{
    TArray<FRigUnit_ModifyBoneTransforms_PerBone> BoneToModify;                       // 0x01D0 (size: 0x10)
    float Weight;                                                                     // 0x01E0 (size: 0x4)
    float WeightMinimum;                                                              // 0x01E4 (size: 0x4)
    float WeightMaximum;                                                              // 0x01E8 (size: 0x4)
    EControlRigModifyBoneMode Mode;                                                   // 0x01EC (size: 0x1)
    FRigUnit_ModifyBoneTransforms_WorkData WorkData;                                  // 0x01F0 (size: 0x10)
...
{
    TArray<FRigUnit_ModifyTransforms_PerItem> ItemToModify;                           // 0x01D0 (size: 0x10)
    float Weight;                                                                     // 0x01E0 (size: 0x4)
    float WeightMinimum;                                                              // 0x01E4 (size: 0x4)
    float WeightMaximum;                                                              // 0x01E8 (size: 0x4)
    EControlRigModifyBoneMode Mode;                                                   // 0x01EC (size: 0x1)
    FRigUnit_ModifyTransforms_WorkData WorkData;                                      // 0x01F0 (size: 0x10)
...
{
    FName RootBone;                                                                   // 0x01D0 (size: 0x8)
    TArray<FRigUnit_MultiFABRIK_EndEffector> Effectors;                               // 0x01D8 (size: 0x10)
    float Precision;                                                                  // 0x01E8 (size: 0x4)
    bool bPropagateToChildren;                                                        // 0x01EC (size: 0x1)
    int32 MaxIterations;                                                              // 0x01F0 (size: 0x4)
    FRigUnit_MultiFABRIK_WorkData WorkData;                                           // 0x01F8 (size: 0x68)
    bool bIsInitialized;                                                              // 0x0260 (size: 0x1)
...
{
    FRigElementKey Item;                                                              // 0x01D0 (size: 0xC)
    FTransform OffsetTransform;                                                       // 0x01E0 (size: 0x60)
    float Weight;                                                                     // 0x0240 (size: 0x4)
    bool bPropagateToChildren;                                                        // 0x0244 (size: 0x1)
    FCachedRigElement CachedIndex;                                                    // 0x0248 (size: 0x20)
...
struct FRigUnit_ParentConstraint : public FRigUnit_HighlevelBaseMutable
{
    FRigElementKey Child;                                                             // 0x01D0 (size: 0xC)
    bool bMaintainOffset;                                                             // 0x01DC (size: 0x1)
    FTransformFilter Filter;                                                          // 0x01DD (size: 0x9)
    TArray<FConstraintParent> Parents;                                                // 0x01E8 (size: 0x10)
    FRigUnit_ParentConstraint_AdvancedSettings AdvancedSettings;                      // 0x01F8 (size: 0x2)
    float Weight;                                                                     // 0x01FC (size: 0x4)
    FCachedRigElement ChildCache;                                                     // 0x0200 (size: 0x20)
    TArray<FCachedRigElement> ParentCaches;                                           // 0x0220 (size: 0x10)
...
{
    FRigElementKey Subject;                                                           // 0x01D0 (size: 0xC)
    int32 ParentIndex;                                                                // 0x01DC (size: 0x4)
    FRigElementKeyCollection Parents;                                                 // 0x01E0 (size: 0x10)
    FTransform InitialGlobalTransform;                                                // 0x01F0 (size: 0x60)
    float Weight;                                                                     // 0x0250 (size: 0x4)
    FTransform Transform;                                                             // 0x0260 (size: 0x60)
    bool Switched;                                                                    // 0x02C0 (size: 0x1)
    FCachedRigElement CachedSubject;                                                  // 0x02C8 (size: 0x20)
    FCachedRigElement CachedParent;                                                   // 0x02E8 (size: 0x20)
    FTransform RelativeOffset;                                                        // 0x0310 (size: 0x60)
...
struct FRigUnit_ParentSwitchConstraintArray : public FRigUnitMutable
{
    FRigElementKey Subject;                                                           // 0x01D0 (size: 0xC)
    int32 ParentIndex;                                                                // 0x01DC (size: 0x4)
    TArray<FRigElementKey> Parents;                                                   // 0x01E0 (size: 0x10)
    FTransform InitialGlobalTransform;                                                // 0x01F0 (size: 0x60)
    float Weight;                                                                     // 0x0250 (size: 0x4)
    FTransform Transform;                                                             // 0x0260 (size: 0x60)
    bool Switched;                                                                    // 0x02C0 (size: 0x1)
...
{
    TArray<FRigVMSimPoint> Points;                                                    // 0x0100 (size: 0x10)
    TArray<FCRSimLinearSpring> links;                                                 // 0x0110 (size: 0x10)
    TArray<FCRSimPointForce> Forces;                                                  // 0x0120 (size: 0x10)
    TArray<FCRSimSoftCollision> CollisionVolumes;                                     // 0x0130 (size: 0x10)
    float SimulatedStepsPerSecond;                                                    // 0x0140 (size: 0x4)
    ERigVMSimPointIntegrateType IntegratorType;                                       // 0x0144 (size: 0x1)
    float VerletBlend;                                                                // 0x0148 (size: 0x4)
    TArray<FRigUnit_PointSimulation_BoneTarget> BoneTargets;                          // 0x0150 (size: 0x10)
    bool bLimitLocalPosition;                                                         // 0x0160 (size: 0x1)
    bool bPropagateToChildren;                                                        // 0x0161 (size: 0x1)
    FVector PrimaryAimAxis;                                                           // 0x0168 (size: 0x18)
    FVector SecondaryAimAxis;                                                         // 0x0180 (size: 0x18)
    FRigUnit_PointSimulation_DebugSettings DebugSettings;                             // 0x01A0 (size: 0x80)
    FRigVMFourPointBezier Bezier;                                                     // 0x0220 (size: 0x60)
    FRigUnit_PointSimulation_WorkData WorkData;                                       // 0x0280 (size: 0x88)
...
{
    FName BlockToRun;                                                                 // 0x01D0 (size: 0x8)
    FRigPose Pose;                                                                    // 0x01D8 (size: 0x70)
    FRigElementKey Item;                                                              // 0x0248 (size: 0xC)
    FTransform GlobalTransform;                                                       // 0x0260 (size: 0x60)
    FTransform LocalTransform;                                                        // 0x02C0 (size: 0x60)
    float CurveValue;                                                                 // 0x0320 (size: 0x4)
    int32 Index;                                                                      // 0x0324 (size: 0x4)
    int32 Count;                                                                      // 0x0328 (size: 0x4)
    float Ratio;                                                                      // 0x032C (size: 0x4)
    FControlRigExecuteContext Completed;                                              // 0x0330 (size: 0x1C0)
...
struct FRigUnit_PositionConstraint : public FRigUnit_HighlevelBaseMutable
{
    ...
    bool bMaintainOffset;                                                             // 0x01DC (size: 0x1)
    FFilterOptionPerAxis Filter;                                                      // 0x01DD (size: 0x3)
    TArray<FConstraintParent> Parents;                                                // 0x01E0 (size: 0x10)
    float Weight;                                                                     // 0x01F0 (size: 0x4)
...
struct FRigUnit_PositionConstraintLocalSpaceOffset : public FRigUnit_HighlevelBaseMutable
{
    ...
    TArray<FConstraintParent> Parents;                                                // 0x01E0 (size: 0x10)
    float Weight;                                                                     // 0x01F0 (size: 0x4)
    FCachedRigElement ChildCache;                                                     // 0x01F8 (size: 0x20)
    TArray<FCachedRigElement> ParentCaches;                                           // 0x0218 (size: 0x10)
...
{
    FRigElementKey Item;                                                              // 0x01D0 (size: 0xC)
    bool bRecomputeGlobal;                                                            // 0x01DC (size: 0x1)
    bool bApplyToChildren;                                                            // 0x01DD (size: 0x1)
    bool bRecursive;                                                                  // 0x01DE (size: 0x1)
    FCachedRigElement CachedIndex;                                                    // 0x01E0 (size: 0x20)
...
{
    FRigElementKey Item;                                                              // 0x01D0 (size: 0xC)
    ERigMetaDataNameSpace NameSpace;                                                  // 0x01DC (size: 0x1)
    bool Removed;                                                                     // 0x01DD (size: 0x1)
    FCachedRigElement CachedIndex;                                                    // 0x01E0 (size: 0x20)
...
struct FRigUnit_RemoveMetadata : public FRigUnitMutable
{
    FRigElementKey Item;                                                              // 0x01D0 (size: 0xC)
    FName Name;                                                                       // 0x01DC (size: 0x8)
    ERigMetaDataNameSpace NameSpace;                                                  // 0x01E4 (size: 0x1)
    bool Removed;                                                                     // 0x01E5 (size: 0x1)
    FCachedRigElement CachedIndex;                                                    // 0x01E8 (size: 0x20)
...
struct FRigUnit_RotationConstraint : public FRigUnit_HighlevelBaseMutable
{
    ...
    FFilterOptionPerAxis Filter;                                                      // 0x01DD (size: 0x3)
    TArray<FConstraintParent> Parents;                                                // 0x01E0 (size: 0x10)
    FRigUnit_RotationConstraint_AdvancedSettings AdvancedSettings;                    // 0x01F0 (size: 0x2)
    float Weight;                                                                     // 0x01F4 (size: 0x4)
...
{
    ERigEvent Event;                                                                  // 0x01D0 (size: 0x1)
    FRigElementKey Item;                                                              // 0x01D4 (size: 0xC)
    float OffsetInSeconds;                                                            // 0x01E0 (size: 0x4)
    bool bEnable;                                                                     // 0x01E4 (size: 0x1)
    bool bOnlyDuringInteraction;                                                      // 0x01E5 (size: 0x1)
...
{
    FControlRigExecuteContext ExecuteContext;                                         // 0x0010 (size: 0x1C0)
    FControlRigExecuteContext A;                                                      // 0x01D0 (size: 0x1C0)
    FControlRigExecuteContext B;                                                      // 0x0390 (size: 0x1C0)
    FControlRigExecuteContext C;                                                      // 0x0550 (size: 0x1C0)
    FControlRigExecuteContext D;                                                      // 0x0710 (size: 0x1C0)

}; // Size: 0x8D0

struct FRigUnit_SetAnimationChannelBase : public FRigUnit_GetAnimationChannelBase
{
    FControlRigExecuteContext ExecuteContext;                                         // 0x0030 (size: 0x1C0)
...
struct FRigUnit_SetBoneInitialTransform : public FRigUnitMutable
{
    FName bone;                                                                       // 0x01D0 (size: 0x8)
    FTransform Transform;                                                             // 0x01E0 (size: 0x60)
    FTransform Result;                                                                // 0x0240 (size: 0x60)
    ERigVMTransformSpace Space;                                                       // 0x02A0 (size: 0x1)
    bool bPropagateToChildren;                                                        // 0x02A1 (size: 0x1)
    FCachedRigElement CachedBone;                                                     // 0x02A8 (size: 0x20)
...
{
    FName bone;                                                                       // 0x01D0 (size: 0x8)
    FQuat Rotation;                                                                   // 0x01E0 (size: 0x20)
    ERigVMTransformSpace Space;                                                       // 0x0200 (size: 0x1)
    float Weight;                                                                     // 0x0204 (size: 0x4)
    bool bPropagateToChildren;                                                        // 0x0208 (size: 0x1)
    FCachedRigElement CachedBone;                                                     // 0x0210 (size: 0x20)
...
struct FRigUnit_SetBoneTransform : public FRigUnitMutable
{
    ...
    FTransform Result;                                                                // 0x0240 (size: 0x60)
    ERigVMTransformSpace Space;                                                       // 0x02A0 (size: 0x1)
    float Weight;                                                                     // 0x02A4 (size: 0x4)
    bool bPropagateToChildren;                                                        // 0x02A8 (size: 0x1)
    FCachedRigElement CachedBone;                                                     // 0x02B0 (size: 0x20)
...
{
    FName bone;                                                                       // 0x01D0 (size: 0x8)
    FVector Translation;                                                              // 0x01D8 (size: 0x18)
    ERigVMTransformSpace Space;                                                       // 0x01F0 (size: 0x1)
    float Weight;                                                                     // 0x01F4 (size: 0x4)
    bool bPropagateToChildren;                                                        // 0x01F8 (size: 0x1)
    FCachedRigElement CachedBone;                                                     // 0x0200 (size: 0x20)

}; // Size: 0x220

struct FRigUnit_SetBoolAnimationChannel : public FRigUnit_SetAnimationChannelBase
{
    bool Value;                                                                       // 0x01F0 (size: 0x1)

}; // Size: 0x200

struct FRigUnit_SetControlBool : public FRigUnitMutable
{
    FName Control;                                                                    // 0x01D0 (size: 0x8)
    bool BoolValue;                                                                   // 0x01D8 (size: 0x1)
    FCachedRigElement CachedControlIndex;                                             // 0x01E0 (size: 0x20)
...
struct FRigUnit_SetControlColor : public FRigUnitMutable
{
    FName Control;                                                                    // 0x01D0 (size: 0x8)
    FLinearColor Color;                                                               // 0x01D8 (size: 0x10)
    FCachedRigElement CachedControlIndex;                                             // 0x01E8 (size: 0x20)
...
{
    FName Control;                                                                    // 0x01D0 (size: 0x8)
    TArray<FRigElementKey> Driven;                                                    // 0x01D8 (size: 0x10)
    FCachedRigElement CachedControlIndex;                                             // 0x01E8 (size: 0x20)
...
{
    FName Control;                                                                    // 0x01D0 (size: 0x8)
    float Weight;                                                                     // 0x01D8 (size: 0x4)
    float FloatValue;                                                                 // 0x01DC (size: 0x4)
    FCachedRigElement CachedControlIndex;                                             // 0x01E0 (size: 0x20)
...
{
    FName Control;                                                                    // 0x01D0 (size: 0x8)
    int32 Weight;                                                                     // 0x01D8 (size: 0x4)
    int32 IntegerValue;                                                               // 0x01DC (size: 0x4)
    FCachedRigElement CachedControlIndex;                                             // 0x01E0 (size: 0x20)
...
{
    FName Control;                                                                    // 0x01D0 (size: 0x8)
    FTransform Offset;                                                                // 0x01E0 (size: 0x60)
    ERigVMTransformSpace Space;                                                       // 0x0240 (size: 0x1)
    FCachedRigElement CachedControlIndex;                                             // 0x0248 (size: 0x20)
...
struct FRigUnit_SetControlRotator : public FRigUnitMutable
{
    FName Control;                                                                    // 0x01D0 (size: 0x8)
    float Weight;                                                                     // 0x01D8 (size: 0x4)
    FRotator Rotator;                                                                 // 0x01E0 (size: 0x18)
    ERigVMTransformSpace Space;                                                       // 0x01F8 (size: 0x1)
...
struct FRigUnit_SetControlVector : public FRigUnitMutable
{
    FName Control;                                                                    // 0x01D0 (size: 0x8)
    float Weight;                                                                     // 0x01D8 (size: 0x4)
    FVector Vector;                                                                   // 0x01E0 (size: 0x18)
    ERigVMTransformSpace Space;                                                       // 0x01F8 (size: 0x1)
    FCachedRigElement CachedControlIndex;                                             // 0x0200 (size: 0x20)
...
struct FRigUnit_SetControlVector2D : public FRigUnitMutable
{
    FName Control;                                                                    // 0x01D0 (size: 0x8)
    float Weight;                                                                     // 0x01D8 (size: 0x4)
    FVector2D Vector;                                                                 // 0x01E0 (size: 0x10)
    FCachedRigElement CachedControlIndex;                                             // 0x01F0 (size: 0x20)
...
{
    FRigElementKey Item;                                                              // 0x01D0 (size: 0xC)
    FString Pattern;                                                                  // 0x01E0 (size: 0x10)
    bool bVisible;                                                                    // 0x01F0 (size: 0x1)
    TArray<FCachedRigElement> CachedControlIndices;                                   // 0x01F8 (size: 0x10)

}; // Size: 0x210

struct FRigUnit_SetCurveValue : public FRigUnitMutable
{
    FName Curve;                                                                      // 0x01D0 (size: 0x8)
    float Value;                                                                      // 0x01D8 (size: 0x4)
    FCachedRigElement CachedCurveIndex;                                               // 0x01E0 (size: 0x20)

}; // Size: 0x200

struct FRigUnit_SetDefaultMatch : public FRigUnitMutable
{
    FRigElementKey Default;                                                           // 0x01D0 (size: 0xC)
...
{
    FRigElementKey Item;                                                              // 0x01D0 (size: 0xC)
    TArray<FName> Tags;                                                               // 0x01E0 (size: 0x10)
    ERigMetaDataNameSpace NameSpace;                                                  // 0x01F0 (size: 0x1)
    FCachedRigElement CachedIndex;                                                    // 0x01F8 (size: 0x20)

}; // Size: 0x220

struct FRigUnit_SetMultiControlBool : public FRigUnitMutable
{
    TArray<FRigUnit_SetMultiControlBool_Entry> Entries;                               // 0x01D0 (size: 0x10)
    TArray<FCachedRigElement> CachedControlIndices;                                   // 0x01E0 (size: 0x10)
...
{
    TArray<FRigUnit_SetMultiControlFloat_Entry> Entries;                              // 0x01D0 (size: 0x10)
    float Weight;                                                                     // 0x01E0 (size: 0x4)
    TArray<FCachedRigElement> CachedControlIndices;                                   // 0x01E8 (size: 0x10)
...
{
    TArray<FRigUnit_SetMultiControlInteger_Entry> Entries;                            // 0x01D0 (size: 0x10)
    float Weight;                                                                     // 0x01E0 (size: 0x4)
    TArray<FCachedRigElement> CachedControlIndices;                                   // 0x01E8 (size: 0x10)
...
{
    TArray<FRigUnit_SetMultiControlRotator_Entry> Entries;                            // 0x01D0 (size: 0x10)
    float Weight;                                                                     // 0x01E0 (size: 0x4)
    TArray<FCachedRigElement> CachedControlIndices;                                   // 0x01E8 (size: 0x10)
...
{
    TArray<FRigUnit_SetMultiControlVector2D_Entry> Entries;                           // 0x01D0 (size: 0x10)
    float Weight;                                                                     // 0x01E0 (size: 0x4)
    TArray<FCachedRigElement> CachedControlIndices;                                   // 0x01E8 (size: 0x10)
...
struct FRigUnit_SetRelativeRotationForItem : public FRigUnitMutable
{
    FRigElementKey Child;                                                             // 0x01D0 (size: 0xC)
    FRigElementKey Parent;                                                            // 0x01DC (size: 0xC)
    bool bParentInitial;                                                              // 0x01E8 (size: 0x1)
    FQuat Value;                                                                      // 0x01F0 (size: 0x20)
    float Weight;                                                                     // 0x0210 (size: 0x4)
    bool bPropagateToChildren;                                                        // 0x0214 (size: 0x1)
    FCachedRigElement CachedChild;                                                    // 0x0218 (size: 0x20)
    FCachedRigElement CachedParent;                                                   // 0x0238 (size: 0x20)
...
struct FRigUnit_SetRelativeTransformForItem : public FRigUnitMutable
{
    ...
    FRigElementKey Parent;                                                            // 0x01DC (size: 0xC)
    bool bParentInitial;                                                              // 0x01E8 (size: 0x1)
    FTransform Value;                                                                 // 0x01F0 (size: 0x60)
    float Weight;                                                                     // 0x0250 (size: 0x4)
    bool bPropagateToChildren;                                                        // 0x0254 (size: 0x1)
    FCachedRigElement CachedChild;                                                    // 0x0258 (size: 0x20)
    FCachedRigElement CachedParent;                                                   // 0x0278 (size: 0x20)
...
struct FRigUnit_SetRelativeTranslationForItem : public FRigUnitMutable
{
    ...
    FRigElementKey Parent;                                                            // 0x01DC (size: 0xC)
    bool bParentInitial;                                                              // 0x01E8 (size: 0x1)
    FVector Value;                                                                    // 0x01F0 (size: 0x18)
    float Weight;                                                                     // 0x0208 (size: 0x4)
    bool bPropagateToChildren;                                                        // 0x020C (size: 0x1)
    FCachedRigElement CachedChild;                                                    // 0x0210 (size: 0x20)
    FCachedRigElement CachedParent;                                                   // 0x0230 (size: 0x20)
...
{
    FRigElementKey Item;                                                              // 0x01D0 (size: 0xC)
    ERigVMTransformSpace Space;                                                       // 0x01DC (size: 0x1)
    bool bInitial;                                                                    // 0x01DD (size: 0x1)
    FQuat Value;                                                                      // 0x01E0 (size: 0x20)
...
{
    FRotator Value;                                                                   // 0x01F0 (size: 0x18)
...
struct FRigUnit_SetScale : public FRigUnitMutable
{
    ...
    ERigVMTransformSpace Space;                                                       // 0x01DC (size: 0x1)
    bool bInitial;                                                                    // 0x01DD (size: 0x1)
    FVector Scale;                                                                    // 0x01E0 (size: 0x18)
    float Weight;                                                                     // 0x01F8 (size: 0x4)
    bool bPropagateToChildren;                                                        // 0x01FC (size: 0x1)
...
struct FRigUnit_SetShapeTransform : public FRigUnitMutable
{
    FName Control;                                                                    // 0x01D0 (size: 0x8)
    FTransform Transform;                                                             // 0x01E0 (size: 0x60)
    FCachedRigElement CachedControlIndex;                                             // 0x0240 (size: 0x20)

}; // Size: 0x260

struct FRigUnit_SetSpaceInitialTransform : public FRigUnitMutable
{
    FName SpaceName;                                                                  // 0x01D0 (size: 0x8)
    FTransform Transform;                                                             // 0x01E0 (size: 0x60)
    FTransform Result;                                                                // 0x0240 (size: 0x60)
    ERigVMTransformSpace Space;                                                       // 0x02A0 (size: 0x1)
    FCachedRigElement CachedSpaceIndex;                                               // 0x02A8 (size: 0x20)

}; // Size: 0x2D0

struct FRigUnit_SetSpaceTransform : public FRigUnitMutable
{
    FName Space;                                                                      // 0x01D0 (size: 0x8)
    float Weight;                                                                     // 0x01D8 (size: 0x4)
    FTransform Transform;                                                             // 0x01E0 (size: 0x60)
    ERigVMTransformSpace SpaceType;                                                   // 0x0240 (size: 0x1)
    FCachedRigElement CachedSpaceIndex;                                               // 0x0248 (size: 0x20)
...
struct FRigUnit_SetTransform : public FRigUnitMutable
{
    ...
    ERigVMTransformSpace Space;                                                       // 0x01DC (size: 0x1)
    bool bInitial;                                                                    // 0x01DD (size: 0x1)
    FTransform Value;                                                                 // 0x01E0 (size: 0x60)
    float Weight;                                                                     // 0x0240 (size: 0x4)
    bool bPropagateToChildren;                                                        // 0x0244 (size: 0x1)
    FCachedRigElement CachedIndex;                                                    // 0x0248 (size: 0x20)
...
{
    FRigElementKeyCollection Items;                                                   // 0x01D0 (size: 0x10)
    ERigVMTransformSpace Space;                                                       // 0x01E0 (size: 0x1)
    bool bInitial;                                                                    // 0x01E1 (size: 0x1)
    TArray<FTransform> Transforms;                                                    // 0x01E8 (size: 0x10)
    float Weight;                                                                     // 0x01F8 (size: 0x4)
    bool bPropagateToChildren;                                                        // 0x01FC (size: 0x1)
    TArray<FCachedRigElement> CachedIndex;                                            // 0x0200 (size: 0x10)
...
struct FRigUnit_SetTranslation : public FRigUnitMutable
{
    ...
    ERigVMTransformSpace Space;                                                       // 0x01DC (size: 0x1)
    bool bInitial;                                                                    // 0x01DD (size: 0x1)
    FVector Value;                                                                    // 0x01E0 (size: 0x18)
    float Weight;                                                                     // 0x01F8 (size: 0x4)
    bool bPropagateToChildren;                                                        // 0x01FC (size: 0x1)
    FCachedRigElement CachedIndex;                                                    // 0x0200 (size: 0x20)
...
{
    FVector2D Value;                                                                  // 0x01F0 (size: 0x10)
...
{
    FString NameSpace;                                                                // 0x01D0 (size: 0x10)
    FString Path;                                                                     // 0x01E0 (size: 0x10)
    FString LibraryName;                                                              // 0x01F0 (size: 0x10)
    bool LogShapeLibraries;                                                           // 0x0200 (size: 0x1)
...
struct FRigUnit_SlideChain : public FRigUnit_HighlevelBaseMutable
{
    FName StartBone;                                                                  // 0x01D0 (size: 0x8)
    FName EndBone;                                                                    // 0x01D8 (size: 0x8)
    float SlideAmount;                                                                // 0x01E0 (size: 0x4)
    bool bPropagateToChildren;                                                        // 0x01E4 (size: 0x1)
    FRigUnit_SlideChain_WorkData WorkData;                                            // 0x01E8 (size: 0x48)
...
{
    float OutputParam;                                                                // 0x01D0 (size: 0x4)
    FRigElementKey DriverItem;                                                        // 0x01D4 (size: 0xC)
    FVector DriverAxis;                                                               // 0x01E0 (size: 0x18)
    FVector RotationOffset;                                                           // 0x01F8 (size: 0x18)
    float ActiveRegionSize;                                                           // 0x0210 (size: 0x4)
    FRegionScaleFactors ActiveRegionScaleFactors;                                     // 0x0214 (size: 0x10)
    float FalloffSize;                                                                // 0x0224 (size: 0x4)
    FRegionScaleFactors FalloffRegionScaleFactors;                                    // 0x0228 (size: 0x10)
    bool FlipWidthScaling;                                                            // 0x0238 (size: 0x1)
    bool FlipHeightScaling;                                                           // 0x0239 (size: 0x1)
    FRigElementKey OptionalParentItem;                                                // 0x023C (size: 0xC)
    FSphericalPoseReaderDebugSettings Debug;                                          // 0x0248 (size: 0x10)
    FSphericalRegion InnerRegion;                                                     // 0x0258 (size: 0x14)
    FSphericalRegion OuterRegion;                                                     // 0x026C (size: 0x14)
    FVector DriverNormal;                                                             // 0x0280 (size: 0x18)
    FVector Driver2D;                                                                 // 0x0298 (size: 0x18)
    FCachedRigElement DriverCache;                                                    // 0x02B0 (size: 0x20)
    FCachedRigElement OptionalParentCache;                                            // 0x02D0 (size: 0x20)
    FTransform LocalDriverTransformInit;                                              // 0x02F0 (size: 0x60)
    FVector CachedRotationOffset;                                                     // 0x0350 (size: 0x18)
    bool bCachedInitTransforms;                                                       // 0x0368 (size: 0x1)
...
struct FRigUnit_SpringIK : public FRigUnit_HighlevelBaseMutable
{
    FName StartBone;                                                                  // 0x01D0 (size: 0x8)
    FName EndBone;                                                                    // 0x01D8 (size: 0x8)
    float HierarchyStrength;                                                          // 0x01E0 (size: 0x4)
    float EffectorStrength;                                                           // 0x01E4 (size: 0x4)
    float EffectorRatio;                                                              // 0x01E8 (size: 0x4)
    float RootStrength;                                                               // 0x01EC (size: 0x4)
    float RootRatio;                                                                  // 0x01F0 (size: 0x4)
    float Damping;                                                                    // 0x01F4 (size: 0x4)
    FVector PoleVector;                                                               // 0x01F8 (size: 0x18)
    bool bFlipPolePlane;                                                              // 0x0210 (size: 0x1)
    EControlRigVectorKind PoleVectorKind;                                             // 0x0211 (size: 0x1)
    FName PoleVectorSpace;                                                            // 0x0214 (size: 0x8)
    FVector PrimaryAxis;                                                              // 0x0220 (size: 0x18)
    FVector SecondaryAxis;                                                            // 0x0238 (size: 0x18)
    bool bLiveSimulation;                                                             // 0x0250 (size: 0x1)
    int32 Iterations;                                                                 // 0x0254 (size: 0x4)
    bool bLimitLocalPosition;                                                         // 0x0258 (size: 0x1)
    bool bPropagateToChildren;                                                        // 0x0259 (size: 0x1)
    FRigUnit_SpringIK_DebugSettings DebugSettings;                                    // 0x0260 (size: 0x80)
    FRigUnit_SpringIK_WorkData WorkData;                                              // 0x02E0 (size: 0xB8)
...
{
    ERigSwitchParentMode Mode;                                                        // 0x01D0 (size: 0x1)
    FRigElementKey Child;                                                             // 0x01D4 (size: 0xC)
    FRigElementKey Parent;                                                            // 0x01E0 (size: 0xC)
    bool bMaintainGlobal;                                                             // 0x01EC (size: 0x1)
...
{
    FName bone;                                                                       // 0x01D0 (size: 0x8)
    ETransformSpaceMode BaseTransformSpace;                                           // 0x01D8 (size: 0x1)
    FTransform BaseTransform;                                                         // 0x01E0 (size: 0x60)
    FName BaseBone;                                                                   // 0x0240 (size: 0x8)
    TArray<FConstraintTarget> Targets;                                                // 0x0248 (size: 0x10)
    bool bUseInitialTransforms;                                                       // 0x0258 (size: 0x1)
    FRigUnit_TransformConstraint_WorkData WorkData;                                   // 0x0260 (size: 0x60)
...
{
    FRigElementKey Item;                                                              // 0x01D0 (size: 0xC)
    ETransformSpaceMode BaseTransformSpace;                                           // 0x01DC (size: 0x1)
    FTransform BaseTransform;                                                         // 0x01E0 (size: 0x60)
    FRigElementKey BaseItem;                                                          // 0x0240 (size: 0xC)
    TArray<FConstraintTarget> Targets;                                                // 0x0250 (size: 0x10)
    bool bUseInitialTransforms;                                                       // 0x0260 (size: 0x1)
    FRigUnit_TransformConstraint_WorkData WorkData;                                   // 0x0268 (size: 0x60)
...
struct FRigUnit_TwistBones : public FRigUnit_HighlevelBaseMutable
{
    FName StartBone;                                                                  // 0x01D0 (size: 0x8)
    FName EndBone;                                                                    // 0x01D8 (size: 0x8)
    FVector TwistAxis;                                                                // 0x01E0 (size: 0x18)
    FVector PoleAxis;                                                                 // 0x01F8 (size: 0x18)
    ERigVMAnimEasingType TwistEaseType;                                               // 0x0210 (size: 0x1)
    float Weight;                                                                     // 0x0214 (size: 0x4)
    bool bPropagateToChildren;                                                        // 0x0218 (size: 0x1)
    FRigUnit_TwistBones_WorkData WorkData;                                            // 0x0220 (size: 0x30)
...
{
    FName StartJoint;                                                                 // 0x01D0 (size: 0x8)
    FName EndJoint;                                                                   // 0x01D8 (size: 0x8)
    FVector PoleTarget;                                                               // 0x01E0 (size: 0x18)
    float Spin;                                                                       // 0x01F8 (size: 0x4)
    FTransform EndEffector;                                                           // 0x0200 (size: 0x60)
    float IKBlend;                                                                    // 0x0260 (size: 0x4)
    FTransform StartJointFKTransform;                                                 // 0x0270 (size: 0x60)
    FTransform MidJointFKTransform;                                                   // 0x02D0 (size: 0x60)
    FTransform EndJointFKTransform;                                                   // 0x0330 (size: 0x60)
    float PreviousFKIKBlend;                                                          // 0x0390 (size: 0x4)
    FTransform StartJointIKTransform;                                                 // 0x03A0 (size: 0x60)
    FTransform MidJointIKTransform;                                                   // 0x0400 (size: 0x60)
    FTransform EndJointIKTransform;                                                   // 0x0460 (size: 0x60)
    int32 StartJointIndex;                                                            // 0x04C0 (size: 0x4)
    int32 MidJointIndex;                                                              // 0x04C4 (size: 0x4)
    int32 EndJointIndex;                                                              // 0x04C8 (size: 0x4)
    float UpperLimbLength;                                                            // 0x04CC (size: 0x4)
    float LowerLimbLength;                                                            // 0x04D0 (size: 0x4)
    bool bIsInitialized;                                                              // 0x04D4 (size: 0x1)

}; // Size: 0x4E0

struct FRigUnit_TwoBoneIKSimple : public FRigUnit_HighlevelBaseMutable
{
    FName BoneA;                                                                      // 0x01D0 (size: 0x8)
    FName BoneB;                                                                      // 0x01D8 (size: 0x8)
    FName EffectorBone;                                                               // 0x01E0 (size: 0x8)
    FTransform Effector;                                                              // 0x01F0 (size: 0x60)
    FVector PrimaryAxis;                                                              // 0x0250 (size: 0x18)
    FVector SecondaryAxis;                                                            // 0x0268 (size: 0x18)
    float SecondaryAxisWeight;                                                        // 0x0280 (size: 0x4)
    FVector PoleVector;                                                               // 0x0288 (size: 0x18)
    EControlRigVectorKind PoleVectorKind;                                             // 0x02A0 (size: 0x1)
    FName PoleVectorSpace;                                                            // 0x02A4 (size: 0x8)
    bool bEnableStretch;                                                              // 0x02AC (size: 0x1)
    float StretchStartRatio;                                                          // 0x02B0 (size: 0x4)
    float StretchMaximumRatio;                                                        // 0x02B4 (size: 0x4)
    float Weight;                                                                     // 0x02B8 (size: 0x4)
    float BoneALength;                                                                // 0x02BC (size: 0x4)
    float BoneBLength;                                                                // 0x02C0 (size: 0x4)
    bool bPropagateToChildren;                                                        // 0x02C4 (size: 0x1)
    FRigUnit_TwoBoneIKSimple_DebugSettings DebugSettings;                             // 0x02D0 (size: 0x70)
    FCachedRigElement CachedBoneAIndex;                                               // 0x0340 (size: 0x20)
    FCachedRigElement CachedBoneBIndex;                                               // 0x0360 (size: 0x20)
    FCachedRigElement CachedEffectorBoneIndex;                                        // 0x0380 (size: 0x20)
    FCachedRigElement CachedPoleVectorSpaceIndex;                                     // 0x03A0 (size: 0x20)

}; // Size: 0x3C0

struct FRigUnit_TwoBoneIKSimplePerItem : public FRigUnit_HighlevelBaseMutable
{
    FRigElementKey ItemA;                                                             // 0x01D0 (size: 0xC)
    FRigElementKey ItemB;                                                             // 0x01DC (size: 0xC)
    FRigElementKey EffectorItem;                                                      // 0x01E8 (size: 0xC)
    FTransform Effector;                                                              // 0x0200 (size: 0x60)
    FVector PrimaryAxis;                                                              // 0x0260 (size: 0x18)
    FVector SecondaryAxis;                                                            // 0x0278 (size: 0x18)
    float SecondaryAxisWeight;                                                        // 0x0290 (size: 0x4)
    FVector PoleVector;                                                               // 0x0298 (size: 0x18)
    EControlRigVectorKind PoleVectorKind;                                             // 0x02B0 (size: 0x1)
    FRigElementKey PoleVectorSpace;                                                   // 0x02B4 (size: 0xC)
    bool bEnableStretch;                                                              // 0x02C0 (size: 0x1)
    float StretchStartRatio;                                                          // 0x02C4 (size: 0x4)
    float StretchMaximumRatio;                                                        // 0x02C8 (size: 0x4)
    float Weight;                                                                     // 0x02CC (size: 0x4)
    float ItemALength;                                                                // 0x02D0 (size: 0x4)
    float ItemBLength;                                                                // 0x02D4 (size: 0x4)
    bool bPropagateToChildren;                                                        // 0x02D8 (size: 0x1)
    FRigUnit_TwoBoneIKSimple_DebugSettings DebugSettings;                             // 0x02E0 (size: 0x70)
    FCachedRigElement CachedItemAIndex;                                               // 0x0350 (size: 0x20)
    FCachedRigElement CachedItemBIndex;                                               // 0x0370 (size: 0x20)
    FCachedRigElement CachedEffectorItemIndex;                                        // 0x0390 (size: 0x20)
    FCachedRigElement CachedPoleVectorSpaceIndex;                                     // 0x03B0 (size: 0x20)
...
{
    FName Curve;                                                                      // 0x01D0 (size: 0x8)
    FCachedRigElement CachedCurveIndex;                                               // 0x01D8 (size: 0x20)
...
class AControlRigControlActor : public AActor
{
    ...
    TSoftObjectPtr<UControlRig> ControlRig;                                           // 0x02D0 (size: 0x28)
    TArray<FName> ControlNames;                                                       // 0x02F8 (size: 0x10)
    TArray<FTransform> ShapeTransforms;                                               // 0x0308 (size: 0x10)
    TArray<class UStaticMeshComponent*> Components;                                   // 0x0318 (size: 0x10)
    TArray<class UMaterialInstanceDynamic*> Materials;                                // 0x0328 (size: 0x10)
    FName ColorParameterName;                                                         // 0x0338 (size: 0x8)
...
class AControlRigShapeActor : public AActor
{
    ...
    uint8 bSelected;                                                                  // 0x0340 (size: 0x1)
    uint8 bHovered;                                                                   // 0x0340 (size: 0x1)
...
{
    ERigExecutionType ExecutionType;                                                  // 0x0288 (size: 0x1)
    FRigHierarchySettings HierarchySettings;                                          // 0x028C (size: 0x4)
    TMap<class FRigElementKey, class FRigControlElementCustomization> ControlCustomizations; // 0x0290 (size: 0x50)
    class URigHierarchy* DynamicHierarchy;                                            // 0x02E0 (size: 0x8)
    TArray<TSoftObjectPtr<UControlRigShapeLibrary>> ShapeLibraries;                   // 0x02E8 (size: 0x10)
    TMap<class FString, class FString> ShapeLibraryNameMap;                           // 0x02F8 (size: 0x50)
    FRigVMExtendedExecuteContext RigVMExtendedExecuteContext;                         // 0x0358 (size: 0x228)
    class UAnimationDataSourceRegistry* DataSourceRegistry;                           // 0x0588 (size: 0x8)
    FRigInfluenceMapPerEvent Influences;                                              // 0x0638 (size: 0x60)
    TMap<class FName, class UDataAssetLink*> ExternalVariableDataAssetLinks;          // 0x0750 (size: 0x50)
    FControlRigOnControlSelected_BP OnControlSelected_BP;                             // 0x0870 (size: 0x1)
    void OnControlSelectedBP(class UControlRig* Rig, const FRigControlElement& Control, bool bSelected);
    bool bIsAdditive;                                                                 // 0x0888 (size: 0x1)
    FRigModuleSettings RigModuleSettings;                                             // 0x0A18 (size: 0x80)
    FString RigModuleNameSpace;                                                       // 0x0A98 (size: 0x10)
...
{
    TArray<bool> IsControlActive;                                                     // 0x0AA8 (size: 0x10)
    EControlRigFKRigExecuteMode ApplyMode;                                            // 0x0AB8 (size: 0x1)

}; // Size: 0xAE8

class UModularRig : public UControlRig
{
    TArray<FRigModuleInstance> Modules;                                               // 0x0AA8 (size: 0x10)
    FModularRigSettings ModularRigSettings;                                           // 0x0AD8 (size: 0x1)
    FModularRigModel ModularRigModel;                                                 // 0x0AE0 (size: 0xA0)
    TArray<FRigModuleExecutionElement> ExecutionQueue;                                // 0x0B80 (size: 0x10)
...
{
    class UControlRig* ControlRig;                                                    // 0x01A0 (size: 0x8)
    TSubclassOf<class UControlRig> ControlRigClass;                                   // 0x01A8 (size: 0x8)
    TArray<bool> ControlsMask;                                                        // 0x01B0 (size: 0x10)
    FMovieSceneTransformMask TransformMask;                                           // 0x01C0 (size: 0x4)
    FMovieSceneFloatChannel Weight;                                                   // 0x01C8 (size: 0x110)
    TMap<class FName, class FChannelMapInfo> ControlChannelMap;                       // 0x02D8 (size: 0x50)
    TArray<FEnumParameterNameAndCurve> EnumParameterNamesAndCurves;                   // 0x0328 (size: 0x10)
    TArray<FIntegerParameterNameAndCurve> IntegerParameterNamesAndCurves;             // 0x0338 (size: 0x10)
    TArray<FSpaceControlNameAndChannel> SpaceChannels;                                // 0x0348 (size: 0x10)
    TArray<FConstraintAndActiveChannel> ConstraintsChannels;                          // 0x0358 (size: 0x10)
...
class UMovieSceneControlRigParameterTrack : public UMovieSceneNameableTrack
{
    ...
    TMap<class FName, class FControlRotationOrder> ControlsRotationOrder;             // 0x0100 (size: 0x50)
    int32 PriorityOrder;                                                              // 0x0150 (size: 0x4)
    TMap<class TWeakObjectPtr<UWorld>, class UControlRig*> GameWorldControlRigs;      // 0x0158 (size: 0x50)
...
class URigHierarchy : public UObject
{
    ...
    uint32 TopologyVersion;                                                           // 0x0098 (size: 0x4)
    uint32 MetadataVersion;                                                           // 0x009C (size: 0x4)
    uint16 MetadataTagVersion;                                                        // 0x00A0 (size: 0x2)
    bool bEnableDirtyPropagation;                                                     // 0x00A2 (size: 0x1)
    int32 TransformStackIndex;                                                        // 0x01D4 (size: 0x4)
    class URigHierarchyController* HierarchyController;                               // 0x0250 (size: 0x8)
    class UModularRigRuleManager* RuleManager;                                        // 0x0260 (size: 0x8)
    TMap<class FRigElementKey, class FRigElementKey> PreviousNameMap;                 // 0x02B8 (size: 0x50)
    class URigHierarchy* HierarchyForCacheValidation;                                 // 0x0400 (size: 0x8)
