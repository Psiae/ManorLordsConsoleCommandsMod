...
class UML_VANotifyHandler_C : public UVANotifyHandler
{
    ...
    void AnimNotify_Bolt();
    void AnimNotify_holsterCrossbow();
    void AnimNotify_sfx_loadCrossbow();
    void AnimNotify_EquipFish();
    void AnimNotify_UnequipFish();
    void AnimNotify_vfx_fishingSplash();
    void AnimNotify_sfx_fishingRod();
