...
class AMyRTSMultiEngineCPP_BP_C : public ARTSMultiEngineCPP
{
    ...
    class UInstancedStaticMeshComponent* InstanceSnowTrails;                          // 0x13E8 (size: 0x8)
    double buildingCullDistance;                                                      // 0x13F0 (size: 0x8)
    double unitCullDistance;                                                          // 0x13F8 (size: 0x8)
