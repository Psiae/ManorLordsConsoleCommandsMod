...
class UMLDefaultRadioButton_fullscreenmode_C : public URadioButton
{
    ...
    FMLDefaultRadioButton_fullscreenmode_CClicked Clicked;                            // 0x0318 (size: 0x10)
    void Clicked(int32 Value);
    FText rawLabel;                                                                   // 0x0328 (size: 0x10)
    TArray<FIntPoint> commonResolutions;                                              // 0x0338 (size: 0x10)
