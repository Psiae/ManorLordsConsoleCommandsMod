...
class UtaxWidget_C : public UNaviSubGrid
{
    ...
    class UTextBlock* appLoss_txt;                                                    // 0x0350 (size: 0x8)
    class UBorder* Border_approvalLoss;                                               // 0x0358 (size: 0x8)
    class UTextBlock* collectionEffectiveness_txt;                                    // 0x0360 (size: 0x8)
    class UButton* help_button;                                                       // 0x0368 (size: 0x8)
    class UImage* help_img;                                                           // 0x0370 (size: 0x8)
    class UImage* icon_approvalFace;                                                  // 0x0378 (size: 0x8)
    class UImage* icon_approvalFace_1;                                                // 0x0380 (size: 0x8)
    class UlocalizedTextBox_C* localizedTextBox_C;                                    // 0x0388 (size: 0x8)
    class UlocalizedTextBox_C* localizedTextBox_C_0;                                  // 0x0390 (size: 0x8)
    class UTextBlock* loyaltyChangeText;                                              // 0x0398 (size: 0x8)
    class UMD_NaviAutoTooltip_C* navi_topTooltip;                                     // 0x03A0 (size: 0x8)
