...
{
    TArray<TSoftObjectPtr<UScriptStruct>> SupportedTypes;                             // 0x0010 (size: 0x10)
...
class UNetObjectGridFilterConfig : public UNetObjectFilterConfig
{
    ...
    float MaxCullDistance;                                                            // 0x0038 (size: 0x4)
    float DefaultCullDistance;                                                        // 0x003C (size: 0x4)
    bool bUseExactCullDistance;                                                       // 0x0040 (size: 0x1)
    TArray<FNetObjectGridFilterProfile> FilterProfiles;                               // 0x0048 (size: 0x10)
...
{
    TArray<class UNetObjectFactory*> NetObjectFactories;                              // 0x0588 (size: 0x10)
