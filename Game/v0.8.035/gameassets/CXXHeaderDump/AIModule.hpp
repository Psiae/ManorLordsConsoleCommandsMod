...
class AAIController : public AController
{
    ...
    class UDEPRECATED_PawnActionsComponent* ActionsComp;                              // 0x0398 (size: 0x8)
    class UBlackboardComponent* Blackboard;                                           // 0x03A0 (size: 0x8)
    class UGameplayTasksComponent* CachedGameplayTasksComponent;                      // 0x03A8 (size: 0x8)
    TSubclassOf<class UNavigationQueryFilter> DefaultNavigationFilterClass;           // 0x03B0 (size: 0x8)
    FAIControllerReceiveMoveCompleted ReceiveMoveCompleted;                           // 0x03B8 (size: 0x10)
...
{
    FVector CrowdAgentMoveDirection;                                                  // 0x0308 (size: 0x18)
...
{
    class UNavLocalGridManager* GridManager;                                          // 0x02F0 (size: 0x8)
...
class UPathFollowingComponent : public UActorComponent
{
    ...
    class ANavigationData* MyNavData;                                                 // 0x0100 (size: 0x8)
