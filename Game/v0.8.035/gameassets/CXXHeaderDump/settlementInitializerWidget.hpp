...
class UsettlementInitializerWidget_C : public UNaviSubGrid
{
    ...
    class UBorder* Border_1;                                                          // 0x0358 (size: 0x8)
    class UBorder* Border_2;                                                          // 0x0360 (size: 0x8)
    class UBorder* Border_3;                                                          // 0x0368 (size: 0x8)
    class UBorder* Border_4;                                                          // 0x0370 (size: 0x8)
    class UBorder* Border_5;                                                          // 0x0378 (size: 0x8)
    class UBorder* Border_6;                                                          // 0x0380 (size: 0x8)
    class UButton* Button;                                                            // 0x0388 (size: 0x8)
    class UButton* Button_1;                                                          // 0x0390 (size: 0x8)
    class UButton* Button_516;                                                        // 0x0398 (size: 0x8)
    class UmenuButton_C* confirm_button;                                              // 0x03A0 (size: 0x8)
    class UHorizontalBox* EarlyAccessChocies;                                         // 0x03A8 (size: 0x8)
