...
class AOnlineBeaconHost : public AOnlineBeacon
{
    ...
    TArray<class AOnlineBeaconClient*> ClientActors;                                  // 0x0338 (size: 0x10)
...
class AOnlineBeaconHostObject : public AActor
{
    ...
    TArray<class AOnlineBeaconClient*> ClientActors;                                  // 0x02C0 (size: 0x10)
...
{
    float SocketErrorDisconnectDelay;                                                 // 0x1E54 (size: 0x4)

}; // Size: 0x1E70

class UIpNetDriver : public UNetDriver
{
    uint8 LogPortUnreach;                                                             // 0x08D0 (size: 0x1)
    uint8 AllowPlayerPortUnreach;                                                     // 0x08D0 (size: 0x1)
    uint8 bExitOnBindFailure;                                                         // 0x08D0 (size: 0x1)
    uint32 MaxPortCountToTry;                                                         // 0x08D4 (size: 0x4)
    uint32 ServerDesiredSocketReceiveBufferBytes;                                     // 0x08DC (size: 0x4)
    uint32 ServerDesiredSocketSendBufferBytes;                                        // 0x08E0 (size: 0x4)
    uint32 ClientDesiredSocketReceiveBufferBytes;                                     // 0x08E4 (size: 0x4)
    uint32 ClientDesiredSocketSendBufferBytes;                                        // 0x08E8 (size: 0x4)
    double MaxSecondsInReceive;                                                       // 0x08F0 (size: 0x8)
    int32 NbPacketsBetweenReceiveTimeTest;                                            // 0x08F8 (size: 0x4)
    float ResolutionConnectionTimeout;                                                // 0x08FC (size: 0x4)
