...
class UFamilyEntry_C : public UNaviSubGrid
{
    ...
    class UTextBlock* action_txt;                                                     // 0x0358 (size: 0x8)
    class UBorder* Border_0;                                                          // 0x0360 (size: 0x8)
    class UVerticalBox* ConsumptionIcon_VB;                                           // 0x0368 (size: 0x8)
    class UImage* consumptionImg;                                                     // 0x0370 (size: 0x8)
    ...
    class UImage* Image_64;                                                           // 0x03A8 (size: 0x8)
    class UTextBlock* job_text;                                                       // 0x03B0 (size: 0x8)
    class UMD_NaviAutoButton_C* naviBtn_Home;                                         // 0x03B8 (size: 0x8)
    class UMD_NaviAutoButton_C* naviBtn_ressign;                                      // 0x03C0 (size: 0x8)
    class UMD_NaviAutoButton_C* naviBtn_workplace;                                    // 0x03C8 (size: 0x8)
    class UButton* reassignButton;                                                    // 0x03D0 (size: 0x8)
    class UButton* workplaceButton;                                                   // 0x03D8 (size: 0x8)
    bool isWorkplace;                                                                 // 0x03E0 (size: 0x1)
    bool widgetSpawnComplete;                                                         // 0x03E1 (size: 0x1)
    bool shouldUpdateByTimer;                                                         // 0x03E2 (size: 0x1)
    FWorkerFamily WorkerFamily;                                                       // 0x03E8 (size: 0x48)
    FFamilyEntry_COnWantScrollIntoView OnWantScrollIntoView;                          // 0x0430 (size: 0x10)
    void OnWantScrollIntoView(class UFamilyEntry_C* ThisWidget);
    int32 WorkerFamilyIndex;                                                          // 0x0440 (size: 0x4)
    class ARegion* Region;                                                            // 0x0448 (size: 0x8)
