...
class UNDA_widget_C : public UUserWidget
{
    ...
    class UButton* Button_279;                                                        // 0x02E8 (size: 0x8)
    class UCheckBox* CheckBox;                                                        // 0x02F0 (size: 0x8)
    class UCheckBox* CheckBox_1;                                                      // 0x02F8 (size: 0x8)
    class UCheckBox* CheckBox_69;                                                     // 0x0300 (size: 0x8)
    class UTextBlock* date_txt;                                                       // 0x0308 (size: 0x8)
    class UTextBlock* Header;                                                         // 0x0310 (size: 0x8)
    class UImage* Image_7;                                                            // 0x0318 (size: 0x8)
    class UTextBlock* nda_txt;                                                        // 0x0320 (size: 0x8)
    class UTextBlock* nda_txt_1;                                                      // 0x0328 (size: 0x8)
