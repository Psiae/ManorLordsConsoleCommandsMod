...
{
    int32 PlayerIndex;                                                                // 0x04E8 (size: 0x4)
    FName MotionSource;                                                               // 0x04EC (size: 0x8)
    uint8 bDisableLowLatencyUpdate;                                                   // 0x04F4 (size: 0x1)
    ETrackingStatus CurrentTrackingStatus;                                            // 0x04F8 (size: 0x1)
