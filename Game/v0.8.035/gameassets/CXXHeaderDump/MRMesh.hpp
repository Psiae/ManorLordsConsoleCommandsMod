...
class UMRMeshBodyHolder : public UObject
{
    ...
    FBodyInstance BodyInstance;                                                       // 0x0038 (size: 0x178)

}; // Size: 0x218

class UMRMeshComponent : public UPrimitiveComponent
{
    class UMaterialInterface* Material;                                               // 0x04F0 (size: 0x8)
    class UMaterialInterface* WireframeMaterial;                                      // 0x04F8 (size: 0x8)
    bool bCreateMeshProxySections;                                                    // 0x0500 (size: 0x1)
    bool bUpdateNavMeshOnMeshUpdate;                                                  // 0x0501 (size: 0x1)
    bool bNeverCreateCollisionMesh;                                                   // 0x0503 (size: 0x1)
    TArray<class UMRMeshBodyHolder*> BodyHolders;                                     // 0x0548 (size: 0x10)
