...
{
    FAnimBlueprintGeneratedMutableData __AnimBlueprintMutables;                       // 0x03C0 (size: 0x8)
    ...
    FAnimNode_SequenceEvaluator AnimGraphNode_SequenceEvaluator;                      // 0x03F8 (size: 0x40)
    double Draw;                                                                      // 0x0438 (size: 0x8)
