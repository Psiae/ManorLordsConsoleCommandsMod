...
{
    FControlRigSpline Spline;                                                         // 0x01F0 (size: 0x18)
    FLinearColor Color;                                                               // 0x0208 (size: 0x10)
    float Thickness;                                                                  // 0x0218 (size: 0x4)
    int32 Detail;                                                                     // 0x021C (size: 0x4)
...
struct FRigUnit_FitChainToSplineCurve : public FRigUnit_HighlevelBaseMutable
{
    ...
    FControlRigSpline Spline;                                                         // 0x0200 (size: 0x18)
    EControlRigCurveAlignment Alignment;                                              // 0x0218 (size: 0x1)
    float Minimum;                                                                    // 0x021C (size: 0x4)
    float Maximum;                                                                    // 0x0220 (size: 0x4)
    int32 SamplingPrecision;                                                          // 0x0224 (size: 0x4)
    FVector PrimaryAxis;                                                              // 0x0228 (size: 0x18)
    FVector SecondaryAxis;                                                            // 0x0240 (size: 0x18)
    FVector PoleVectorPosition;                                                       // 0x0258 (size: 0x18)
    TArray<FRigUnit_FitChainToCurve_Rotation> Rotations;                              // 0x0270 (size: 0x10)
    ERigVMAnimEasingType RotationEaseType;                                            // 0x0280 (size: 0x1)
    float Weight;                                                                     // 0x0284 (size: 0x4)
    bool bPropagateToChildren;                                                        // 0x0288 (size: 0x1)
    FRigUnit_FitChainToCurve_DebugSettings DebugSettings;                             // 0x0290 (size: 0x90)
    FRigUnit_FitChainToCurve_WorkData WorkData;                                       // 0x0320 (size: 0x98)
...
struct FRigUnit_SplineConstraint : public FRigUnit_HighlevelBaseMutable
{
    ...
    FVector PrimaryAxis;                                                              // 0x0228 (size: 0x18)
    FVector SecondaryAxis;                                                            // 0x0240 (size: 0x18)
    bool bPropagateToChildren;                                                        // 0x0258 (size: 0x1)
    FRigUnit_SplineConstraint_WorkData WorkData;                                      // 0x0260 (size: 0x38)
