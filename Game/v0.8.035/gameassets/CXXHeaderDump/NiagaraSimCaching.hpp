...
{
    FMovieSceneNiagaraCacheParams Params;                                             // 0x0100 (size: 0x88)
    bool bCacheOutOfDate;                                                             // 0x0188 (size: 0x1)

}; // Size: 0x190

class UMovieSceneNiagaraCacheTrack : public UMovieSceneNameableTrack
{
    bool bIsRecording;                                                                // 0x0108 (size: 0x1)
    TArray<class UMovieSceneSection*> AnimationSections;                              // 0x0110 (size: 0x10)
    bool bCacheRecordingEnabled;                                                      // 0x0120 (size: 0x1)
