...
class UpackTrainPlanner_connection_C : public UUserWidget
{
    ...
    class UTextBlock* barter_value_txt;                                               // 0x02D8 (size: 0x8)
    class UButton* Button;                                                            // 0x02E0 (size: 0x8)
    class UButton* Button_1;                                                          // 0x02E8 (size: 0x8)
    class UButton* Button_2;                                                          // 0x02F0 (size: 0x8)
    class UButton* Button_121;                                                        // 0x02F8 (size: 0x8)
    class UComboBoxString* ComboBox_buying;                                           // 0x0300 (size: 0x8)
    ...
    class UImage* Image_34;                                                           // 0x0330 (size: 0x8)
    class UTextBlock* source_txt;                                                     // 0x0338 (size: 0x8)
    class UTextBlock* target_txt;                                                     // 0x0340 (size: 0x8)
    class UVerticalBox* transportlist_vb_1;                                           // 0x0348 (size: 0x8)
    class ASMBuildingMaster* building;                                                // 0x0350 (size: 0x8)
