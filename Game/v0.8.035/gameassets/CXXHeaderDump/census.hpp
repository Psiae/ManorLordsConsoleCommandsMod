...
class Ucensus_C : public UUserWidget
{
    ...
    class UButton* close_button_1;                                                    // 0x02E0 (size: 0x8)
    class UImage* construction_separator_4;                                           // 0x02E8 (size: 0x8)
    class UMLDefaultSpinner_C* DefaultSpinner;                                        // 0x02F0 (size: 0x8)
    class UImage* Image;                                                              // 0x02F8 (size: 0x8)
    class UFamilyEntry_C* PersonEntry;                                                // 0x0300 (size: 0x8)
    class UVerticalBox* pops_VB;                                                      // 0x0308 (size: 0x8)
    class UTextBlock* TextBlock_61;                                                   // 0x0310 (size: 0x8)
    bool unassignedOnly;                                                              // 0x0318 (size: 0x1)
    bool Pinned;                                                                      // 0x0319 (size: 0x1)
    bool dragging;                                                                    // 0x031A (size: 0x1)
    FVector2D Offset;                                                                 // 0x0320 (size: 0x10)
    FVector2D LastPosition;                                                           // 0x0330 (size: 0x10)
    TArray<class UFamilyEntry_C*> obsoleteEntries;                                    // 0x0340 (size: 0x10)
    FString Current Filter;                                                           // 0x0350 (size: 0x10)
