...
{
    ETexelDensityToolMode TexelDensityMode;                                           // 0x00A8 (size: 0x4)
    float TargetWorldUnits;                                                           // 0x00AC (size: 0x4)
    float TargetPixelCount;                                                           // 0x00B0 (size: 0x4)
    float TextureResolution;                                                          // 0x00B4 (size: 0x4)
    bool bEnableUDIMLayout;                                                           // 0x00B8 (size: 0x1)
...
class UUVLayoutProperties : public UInteractiveToolPropertySet
{
    ...
    bool bPreserveScale;                                                              // 0x00C8 (size: 0x1)
    bool bPreserveRotation;                                                           // 0x00C9 (size: 0x1)
    bool bAllowFlips;                                                                 // 0x00CA (size: 0x1)
    bool bEnableUDIMLayout;                                                           // 0x00CB (size: 0x1)
    bool bUDIMCVAREnabled;                                                            // 0x00CC (size: 0x1)

}; // Size: 0xD0

class UUVTexelDensityOperatorFactory : public UObject
{
    class UUVEditorTexelDensitySettings* Settings;                                    // 0x0030 (size: 0x8)
