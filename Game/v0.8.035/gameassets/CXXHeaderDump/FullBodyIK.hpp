...
{
    FRigElementKey Root;                                                              // 0x01F0 (size: 0xC)
    TArray<FFBIKEndEffector> Effectors;                                               // 0x0200 (size: 0x10)
    TArray<FFBIKConstraintOption> Constraints;                                        // 0x0210 (size: 0x10)
    FSolverInput SolverProperty;                                                      // 0x0220 (size: 0x24)
    FMotionProcessInput MotionProperty;                                               // 0x0244 (size: 0x2)
    bool bPropagateToChildren;                                                        // 0x0246 (size: 0x1)
    FFBIKDebugOption DebugOption;                                                     // 0x0250 (size: 0x80)
    FRigUnit_FullbodyIK_WorkData WorkData;                                            // 0x02D0 (size: 0x198)
