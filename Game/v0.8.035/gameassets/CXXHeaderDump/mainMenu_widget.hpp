...
class UmainMenu_widget_C : public UNaviGrid
{
    ...
    class UWidgetAnimation* FadeOut;                                                  // 0x0468 (size: 0x8)
    class UWidgetAnimation* FadeIn;                                                   // 0x0470 (size: 0x8)
    class USizeBox* back_sb;                                                          // 0x0478 (size: 0x8)
    class UScaleBox* back_scaleBox;                                                   // 0x0480 (size: 0x8)
    class UVerticalBox* back_vb;                                                      // 0x0488 (size: 0x8)
    class UBorder* background_darkening_border;                                       // 0x0490 (size: 0x8)
    class UBackgroundBlur* BackgroundBlur_51;                                         // 0x0498 (size: 0x8)
    class UButton* Button_3;                                                          // 0x04A0 (size: 0x8)
    class UButton* Button_4;                                                          // 0x04A8 (size: 0x8)
    class UCanvasPanel* CanvasRoot;                                                   // 0x04B0 (size: 0x8)
    class UCreditsPage_C* CreditsPage;                                                // 0x04B8 (size: 0x8)
    class UImage* Image;                                                              // 0x04C0 (size: 0x8)
    class UImage* Image_254;                                                          // 0x04C8 (size: 0x8)
    class UBorder* inGameFadeBorder;                                                  // 0x04D0 (size: 0x8)
    class UImage* logo_img;                                                           // 0x04D8 (size: 0x8)
    class USizeBox* main_buttons_sb;                                                  // 0x04E0 (size: 0x8)
    class UVerticalBox* main_buttons_vb;                                              // 0x04E8 (size: 0x8)
    class Umain_menu_lord_customization_C* main_menu_lordCustomization;               // 0x04F0 (size: 0x8)
    class Umenu_saveLoadMenu_C* menu_load;                                            // 0x04F8 (size: 0x8)
    class Umenu_settingsWrapper_C* menu_settingsWrapper_fullscreen;                   // 0x0500 (size: 0x8)
    class UmenuButton_C* menuButton_back;                                             // 0x0508 (size: 0x8)
    class UmenuButton_C* menuButton_continue;                                         // 0x0510 (size: 0x8)
    class UmenuButton_C* menuButton_credits;                                          // 0x0518 (size: 0x8)
    class UmenuButton_C* menuButton_loadGame;                                         // 0x0520 (size: 0x8)
    class UmenuButton_C* menuButton_mainMenu;                                         // 0x0528 (size: 0x8)
    class UmenuButton_C* menuButton_newGame;                                          // 0x0530 (size: 0x8)
    class UmenuButton_C* menuButton_quit;                                             // 0x0538 (size: 0x8)
    class UmenuButton_C* menuButton_save;                                             // 0x0540 (size: 0x8)
    class UmenuButton_C* menuButton_settings;                                         // 0x0548 (size: 0x8)
    class UTextBlock* Ver;                                                            // 0x0550 (size: 0x8)
    UDLSSMode DLSS_used;                                                              // 0x0558 (size: 0x1)
    class UmainMenu_GameSetup_C* mainMenu_newGameSettingsWidget;                      // 0x0560 (size: 0x8)
    class UWidget* activeMenu;                                                        // 0x0568 (size: 0x8)
    TSubclassOf<class UCoatOfArmsLibrary> CoatOfArmsLibraryClass;                     // 0x0570 (size: 0x8)
    class UCoatOfArmsLibrary* CoatOfArmsLibrary;                                      // 0x0578 (size: 0x8)
    bool StartingNewGame;                                                             // 0x0580 (size: 0x1)
    class UMainMenu_LoadingThrobber_C* ShownLoadingIndicator;                         // 0x0588 (size: 0x8)
