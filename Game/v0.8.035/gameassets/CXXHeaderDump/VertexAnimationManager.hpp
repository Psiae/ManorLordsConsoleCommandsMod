...
struct FVAAnimNode_Base : public FAnimNode_Base
{
...
struct FVAAnimNode_CopyPose : public FVAAnimNode_Base
{
    FName AnimationName;                                                              // 0x0034 (size: 0x8)
    FName SyncGroup;                                                                  // 0x003C (size: 0x8)

}; // Size: 0x48

struct FVAComputeShaderDispatchParams
{
    class UTexture2D* InputTexture;                                                   // 0x0020 (size: 0x8)
    class UTexture2D* InputTextureRotation;                                           // 0x0058 (size: 0x8)
...
struct FVertexAnimationBone
{
    ...
    int32 ParentInternal;                                                             // 0x0030 (size: 0x4)
...
class UVAComputeShaderLibrary : public UObject
{
}; // Size: 0x28
...
class UVAInstancedComponent : public UActorComponent
{
    int32 MaxInstances;                                                               // 0x00A0 (size: 0x4)
    int32 MaxSockets;                                                                 // 0x00A4 (size: 0x4)
    int32 BoneColumnCount;                                                            // 0x00A8 (size: 0x4)
    TSoftObjectPtr<UVertexAnimationProfile> ProfileAsset;                             // 0x00B0 (size: 0x28)
    class UTextureRenderTarget2D* RenderTargetPosition;                               // 0x00D8 (size: 0x8)
    class UTextureRenderTarget2D* RenderTargetRotation;                               // 0x00E0 (size: 0x8)
    class UTextureRenderTarget2D* RenderTargetPositionPrevious;                       // 0x00E8 (size: 0x8)
    class UTextureRenderTarget2D* RenderTargetRotationPrevious;                       // 0x00F0 (size: 0x8)

    bool UpdateInstanceAnimation(class UVARuntimeComponent* RuntimeComponent);
    bool UpdateInstance(class UVARuntimeComponent* RuntimeComponent);
    bool UpdateBlendSpace(class UVARuntimeComponent* RuntimeComponent, float Direction, float Speed);
    bool UpdateAimOffset(class UVARuntimeComponent* RuntimeComponent, const FQuat& Rotator);
    bool SetPosition(class UVARuntimeComponent* RuntimeComponent, int32 RuntimeIndex, float position);
    bool SetBlendSpace(class UVARuntimeComponent* RuntimeComponent, int32 BlendSpaceIndex, FName BlendProfile);
    bool SetBlendProfile(class UVARuntimeComponent* RuntimeComponent, int32 Track, class UBlendProfile* BlendProfile);
    bool SetAimOffset(class UVARuntimeComponent* RuntimeComponent, const FQuat& Rotator, FName BlendProfile, float Alpha);
    bool RemoveInstance(class UVARuntimeComponent* RuntimeComponent);
    class UVARuntimeComponent* GetRuntime(int32 InstanceId);
    int32 GetInstanceDataIndex(class UVARuntimeComponent* RuntimeComponent);
    float GetBoneProfileWeight(class UBlendProfile* BlendProfile, const FVertexAnimationBone& bone);
    bool Execute();
    bool AddInstance(class UVARuntimeComponent* RuntimeComponent);
    bool AddAdditivePose(class UVARuntimeComponent* RuntimeComponent, FName InAnimationName, int32 Frame);
}; // Size: 0x480
...
class UVARuntimeBPLibrary : public UBlueprintFunctionLibrary
{
    ...
    void UnregisterTransformUpdated(class USceneComponent* InComponent, FVADelegateHandle& Handle);
    ...
    void RegisterTransformUpdated(class USceneComponent* InComponent, FVADelegateHandle& Handle);
...
class UVARuntimeComponent : public UActorComponent
{
    ...
    FVARuntimeComponentOnAimOffset OnAimOffset;                                       // 0x0428 (size: 0x10)
    void OnAimOffsetSignature();
    FVARuntimeComponentOnAnimationEnd OnAnimationEnd;                                 // 0x0438 (size: 0x10)
    void OnAnimationEndSignature();
    class UVAWorldSubsystem* Subsystem;                                               // 0x0448 (size: 0x8)
    class USkeletalMeshComponent* SkeletalMeshComponent;                              // 0x0450 (size: 0x8)
    class UVertexAnimationProfile* Profile;                                           // 0x0458 (size: 0x8)
    TSoftObjectPtr<UVertexAnimationProfile> ProfileAsset;                             // 0x0460 (size: 0x28)
    TSoftObjectPtr<USkeletalMesh> SkeletalMesh;                                       // 0x0488 (size: 0x28)
    TSubclassOf<class USkeletalMeshComponent> SkeletalMeshComponentClass;             // 0x04B0 (size: 0x8)
    TSubclassOf<class UAnimInstance> AnimClass;                                       // 0x04B8 (size: 0x8)
    TSubclassOf<class UVANotifyHandler> NotifyHandlerClass;                           // 0x04C0 (size: 0x8)
    bool bDebugBones;                                                                 // 0x04C8 (size: 0x1)
    FVADebugBoneSettings BoneSettings;                                                // 0x04CC (size: 0xC)
    bool bPlaying;                                                                    // 0x04D8 (size: 0x1)
    bool bFrameInterpolation;                                                         // 0x04D9 (size: 0x1)
    bool bAnimationTransition;                                                        // 0x04DA (size: 0x1)
    float AnimationTransitionDuration;                                                // 0x04DC (size: 0x4)
    bool bNotifications;                                                              // 0x04E0 (size: 0x1)
    bool bUseSyncGroup;                                                               // 0x04E1 (size: 0x1)
    FName AnimationName;                                                              // 0x04E4 (size: 0x8)
    float AnimationPlayRate;                                                          // 0x04EC (size: 0x4)
    TEnumAsByte<EVARootMotionMode> RootMotionMode;                                    // 0x04F0 (size: 0x1)
    bool bUpdateTransforms;                                                           // 0x04F1 (size: 0x1)
    bool bSync;                                                                       // 0x04F2 (size: 0x1)
    float SyncFrameRate;                                                              // 0x04F4 (size: 0x4)
    bool bLODEnabled;                                                                 // 0x04F8 (size: 0x1)
    FVertexAnimationLOD LOD;                                                          // 0x04FC (size: 0x30)
    bool bPhysics;                                                                    // 0x052C (size: 0x1)
    bool bComputeShader;                                                              // 0x052D (size: 0x1)
    int32 ComputeShaderMaxInstances;                                                  // 0x0530 (size: 0x4)
    int32 ComputeShaderInstance;                                                      // 0x0534 (size: 0x4)
    class UVAInstancedComponent* InstancedComponent;                                  // 0x0538 (size: 0x8)
    TArray<class UShapeComponent*> PhysicsShapes;                                     // 0x0540 (size: 0x10)
    int32 NotifyCullDistance;                                                         // 0x0550 (size: 0x4)

    bool UpdateBlendSpace(float Direction, float Speed);
    void UpdateAnimationBlueprint();
    bool UpdateAimOffset(const FQuat& Rotator);
    void Stop();
    void SetTimePlayed(float TimePlayed);
    void SetSkeletalMeshOn();
    void SetRagdollOn(TEnumAsByte<ECollisionEnabled::Type> CollisionType, FName VariationName);
    void SetRagdollOff();
    ...
    bool SetBlendSpace(int32 Index, FName BlendProfile);
    bool SetBlendProfileByName(int32 Track, FName ProfileName);
    bool SetBlendProfile(int32 Track, class UBlendProfile* BlendProfile);
    bool SetAnimationIndex(int32 InAnimationIndex, bool Loop);
    bool SetAnimationByName(FName InAnimationName, bool Loop);
    bool SetAimOffset(const FQuat& Rotator, FName BlendProfile, float Alpha);
    bool SetAdditivePosePosition(float position);
    void ResumeWorld();
    void Resume();
    void Reset();
    void Reregister();
    ...
    int32 GetBlendProfileIndex(const FName& InProfileName);
    class UBlendProfile* GetBlendProfile(const FName& InProfileName);
    class UAnimInstance* GetAnimInstance();
    TArray<FName> GetAnimationNames();
    int32 GetAnimationIndexByName(FName InAnimationName);
    ...
    bool AddAdditivePose(FName InAnimationName, int32 Frame);
}; // Size: 0x560

class UVASMComponent : public UStaticMeshComponent
{
    FName RuntimeComponentName;                                                       // 0x05B8 (size: 0x8)
    TWeakObjectPtr<class UVARuntimeComponent> RuntimeComponent;                       // 0x05C0 (size: 0x8)
    FName VariationName;                                                              // 0x05C8 (size: 0x8)
...
{
    TMap<class FGuid, class UVAInstancedManager*> InstancedManager;                   // 0x01C0 (size: 0x50)
    TArray<class UVARuntimeComponent*> SyncComponents;                                // 0x0210 (size: 0x10)
    TMap<class FGuid, class UVAInstancedComponent*> InstancedComponent;               // 0x02C8 (size: 0x50)
...
class UVertexAnimationProfile : public UDataAsset
{
    ...
    bool bUseRootMotion;                                                              // 0x00ED (size: 0x1)
    FVertexAnimationTransformSelection RootMotionAxis;                                // 0x00EE (size: 0x8)
    FRotator Rotation;                                                                // 0x00F8 (size: 0x18)
    TArray<FName> ActiveSockets;                                                      // 0x0110 (size: 0x10)
    TArray<FName> ActiveSocketsInternal;                                              // 0x0120 (size: 0x10)
    bool bPhysicsSockets;                                                             // 0x0130 (size: 0x1)
    bool bNaniteSupport;                                                              // 0x0131 (size: 0x1)
    uint8 bPreserveArea;                                                              // 0x0132 (size: 0x1)
    FName PositionPrecisionName;                                                      // 0x0134 (size: 0x8)
    int32 PositionPrecision;                                                          // 0x013C (size: 0x4)
    int32 KeepPercentTriangles;                                                       // 0x0140 (size: 0x4)
    ENaniteFallbackTarget FallbackTarget;                                             // 0x0144 (size: 0x1)
    float FallbackPercentTriangles;                                                   // 0x0148 (size: 0x4)
    float FallbackRelativeError;                                                      // 0x014C (size: 0x4)
    TEnumAsByte<ENaniteUVChannel> NaniteUVChannel;                                    // 0x0150 (size: 0x1)
    int32 NaniteUVChannelIndex;                                                       // 0x0154 (size: 0x4)
    int32 NaniteTextureSize;                                                          // 0x0158 (size: 0x4)
    TSoftObjectPtr<USkeletalMesh> SkeletalMesh;                                       // 0x0160 (size: 0x28)
    bool bOverrideStaticMesh;                                                         // 0x0188 (size: 0x1)
    TSoftObjectPtr<UStaticMesh> StaticMesh;                                           // 0x0190 (size: 0x28)
    bool bOverrideBonePosition;                                                       // 0x01B8 (size: 0x1)
    FMeshBuildSettings BuildSettings;                                                 // 0x01C0 (size: 0x48)
    TSoftObjectPtr<UTexture2D> BonePosition;                                          // 0x0208 (size: 0x28)
    bool bOverrideBoneRotation;                                                       // 0x0230 (size: 0x1)
    TSoftObjectPtr<UTexture2D> BoneRotation;                                          // 0x0238 (size: 0x28)
    bool bOverrideBoneWeight;                                                         // 0x0260 (size: 0x1)
    TSoftObjectPtr<UTexture2D> BoneWeight;                                            // 0x0268 (size: 0x28)
    bool bOverrideVertexOffset;                                                       // 0x0290 (size: 0x1)
    TSoftObjectPtr<UTexture2D> VertexOffset;                                          // 0x0298 (size: 0x28)
    bool bOverrideVertexNormal;                                                       // 0x02C0 (size: 0x1)
    TSoftObjectPtr<UTexture2D> VertexNormal;                                          // 0x02C8 (size: 0x28)
    bool bOverrideNanite;                                                             // 0x02F0 (size: 0x1)
    TSoftObjectPtr<UTexture2D> Nanite;                                                // 0x02F8 (size: 0x28)
    TArray<FVertexAnimation> Animations;                                              // 0x0320 (size: 0x10)
    TArray<class UBlendSpace*> BlendSpaces;                                           // 0x0330 (size: 0x10)
    TMap<class FName, class FVertexAnimationMaterialRef> MaterialSlots;               // 0x0340 (size: 0x50)
    class UVAVariations* variations;                                                  // 0x0390 (size: 0x8)
    bool bIsBaked;                                                                    // 0x0398 (size: 0x1)
    FIntPoint BoneTextureSize;                                                        // 0x039C (size: 0x8)
    FIntPoint BoneWeightsTextureSize;                                                 // 0x03A4 (size: 0x8)
    int32 BoneColumnCount;                                                            // 0x03AC (size: 0x4)
    FIntPoint VertexTextureSize;                                                      // 0x03B0 (size: 0x8)
    int32 MaxBones;                                                                   // 0x03B8 (size: 0x4)
    float MaxBoneLength;                                                              // 0x03BC (size: 0x4)
    int32 MaxVertices;                                                                // 0x03C0 (size: 0x4)
    int32 VerticesRowPerFrame;                                                        // 0x03C4 (size: 0x4)
    int32 TotalFrames;                                                                // 0x03C8 (size: 0x4)
    float MaxValue;                                                                   // 0x03CC (size: 0x4)
    TArray<FVertexAnimationBone> Bones;                                               // 0x03D0 (size: 0x10)
    bool bWedgeIndicesUnique;                                                         // 0x03E0 (size: 0x1)
    FGuid Guid;                                                                       // 0x03E4 (size: 0x10)

    void PreloadVariationsByGroup(FName GroupName);
    void PreloadVariations();
    FName GetSocketParentName(const FName& InSocketName);
    int32 GetSocketIndex(const FName& InSocketName);
    TArray<FName> GetOptionsPositionPrecision();
    int32 GetMaxSockets();
    TArray<FName> GetInactiveSocketNames();
}; // Size: 0x3F8
