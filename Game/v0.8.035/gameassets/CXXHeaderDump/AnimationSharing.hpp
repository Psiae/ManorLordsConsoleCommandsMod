...
{
    TWeakObjectPtr<class USkeletalMeshComponent> BaseComponent;                       // 0x03B8 (size: 0x8)
    TWeakObjectPtr<class UAnimSequence> AdditiveAnimation;                            // 0x03C0 (size: 0x8)
    float Alpha;                                                                      // 0x03C8 (size: 0x4)
    bool bStateBool;                                                                  // 0x03CC (size: 0x1)
...
{
    class UAnimSequence* AnimationToPlay;                                             // 0x03B8 (size: 0x8)
    float PermutationTimeOffset;                                                      // 0x03C0 (size: 0x4)
    float PlayRate;                                                                   // 0x03C4 (size: 0x4)
    bool bStateBool;                                                                  // 0x03C8 (size: 0x1)
    class UAnimSharingInstance* Instance;                                             // 0x03D0 (size: 0x8)
...
{
    TWeakObjectPtr<class USkeletalMeshComponent> FromComponent;                       // 0x03B8 (size: 0x8)
    TWeakObjectPtr<class USkeletalMeshComponent> ToComponent;                         // 0x03C0 (size: 0x8)
    float BlendTime;                                                                  // 0x03C8 (size: 0x4)
    bool bBlendBool;                                                                  // 0x03CC (size: 0x1)
