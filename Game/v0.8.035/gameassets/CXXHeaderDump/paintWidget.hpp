...
class UpaintWidget_C : public UUserWidget
{
    ...
    class UImage* itemIMG;                                                            // 0x02D8 (size: 0x8)
    FLinearColor itemColor;                                                           // 0x02E0 (size: 0x10)
    class UMaterialInstanceDynamic* materialDynamic;                                  // 0x02F0 (size: 0x8)
    FpaintWidget_CItemClicked itemClicked;                                            // 0x02F8 (size: 0x10)
