...
class UWorkplaceLimitsWidget_C : public UUserWidget
{
    ...
    class UButton* help_button_consumption;                                           // 0x02D8 (size: 0x8)
    class UButton* help_button_productionLimit;                                       // 0x02E0 (size: 0x8)
    class UImage* help_img_consumption;                                               // 0x02E8 (size: 0x8)
    class UImage* help_img_production;                                                // 0x02F0 (size: 0x8)
    class UImage* img_category_line_1;                                                // 0x02F8 (size: 0x8)
    class UImage* img_category_line_2;                                                // 0x0300 (size: 0x8)
    class UMD_NaviAutoTooltip_C* MD_NaviAutoTooltip;                                  // 0x0308 (size: 0x8)
    class UMD_NaviAutoTooltip_C* MD_NaviAutoTooltip_74;                               // 0x0310 (size: 0x8)
