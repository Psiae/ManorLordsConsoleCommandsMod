...
class UChaosClothConfig : public UClothConfigCommon
{
    ...
    FVector LinearVelocityScale;                                                      // 0x0120 (size: 0x18)
    float AngularVelocityScale;                                                       // 0x0138 (size: 0x4)
    float FictitiousAngularScale;                                                     // 0x013C (size: 0x4)
    bool bUseTetrahedralConstraints;                                                  // 0x0140 (size: 0x1)
    bool bUseThinShellVolumeConstraints;                                              // 0x0141 (size: 0x1)
    bool bUseContinuousCollisionDetection;                                            // 0x0142 (size: 0x1)
