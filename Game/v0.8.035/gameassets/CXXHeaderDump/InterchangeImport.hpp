...
{
    class UInterchangeFbxTranslatorSettings* CacheFbxTranslatorSettings;              // 0x0058 (size: 0x8)
...
{
    class UInterchangeUsdTranslatorSettings* TranslatorSettings;                      // 0x0060 (size: 0x8)

}; // Size: 0x68

class UInterchangeUsdTranslatorSettings : public UInterchangeTranslatorSettings
{
    int32 GeometryPurpose;                                                            // 0x0028 (size: 0x4)
    FName RenderContext;                                                              // 0x002C (size: 0x8)
    FName MaterialPurpose;                                                            // 0x0034 (size: 0x8)
    EUsdInterpolationType InterpolationType;                                          // 0x003C (size: 0x1)
    bool bOverrideStageOptions;                                                       // 0x003D (size: 0x1)
    FUsdStageOptions StageOptions;                                                    // 0x0040 (size: 0x8)
