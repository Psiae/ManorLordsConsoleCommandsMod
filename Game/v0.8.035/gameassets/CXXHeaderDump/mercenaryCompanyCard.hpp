...
class UmercenaryCompanyCard_C : public UUserWidget
{
    ...
    class UTextBlock* arrivein_txt;                                                   // 0x02E0 (size: 0x8)
    class UTextBlock* arrivein_txt_1;                                                 // 0x02E8 (size: 0x8)
    class UImage* banner;                                                             // 0x02F0 (size: 0x8)
    class UButton* Button_76;                                                         // 0x02F8 (size: 0x8)
    class UButton* check_region;                                                      // 0x0300 (size: 0x8)
    class UTextBlock* companyName_txt;                                                // 0x0308 (size: 0x8)
    class UTextBlock* cost;                                                           // 0x0310 (size: 0x8)
    class UHorizontalBox* cost-HB;                                                    // 0x0318 (size: 0x8)
    class UTextBlock* eta_txt;                                                        // 0x0320 (size: 0x8)
    class UImage* Image;                                                              // 0x0328 (size: 0x8)
    class UImage* Image_1;                                                            // 0x0330 (size: 0x8)
    class UImage* Image_2;                                                            // 0x0338 (size: 0x8)
    class UImage* Image_54;                                                           // 0x0340 (size: 0x8)
    class UImage* Image_104;                                                          // 0x0348 (size: 0x8)
    class UMD_NaviAutoButton_C* navi_Accept;                                          // 0x0350 (size: 0x8)
    class UMD_NaviAutoTooltip_C* Navi_CostTooltip;                                    // 0x0358 (size: 0x8)
