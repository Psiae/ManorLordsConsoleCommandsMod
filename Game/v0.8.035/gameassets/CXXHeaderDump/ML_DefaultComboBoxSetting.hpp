...
class UML_DefaultComboBoxSetting_C : public UComboBoxSetting
{
    ...
    class UMD_NaviComboBoxWrapper_C* MD_NaviComboBoxWrapper;                          // 0x0350 (size: 0x8)
    FML_DefaultComboBoxSetting_COnOpen onOpen;                                        // 0x0358 (size: 0x10)
    void onOpen();
    FML_DefaultComboBoxSetting_COnSelectionChanged OnSelectionChanged;                // 0x0368 (size: 0x10)
    void onSelectionChanged(FString Item, TEnumAsByte<ESelectInfo::Type> Type);
    TArray<FSettingOption> optionsCache;                                              // 0x0378 (size: 0x10)
    TArray<FIntPoint> supportedResolutions;                                           // 0x0388 (size: 0x10)
    FString selectedoptioncache;                                                      // 0x0398 (size: 0x10)
    TArray<FString> currentoptionscache;                                              // 0x03A8 (size: 0x10)
    TArray<FIntPoint> commonResolutions;                                              // 0x03B8 (size: 0x10)
    FString NewVar_0;                                                                 // 0x03C8 (size: 0x10)
