...
class AALS_Base_CharacterBP_C : public ACharacter
{
    ...
    class UCameraComponent* Camera;                                                   // 0x0658 (size: 0x8)
    class USpringArmComponent* SpringArm;                                             // 0x0660 (size: 0x8)
    float MantleTimeline_BlendIn_91D7A42A4A23268AEE2E28853DEE703D;                    // 0x0668 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> MantleTimeline__Direction_91D7A42A4A23268AEE2E28853DEE703D; // 0x066C (size: 0x1)
    class UTimelineComponent* MantleTimeline;                                         // 0x0670 (size: 0x8)
    TEnumAsByte<ALS_MovementState::Type> MovementState;                               // 0x0678 (size: 0x1)
    TEnumAsByte<ALS_MovementState::Type> PrevMovementState;                           // 0x0679 (size: 0x1)
    TEnumAsByte<ALS_RotationMode::Type> DesiredRotationMode;                          // 0x067A (size: 0x1)
    TEnumAsByte<ALS_MovementAction::Type> MovementAction;                             // 0x067B (size: 0x1)
    TEnumAsByte<ALS_RotationMode::Type> RotationMode;                                 // 0x067C (size: 0x1)
    TEnumAsByte<ALS_Gait::Type> DesiredGait;                                          // 0x067D (size: 0x1)
    TEnumAsByte<ALS_Gait::Type> Gait;                                                 // 0x067E (size: 0x1)
    TEnumAsByte<ALS_Stance::Type> Stance;                                             // 0x067F (size: 0x1)
    TEnumAsByte<ALS_ViewMode::Type> ViewMode;                                         // 0x0680 (size: 0x1)
    FVector PreviousVelocity;                                                         // 0x0688 (size: 0x18)
    FVector Acceleration;                                                             // 0x06A0 (size: 0x18)
    bool IsMoving;                                                                    // 0x06B8 (size: 0x1)
    bool HasMovementInput;                                                            // 0x06B9 (size: 0x1)
    FRotator LastVelocityRotation;                                                    // 0x06C0 (size: 0x18)
    FRotator LastMovementInputRotation;                                               // 0x06D8 (size: 0x18)
    double Speed;                                                                     // 0x06F0 (size: 0x8)
    double MovementInputAmount;                                                       // 0x06F8 (size: 0x8)
    double PreviousAimYaw;                                                            // 0x0700 (size: 0x8)
    FRotator TargetRotation;                                                          // 0x0708 (size: 0x18)
    FRotator InAirRotation;                                                           // 0x0720 (size: 0x18)
    double YawOffset;                                                                 // 0x0738 (size: 0x8)
    FDataTableRowHandle MovementModel;                                                // 0x0740 (size: 0x10)
    FMovementSettings_State MovementData;                                             // 0x0750 (size: 0xC0)
    FMovementSettings CurrentMovementSettings;                                        // 0x0810 (size: 0x20)
    FMantle_Params MantleParams;                                                      // 0x0830 (size: 0x30)
    FALS_ComponentAndTransform MantleLedgeLS;                                         // 0x0860 (size: 0x70)
    FTransform MantleTarget;                                                          // 0x08D0 (size: 0x60)
    FTransform MantleActualStartOffset;                                               // 0x0930 (size: 0x60)
    FTransform MantleAnimatedStartOffset;                                             // 0x0990 (size: 0x60)
    FMantle_TraceSettings GroundedTraceSettings;                                      // 0x09F0 (size: 0x14)
    FMantle_TraceSettings AutomaticTraceSettings;                                     // 0x0A04 (size: 0x14)
    FMantle_TraceSettings FallingTraceSettings;                                       // 0x0A18 (size: 0x14)
    TEnumAsByte<ALS_Stance::Type> DesiredStance;                                      // 0x0A2C (size: 0x1)
    double LookUp/DownRate;                                                           // 0x0A30 (size: 0x8)
    double LookLeftRightRate;                                                         // 0x0A38 (size: 0x8)
    double AimYawRate;                                                                // 0x0A40 (size: 0x8)
    TEnumAsByte<ALS_OverlayState::Type> OverlayState;                                 // 0x0A48 (size: 0x1)
    int32 TimesPressedStance;                                                         // 0x0A4C (size: 0x4)
    bool BreakFall;                                                                   // 0x0A50 (size: 0x1)
    bool SprintHeld;                                                                  // 0x0A51 (size: 0x1)
    class UAnimInstance* MainAnimInstance;                                            // 0x0A58 (size: 0x8)
    bool RagdollOnGround;                                                             // 0x0A60 (size: 0x1)
    bool RagdollFaceUp;                                                               // 0x0A61 (size: 0x1)
    FVector LastRagdollVelocity;                                                      // 0x0A68 (size: 0x18)
    double ThirdPersonFOV;                                                            // 0x0A80 (size: 0x8)
    double FirstPersonFOV;                                                            // 0x0A88 (size: 0x8)
    bool RightShoulder;                                                               // 0x0A90 (size: 0x1)
    class APawnCPP* rtsPawn;                                                          // 0x0A98 (size: 0x8)
    FVector2D mouseMove2D;                                                            // 0x0AA0 (size: 0x10)
    FVector2D prevMousePos2D;                                                         // 0x0AB0 (size: 0x10)
    double walkaroundCamera_rotationSpeed;                                            // 0x0AC0 (size: 0x8)
    class UHideCursorWidget_C* HideCursorWidget;                                      // 0x0AC8 (size: 0x8)
