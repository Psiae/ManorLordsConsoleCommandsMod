...
class AMenuPawn_C : public AMenuPawn
{
    ...
    class UAudioComponent* music;                                                     // 0x0330 (size: 0x8)
    class UCineCameraComponent* CineCamera;                                           // 0x0338 (size: 0x8)
    class USceneComponent* DefaultSceneRoot;                                          // 0x0340 (size: 0x8)
    TEnumAsByte<ETimelineDirection::Type> start_the_game_delayed__Direction_92EB535847828C20F93D97B2218879BC; // 0x0348 (size: 0x1)
    class UTimelineComponent* start_the_game_delayed;                                 // 0x0350 (size: 0x8)
    FVector cameraMove_relativeLocation_51C2489046C8A91551D142947AC51778;             // 0x0358 (size: 0x18)
    TEnumAsByte<ETimelineDirection::Type> cameraMove__Direction_51C2489046C8A91551D142947AC51778; // 0x0370 (size: 0x1)
    class UTimelineComponent* cameraMove;                                             // 0x0378 (size: 0x8)
    class UmainMenu_widget_C* MainMenu;                                               // 0x0380 (size: 0x8)
    FString CurrentAppliedAaAlgo;                                                     // 0x0388 (size: 0x10)
    class UEarlyAccessWidget_C* EarlyAccessDialog;                                    // 0x0398 (size: 0x8)

    void ApplyConsoleTuning();
    ...
    void OnFailure_D9EE8F754992F2A1F06210A881D697FF(FName WrittenAchievementName, float WrittenProgress, int32 WrittenUserTag);
    void OnSuccess_D9EE8F754992F2A1F06210A881D697FF(FName WrittenAchievementName, float WrittenProgress, int32 WrittenUserTag);
    void OnWriteFailure_D9EE8F754992F2A1F06210A881D697FF(FString WrittenAchievementName, float WrittenProgress, int32 WrittenUserTag);
    void OnWriteSuccess_D9EE8F754992F2A1F06210A881D697FF(FString WrittenAchievementName, float WrittenProgress, int32 WrittenUserTag);
