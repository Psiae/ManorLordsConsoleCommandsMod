...
class UproductionFocusChoice_C : public UUserWidget
{
    ...
    class UButton* Button_15;                                                         // 0x02D8 (size: 0x8)
    class UImage* goodIcon;                                                           // 0x02E0 (size: 0x8)
    class UMD_NaviAutoButton_C* MD_NaviAutoButton;                                    // 0x02E8 (size: 0x8)
    class UImage* selected_img;                                                       // 0x02F0 (size: 0x8)
    int32 goodType;                                                                   // 0x02F8 (size: 0x4)
    bool IsSelected;                                                                  // 0x02FC (size: 0x1)
    FproductionFocusChoice_CProductionFocusChanged productionFocusChanged;            // 0x0300 (size: 0x10)
