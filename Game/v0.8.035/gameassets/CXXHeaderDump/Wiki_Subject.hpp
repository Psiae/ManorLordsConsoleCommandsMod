...
class UWiki_Subject_C : public UUserWidget
{
    ...
    class URichTextBlock* subjectText;                                                // 0x02E8 (size: 0x8)
    FName SubjectKey;                                                                 // 0x02F0 (size: 0x8)
    FWiki_Subject_CChangeSubject changeSubject;                                       // 0x02F8 (size: 0x10)
    void changeSubject(FName newSubject);
    FName subjectCategory;                                                            // 0x0308 (size: 0x8)
