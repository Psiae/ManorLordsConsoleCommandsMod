...
class UInterchangePipelineBase : public UObject
{
    ...
    FSoftObjectPath ReimportLevel;                                                    // 0x0048 (size: 0x20)
    bool bFromReimportOrOverride;                                                     // 0x006B (size: 0x1)
    class UInterchangeResultsContainer* Results;                                      // 0x0070 (size: 0x8)
    TMap<class FName, class FInterchangePipelinePropertyStates> PropertiesStates;     // 0x0078 (size: 0x50)
