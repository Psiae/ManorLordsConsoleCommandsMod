...
struct FGrassVariety
{
    ...
    FFloatInterval AllowedDensityRange;                                               // 0x0174 (size: 0x8)
    EGrassScaling Scaling;                                                            // 0x017C (size: 0x1)
    FFloatInterval ScaleX;                                                            // 0x0180 (size: 0x8)
    FFloatInterval ScaleY;                                                            // 0x0188 (size: 0x8)
    FFloatInterval ScaleZ;                                                            // 0x0190 (size: 0x8)
    bool bWeightAttenuatesMaxScale;                                                   // 0x0198 (size: 0x1)
    float MaxScaleWeightAttenuation;                                                  // 0x019C (size: 0x4)
    bool RandomRotation;                                                              // 0x01A0 (size: 0x1)
    bool AlignToSurface;                                                              // 0x01A1 (size: 0x1)
    bool bUseLandscapeLightmap;                                                       // 0x01A2 (size: 0x1)
    FLightingChannels LightingChannels;                                               // 0x01A3 (size: 0x1)
    bool bReceivesDecals;                                                             // 0x01A4 (size: 0x1)
    bool bAffectDistanceFieldLighting;                                                // 0x01A5 (size: 0x1)
    bool bCastDynamicShadow;                                                          // 0x01A6 (size: 0x1)
    bool bCastContactShadow;                                                          // 0x01A7 (size: 0x1)
    bool bKeepInstanceBufferCPUCopy;                                                  // 0x01A8 (size: 0x1)
    uint32 InstanceWorldPositionOffsetDisableDistance;                                // 0x01AC (size: 0x4)
    EShadowCacheInvalidationBehavior ShadowCacheInvalidationBehavior;                 // 0x01B0 (size: 0x1)
...
{
    FTransform RenderAreaWorldTransform;                                              // 0x0000 (size: 0x60)
    FIntPoint RenderAreaSize;                                                         // 0x0060 (size: 0x8)
    class UTextureRenderTarget2D* CombinedResult;                                     // 0x0068 (size: 0x8)
    ELandscapeToolTargetType LayerType;                                               // 0x0070 (size: 0x1)
    FName WeightmapLayerName;                                                         // 0x0074 (size: 0x8)
...
struct FLandscapeLayer
{
    ...
    bool bVisible;                                                                    // 0x0020 (size: 0x1)
    bool bLocked;                                                                     // 0x0021 (size: 0x1)
    float HeightmapAlpha;                                                             // 0x0024 (size: 0x4)
    float WeightmapAlpha;                                                             // 0x0028 (size: 0x4)
    TEnumAsByte<ELandscapeBlendMode> BlendMode;                                       // 0x002C (size: 0x1)
    TArray<FLandscapeLayerBrush> Brushes;                                             // 0x0030 (size: 0x10)
    TMap<class ULandscapeLayerInfoObject*, class bool> WeightmapLayerAllocationBlend; // 0x0040 (size: 0x50)
    class ULandscapeEditLayerBase* EditLayer;                                         // 0x0090 (size: 0x8)
...
struct FLandscapeSplineMeshEntry
{
    ...
    uint8 bNoZScaling;                                                                // 0x0030 (size: 0x1)
...
{
    class UControlPointMeshComponent* ControlPointMeshComponent;                      // 0x02A8 (size: 0x8)
...
{
    bool UpdateOnPropertyChange;                                                      // 0x02A8 (size: 0x1)
    bool AffectHeightmap;                                                             // 0x02A9 (size: 0x1)
    bool AffectWeightmap;                                                             // 0x02AA (size: 0x1)
    bool AffectVisibilityLayer;                                                       // 0x02AB (size: 0x1)
    TArray<FName> AffectedWeightmapLayers;                                            // 0x02B0 (size: 0x10)
...
{
    class ULandscapeMeshProxyComponent* LandscapeMeshProxyComponent;                  // 0x02A8 (size: 0x8)
...
class ALandscapeProxy : public APartitionActor
{
    ...
    FGuid OriginalLandscapeGuid;                                                      // 0x02C8 (size: 0x10)
    bool bEnableNanite;                                                               // 0x02D8 (size: 0x1)
    TArray<FLandscapePerLODMaterialOverride> PerLODOverrideMaterials;                 // 0x02E0 (size: 0x10)
    bool bDisableRuntimeGrassMapGeneration;                                           // 0x02F0 (size: 0x1)
    FIntPoint LandscapeSectionOffset;                                                 // 0x02F4 (size: 0x8)
    int32 MaxLODLevel;                                                                // 0x02FC (size: 0x4)
    float ComponentScreenSizeToUseSubSections;                                        // 0x0300 (size: 0x4)
    float LOD0ScreenSize;                                                             // 0x0304 (size: 0x4)
    uint32 LODGroupKey;                                                               // 0x0308 (size: 0x4)
    float LOD0DistributionSetting;                                                    // 0x030C (size: 0x4)
    float LODDistributionSetting;                                                     // 0x0310 (size: 0x4)
    FPerQualityLevelFloat ScalableLOD0ScreenSize;                                     // 0x0318 (size: 0x68)
    FPerQualityLevelFloat ScalableLOD0DistributionSetting;                            // 0x0380 (size: 0x68)
    FPerQualityLevelFloat ScalableLODDistributionSetting;                             // 0x03E8 (size: 0x68)
    bool bUseScalableLODSettings;                                                     // 0x0450 (size: 0x1)
    float LODBlendRange;                                                              // 0x0454 (size: 0x4)
    int32 StaticLightingLOD;                                                          // 0x0458 (size: 0x4)
    class UPhysicalMaterial* DefaultPhysMaterial;                                     // 0x0460 (size: 0x8)
    float StreamingDistanceMultiplier;                                                // 0x0468 (size: 0x4)
    class UMaterialInterface* LandscapeMaterial;                                      // 0x0470 (size: 0x8)
    class UMaterialInterface* LandscapeHoleMaterial;                                  // 0x0478 (size: 0x8)
    TArray<class URuntimeVirtualTexture*> RuntimeVirtualTextures;                     // 0x0480 (size: 0x10)
    bool bSetCreateRuntimeVirtualTextureVolumes;                                      // 0x0490 (size: 0x1)
    bool bVirtualTextureRenderWithQuad;                                               // 0x0491 (size: 0x1)
    bool bVirtualTextureRenderWithQuadHQ;                                             // 0x0492 (size: 0x1)
    int32 VirtualTextureNumLods;                                                      // 0x0494 (size: 0x4)
    int32 VirtualTextureLodBias;                                                      // 0x0498 (size: 0x4)
    ERuntimeVirtualTextureMainPassType VirtualTextureRenderPassType;                  // 0x049C (size: 0x1)
    float NegativeZBoundsExtension;                                                   // 0x04A0 (size: 0x4)
    float PositiveZBoundsExtension;                                                   // 0x04A4 (size: 0x4)
    TArray<class ULandscapeComponent*> LandscapeComponents;                           // 0x04A8 (size: 0x10)
    TArray<class ULandscapeHeightfieldCollisionComponent*> CollisionComponents;       // 0x04B8 (size: 0x10)
    TArray<class UHierarchicalInstancedStaticMeshComponent*> FoliageComponents;       // 0x04C8 (size: 0x10)
    class ULandscapeNaniteComponent* NaniteComponent;                                 // 0x04D8 (size: 0x8)
    TArray<class ULandscapeNaniteComponent*> NaniteComponents;                        // 0x04E0 (size: 0x10)
    float GrassTypesMaxDiscardDistance;                                               // 0x0554 (size: 0x4)
    float StaticLightingResolution;                                                   // 0x0568 (size: 0x4)
    uint8 CastShadow;                                                                 // 0x056C (size: 0x1)
    uint8 bCastDynamicShadow;                                                         // 0x056C (size: 0x1)
    uint8 bCastStaticShadow;                                                          // 0x056C (size: 0x1)
    EShadowCacheInvalidationBehavior ShadowCacheInvalidationBehavior;                 // 0x056D (size: 0x1)
    uint8 bCastContactShadow;                                                         // 0x056E (size: 0x1)
    uint8 bCastFarShadow;                                                             // 0x0570 (size: 0x1)
    uint8 bCastHiddenShadow;                                                          // 0x0574 (size: 0x1)
    uint8 bCastShadowAsTwoSided;                                                      // 0x0578 (size: 0x1)
    uint8 bAffectDistanceFieldLighting;                                               // 0x057C (size: 0x1)
    uint8 bAffectDynamicIndirectLighting;                                             // 0x057C (size: 0x1)
    uint8 bAffectIndirectLightingWhileHidden;                                         // 0x057C (size: 0x1)
    FLightingChannels LightingChannels;                                               // 0x057D (size: 0x1)
    uint8 bUseMaterialPositionOffsetInStaticLighting;                                 // 0x0580 (size: 0x1)
    float NonNaniteVirtualShadowMapConstantDepthBias;                                 // 0x0584 (size: 0x4)
    float NonNaniteVirtualShadowMapInvalidationHeightErrorThreshold;                  // 0x0588 (size: 0x4)
    float NonNaniteVirtualShadowMapInvalidationScreenSizeLimit;                       // 0x058C (size: 0x4)
    uint8 bHoldout;                                                                   // 0x0590 (size: 0x1)
    uint8 bRenderCustomDepth;                                                         // 0x0594 (size: 0x1)
    ERendererStencilMask CustomDepthStencilWriteMask;                                 // 0x0598 (size: 0x1)
    int32 CustomDepthStencilValue;                                                    // 0x059C (size: 0x4)
    float LDMaxDrawDistance;                                                          // 0x05A0 (size: 0x4)
    FLightmassPrimitiveSettings LightmassSettings;                                    // 0x05A4 (size: 0x18)
    int32 CollisionMipLevel;                                                          // 0x05BC (size: 0x4)
    int32 SimpleCollisionMipLevel;                                                    // 0x05C0 (size: 0x4)
    FBodyInstance BodyInstance;                                                       // 0x05C8 (size: 0x178)
    ...
    TMap<class FName, class FLandscapeTargetLayerSettings> TargetLayers;              // 0x0760 (size: 0x50)
...
{
    FGuid LandscapeGuid;                                                              // 0x02B0 (size: 0x10)

}; // Size: 0x2C0

class ALandscapeSplineMeshesActor : public APartitionActor
{
    TArray<class UStaticMeshComponent*> StaticMeshComponents;                         // 0x02A8 (size: 0x10)

}; // Size: 0x2B8

class ALandscapeStreamingProxy : public ALandscapeProxy
{
    TSoftObjectPtr<ALandscape> LandscapeActorRef;                                     // 0x07B0 (size: 0x28)
    TSet<FName> OverriddenSharedProperties;                                           // 0x07D8 (size: 0x50)

}; // Size: 0x828

class ILandscapeBrushRenderCallAdapter_GlobalMergeLegacySupport : public IInterface
{
}; // Size: 0x28

class ILandscapeEditLayerRenderer : public IInterface
{
}; // Size: 0x28
...
{
    float VirtualTextureMainPassMaxDrawDistance;                                      // 0x05B8 (size: 0x4)

}; // Size: 0x5C0

class ULandscapeComponent : public UPrimitiveComponent
{
    int32 SectionBaseX;                                                               // 0x04E8 (size: 0x4)
    int32 SectionBaseY;                                                               // 0x04EC (size: 0x4)
    int32 ComponentSizeQuads;                                                         // 0x04F0 (size: 0x4)
    int32 SubsectionSizeQuads;                                                        // 0x04F4 (size: 0x4)
    int32 NumSubsections;                                                             // 0x04F8 (size: 0x4)
    class UMaterialInterface* OverrideMaterial;                                       // 0x0500 (size: 0x8)
    class UMaterialInterface* OverrideHoleMaterial;                                   // 0x0508 (size: 0x8)
    TArray<class UMaterialInstanceConstant*> MaterialInstances;                       // 0x0510 (size: 0x10)
    TArray<class UMaterialInstanceDynamic*> MaterialInstancesDynamic;                 // 0x0520 (size: 0x10)
    TArray<int8> LODIndexToMaterialIndex;                                             // 0x0530 (size: 0x10)
    class UTexture2D* XYOffsetmapTexture;                                             // 0x0540 (size: 0x8)
    FVector4 WeightmapScaleBias;                                                      // 0x0550 (size: 0x20)
    float WeightmapSubsectionOffset;                                                  // 0x0570 (size: 0x4)
    FVector4 HeightmapScaleBias;                                                      // 0x0580 (size: 0x20)
    FBox CachedLocalBox;                                                              // 0x05A0 (size: 0x38)
    TArray<double> MipToMipMaxDeltas;                                                 // 0x05D8 (size: 0x10)
    class ULandscapeHeightfieldCollisionComponent* CollisionComponentRef;             // 0x05E8 (size: 0x8)
    bool bUserTriggeredChangeRequested;                                               // 0x05F0 (size: 0x1)
    bool bNaniteActive;                                                               // 0x05F1 (size: 0x1)
    class UTexture2D* HeightmapTexture;                                               // 0x05F8 (size: 0x8)
    TArray<FWeightmapLayerAllocationInfo> WeightmapLayerAllocations;                  // 0x0600 (size: 0x10)
    TArray<class UTexture2D*> WeightmapTextures;                                      // 0x0610 (size: 0x10)
    TArray<FLandscapePerLODMaterialOverride> PerLODOverrideMaterials;                 // 0x0620 (size: 0x10)
    TArray<class ULandscapeGrassType*> GrassTypes;                                    // 0x0630 (size: 0x10)
    FGuid MapBuildDataId;                                                             // 0x0650 (size: 0x10)
    int32 CollisionMipLevel;                                                          // 0x0660 (size: 0x4)
    int32 SimpleCollisionMipLevel;                                                    // 0x0664 (size: 0x4)
    float NegativeZBoundsExtension;                                                   // 0x0668 (size: 0x4)
    float PositiveZBoundsExtension;                                                   // 0x066C (size: 0x4)
    float StaticLightingResolution;                                                   // 0x0670 (size: 0x4)
    int32 ForcedLOD;                                                                  // 0x0674 (size: 0x4)
    int32 LODBias;                                                                    // 0x0678 (size: 0x4)
    FGuid StateId;                                                                    // 0x067C (size: 0x10)
    TArray<class UMaterialInterface*> MobileMaterialInterfaces;                       // 0x0690 (size: 0x10)
    TArray<class UTexture2D*> MobileWeightmapTextures;                                // 0x06A0 (size: 0x10)
    class UTexture2DArray* MobileWeightmapTextureArray;                               // 0x06B0 (size: 0x8)
    TArray<FWeightmapLayerAllocationInfo> MobileWeightmapLayerAllocations;            // 0x06B8 (size: 0x10)
...
{
    TWeakObjectPtr<class ALandscape> OwningLandscape;                                 // 0x0028 (size: 0x8)
...
{
    TArray<class ULandscapeScratchRenderTarget*> ScratchRenderTargets;                // 0x0030 (size: 0x10)
...
{
    TArray<class ULandscapeLayerInfoObject*> ComponentLayerInfos;                     // 0x04E8 (size: 0x10)
    int32 SectionBaseX;                                                               // 0x04F8 (size: 0x4)
    int32 SectionBaseY;                                                               // 0x04FC (size: 0x4)
    int32 CollisionSizeQuads;                                                         // 0x0500 (size: 0x4)
    float CollisionScale;                                                             // 0x0504 (size: 0x4)
    int32 SimpleCollisionSizeQuads;                                                   // 0x0508 (size: 0x4)
    TArray<uint8> CollisionQuadFlags;                                                 // 0x0510 (size: 0x10)
    FGuid HeightfieldGuid;                                                            // 0x0520 (size: 0x10)
    FBox CachedLocalBox;                                                              // 0x0530 (size: 0x38)
    class ULandscapeComponent* RenderComponentRef;                                    // 0x0568 (size: 0x8)
    TArray<class UPhysicalMaterial*> CookedPhysicalMaterials;                         // 0x0580 (size: 0x10)
...
class ULandscapeInfo : public UObject
{
    ...
    TArray<TWeakObjectPtr<ALandscapeStreamingProxy>> StreamingProxies;                // 0x00F0 (size: 0x10)
...
{
    TArray<FLandscapeMaterialTextureStreamingInfo> TextureStreamingInfo;              // 0x02C8 (size: 0x10)
    uint8 bIsLayerThumbnail;                                                          // 0x02D8 (size: 0x1)
    uint8 bDisableTessellation;                                                       // 0x02D8 (size: 0x1)
    uint8 bMobile;                                                                    // 0x02D8 (size: 0x1)
    uint8 bEditorToolUsage;                                                           // 0x02D8 (size: 0x1)

}; // Size: 0x2E0

class ULandscapeMeshCollisionComponent : public ULandscapeHeightfieldCollisionComponent
{
    FGuid MeshGuid;                                                                   // 0x05E0 (size: 0x10)

}; // Size: 0x600

class ULandscapeMeshProxyComponent : public UStaticMeshComponent
{
    FGuid LandscapeGuid;                                                              // 0x05B8 (size: 0x10)
    TArray<FIntPoint> ProxyComponentBases;                                            // 0x05C8 (size: 0x10)
    TArray<FVector> ProxyComponentCentersObjectSpace;                                 // 0x05D8 (size: 0x10)
    FVector ComponentXVectorObjectSpace;                                              // 0x05E8 (size: 0x18)
    FVector ComponentYVectorObjectSpace;                                              // 0x0600 (size: 0x18)
    int32 ComponentResolution;                                                        // 0x0618 (size: 0x4)
    int8 ProxyLOD;                                                                    // 0x061C (size: 0x1)
    uint32 LODGroupKey;                                                               // 0x0620 (size: 0x4)

}; // Size: 0x630

class ULandscapeNaniteComponent : public UStaticMeshComponent
{
    FGuid ProxyContentId;                                                             // 0x05B8 (size: 0x10)
    bool bEnabled;                                                                    // 0x05C8 (size: 0x1)
    TArray<class ULandscapeComponent*> SourceLandscapeComponents;                     // 0x05D0 (size: 0x10)

}; // Size: 0x5E0

class ULandscapeScratchRenderTarget : public UObject
{
    class UTextureRenderTarget* RenderTarget;                                         // 0x0028 (size: 0x8)
...
class ULandscapeSettings : public UDeveloperSettings
{
    ...
    bool bShowDialogForAutomaticLayerCreation;                                        // 0x003C (size: 0x1)
    int32 MaxComponents;                                                              // 0x0040 (size: 0x4)
    uint32 MaxImageImportCacheSizeMegaBytes;                                          // 0x0044 (size: 0x4)
    float PaintStrengthGamma;                                                         // 0x0048 (size: 0x4)
    bool bDisablePaintingStartupSlowdown;                                             // 0x004C (size: 0x1)
    ELandscapeDirtyingMode LandscapeDirtyingMode;                                     // 0x004D (size: 0x1)
    int32 SideResolutionLimit;                                                        // 0x0050 (size: 0x4)
    TSoftObjectPtr<UMaterialInterface> DefaultLandscapeMaterial;                      // 0x0058 (size: 0x28)
    TSoftObjectPtr<ULandscapeLayerInfoObject> DefaultLayerInfoObject;                 // 0x0080 (size: 0x28)
    float BrushSizeUIMax;                                                             // 0x00A8 (size: 0x4)
    float BrushSizeClampMax;                                                          // 0x00AC (size: 0x4)
    int32 HLODMaxTextureSize;                                                         // 0x00B0 (size: 0x4)
    bool bRestrictiveMode;                                                            // 0x00B4 (size: 0x1)
...
{
    TArray<class ULandscapeSplineControlPoint*> ControlPoints;                        // 0x04E8 (size: 0x10)
    TArray<class ULandscapeSplineSegment*> Segments;                                  // 0x04F8 (size: 0x10)
    TArray<class UMeshComponent*> CookedForeignMeshComponents;                        // 0x0508 (size: 0x10)
...
{
    TArray<class ALandscape*> LandscapeActors;                                        // 0x0048 (size: 0x10)
    TArray<class ALandscapeProxy*> Proxies;                                           // 0x0058 (size: 0x10)
