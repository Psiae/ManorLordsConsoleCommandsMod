...
class UsettlementTypeButton_C : public UUserWidget
{
    ...
    class UImage* artwork;                                                            // 0x02D8 (size: 0x8)
    class UButton* Button_62;                                                         // 0x02E0 (size: 0x8)
    ...
    class UMLDefaultSpinner_C* MLDefaultSpinner;                                      // 0x0300 (size: 0x8)
    class USizeBox* outpostMotherSelector;                                            // 0x0308 (size: 0x8)
    class UTextBlock* TextBlock_294;                                                  // 0x0310 (size: 0x8)
    class UMaterialInterface* Material;                                               // 0x0318 (size: 0x8)
    FsettlementTypeButton_COnButtonPressed onButtonPressed;                           // 0x0320 (size: 0x10)
    void onButtonPressed();
    ESettlementType settlementType;                                                   // 0x0330 (size: 0x1)
    FsettlementTypeButton_CRegionChanged regionChanged;                               // 0x0338 (size: 0x10)
