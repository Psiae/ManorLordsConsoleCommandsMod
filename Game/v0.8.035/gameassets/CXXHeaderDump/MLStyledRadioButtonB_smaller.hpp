...
class UMLStyledRadioButtonB_smaller_C : public URadioButton
{
    ...
    FMLStyledRadioButtonB_smaller_COnHover onHover;                                   // 0x0318 (size: 0x10)
    void onHover(FString Value);
    FMLStyledRadioButtonB_smaller_COnLeave onLeave;                                   // 0x0328 (size: 0x10)
    void onLeave();
    FText originalLabel;                                                              // 0x0338 (size: 0x10)
