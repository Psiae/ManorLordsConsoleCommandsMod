...
class UDLSSSettings : public UObject
{
    ...
    EDLSSRRPreset DLAARRPreset;                                                       // 0x0061 (size: 0x1)
    EDLSSRRPreset DLSSRRQualityPreset;                                                // 0x0063 (size: 0x1)
    EDLSSRRPreset DLSSRRBalancedPreset;                                               // 0x0064 (size: 0x1)
    EDLSSRRPreset DLSSRRPerformancePreset;                                            // 0x0065 (size: 0x1)
    EDLSSRRPreset DLSSRRUltraPerformancePreset;                                       // 0x0066 (size: 0x1)
