...
class UrenameFullscreen_C : public UNaviSubGrid
{
    ...
    class UButton* close_button_1;                                                    // 0x0350 (size: 0x8)
    class UEditableText* EditableText_130;                                            // 0x0358 (size: 0x8)
    class UTextBlock* header_txt;                                                     // 0x0360 (size: 0x8)
    class UImage* Image;                                                              // 0x0368 (size: 0x8)
    class UMD_NaviAutoButton_C* Navi_ExitButton;                                      // 0x0370 (size: 0x8)
    class UMD_NaviHijackProxy_C* Navi_TextEdit;                                       // 0x0378 (size: 0x8)
