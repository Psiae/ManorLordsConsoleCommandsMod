...
enum class EBlendSpacePerBoneBlendMode {
...
enum class EChunkSeekTableMode {
...
enum class EFirstPersonPrimitiveType {
    None = 0,
    FirstPerson = 1,
    EFirstPersonPrimitiveType_MAX = 2,
};
...
enum class EHLODLevelExclusion {
    HLOD0 = 1,
    HLOD1 = 2,
    HLOD2 = 4,
    HLOD3 = 8,
...
enum class EHardwareDevicePrimaryType {
    Unspecified = 0,
    KeyboardAndMouse = 1,
    Gamepad = 2,
    Touch = 3,
...
enum EMaterialPositionTransformSource {
    ...
    TRANSFORMPOSSOURCE_Camera = 5,
    TRANSFORMPOSSOURCE_Particle = 6,
    TRANSFORMPOSSOURCE_Instance = 7,
    TRANSFORMPOSSOURCE_MAX = 8,
};
...
enum class EModulationDestination {
    Volume = 0,
    Pitch = 1,
    Lowpass = 2,
    Highpass = 3,
...
enum class ENaniteFallbackTarget {
    Auto = 0,
    PercentTriangles = 1,
    RelativeError = 2,
...
enum class ENavigationDataResolution {
    Low = 0,
    Default = 1,
    High = 2,
    Invalid = 3,
...
enum class ENavigationSortPendingTilesMethod {
...
enum class ENonSpatializedRadiusSpeakerMapMode {
    OmniDirectional = 0,
    Direct2D = 1,
    Surround2D = 2,
...
enum class EPhysicsStateAction {
    AddForce = 0,
    AddTorque = 1,
...
enum class EShadowCacheInvalidationBehavior {
    Auto = 0,
    Always = 1,
    Rigid = 2,
    Static = 3,
...
enum class ESpecularProfileFormat {
    ViewLightVector = 0,
    HalfVector = 1,
...
enum class EStreamingSourceTargetBehavior {
    Include = 0,
    Exclude = 1,
...
enum class EWorldPartitionCVarProjectDefaultOverride {
    ProjectDefault = 0,
    Disabled = 1,
    Enabled = 2,
