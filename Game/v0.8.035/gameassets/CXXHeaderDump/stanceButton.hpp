...
class UstanceButton_C : public UUserWidget
{
    ...
    class UTexture2D* skillIcon;                                                      // 0x0310 (size: 0x8)
    bool activated;                                                                   // 0x0318 (size: 0x1)
    EBehaviourStance behaviourStance;                                                 // 0x0319 (size: 0x1)
    bool isPushStance;                                                                // 0x031A (size: 0x1)
    EPushStance pushStance;                                                           // 0x031B (size: 0x1)
