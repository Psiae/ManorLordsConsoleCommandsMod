...
class UCameraAnimationSequenceCameraStandIn : public UObject
{
    ...
    float PostProcessBlendWeight;                                                     // 0x0740 (size: 0x4)
    FCameraFilmbackSettings Filmback;                                                 // 0x0744 (size: 0x14)
    FCameraLensSettings LensSettings;                                                 // 0x0758 (size: 0x1C)
    FCameraFocusSettings FocusSettings;                                               // 0x0778 (size: 0x60)
    float CurrentFocalLength;                                                         // 0x07D8 (size: 0x4)
    float CurrentAperture;                                                            // 0x07DC (size: 0x4)
    float CurrentFocusDistance;                                                       // 0x07E0 (size: 0x4)
...
{
    TArray<FTemplateSectionPropertyScale> PropertyScales;                             // 0x07E0 (size: 0x10)
