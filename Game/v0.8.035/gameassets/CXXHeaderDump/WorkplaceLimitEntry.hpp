...
class UWorkplaceLimitEntry_C : public UNaviSubGrid
{
    ...
    class UMLDefaultCheckbox_C* checkbox_EnableLimit;                                 // 0x0358 (size: 0x8)
    class UEditableTextBox* EditableTextBox_limit_value;                              // 0x0360 (size: 0x8)
    class UHorizontalBox* HorizontalBox_tradeTarget;                                  // 0x0368 (size: 0x8)
    class UImage* Image_22;                                                           // 0x0370 (size: 0x8)
    class UHorizontalBox* limitContentParent;                                         // 0x0378 (size: 0x8)
    class UMD_NaviAutoButton_C* naviBtn_Add;                                          // 0x0380 (size: 0x8)
    class UMD_NaviAutoButton_C* naviBtn_Minus;                                        // 0x0388 (size: 0x8)
    class UButton* Remove;                                                            // 0x0390 (size: 0x8)
    class UHorizontalBox* target_inv_hb;                                              // 0x0398 (size: 0x8)
    class UTextBlock* TextBlock_28;                                                   // 0x03A0 (size: 0x8)
    bool isProductionLimit;                                                           // 0x03A8 (size: 0x1)
    int32 goodType;                                                                   // 0x03AC (size: 0x4)
    class ARegion* Region;                                                            // 0x03B0 (size: 0x8)
    int32 currentlyProducedGoodType;                                                  // 0x03B8 (size: 0x4)
