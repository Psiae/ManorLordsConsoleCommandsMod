...
{
    FName ActionName;                                                                 // 0x0300 (size: 0x8)
    TSubclassOf<class UKeyLabel> KeyLabelWidgetClass;                                 // 0x0308 (size: 0x8)
    TSubclassOf<class UWidget> KeySeparatorWidgetClass;                               // 0x0310 (size: 0x8)
    class UPanelWidget* KeyContainer;                                                 // 0x0318 (size: 0x8)
    class UKeyLabel* PrimaryKeyLabel;                                                 // 0x0320 (size: 0x8)
    class UKeyLabel* ShiftLabel;                                                      // 0x0328 (size: 0x8)
    class UKeyLabel* CtrlLabel;                                                       // 0x0330 (size: 0x8)
    class UKeyLabel* AltLabel;                                                        // 0x0338 (size: 0x8)
    class UKeyLabel* CmdLabel;                                                        // 0x0340 (size: 0x8)
    class UWidget* ShiftSeparator;                                                    // 0x0348 (size: 0x8)
    class UWidget* CtrlSeparator;                                                     // 0x0350 (size: 0x8)
    class UWidget* AltSeparator;                                                      // 0x0358 (size: 0x8)
    class UWidget* CmdSeparator;                                                      // 0x0360 (size: 0x8)

}; // Size: 0x368

class UActionMapping : public UInputMapping
{
    FName ActionName;                                                                 // 0x0308 (size: 0x8)
    class UActionLabel* ActionLabel;                                                  // 0x0310 (size: 0x8)
...
{
    FName AxisName;                                                                   // 0x0300 (size: 0x8)
    float scale;                                                                      // 0x0308 (size: 0x4)
    class UKeyLabel* KeyLabel;                                                        // 0x0310 (size: 0x8)

}; // Size: 0x318

class UAxisMapping : public UInputMapping
{
    FName AxisName;                                                                   // 0x0308 (size: 0x8)
    float scale;                                                                      // 0x0310 (size: 0x4)
    class UAxisLabel* AxisLabel;                                                      // 0x0318 (size: 0x8)

}; // Size: 0x320

class UBindCaptureButton : public UUserWidget
{
    FGameplayTag KeyGroup;                                                            // 0x02D0 (size: 0x8)
    TSubclassOf<class UBindCapturePrompt> BindCapturePromptClass;                     // 0x02D8 (size: 0x8)
    int32 CapturePromptZOrder;                                                        // 0x02E0 (size: 0x4)
    class UBindCapturePrompt* Prompt;                                                 // 0x02F8 (size: 0x8)
...
{
    bool bIgnoreGameViewportInputWhileCapturing;                                      // 0x02D0 (size: 0x1)
    bool bRestrictKeyGroup;                                                           // 0x02D1 (size: 0x1)
    EBindingCaptureMode CaptureMode;                                                  // 0x02D2 (size: 0x1)
    FGameplayTag KeyGroup;                                                            // 0x02D4 (size: 0x8)
    FBindCapturePromptOnChordCaptured OnChordCaptured;                                // 0x02E0 (size: 0x10)
    void ChordCapturedEvent(FCapturedInput CapturedInput);
    FBindCapturePromptOnChordRejected OnChordRejected;                                // 0x02F0 (size: 0x10)
    void ChordRejectedEvent(FCapturedInput CapturedInput);
    FBindCapturePromptOnCapturePromptClosed OnCapturePromptClosed;                    // 0x0300 (size: 0x10)
    void CapturePromptClosedEvent(bool bWasCancelled);
    TArray<FKey> KeysDown;                                                            // 0x0310 (size: 0x10)
    bool PreviousIgnoreInput;                                                         // 0x0320 (size: 0x1)
    FVector2D AccumulatedMouseDelta;                                                  // 0x0328 (size: 0x10)
...
{
    int32 MappingGroup;                                                               // 0x02D0 (size: 0x4)
    FGameplayTag KeyGroup;                                                            // 0x02D4 (size: 0x8)
    bool bUsePlayerKeyGroup;                                                          // 0x02DC (size: 0x1)
    FGameplayTagContainer IconTags;                                                   // 0x02E0 (size: 0x20)
...
class UInputMapping : public UUserWidget
{
    ...
    FGameplayTag KeyGroup;                                                            // 0x02D4 (size: 0x8)
    FGameplayTagContainer IconTags;                                                   // 0x02E0 (size: 0x20)
    class UBindCaptureButton* BindCaptureButton;                                      // 0x0300 (size: 0x8)
...
{
    FText KeyInvalidText;                                                             // 0x02D0 (size: 0x10)
    FText LabelOverride;                                                              // 0x02E0 (size: 0x10)
