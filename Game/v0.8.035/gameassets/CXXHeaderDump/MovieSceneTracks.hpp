...
struct FComponentMaterialInfo
{
    ...
    EComponentMaterialType MaterialType;                                              // 0x000C (size: 0x1)
...
struct FMovieSceneDirectorBlueprintConditionData
{
    ...
    TFieldPath<FProperty> ConditionContextProperty;                                   // 0x0008 (size: 0x20)
...
{
    FMovieSceneParticleChannel ParticleKeys;                                          // 0x0020 (size: 0x110)
...
struct FMovieSceneSkeletalAnimationParams
{
    ...
    FFrameNumber StartFrameOffset;                                                    // 0x000C (size: 0x4)
    FFrameNumber EndFrameOffset;                                                      // 0x0010 (size: 0x4)
    FMovieSceneTimeWarpVariant PlayRate;                                              // 0x0018 (size: 0x8)
    uint8 bReverse;                                                                   // 0x0020 (size: 0x1)
    FName SlotName;                                                                   // 0x0024 (size: 0x8)
    class UMirrorDataTable* MirrorDataTable;                                          // 0x0030 (size: 0x8)
    FMovieSceneFloatChannel Weight;                                                   // 0x0038 (size: 0x110)
    bool bSkipAnimNotifiers;                                                          // 0x0148 (size: 0x1)
    bool bForceCustomMode;                                                            // 0x0149 (size: 0x1)
    ESwapRootBone SwapRootBone;                                                       // 0x014A (size: 0x1)
    float StartOffset;                                                                // 0x014C (size: 0x4)
    float EndOffset;                                                                  // 0x0150 (size: 0x4)
...
class IMovieSceneSectionsToKey : public IInterface
{
}; // Size: 0x28
...
{
    FName AttachSocketName;                                                           // 0x0128 (size: 0x8)
    FName AttachComponentName;                                                        // 0x0130 (size: 0x8)
    EAttachmentRule AttachmentLocationRule;                                           // 0x0138 (size: 0x1)
    EAttachmentRule AttachmentRotationRule;                                           // 0x0139 (size: 0x1)
    EAttachmentRule AttachmentScaleRule;                                              // 0x013A (size: 0x1)
    EDetachmentRule DetachmentLocationRule;                                           // 0x013B (size: 0x1)
    EDetachmentRule DetachmentRotationRule;                                           // 0x013C (size: 0x1)
    EDetachmentRule DetachmentScaleRule;                                              // 0x013D (size: 0x1)
...
{
    FGuid ConstraintID;                                                               // 0x00F8 (size: 0x10)
    FMovieSceneObjectBindingID ConstraintBindingID;                                   // 0x0108 (size: 0x18)
...
{
    TArray<class UMovieSceneSection*> ConstraintSections;                             // 0x00F8 (size: 0x10)

}; // Size: 0x108

class UMovieScene3DPathSection : public UMovieScene3DConstraintSection
{
    FMovieSceneFloatChannel TimingCurve;                                              // 0x0120 (size: 0x110)
    MovieScene3DPathSection_Axis FrontAxisEnum;                                       // 0x0230 (size: 0x1)
    MovieScene3DPathSection_Axis UpAxisEnum;                                          // 0x0231 (size: 0x1)
    uint8 bFollow;                                                                    // 0x0234 (size: 0x1)
    uint8 bReverse;                                                                   // 0x0234 (size: 0x1)
    uint8 bForceUpright;                                                              // 0x0234 (size: 0x1)
...
{
    FMovieSceneTransformMask TransformMask;                                           // 0x0138 (size: 0x4)
    FMovieSceneDoubleChannel Translation;                                             // 0x0140 (size: 0x348)
    FMovieSceneDoubleChannel Rotation;                                                // 0x0488 (size: 0x348)
    FMovieSceneDoubleChannel scale;                                                   // 0x07D0 (size: 0x348)
    FMovieSceneFloatChannel ManualWeight;                                             // 0x0B18 (size: 0x110)
    class UMovieSceneSectionChannelOverrideRegistry* OverrideRegistry;                // 0x0C28 (size: 0x8)
    class UMovieScene3DTransformSectionConstraints* Constraints;                      // 0x0C30 (size: 0x8)
    bool bUseQuaternionInterpolation;                                                 // 0x0C38 (size: 0x1)
...
{
    TSubclassOf<class UMovieSceneBlenderSystem> BlenderSystemClass;                   // 0x0130 (size: 0x8)

}; // Size: 0x138

class UMovieSceneActorReferenceSection : public UMovieSceneSection
{
    FMovieSceneActorReferenceData ActorReferenceData;                                 // 0x00F8 (size: 0x120)
    FIntegralCurve ActorGuidIndexCurve;                                               // 0x0218 (size: 0x80)
    TArray<FString> ActorGuidStrings;                                                 // 0x0298 (size: 0x10)
...
{
    class USoundBase* Sound;                                                          // 0x0100 (size: 0x8)
    FFrameNumber StartFrameOffset;                                                    // 0x0108 (size: 0x4)
    float StartOffset;                                                                // 0x010C (size: 0x4)
    float AudioStartTime;                                                             // 0x0110 (size: 0x4)
    float AudioDilationFactor;                                                        // 0x0114 (size: 0x4)
    float AudioVolume;                                                                // 0x0118 (size: 0x4)
    FMovieSceneFloatChannel SoundVolume;                                              // 0x0120 (size: 0x110)
    FMovieSceneFloatChannel PitchMultiplier;                                          // 0x0230 (size: 0x110)
    TMap<class FName, class FMovieSceneFloatChannel> Inputs_Float;                    // 0x0340 (size: 0x50)
    TMap<class FName, class FMovieSceneStringChannel> Inputs_String;                  // 0x0390 (size: 0x50)
    TMap<class FName, class FMovieSceneBoolChannel> Inputs_Bool;                      // 0x03E0 (size: 0x50)
    TMap<class FName, class FMovieSceneIntegerChannel> Inputs_Int;                    // 0x0430 (size: 0x50)
    TMap<class FName, class FMovieSceneAudioTriggerChannel> Inputs_Trigger;           // 0x0480 (size: 0x50)
    FMovieSceneActorReferenceData AttachActorData;                                    // 0x04D0 (size: 0x120)
    bool bLooping;                                                                    // 0x05F0 (size: 0x1)
    bool bSuppressSubtitles;                                                          // 0x05F1 (size: 0x1)
    bool bOverrideAttenuation;                                                        // 0x05F2 (size: 0x1)
    class USoundAttenuation* AttenuationSettings;                                     // 0x05F8 (size: 0x8)
    FMovieSceneAudioSectionOnQueueSubtitles OnQueueSubtitles;                         // 0x0600 (size: 0x10)
    void OnQueueSubtitles(const TArray<FSubtitleCue>& Subtitles, float CueDuration);
    FMovieSceneAudioSectionOnAudioFinished OnAudioFinished;                           // 0x0610 (size: 0x10)
    void OnAudioFinished();
    FMovieSceneAudioSectionOnAudioPlaybackPercent OnAudioPlaybackPercent;             // 0x0620 (size: 0x10)
...
{
    TArray<class UMovieSceneSection*> AudioSections;                                  // 0x00F8 (size: 0x10)
...
{
    FMovieSceneByteChannel ByteCurve;                                                 // 0x0100 (size: 0x110)

}; // Size: 0x210

class UMovieSceneByteTrack : public UMovieScenePropertyTrack
{
    class UEnum* Enum;                                                                // 0x0128 (size: 0x8)

}; // Size: 0x130

class UMovieSceneCVarSection : public UMovieSceneSection
{
    TArray<FMovieSceneConsoleVariableCollection> ConsoleVariableCollections;          // 0x0100 (size: 0x10)
    FMovieSceneCVarOverrides ConsoleVariables;                                        // 0x0110 (size: 0x50)
...
{
    bool bLockPreviousCamera;                                                         // 0x0100 (size: 0x1)
    FGuid CameraGuid;                                                                 // 0x0104 (size: 0x10)
    FMovieSceneObjectBindingID CameraBindingID;                                       // 0x0114 (size: 0x18)
...
{
    bool bCanBlend;                                                                   // 0x00F8 (size: 0x1)
    TArray<class UMovieSceneSection*> Sections;                                       // 0x0100 (size: 0x10)
    bool bAutoArrangeSections;                                                        // 0x0110 (size: 0x1)
...
{
    FMovieSceneCameraShakeSectionData ShakeData;                                      // 0x0100 (size: 0x28)
    TSubclassOf<class UCameraShakeBase> ShakeClass;                                   // 0x0128 (size: 0x8)
    float PlayScale;                                                                  // 0x0130 (size: 0x4)
    ECameraShakePlaySpace PlaySpace;                                                  // 0x0134 (size: 0x1)
    FRotator UserDefinedPlaySpace;                                                    // 0x0138 (size: 0x18)
...
{
    TArray<class UMovieSceneSection*> CameraShakeSections;                            // 0x00F8 (size: 0x10)

}; // Size: 0x108

class UMovieSceneCameraShakeSourceTriggerSection : public UMovieSceneSection
{
    FMovieSceneCameraShakeSourceTriggerChannel Channel;                               // 0x0100 (size: 0xF8)
...
{
    FString ShotDisplayName;                                                          // 0x07E0 (size: 0x10)
    FText DisplayName;                                                                // 0x07F0 (size: 0x10)
...
{
    FMovieSceneFloatChannel RedCurve;                                                 // 0x0100 (size: 0x110)
    FMovieSceneFloatChannel GreenCurve;                                               // 0x0210 (size: 0x110)
    FMovieSceneFloatChannel BlueCurve;                                                // 0x0320 (size: 0x110)
    FMovieSceneFloatChannel AlphaCurve;                                               // 0x0430 (size: 0x110)

}; // Size: 0x540

class UMovieSceneColorTrack : public UMovieScenePropertyTrack
{
    bool bIsSlateColor;                                                               // 0x0128 (size: 0x1)
...
{
    TArray<FScalarMaterialParameterInfoAndCurve> ScalarParameterInfosAndCurves;       // 0x0100 (size: 0x10)
    TArray<FColorMaterialParameterInfoAndCurves> ColorParameterInfosAndCurves;        // 0x0110 (size: 0x10)
    ...
    void AddColorParameterKey(const FMaterialParameterInfo& InParameterInfo, FFrameNumber InTime, FLinearColor InValue, FString InLayerName, FString InAssetName, const FParameterChannelNames& InChannelNames);
}; // Size: 0x120
...
{
    FComponentMaterialInfo MaterialInfo;                                              // 0x0120 (size: 0x10)
...
{
    class UMovieScenePiecewiseDoubleBlenderSystem* DoubleBlenderSystem;               // 0x01D0 (size: 0x8)

}; // Size: 0x1D8

class UMovieSceneCustomPrimitiveDataTrack : public UMovieSceneNameableTrack
{
    TArray<class UMovieSceneSection*> Sections;                                       // 0x0108 (size: 0x10)
    class UMovieSceneSection* SectionToKey;                                           // 0x0118 (size: 0x8)

}; // Size: 0x120

class UMovieSceneDataLayerSection : public UMovieSceneSection
{
    TArray<class UDataLayerAsset*> DataLayerAssets;                                   // 0x0100 (size: 0x10)
    EDataLayerRuntimeState DesiredState;                                              // 0x0110 (size: 0x1)
    EDataLayerRuntimeState PrerollState;                                              // 0x0111 (size: 0x1)
    bool bFlushOnActivated;                                                           // 0x0112 (size: 0x1)
    bool bFlushOnUnload;                                                              // 0x0113 (size: 0x1)
...
{
    FMovieSceneDirectorBlueprintConditionData DirectorBlueprintConditionData;         // 0x0060 (size: 0x28)
    EMovieSceneConditionScope Scope;                                                  // 0x0088 (size: 0x1)
    EMovieSceneConditionCheckFrequency CheckFrequency;                                // 0x0089 (size: 0x1)
...
{
    FMovieSceneDoubleChannel DoubleCurve;                                             // 0x0100 (size: 0x118)
...
{
    FMovieSceneDoubleChannel Curves;                                                  // 0x0100 (size: 0x460)
    int32 ChannelsUsed;                                                               // 0x0560 (size: 0x4)

}; // Size: 0x568

class UMovieSceneDoubleVectorTrack : public UMovieScenePropertyTrack
{
    int32 NumChannelsUsed;                                                            // 0x0128 (size: 0x4)
...
{
    FMovieSceneByteChannel EnumCurve;                                                 // 0x0100 (size: 0x110)
...
{
    FMovieSceneEvent Event;                                                           // 0x0100 (size: 0x28)

}; // Size: 0x128

class UMovieSceneEventSection : public UMovieSceneSection
{
    FNameCurve Events;                                                                // 0x00F8 (size: 0x78)
    FMovieSceneEventSectionData EventData;                                            // 0x0170 (size: 0xF8)
...
{
    uint8 bFireEventsWhenForwards;                                                    // 0x0108 (size: 0x1)
    uint8 bFireEventsWhenBackwards;                                                   // 0x0108 (size: 0x1)
    EFireEventsAtPosition EventPosition;                                              // 0x010C (size: 0x1)
    TArray<class UMovieSceneSection*> Sections;                                       // 0x0110 (size: 0x10)

}; // Size: 0x120

class UMovieSceneEventTriggerSection : public UMovieSceneEventSectionBase
{
    FMovieSceneEventChannel EventChannel;                                             // 0x0100 (size: 0xF8)
...
class UMovieSceneFadeSection : public UMovieSceneSection
{
    ...
    FLinearColor FadeColor;                                                           // 0x0210 (size: 0x10)
    uint8 bFadeAudio;                                                                 // 0x0220 (size: 0x1)
...
{
    FMovieSceneFloatChannel FloatCurve;                                               // 0x0108 (size: 0x110)
    class UMovieSceneSectionChannelOverrideRegistry* OverrideRegistry;                // 0x0218 (size: 0x8)
...
{
    FMovieSceneFloatChannel Curves;                                                   // 0x0100 (size: 0x440)
    int32 ChannelsUsed;                                                               // 0x0540 (size: 0x4)
...
{
    class UMovieSceneEntityGroupingSystem* GroupingSystem;                            // 0x0040 (size: 0x8)
...
{
    FMovieSceneIntegerChannel IntegerCurve;                                           // 0x0100 (size: 0x108)
...
{
    ELevelVisibility Visibility;                                                      // 0x0100 (size: 0x1)
    TArray<FName> LevelNames;                                                         // 0x0108 (size: 0x10)
...
{
    class UMaterialParameterCollection* MPC;                                          // 0x0120 (size: 0x8)
...
{
    TArray<class UMovieSceneSection*> Sections;                                       // 0x00F8 (size: 0x10)
    class UMovieSceneSection* SectionToKey;                                           // 0x0108 (size: 0x8)
...
{
    FMovieSceneObjectPathChannel ObjectChannel;                                       // 0x0100 (size: 0x130)
...
{
    UClass* PropertyClass;                                                            // 0x0128 (size: 0x8)

}; // Size: 0x130

class UMovieSceneParameterSection : public UMovieSceneSection
{
    TArray<FBoolParameterNameAndCurve> BoolParameterNamesAndCurves;                   // 0x0100 (size: 0x10)
    TArray<FScalarParameterNameAndCurve> ScalarParameterNamesAndCurves;               // 0x0110 (size: 0x10)
    TArray<FVector2DParameterNameAndCurves> Vector2DParameterNamesAndCurves;          // 0x0120 (size: 0x10)
    TArray<FVectorParameterNameAndCurves> VectorParameterNamesAndCurves;              // 0x0130 (size: 0x10)
    TArray<FColorParameterNameAndCurves> ColorParameterNamesAndCurves;                // 0x0140 (size: 0x10)
    TArray<FTransformParameterNameAndCurves> TransformParameterNamesAndCurves;        // 0x0150 (size: 0x10)
...
{
    FMovieSceneParticleChannel ParticleKeys;                                          // 0x00F8 (size: 0x110)

}; // Size: 0x208

class UMovieSceneParticleTrack : public UMovieSceneNameableTrack
{
    TArray<class UMovieSceneSection*> ParticleSections;                               // 0x0100 (size: 0x10)
...
{
    TArray<FName> ValidPlatforms;                                                     // 0x0060 (size: 0x10)
...
{
    FMovieSceneObjectPathChannel MaterialChannel;                                     // 0x0100 (size: 0x130)

}; // Size: 0x230

class UMovieScenePrimitiveMaterialTrack : public UMovieScenePropertyTrack
{
    FComponentMaterialInfo MaterialInfo;                                              // 0x0128 (size: 0x10)
...
{
    class UMovieSceneSection* SectionToKey;                                           // 0x00F8 (size: 0x8)
    FMovieScenePropertyBinding PropertyBinding;                                       // 0x0100 (size: 0x14)
    TArray<class UMovieSceneSection*> Sections;                                       // 0x0118 (size: 0x10)
...
{
    int32 CustomBindingPriority;                                                      // 0x0028 (size: 0x4)
    TSubclassOf<class UMovieSceneSpawnableBindingBase> PreviewSpawnableType;          // 0x0030 (size: 0x8)

    bool BP_SupportsBindingCreationFromObject(const class UObject* SourceObject);
    FMovieSceneBindingResolveResult BP_ResolveRuntimeBinding(const FMovieSceneBindingResolveContext& ResolveContext);
...
class UMovieSceneReplaceableDirectorBlueprintBinding : public UMovieSceneReplaceableBindingBase
{
    ...
    TSubclassOf<class UMovieSceneSpawnableBindingBase> PreviewSpawnableType;          // 0x0050 (size: 0x8)
...
{
    FMovieSceneDoubleChannel Rotation;                                                // 0x0100 (size: 0x348)
...
{
    EMovieSceneScalabilityConditionGroup Group;                                       // 0x0060 (size: 0x1)
    EMovieSceneScalabilityConditionOperator Operator;                                 // 0x0061 (size: 0x1)
    EMovieSceneScalabilityConditionLevel Level;                                       // 0x0062 (size: 0x1)

}; // Size: 0x68

class UMovieSceneSkeletalAnimationSection : public UMovieSceneSection
{
    FMovieSceneSkeletalAnimationParams Params;                                        // 0x0100 (size: 0x158)
    class UAnimSequence* AnimSequence;                                                // 0x0258 (size: 0x8)
    class UAnimSequenceBase* Animation;                                               // 0x0260 (size: 0x8)
    float StartOffset;                                                                // 0x0268 (size: 0x4)
    float EndOffset;                                                                  // 0x026C (size: 0x4)
    float PlayRate;                                                                   // 0x0270 (size: 0x4)
    uint8 bReverse;                                                                   // 0x0274 (size: 0x1)
    FName SlotName;                                                                   // 0x0278 (size: 0x8)
    FVector StartLocationOffset;                                                      // 0x0280 (size: 0x18)
    FRotator StartRotationOffset;                                                     // 0x0298 (size: 0x18)
    FName MatchedBoneName;                                                            // 0x02B0 (size: 0x8)
    FVector MatchedLocationOffset;                                                    // 0x02B8 (size: 0x18)
    FRotator MatchedRotationOffset;                                                   // 0x02D0 (size: 0x18)
    uint8 bMatchWithPrevious;                                                         // 0x02E8 (size: 0x1)
    uint8 bMatchTranslation;                                                          // 0x02E8 (size: 0x1)
    uint8 bMatchIncludeZHeight;                                                       // 0x02E8 (size: 0x1)
    uint8 bMatchRotationYaw;                                                          // 0x02E8 (size: 0x1)
    uint8 bMatchRotationPitch;                                                        // 0x02E8 (size: 0x1)
    uint8 bMatchRotationRoll;                                                         // 0x02E8 (size: 0x1)
    uint8 bDebugForceTickPose;                                                        // 0x02E8 (size: 0x1)
...
{
    TArray<class UMovieSceneSection*> AnimationSections;                              // 0x00F8 (size: 0x10)
    bool bUseLegacySectionIndexBlend;                                                 // 0x0108 (size: 0x1)
    FMovieSceneSkeletalAnimRootMotionTrackParams RootMotionParams;                    // 0x0110 (size: 0x80)
    bool bBlendFirstChildOfRoot;                                                      // 0x0190 (size: 0x1)
    ESwapRootBone SwapRootBone;                                                       // 0x0191 (size: 0x1)
...
{
    class AActor* ActorTemplate;                                                      // 0x0040 (size: 0x8)

}; // Size: 0x48

class UMovieSceneSpawnableActorBindingBase : public UMovieSceneSpawnableBindingBase
{
    bool bNetAddressableName;                                                         // 0x0030 (size: 0x1)
    FName LevelName;                                                                  // 0x0034 (size: 0x8)

}; // Size: 0x40

class UMovieSceneSpawnableDirectorBlueprintBinding : public UMovieSceneSpawnableBindingBase
{
    FMovieSceneDynamicBinding DynamicBinding;                                         // 0x0030 (size: 0x28)
...
{
    FMovieSceneStringChannel StringCurve;                                             // 0x0100 (size: 0x110)
