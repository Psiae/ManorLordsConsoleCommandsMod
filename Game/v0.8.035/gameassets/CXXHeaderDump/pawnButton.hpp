...
class UpawnButton_C : public UUserWidget
{
    ...
    class UcoatsDynamic_C* coatsDynamicWidget;                                        // 0x02D8 (size: 0x8)
    class UMD_NaviAutoButton_C* MD_NaviAutoButton;                                    // 0x02E0 (size: 0x8)
    class UBorder* playerColorBorder;                                                 // 0x02E8 (size: 0x8)
    class UImage* portrait_img;                                                       // 0x02F0 (size: 0x8)
    class UButton* portraitButton;                                                    // 0x02F8 (size: 0x8)
    class APawnCPP* Pawn;                                                             // 0x0300 (size: 0x8)
    class UregionViewOverlay_C* Daddy;                                                // 0x0308 (size: 0x8)
    class UMaterialInstanceDynamic* coatMat;                                          // 0x0310 (size: 0x8)
