...
{
    FName Root;                                                                       // 0x01F0 (size: 0x8)
    TArray<FPBIKEffector> Effectors;                                                  // 0x01F8 (size: 0x10)
    TArray<int32> EffectorSolverIndices;                                              // 0x0208 (size: 0x10)
    TArray<FPBIKBoneSetting> BoneSettings;                                            // 0x0218 (size: 0x10)
    TArray<FName> ExcludedBones;                                                      // 0x0228 (size: 0x10)
    FPBIKSolverSettings Settings;                                                     // 0x0238 (size: 0x40)
    FPBIKDebug Debug;                                                                 // 0x0278 (size: 0x8)
    FPBIKWorkData WorkData;                                                           // 0x0280 (size: 0x80)
