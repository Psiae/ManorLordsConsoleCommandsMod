...
class UMD_NaviComboBoxWrapper_C : public UNaviUi
{
    ...
    class UNamedSlot* ComboBoxSlot;                                                   // 0x0348 (size: 0x8)
    class UMD_NaviAutoFocusHighlight_C* MD_NaviAutoFocusHighlight;                    // 0x0350 (size: 0x8)
    class UComboBoxString* ActiveComboBox;                                            // 0x0358 (size: 0x8)
    FMD_NaviComboBoxWrapper_COnComboFinish OnComboFinish;                             // 0x0360 (size: 0x10)
    void OnComboFinish();
    ...
    void OnComboFinish__DelegateSignature();
}; // Size: 0x370
