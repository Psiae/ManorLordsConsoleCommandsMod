...
class UStallEntry_C : public UUserWidget
{
    ...
    class UButton* Button_0;                                                          // 0x02E0 (size: 0x8)
    class UButton* Button_1;                                                          // 0x02E8 (size: 0x8)
    class UImage* Image_0;                                                            // 0x02F0 (size: 0x8)
    class UImage* Image_54;                                                           // 0x02F8 (size: 0x8)
    class UMD_NaviAutoButton_C* MD_NaviAutoButton;                                    // 0x0300 (size: 0x8)
    class UMD_NaviAutoButton_C* MD_NaviAutoButton_95;                                 // 0x0308 (size: 0x8)
    class UTextBlock* role_txt;                                                       // 0x0310 (size: 0x8)
    class UTextBlock* TextBlock_0;                                                    // 0x0318 (size: 0x8)
