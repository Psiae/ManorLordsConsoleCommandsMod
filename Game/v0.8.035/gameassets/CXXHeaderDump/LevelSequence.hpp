...
{
    FLevelSequencePlayerSnapshot FrameInformation;                                    // 0x02D0 (size: 0xA8)
    class ALevelSequenceActor* LevelSequenceActor;                                    // 0x0378 (size: 0x8)
...
{
    FLevelSequencePlayerOnCameraCut OnCameraCut;                                      // 0x0470 (size: 0x10)
