...
struct FCreateTextureObjectParams
{
    ...
    FString FullAssetPath;                                                            // 0x0030 (size: 0x10)
...
{
    class UMaterialInstanceDynamic* SelectionFillColor;                               // 0x0040 (size: 0x8)
...
{
    class UMeshOpPreviewWithBackgroundCompute* Preview;                               // 0x0138 (size: 0x8)
...
class UGeometrySelectionManager : public UObject
{
    ...
    FMeshElementSelectionParams UnselectedParams;                                     // 0x02C0 (size: 0x48)
    FMeshElementSelectionParams HoverOverSelectedParams;                              // 0x0308 (size: 0x48)
    FMeshElementSelectionParams HoverOverUnselectedParams;                            // 0x0350 (size: 0x48)
    FMeshElementSelectionParams SelectedParams;                                       // 0x0398 (size: 0x48)
...
{
    class UMaterialInterface* LineMaterial;                                           // 0x0518 (size: 0x8)
    FBoxSphereBounds Bounds;                                                          // 0x0520 (size: 0x38)
    bool bBoundsDirty;                                                                // 0x0558 (size: 0x1)

    void SetLineMaterial(class UMaterialInterface* InLineMaterial);
    void Clear();
    int32 AddLines(const TArray<FVector>& InStart, const TArray<FVector>& InEnd, const FColor& InColor, const float InThickness, const float InDepthBias);
}; // Size: 0x5A0
...
{
    float LineDepthBias;                                                              // 0x0518 (size: 0x4)
    float LineDepthBiasSizeScale;                                                     // 0x051C (size: 0x4)
    float ThicknessScale;                                                             // 0x0520 (size: 0x4)
    bool bEnableWireframe;                                                            // 0x0524 (size: 0x1)
    FColor WireframeColor;                                                            // 0x0528 (size: 0x4)
    float WireframeThickness;                                                         // 0x052C (size: 0x4)
    bool bEnableBoundaryEdges;                                                        // 0x0530 (size: 0x1)
    FColor BoundaryEdgeColor;                                                         // 0x0534 (size: 0x4)
    float BoundaryEdgeThickness;                                                      // 0x0538 (size: 0x4)
    bool bEnableUVSeams;                                                              // 0x053C (size: 0x1)
    FColor UVSeamColor;                                                               // 0x0540 (size: 0x4)
    float UVSeamThickness;                                                            // 0x0544 (size: 0x4)
    bool bEnableNormalSeams;                                                          // 0x0548 (size: 0x1)
    FColor NormalSeamColor;                                                           // 0x054C (size: 0x4)
    float NormalSeamThickness;                                                        // 0x0550 (size: 0x4)
    bool bEnableTangentSeams;                                                         // 0x0554 (size: 0x1)
    FColor TangentSeamColor;                                                          // 0x0558 (size: 0x4)
    float TangentSeamThickness;                                                       // 0x055C (size: 0x4)
    bool bEnableColorSeams;                                                           // 0x0560 (size: 0x1)
    FColor ColorSeamColor;                                                            // 0x0564 (size: 0x4)
    float ColorSeamThickness;                                                         // 0x0568 (size: 0x4)
    class UMaterialInterface* LineMaterial;                                           // 0x0570 (size: 0x8)
    FBoxSphereBounds LocalBounds;                                                     // 0x0578 (size: 0x38)
...
{
    TWeakObjectPtr<class UWorld> TargetWorld;                                         // 0x00B0 (size: 0x8)
    class UGeometrySelectionVisualizationProperties* GeometrySelectionVizProperties;  // 0x00D8 (size: 0x8)
    class UPreviewGeometry* GeometrySelectionViz;                                     // 0x00E0 (size: 0x8)
...
{
    class UMaterialInterface* PointMaterial;                                          // 0x0518 (size: 0x8)
    FBoxSphereBounds Bounds;                                                          // 0x0520 (size: 0x38)
    bool bBoundsDirty;                                                                // 0x0558 (size: 0x1)
...
{
    FBoxSphereBounds Bounds;                                                          // 0x0518 (size: 0x38)
    bool bBoundsDirty;                                                                // 0x0550 (size: 0x1)
