...
{
    bool bExplicitShowWireframe;                                                      // 0x0538 (size: 0x1)
    FLinearColor WireframeColor;                                                      // 0x053C (size: 0x10)
    EDynamicMeshComponentColorOverrideMode ColorMode;                                 // 0x054C (size: 0x1)
    FColor ConstantColor;                                                             // 0x0550 (size: 0x4)
    EDynamicMeshVertexColorTransformMode ColorSpaceMode;                              // 0x0554 (size: 0x1)
    bool bEnableFlatShading;                                                          // 0x0555 (size: 0x1)
    bool bEnableViewModeOverrides;                                                    // 0x0556 (size: 0x1)
    class UMaterialInterface* OverrideRenderMaterial;                                 // 0x0558 (size: 0x8)
    class UMaterialInterface* SecondaryRenderMaterial;                                // 0x0560 (size: 0x8)
    bool bEnableRayTracing;                                                           // 0x0569 (size: 0x1)
    EDynamicMeshDrawPath DrawPath;                                                    // 0x056A (size: 0x1)
    EDynamicMeshComponentDistanceFieldMode DistanceFieldMode;                         // 0x056B (size: 0x1)
    TArray<class UMaterialInterface*> BaseMaterials;                                  // 0x0570 (size: 0x10)
...
{
    class UDynamicMesh* MeshObject;                                                   // 0x0588 (size: 0x8)
    bool bAllowsGeometrySelection;                                                    // 0x05D1 (size: 0x1)
    EDynamicMeshComponentTangentsMode TangentsType;                                   // 0x06D0 (size: 0x1)
    TEnumAsByte<ECollisionTraceFlag> CollisionType;                                   // 0x07D0 (size: 0x1)
    bool bUseAsyncCooking;                                                            // 0x07D1 (size: 0x1)
    bool bEnableComplexCollision;                                                     // 0x07D2 (size: 0x1)
    bool bDeferCollisionUpdates;                                                      // 0x07D3 (size: 0x1)
    class UBodySetup* MeshBodySetup;                                                  // 0x07D8 (size: 0x8)
    FKAggregateGeom AggGeom;                                                          // 0x0818 (size: 0x80)
    TArray<class UBodySetup*> AsyncBodySetupQueue;                                    // 0x0898 (size: 0x10)
