...
class UresolutionConfirmation_C : public UUserWidget
{
    ...
    class UmenuButton_C* dontKeep;                                                    // 0x02D8 (size: 0x8)
    class UmenuButton_C* keep;                                                        // 0x02E0 (size: 0x8)
    class UlocalizedTextBox_C* localizedTextBox;                                      // 0x02E8 (size: 0x8)
    class UTextBlock* TextBlock_46;                                                   // 0x02F0 (size: 0x8)
    double TimeElapsed;                                                               // 0x02F8 (size: 0x8)
    FresolutionConfirmation_CGoBackToPreviousResolution goBackToPreviousResolution;   // 0x0300 (size: 0x10)
    void goBackToPreviousResolution();
    FTimerHandle abortTimerHandle;                                                    // 0x0310 (size: 0x8)
