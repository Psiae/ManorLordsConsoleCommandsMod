...
class UletterParagraph_C : public UUserWidget
{
    ...
    class UBorder* borderMain;                                                        // 0x02E0 (size: 0x8)
    class UComboBoxString* ComboBoxString_384;                                        // 0x02E8 (size: 0x8)
    class UEditableText* EditableText_amt;                                            // 0x02F0 (size: 0x8)
    class UImage* Locked;                                                             // 0x02F8 (size: 0x8)
    class UMD_NaviHijackProxy_C* MD_NaviHijackProxy;                                  // 0x0300 (size: 0x8)
    class UBorder* paraCombosBorder;                                                  // 0x0308 (size: 0x8)
    class UTextBlock* paragraph_txt;                                                  // 0x0310 (size: 0x8)
    class UImage* paragraphType_Icon;                                                 // 0x0318 (size: 0x8)
    int32 R;                                                                          // 0x0320 (size: 0x4)
    FName para;                                                                       // 0x0324 (size: 0x8)
    bool onLetterCreator;                                                             // 0x032C (size: 0x1)
    bool onMessage;                                                                   // 0x032D (size: 0x1)
    bool onLetterCreatorAvailable;                                                    // 0x032E (size: 0x1)
    FName paraLeftSide;                                                               // 0x0330 (size: 0x8)
    FString paraRightSide;                                                            // 0x0338 (size: 0x10)
    EParaPick Para Pick;                                                              // 0x0348 (size: 0x1)
    FString paraRightSide_translated;                                                 // 0x0350 (size: 0x10)
    bool isPendingLetterPart;                                                         // 0x0360 (size: 0x1)
    ...
    void BndEvt__letterParagraph_MD_NaviHijackProxy_K2Node_ComponentBoundEvent_1_OnFocusChange__DelegateSignature(bool HasFocus);
