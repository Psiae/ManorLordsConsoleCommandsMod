...
{
    class UImage* banner;                                                             // 0x02D0 (size: 0x8)
    class UTextBlock* cost;                                                           // 0x02D8 (size: 0x8)
    class UImage* Image;                                                              // 0x02E0 (size: 0x8)
    class UImage* Image_104;                                                          // 0x02E8 (size: 0x8)
    class UTextBlock* TimeLeft;                                                       // 0x02F0 (size: 0x8)
    int32 companyID;                                                                  // 0x02F8 (size: 0x4)
    FMercenaryCompany Mercenary Company;                                              // 0x0300 (size: 0x60)
    int32 costPerMonth;                                                               // 0x0360 (size: 0x4)
