...
class UChaosCache : public UObject
{
    ...
    TMap<class FName, class FRichCurves> ChannelsTracks;                              // 0x0068 (size: 0x50)
    TMap<class FName, class FCompressedRichCurves> CompressedChannelsTracks;          // 0x00B8 (size: 0x50)
    TMap<class FName, class FRichCurve> CurveData;                                    // 0x0108 (size: 0x50)
    TMap<class FName, class FParticleTransformTrack> NamedTransformTracks;            // 0x0158 (size: 0x50)
    ...
    TMap<class FName, class FCacheEventTrack> EventTracks;                            // 0x01B8 (size: 0x50)
    FCacheSpawnableTemplate Spawnable;                                                // 0x0210 (size: 0xD0)
    FGuid AdapterGuid;                                                                // 0x02E0 (size: 0x10)
    int32 Version;                                                                    // 0x02F0 (size: 0x4)
...
{
    FMovieSceneChaosCacheParams Params;                                               // 0x0100 (size: 0x28)
