...
class UquestObjective_C : public UUserWidget
{
    ...
    class UImage* Image_91;                                                           // 0x02D8 (size: 0x8)
    class URichTextBlock* objective_txt;                                              // 0x02E0 (size: 0x8)
    FObjective Objective;                                                             // 0x02E8 (size: 0x90)
    FQuest Quest;                                                                     // 0x0378 (size: 0x118)
    ...
    void findAttachedHaveCashObjectiveToSendPromisedCashParagraph(double& Cash to Have);
    void Construct();
