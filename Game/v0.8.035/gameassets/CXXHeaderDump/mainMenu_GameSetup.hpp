...
class UmainMenu_GameSetup_C : public UNaviSubGrid
{
    ...
    class UImage* Image_13;                                                           // 0x04D8 (size: 0x8)
    class UImage* Image_14;                                                           // 0x04E0 (size: 0x8)
    class UImage* Image_15;                                                           // 0x04E8 (size: 0x8)
    class UImage* Image_16;                                                           // 0x04F0 (size: 0x8)
    class UImage* Image_17;                                                           // 0x04F8 (size: 0x8)
    class UImage* Image_18;                                                           // 0x0500 (size: 0x8)
    class UImage* Image_19;                                                           // 0x0508 (size: 0x8)
    class UImage* Image_20;                                                           // 0x0510 (size: 0x8)
    class UImage* Image_21;                                                           // 0x0518 (size: 0x8)
    class UImage* Image_22;                                                           // 0x0520 (size: 0x8)
    class UImage* Image_23;                                                           // 0x0528 (size: 0x8)
    class UImage* Image_24;                                                           // 0x0530 (size: 0x8)
    ...
    class UlocalizedTextBox_C* localizedTextBox_57;                                   // 0x0560 (size: 0x8)
    class UlocalizedTextBox_C* localizedTextBox_88;                                   // 0x0568 (size: 0x8)
    class UImage* mapParchment;                                                       // 0x0570 (size: 0x8)
    class UCanvasPanel* mapParchmentContainer;                                        // 0x0578 (size: 0x8)
    class UScaleBox* MapParchmentParent;                                              // 0x0580 (size: 0x8)
    class UComboBoxString* mapSelectorCombo;                                          // 0x0588 (size: 0x8)
    class UImage* mapThumb;                                                           // 0x0590 (size: 0x8)
    class UVerticalBox* menu_Container;                                               // 0x0598 (size: 0x8)
    class UMLDefaultSpinner_C* MLDefaultSpinner;                                      // 0x05A0 (size: 0x8)
    class UMLDefaultSpinner_C* MLDefaultSpinner_2;                                    // 0x05A8 (size: 0x8)
    class UWrapBox* ModePresets;                                                      // 0x05B0 (size: 0x8)
    class UMD_NaviComboBoxWrapper_C* Navi_MapSelectorWrapper;                         // 0x05B8 (size: 0x8)
    class UUniformGridPanel* older_economic_settings_uniformPanel;                    // 0x05C0 (size: 0x8)
    class UmenuButton_C* play_button;                                                 // 0x05C8 (size: 0x8)
    class UHorizontalBox* presetDifficulty_HB;                                        // 0x05D0 (size: 0x8)
    class UHorizontalBox* presets_hb;                                                 // 0x05D8 (size: 0x8)
    class UHorizontalBox* raiderFreeYears_hb_2;                                       // 0x05E0 (size: 0x8)
    class UHorizontalBox* raiders_hb;                                                 // 0x05E8 (size: 0x8)
    class UHorizontalBox* raiders_hb_1;                                               // 0x05F0 (size: 0x8)
    class UHorizontalBox* raiders_hb_2;                                               // 0x05F8 (size: 0x8)
    class URetainerBox* RetainerBox_0;                                                // 0x0600 (size: 0x8)
    class UmenuButton_C* return_button;                                               // 0x0608 (size: 0x8)
    class UVerticalBox* RIGHT_VB;                                                     // 0x0610 (size: 0x8)
    class UMLDefaultSpinner_C* setting_aggressiveness;                                // 0x0618 (size: 0x8)
    class UMLDefaultSpinner_C* setting_approval;                                      // 0x0620 (size: 0x8)
    class UMLDefaultSpinner_C* setting_armamentDelivery;                              // 0x0628 (size: 0x8)
    class UMLDefaultSpinner_C* setting_banditCamps_initial;                           // 0x0630 (size: 0x8)
    class UMLDefaultSpinner_C* setting_banditCamps_max;                               // 0x0638 (size: 0x8)
    class UMLDefaultSpinner_C* setting_baron;                                         // 0x0640 (size: 0x8)
    class UMLDefaultSpinner_C* setting_goals;                                         // 0x0648 (size: 0x8)
    class UMLDefaultSpinner_C* setting_num_ai_opponents;                              // 0x0650 (size: 0x8)
    class UMLDefaultSpinner_C* setting_raiders;                                       // 0x0658 (size: 0x8)
    class UMLDefaultSpinner_C* setting_raiders_2;                                     // 0x0660 (size: 0x8)
    class UMLDefaultSpinner_C* setting_requirements;                                  // 0x0668 (size: 0x8)
    class UMLDefaultSpinner_C* setting_resourceRandomization;                         // 0x0670 (size: 0x8)
    class UMLDefaultSpinner_C* setting_spoilage;                                      // 0x0678 (size: 0x8)
    class UMLDefaultSpinner_C* setting_startingDay;                                   // 0x0680 (size: 0x8)
    class UMLDefaultSpinner_C* setting_startingKingsTaxVal;                           // 0x0688 (size: 0x8)
    class UMLDefaultSpinner_C* setting_startingResourcesMul;                          // 0x0690 (size: 0x8)
    class UMLDefaultSpinner_C* setting_tutorialQuests;                                // 0x0698 (size: 0x8)
    class UMLDefaultSpinner_C* setting_water;                                         // 0x06A0 (size: 0x8)
    class UMLDefaultSpinner_C* setting_weather;                                       // 0x06A8 (size: 0x8)
    class UHorizontalBox* SettingsAiOpParent;                                         // 0x06B0 (size: 0x8)
    class UScrollBox* SettingsScrollBox;                                              // 0x06B8 (size: 0x8)
    class UHorizontalBox* spoilage_hb;                                                // 0x06C0 (size: 0x8)
    class UHorizontalBox* startingResource_HB;                                        // 0x06C8 (size: 0x8)
    class UTextBlock* title_coats_txt;                                                // 0x06D0 (size: 0x8)
    class UImage* top_spacer;                                                         // 0x06D8 (size: 0x8)
    FmainMenu_GameSetup_CBeginGame BeginGame;                                         // 0x06E0 (size: 0x10)
    void beginGame();
    FmainMenu_GameSetup_CGoBackToBanner goBackToBanner;                               // 0x06F0 (size: 0x10)
    void goBackToBanner();
    bool tempPresetWhenChangingDifficulty;                                            // 0x0700 (size: 0x1)
    double lastSettingHoverSfxTime;                                                   // 0x0708 (size: 0x8)
    TSubclassOf<class UCoatOfArmsLibrary> CoatOfArmsLibraryClass;                     // 0x0710 (size: 0x8)
    TArray<class UmapSelectionEntry_C*> mapSelectionOptionWidgets;                    // 0x0718 (size: 0x10)
    TArray<class UstartVillageEntry_C*> startVillageEntryWidgets;                     // 0x0728 (size: 0x10)
    TArray<class UregionOwnershipEntry_C*> regionOwnerWidgets;                        // 0x0738 (size: 0x10)
    ...
    void PopulateParchmentWithRegionOwners(TSet<FRegionData> Regions, FMapBounds Bounds, FIntVector Bounds_mapCentre, int32 Bounds_xBounds, int32 Bounds_yBounds);
    void PopulateParchmentWithStartLocations(TSet<FVillageSpawnerData> Locations, FMapBounds Bounds);
    void SetOptionAvailable(class UWidget* OtherOptionHb, bool isAvailable);
    ...
    void BndEvt__mainMenu_GameSetup_Navi_MapSelectorWrapper_K2Node_ComponentBoundEvent_9_OnComboFinish__DelegateSignature();
