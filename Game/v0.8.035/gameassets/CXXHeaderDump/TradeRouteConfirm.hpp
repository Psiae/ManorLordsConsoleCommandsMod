...
class UTradeRouteConfirm_C : public UNaviSubGrid
{
    ...
    class UMD_NaviAutoButton_C* navi_Accept;                                          // 0x0380 (size: 0x8)
    class UMD_NaviAutoButton_C* navi_Cancel;                                          // 0x0388 (size: 0x8)
    class UlocalizedTextBox_C* question_txt;                                          // 0x0390 (size: 0x8)
    FTradeRouteConfirm_CConfirmDemolish confirmDemolish;                              // 0x0398 (size: 0x10)
