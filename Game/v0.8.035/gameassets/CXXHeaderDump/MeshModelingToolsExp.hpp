...
class UBakeMeshAttributeMapsTool : public UBakeMeshAttributeMapsToolBase
{
    ...
    class UBakeUVShellMapToolProperties* UVShellSettings;                             // 0x0338 (size: 0x8)
...
class UBakeOcclusionMapToolProperties : public UInteractiveToolPropertySet
{
    ...
    EBakeNormalSpace NormalSpace;                                                     // 0x00B8 (size: 0x4)
...
{
    int32 UVLayer;                                                                    // 0x00A8 (size: 0x4)
    float WireframeThickness;                                                         // 0x00AC (size: 0x4)
    FLinearColor WireframeColor;                                                      // 0x00B0 (size: 0x10)
    FLinearColor ShellColor;                                                          // 0x00C0 (size: 0x10)
    FLinearColor BackgroundColor;                                                     // 0x00D0 (size: 0x10)
...
class UCubeGridToolProperties : public UInteractiveToolPropertySet
{
    ...
    bool bShowGrid;                                                                   // 0x00D8 (size: 0x1)
    bool bShowGizmo;                                                                  // 0x00D9 (size: 0x1)
...
class UDisplaceMeshTool : public USingleTargetWithSelectionTool
{
    ...
    class AInternalToolFrameworkActor* PreviewMeshActor;                              // 0x04A8 (size: 0x8)
    class UDynamicMeshComponent* DynamicMeshComponent;                                // 0x04B0 (size: 0x8)
...
{
    class UPreviewMesh* PreviewMesh;                                                  // 0x02A0 (size: 0x8)
...
class UEditPivotTool : public UMultiSelectionMeshEditingTool
{
    ...
    TArray<FEditPivotTarget> ActiveGizmos;                                            // 0x0220 (size: 0x10)
    class UDragAlignmentMechanic* DragAlignmentMechanic;                              // 0x0230 (size: 0x8)
...
{
    bool bApplyToAllLODs;                                                             // 0x00A8 (size: 0x1)
    bool bSnapDragPosition;                                                           // 0x00A9 (size: 0x1)
    bool bSnapDragRotation;                                                           // 0x00AA (size: 0x1)
    EEditPivotSnapDragRotationMode RotationMode;                                      // 0x00AB (size: 0x1)
...
{
    class ULatticeControlPointsMechanic* ControlPointsMechanic;                       // 0x0180 (size: 0x8)
    class ULatticeDeformerToolProperties* Settings;                                   // 0x0188 (size: 0x8)
    class UMeshOpPreviewWithBackgroundCompute* Preview;                               // 0x0190 (size: 0x8)
    bool bLatticeDeformed;                                                            // 0x0198 (size: 0x1)
...
{
    class UMeshAttributePaintBrushOperationProperties* BrushActionProps;              // 0x02F0 (size: 0x8)
    class UMeshAttributePaintToolProperties* AttribProps;                             // 0x02F8 (size: 0x8)
...
{
    class UMeshSelectionToolProperties* SelectionProps;                               // 0x02F0 (size: 0x8)
    class UMeshSelectionEditActions* SelectionActions;                                // 0x02F8 (size: 0x8)
    class UMeshSelectionToolActionPropertySet* EditActions;                           // 0x0300 (size: 0x8)
    class UMeshStatisticsProperties* MeshStatisticsProperties;                        // 0x0308 (size: 0x8)
    class UMeshElementsVisualizer* MeshElementsDisplay;                               // 0x0310 (size: 0x8)
    class UMeshUVChannelProperties* UVChannelProperties;                              // 0x0318 (size: 0x8)
    class UPolygroupLayersProperties* PolygroupLayerProperties;                       // 0x0320 (size: 0x8)
    class UMeshSelectionSet* Selection;                                               // 0x0380 (size: 0x8)
    TArray<class AActor*> SpawnedActors;                                              // 0x0388 (size: 0x10)
...
{
    class UOffsetMeshToolProperties* OffsetProperties;                                // 0x0470 (size: 0x8)
    class UIterativeOffsetProperties* IterativeProperties;                            // 0x0478 (size: 0x8)
    class UImplicitOffsetProperties* ImplicitProperties;                              // 0x0480 (size: 0x8)
    class UOffsetWeightMapSetProperties* WeightMapProperties;                         // 0x0488 (size: 0x8)
...
class UPatternTool : public UMultiSelectionMeshEditingTool
{
    ...
    class UComponentBoundTransformProxy* PatternGizmoProxy;                           // 0x0158 (size: 0x8)
    class UInteractiveGizmo* PatternGizmo;                                            // 0x0160 (size: 0x8)
    class UPrimitiveComponent* PatternGizmoComponent;                                 // 0x0168 (size: 0x8)
    class UDragAlignmentMechanic* DragAlignmentMechanic;                              // 0x0188 (size: 0x8)
    class UConstructionPlaneMechanic* PlaneMechanic;                                  // 0x0190 (size: 0x8)
    TSet<UPrimitiveComponent*> AllComponents;                                         // 0x0378 (size: 0x50)
    class UPreviewGeometry* PreviewGeometry;                                          // 0x0468 (size: 0x8)
...
{
    class URevolveSplineToolProperties* Settings;                                     // 0x0100 (size: 0x8)
    class URevolveSplineToolActionPropertySet* ToolActions;                           // 0x0108 (size: 0x8)
...
{
    class USeamSculptToolProperties* Settings;                                        // 0x02F0 (size: 0x8)
    class UPreviewGeometry* PreviewGeom;                                              // 0x02F8 (size: 0x8)
...
class USeamSculptToolProperties : public UInteractiveToolPropertySet
{
    ...
    double PathSimilarityWeight;                                                      // 0x00B0 (size: 0x8)
...
class USetCollisionGeometryToolProperties : public UInteractiveToolPropertySet
{
    ...
    bool bPreSimplifyToEdgeLength;                                                    // 0x00D0 (size: 0x1)
    double DecompositionTargetEdgeLength;                                             // 0x00D8 (size: 0x8)
    EConvexDecompositionMethod DecompositionMethod;                                   // 0x00E0 (size: 0x4)
    bool bLimitHullsPerShape;                                                         // 0x00E4 (size: 0x1)
    int32 MaxHullsPerShape;                                                           // 0x00E8 (size: 0x4)
    float ConvexDecompositionSearchFactor;                                            // 0x00EC (size: 0x4)
    float AddHullsErrorTolerance;                                                     // 0x00F0 (size: 0x4)
    float MinPartThickness;                                                           // 0x00F4 (size: 0x4)
    double NegativeSpaceTolerance;                                                    // 0x00F8 (size: 0x8)
    double NegativeSpaceMinRadius;                                                    // 0x0100 (size: 0x8)
    bool bIgnoreInternalNegativeSpace;                                                // 0x0108 (size: 0x1)
    float HullTolerance;                                                              // 0x010C (size: 0x4)
    EProjectedHullAxis SweepAxis;                                                     // 0x0110 (size: 0x4)
    int32 LevelSetResolution;                                                         // 0x0114 (size: 0x4)
    ECollisionGeometryMode SetCollisionType;                                          // 0x0118 (size: 0x4)
    bool bShowTargetMesh;                                                             // 0x011C (size: 0x1)
    bool bUsingMultipleInputs;                                                        // 0x011D (size: 0x1)
...
{
    class USmoothMeshToolProperties* SmoothProperties;                                // 0x0478 (size: 0x8)
    class UIterativeSmoothProperties* IterativeProperties;                            // 0x0480 (size: 0x8)
    class UDiffusionSmoothProperties* DiffusionProperties;                            // 0x0488 (size: 0x8)
    class UImplicitSmoothProperties* ImplicitProperties;                              // 0x0490 (size: 0x8)
    class USmoothWeightMapSetProperties* WeightMapProperties;                         // 0x0498 (size: 0x8)
...
{
    class USplitMeshesToolProperties* BasicProperties;                                // 0x00E8 (size: 0x8)
    class UCreateMeshObjectTypeProperties* OutputTypeProperties;                      // 0x00F0 (size: 0x8)
    TArray<class UPreviewGeometry*> PerTargetPreviews;                                // 0x0120 (size: 0x10)
    class UMaterialInterface* PreviewMaterial;                                        // 0x0130 (size: 0x8)
...
{
    ESplitMeshesMethod SplitMethod;                                                   // 0x00A8 (size: 0x1)
    double ConnectVerticesThreshold;                                                  // 0x00B0 (size: 0x8)
    bool bTransferMaterials;                                                          // 0x00B8 (size: 0x1)
    bool bShowPreview;                                                                // 0x00B9 (size: 0x1)
    bool bIsInSelectionMode;                                                          // 0x00BA (size: 0x1)
...
{
    class UTriangulateSplinesToolProperties* TriangulateProperties;                   // 0x0100 (size: 0x8)
...
{
    class UUVTransferToolProperties* Settings;                                        // 0x00F8 (size: 0x8)
    class UMeshUVChannelProperties* UVChannelProperties;                              // 0x0100 (size: 0x8)
    class UExistingMeshMaterialProperties* DestinationMaterialSettings;               // 0x0108 (size: 0x8)
    class UMeshOpPreviewWithBackgroundCompute* DestinationPreview;                    // 0x0110 (size: 0x8)
    class UPreviewMesh* SourcePreview;                                                // 0x0118 (size: 0x8)
    class UMeshElementsVisualizer* SourceSeamVisualizer;                              // 0x0120 (size: 0x8)
    class UMeshElementsVisualizer* DestinationSeamVisualizer;                         // 0x0128 (size: 0x8)
...
{
    bool bReverseDirection;                                                           // 0x00A8 (size: 0x1)
    bool bTransferSeamsOnly;                                                          // 0x00A9 (size: 0x1)
    bool bClearExistingSeams;                                                         // 0x00AA (size: 0x1)
    double PathSimilarityWeight;                                                      // 0x00B0 (size: 0x8)
    bool bShowWireframes;                                                             // 0x00B8 (size: 0x1)
    bool bShowSeams;                                                                  // 0x00B9 (size: 0x1)
    double VertexSearchDistance;                                                      // 0x00C0 (size: 0x8)
