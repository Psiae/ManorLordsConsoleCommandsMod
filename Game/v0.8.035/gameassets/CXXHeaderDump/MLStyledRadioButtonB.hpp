...
class UMLStyledRadioButtonB_C : public URadioButton
{
    ...
    FMLStyledRadioButtonB_COnHover onHover;                                           // 0x0328 (size: 0x10)
    void onHover(FString Value);
    FMLStyledRadioButtonB_COnLeave onLeave;                                           // 0x0338 (size: 0x10)
    void onLeave();
    bool Localized;                                                                   // 0x0348 (size: 0x1)
    FText originalLabel;                                                              // 0x0350 (size: 0x10)
    class UFontFace* LabelFont;                                                       // 0x0360 (size: 0x8)
