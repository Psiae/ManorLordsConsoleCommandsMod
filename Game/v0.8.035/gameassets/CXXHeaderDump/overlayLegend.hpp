...
class UoverlayLegend_C : public UNaviSubGrid
{
    ...
    class UImage* Image_35;                                                           // 0x0350 (size: 0x8)
    class UlocalizedTextBox_C* localizedTextBox;                                      // 0x0358 (size: 0x8)
    class UVerticalRadioSelect_C* VerticalRadioSelect;                                // 0x0360 (size: 0x8)
    FString SelectedOption;                                                           // 0x0368 (size: 0x10)
