...
class UtransactionLog_GoodIcon_C : public UUserWidget
{
    ...
    class UImage* Image_39;                                                           // 0x02D8 (size: 0x8)
    class UImage* Image_138;                                                          // 0x02E0 (size: 0x8)
    class UTextBlock* TextBlock_numberOfGoods;                                        // 0x02E8 (size: 0x8)
    class UTextBlock* TextBlock_value;                                                // 0x02F0 (size: 0x8)
