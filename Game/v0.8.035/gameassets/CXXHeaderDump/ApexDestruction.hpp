...
{
    uint8 bFractureEffectOverride;                                                    // 0x0890 (size: 0x1)
    TArray<FFractureEffect> FractureEffects;                                          // 0x0898 (size: 0x10)
    bool bEnableHardSleeping;                                                         // 0x08A8 (size: 0x1)
    float LargeChunkThreshold;                                                        // 0x08AC (size: 0x4)
    FDestructibleComponentOnComponentFracture OnComponentFracture;                    // 0x08B0 (size: 0x10)
...
{
    FDestructibleParameters DefaultDestructibleParameters;                            // 0x0528 (size: 0xA8)
    TArray<FFractureEffect> FractureEffects;                                          // 0x05D0 (size: 0x10)
