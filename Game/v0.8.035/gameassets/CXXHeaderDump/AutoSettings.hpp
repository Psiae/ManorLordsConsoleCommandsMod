...
{
    FName CVarName;                                                                   // 0x02D0 (size: 0x8)
    TSubclassOf<class USettingValueMask> ValueMask;                                   // 0x02D8 (size: 0x8)
    bool bAutoSave;                                                                   // 0x02E0 (size: 0x1)
    bool bAutoApply;                                                                  // 0x02E1 (size: 0x1)
    FGameplayTagContainer SettingTags;                                                // 0x02E8 (size: 0x20)
    FString CurrentValue;                                                             // 0x0308 (size: 0x10)
    bool bHasUnappliedChange;                                                         // 0x0318 (size: 0x1)
    bool bHasUnsavedChange;                                                           // 0x0319 (size: 0x1)
    bool bUpdatingSettingSelection;                                                   // 0x031A (size: 0x1)
...
{
    class UCheckBox* CheckBox;                                                        // 0x0320 (size: 0x8)
...
{
    class UComboBoxString* ComboBox;                                                  // 0x0340 (size: 0x8)
...
{
    class USlider* Slider;                                                            // 0x0328 (size: 0x8)
    bool bMouseCaptureInProgress;                                                     // 0x0330 (size: 0x1)
...
{
    FRadioButtonOnSelected OnSelected;                                                // 0x02D0 (size: 0x10)
    void RadioSelectedSignature(FString Value);
    FText Label;                                                                      // 0x02E0 (size: 0x10)
    FString Value;                                                                    // 0x02F0 (size: 0x10)
...
{
    TArray<FSettingOption> Options;                                                   // 0x02D0 (size: 0x10)
    TSubclassOf<class URadioButton> RadioButtonClass;                                 // 0x02E0 (size: 0x8)
    FRadioSelectSelectionChangedEvent SelectionChangedEvent;                          // 0x02E8 (size: 0x10)
    void RadioSelectedSignature(FString Value);
    class UPanelWidget* ButtonContainer;                                              // 0x02F8 (size: 0x8)
    TArray<class URadioButton*> RadioButtons;                                         // 0x0300 (size: 0x10)
...
{
    TSubclassOf<class URadioButton> RadioButtonClass;                                 // 0x0340 (size: 0x8)
    class URadioSelect* RadioSelect;                                                  // 0x0348 (size: 0x8)
...
{
    TArray<FSettingOption> Options;                                                   // 0x0320 (size: 0x10)
    TSubclassOf<class USettingOptionFactory> OptionFactory;                           // 0x0330 (size: 0x8)
    bool bUpdatingSettingOptions;                                                     // 0x0338 (size: 0x1)
...
{
    float LeftValue;                                                                  // 0x0320 (size: 0x4)
    float RightValue;                                                                 // 0x0324 (size: 0x4)
...
{
    TArray<FSettingOption> Options;                                                   // 0x02D0 (size: 0x10)
    bool bAllowWrapping;                                                              // 0x02E0 (size: 0x1)
    FSpinnerSelectionChangedEvent SelectionChangedEvent;                              // 0x02E8 (size: 0x10)
...
{
    class USpinner* Spinner;                                                          // 0x0340 (size: 0x8)
