...
class ACombinedTransformGizmoActor : public AGizmoActor
{
    ...
    class UPrimitiveComponent* UniformScale;                                          // 0x0300 (size: 0x8)
    class UPrimitiveComponent* AxisScaleX;                                            // 0x0308 (size: 0x8)
    class UPrimitiveComponent* AxisScaleY;                                            // 0x0310 (size: 0x8)
    class UPrimitiveComponent* AxisScaleZ;                                            // 0x0318 (size: 0x8)
    class UPrimitiveComponent* PlaneScaleYZ;                                          // 0x0320 (size: 0x8)
    class UPrimitiveComponent* PlaneScaleXZ;                                          // 0x0328 (size: 0x8)
    class UPrimitiveComponent* PlaneScaleXY;                                          // 0x0330 (size: 0x8)
...
{
    FVector Direction;                                                                // 0x0520 (size: 0x18)
    float Gap;                                                                        // 0x0538 (size: 0x4)
    float Length;                                                                     // 0x053C (size: 0x4)
    float Thickness;                                                                  // 0x0540 (size: 0x4)
...
class UGizmoAxisScaleParameterSource : public UGizmoBaseFloatParameterSource
{
    TScriptInterface<class IGizmoAxisSource> AxisSource;                              // 0x00D0 (size: 0x10)
    TScriptInterface<class IGizmoTransformSource> TransformSource;                    // 0x00E0 (size: 0x10)
    float ScaleMultiplier;                                                            // 0x00F0 (size: 0x4)
    bool bClampToZero;                                                                // 0x00F4 (size: 0x1)
    float Parameter;                                                                  // 0x00F8 (size: 0x4)
    FGizmoFloatParameterChange LastChange;                                            // 0x00FC (size: 0x8)
    FVector CurScaleAxis;                                                             // 0x0108 (size: 0x18)
    FVector CurScaleOrigin;                                                           // 0x0120 (size: 0x18)
    FTransform InitialTransform;                                                      // 0x0140 (size: 0x60)
...
{
    FLinearColor Color;                                                               // 0x04F0 (size: 0x10)
    float HoverSizeMultiplier;                                                        // 0x0500 (size: 0x4)
    float PixelHitDistanceThreshold;                                                  // 0x0504 (size: 0x4)
    class UGizmoViewContext* GizmoViewContext;                                        // 0x0510 (size: 0x8)
...
{
    FVector Origin;                                                                   // 0x0520 (size: 0x18)
    FQuat Rotation;                                                                   // 0x0540 (size: 0x20)
    FVector Dimensions;                                                               // 0x0560 (size: 0x18)
    float LineThickness;                                                              // 0x0578 (size: 0x4)
    bool bRemoveHiddenLines;                                                          // 0x057C (size: 0x1)
    bool bEnableAxisFlip;                                                             // 0x057D (size: 0x1)

}; // Size: 0x580

class UGizmoCircleComponent : public UGizmoBaseComponent
{
    FVector Normal;                                                                   // 0x0520 (size: 0x18)
    float Radius;                                                                     // 0x0538 (size: 0x4)
    float Thickness;                                                                  // 0x053C (size: 0x4)
    int32 NumSides;                                                                   // 0x0540 (size: 0x4)
    bool bViewAligned;                                                                // 0x0544 (size: 0x1)
    bool bDrawFullCircle;                                                             // 0x0545 (size: 0x1)
    bool bOnlyAllowFrontFacingHits;                                                   // 0x0546 (size: 0x1)
...
{
    FVector Normal;                                                                   // 0x0520 (size: 0x18)
    float HandleSize;                                                                 // 0x0538 (size: 0x4)
    float Thickness;                                                                  // 0x053C (size: 0x4)
    FVector Direction;                                                                // 0x0540 (size: 0x18)
    float Length;                                                                     // 0x0558 (size: 0x4)
    bool bImageScale;                                                                 // 0x055C (size: 0x1)
...
{
    TScriptInterface<class IGizmoAxisSource> AxisSource;                              // 0x0150 (size: 0x10)
    TScriptInterface<class IGizmoTransformSource> TransformSource;                    // 0x0160 (size: 0x10)
    float ScaleMultiplier;                                                            // 0x0170 (size: 0x4)
    bool bUseEqualScaling;                                                            // 0x0174 (size: 0x1)
    bool bClampToZero;                                                                // 0x0175 (size: 0x1)
    FVector2D Parameter;                                                              // 0x0178 (size: 0x10)
    FGizmoVec2ParameterChange LastChange;                                             // 0x0188 (size: 0x20)
    FVector CurScaleOrigin;                                                           // 0x01A8 (size: 0x18)
    FVector CurScaleNormal;                                                           // 0x01C0 (size: 0x18)
    FVector CurScaleAxisX;                                                            // 0x01D8 (size: 0x18)
    FVector CurScaleAxisY;                                                            // 0x01F0 (size: 0x18)
    FTransform InitialTransform;                                                      // 0x0210 (size: 0x60)
...
{
    FVector DirectionX;                                                               // 0x0520 (size: 0x18)
    FVector DirectionY;                                                               // 0x0538 (size: 0x18)
    bool bOrientYAccordingToCamera;                                                   // 0x0550 (size: 0x1)
    float OffsetX;                                                                    // 0x0554 (size: 0x4)
    float OffsetY;                                                                    // 0x0558 (size: 0x4)
    float LengthX;                                                                    // 0x055C (size: 0x4)
    float LengthY;                                                                    // 0x0560 (size: 0x4)
    float Thickness;                                                                  // 0x0564 (size: 0x4)
    uint8 SegmentFlags;                                                               // 0x0568 (size: 0x1)
...
class UGizmoUniformScaleParameterSource : public UGizmoBaseVec2ParameterSource
{
    ...
    TScriptInterface<class IGizmoTransformSource> TransformSource;                    // 0x00E0 (size: 0x10)
    float ScaleMultiplier;                                                            // 0x00F0 (size: 0x4)
    FVector2D Parameter;                                                              // 0x00F8 (size: 0x10)
    FGizmoVec2ParameterChange LastChange;                                             // 0x0108 (size: 0x20)
    FVector CurScaleOrigin;                                                           // 0x0128 (size: 0x18)
    FVector CurScaleNormal;                                                           // 0x0140 (size: 0x18)
    FVector CurScaleAxisX;                                                            // 0x0158 (size: 0x18)
    FVector CurScaleAxisY;                                                            // 0x0170 (size: 0x18)
...
{
    class UGizmoTransformChangeStateTarget* RepositionStateTarget;                    // 0x0440 (size: 0x8)
...
{
    class UGizmoViewContext* GizmoViewContext;                                        // 0x05C0 (size: 0x8)
    class UPrimitiveComponent* SubstituteInteractionComponent;                        // 0x05C8 (size: 0x8)
    class UMaterialInterface* HoverOverrideMaterial;                                  // 0x05D0 (size: 0x8)
