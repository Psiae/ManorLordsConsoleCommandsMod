...
class UworkerAssignment_C : public UUserWidget
{
    ...
    class UButton* worker_add;                                                        // 0x0318 (size: 0x8)
    class UButton* worker_add_oldstyle;                                               // 0x0320 (size: 0x8)
    class UButton* worker_remove;                                                     // 0x0328 (size: 0x8)
    class USizeBox* workerGrid_sizeBox;                                               // 0x0330 (size: 0x8)
    class UUniformGridPanel* workerSlots_Grid;                                        // 0x0338 (size: 0x8)
    FworkerAssignment_CChangeActiveWorkers changeActiveWorkers;                       // 0x0340 (size: 0x10)
