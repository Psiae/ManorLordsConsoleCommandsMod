...
class UBigTooltipSeasons_C : public UUserWidget
{
    ...
    class URichTextBlock* name_txt;                                                   // 0x0328 (size: 0x8)
    class URichTextBlock* RichTextBlock;                                              // 0x0330 (size: 0x8)
    class URichTextBlock* RichTextBlock_1;                                            // 0x0338 (size: 0x8)
    class URichTextBlock* RichTextBlock_2;                                            // 0x0340 (size: 0x8)
    class URichTextBlock* RichTextBlock_70;                                           // 0x0348 (size: 0x8)
    FName headerKey;                                                                  // 0x0350 (size: 0x8)
    FName mainTextKey;                                                                // 0x0358 (size: 0x8)
    TArray<FApprovalMemory> factors;                                                  // 0x0360 (size: 0x10)
    int32 season;                                                                     // 0x0370 (size: 0x4)
