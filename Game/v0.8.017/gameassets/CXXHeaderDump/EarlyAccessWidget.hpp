...
class UEarlyAccessWidget_C : public UNaviUi
{
    ...
    class UTextBlock* Header;                                                         // 0x0360 (size: 0x8)
    class UImage* Image;                                                              // 0x0368 (size: 0x8)
    class UImage* Image_7;                                                            // 0x0370 (size: 0x8)
    class UImage* Image_54;                                                           // 0x0378 (size: 0x8)
    class UTextBlock* nda_txt_1;                                                      // 0x0380 (size: 0x8)
    FEarlyAccessWidget_COnDone OnDone;                                                // 0x0388 (size: 0x10)
    void OnDone();
