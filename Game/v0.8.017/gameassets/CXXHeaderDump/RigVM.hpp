...
{
    FRigVMGraphFunctionHeader Header;                                                 // 0x0000 (size: 0x118)
    FRigVMFunctionCompilationData CompilationData;                                    // 0x0118 (size: 0x238)
    FString SerializedCollapsedNode;                                                  // 0x0350 (size: 0x10)
...
struct FRigVMGraphFunctionHeader
{
    ...
    FText ToolTip;                                                                    // 0x0068 (size: 0x10)
    FString Description;                                                              // 0x0078 (size: 0x10)
    FString Category;                                                                 // 0x0088 (size: 0x10)
    FString Keywords;                                                                 // 0x0098 (size: 0x10)
    TArray<FRigVMGraphFunctionArgument> Arguments;                                    // 0x00A8 (size: 0x10)
    TMap<FRigVMGraphFunctionIdentifier, uint32> Dependencies;                         // 0x00B8 (size: 0x50)
    TArray<FRigVMExternalVariable> ExternalVariables;                                 // 0x0108 (size: 0x10)
