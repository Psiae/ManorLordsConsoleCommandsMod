...
class UmainTabButton_C : public UNaviUi
{
    ...
    class UImage* ring_glow;                                                          // 0x0370 (size: 0x8)
    class UButton* TabButton;                                                         // 0x0378 (size: 0x8)
    class UMainUICPP_C* mainUI reference;                                             // 0x0380 (size: 0x8)
    FText Text;                                                                       // 0x0388 (size: 0x10)
    class UTexture2D* iconTexture;                                                    // 0x0398 (size: 0x8)
    int32 tabID;                                                                      // 0x03A0 (size: 0x4)
    int32 previousTabID;                                                              // 0x03A4 (size: 0x4)
    FName MappingName;                                                                // 0x03A8 (size: 0x8)
