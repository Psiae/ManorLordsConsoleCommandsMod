...
class UMLDefaultSpinner_C : public USpinner
{
    ...
    class UWidgetAnimation* scrollright;                                              // 0x0318 (size: 0x8)
    class UWidgetAnimation* scrollleft;                                               // 0x0320 (size: 0x8)
    class UImage* LeftArrow;                                                          // 0x0328 (size: 0x8)
    class UButton* LeftButton;                                                        // 0x0330 (size: 0x8)
    class UMD_NaviHijackProxy_C* MD_NaviHijackProxy;                                  // 0x0338 (size: 0x8)
    class UImage* RightArrow;                                                         // 0x0340 (size: 0x8)
    class UButton* RightButton;                                                       // 0x0348 (size: 0x8)
    class UTextBlock* TextBlock_0;                                                    // 0x0350 (size: 0x8)
    FMLDefaultSpinner_CButtonPressed ButtonPressed;                                   // 0x0358 (size: 0x10)
    void buttonPressed(FString Value);
    bool localize;                                                                    // 0x0368 (size: 0x1)
