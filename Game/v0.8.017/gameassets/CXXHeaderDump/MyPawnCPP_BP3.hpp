...
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x11E0 (size: 0x8)
    class UVAISMController* unitCreator_VAISMController_Bonus;                        // 0x11E8 (size: 0x8)
    class UVAISMController* unitCreator_VAISMController_Accessory;                    // 0x11F0 (size: 0x8)
    class UVAISMController* unitCreator_VAISMController_Shield;                       // 0x11F8 (size: 0x8)
    class UVAISMController* unitCreator_VAISMController_Helmet;                       // 0x1200 (size: 0x8)
    class UVAISMController* unitCreator_VAISMController_Head;                         // 0x1208 (size: 0x8)
    class UVAISMController* unitCreator_VAISMController_Weapon;                       // 0x1210 (size: 0x8)
    class UVAISMController* unitCreator_VAISMController_Body;                         // 0x1218 (size: 0x8)
    class UStaticMeshComponent* blurryFogCylinder_DISABLED;                           // 0x1220 (size: 0x8)
    class USceneCaptureComponent2D* unitCreator_SceneCaptureComponent2D;              // 0x1228 (size: 0x8)
    class UVARuntimeComponent* VARuntime_UnitPreview;                                 // 0x1230 (size: 0x8)
    class USceneComponent* dynamicAmbienceSystem;                                     // 0x1238 (size: 0x8)
    class UAudioComponent* CenB;                                                      // 0x1240 (size: 0x8)
    class UStaticMeshComponent* bbox_outlineCullPlane_DISABLED;                       // 0x1248 (size: 0x8)
    class UDecalComponent* moduleMaskDecal;                                           // 0x1250 (size: 0x8)
    class UAudioComponent* CenA;                                                      // 0x1258 (size: 0x8)
    class UAudioComponent* LeftB;                                                     // 0x1260 (size: 0x8)
    class UAudioComponent* RightB;                                                    // 0x1268 (size: 0x8)
    class UAudioComponent* RightA;                                                    // 0x1270 (size: 0x8)
    class UAudioComponent* LeftA;                                                     // 0x1278 (size: 0x8)
    class USceneCaptureComponent2D* thumbCapture;                                     // 0x1280 (size: 0x8)
    class UAudioComponent* StaticAmbience_HighWind;                                   // 0x1288 (size: 0x8)
    class UAudioComponent* music_leadingTrackB;                                       // 0x1290 (size: 0x8)
    class UAudioComponent* music_leadingTrackA;                                       // 0x1298 (size: 0x8)
    class USceneComponent* dynamicMusicSystem;                                        // 0x12A0 (size: 0x8)
    class USpotLightComponent* SpotLight;                                             // 0x12A8 (size: 0x8)
    class USpotLightComponent* SpotLight1;                                            // 0x12B0 (size: 0x8)
    class USceneComponent* unitCreator_Scene;                                         // 0x12B8 (size: 0x8)
    class UArrowComponent* Arrow;                                                     // 0x12C0 (size: 0x8)
    TEnumAsByte<ETimelineDirection::Type> Timeline_0__Direction_828BA552426AFD6A7E796CAB0E235D1F; // 0x12C8 (size: 0x1)
    class UTimelineComponent* Timeline_0;                                             // 0x12D0 (size: 0x8)
    TEnumAsByte<ETimelineDirection::Type> zoomTransition__Direction_4F8545034896CEEBF9D81587D9D4525A; // 0x12D8 (size: 0x1)
    class UTimelineComponent* zoomTransition;                                         // 0x12E0 (size: 0x8)
    float introSweepTimeline_prog_A142DBE24E482CF94AA1509BB14AC283;                   // 0x12E8 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> introSweepTimeline__Direction_A142DBE24E482CF94AA1509BB14AC283; // 0x12EC (size: 0x1)
    class UTimelineComponent* introSweepTimeline;                                     // 0x12F0 (size: 0x8)
    class UMainUICPP_C* mainUI;                                                       // 0x12F8 (size: 0x8)
    double bbox_scale_anim;                                                           // 0x1300 (size: 0x8)
    double bbox_scale_lerp;                                                           // 0x1308 (size: 0x8)
    double clickAnim;                                                                 // 0x1310 (size: 0x8)
    class UMaterialInstanceDynamic* highlight_materialinstance;                       // 0x1318 (size: 0x8)
    double gridRange;                                                                 // 0x1320 (size: 0x8)
    bool TownNamesUpdated;                                                            // 0x1328 (size: 0x1)
    bool HighlightAnimationRunning;                                                   // 0x1329 (size: 0x1)
    bool BLMB;                                                                        // 0x132A (size: 0x1)
    bool bRMB;                                                                        // 0x132B (size: 0x1)
    FVector2D RMBLast;                                                                // 0x1330 (size: 0x10)
    bool isUIHovered;                                                                 // 0x1340 (size: 0x1)
    bool isInventoryHovered;                                                          // 0x1341 (size: 0x1)
    TArray<class UquestItem_C*> questItems;                                           // 0x1348 (size: 0x10)
    double MMB_axis_0;                                                                // 0x1358 (size: 0x8)
    int32 lastDebrisSnd;                                                              // 0x1360 (size: 0x4)
    bool skipRMB;                                                                     // 0x1364 (size: 0x1)
    TArray<class UgenericAchievement_EventMessage_C*> progressUpdates;                // 0x1368 (size: 0x10)
    double timeCorrected;                                                             // 0x1378 (size: 0x8)
    double ctrlAxis;                                                                  // 0x1380 (size: 0x8)
    double deltaT;                                                                    // 0x1388 (size: 0x8)
    class ASMBuildingMaster* nullBuilding;                                            // 0x1390 (size: 0x8)
    bool UI setup Finished;                                                           // 0x1398 (size: 0x1)
    double startingPitch;                                                             // 0x13A0 (size: 0x8)
    double startingYaw;                                                               // 0x13A8 (size: 0x8)
    int32 inventoryAudioBType;                                                        // 0x13B0 (size: 0x4)
    bool ambienceSoundFound;                                                          // 0x13B4 (size: 0x1)
    TArray<int32> tutorialsShown;                                                     // 0x13B8 (size: 0x10)
    double desat;                                                                     // 0x13C8 (size: 0x8)
    class ASkyAtmosphere* atmFog;                                                     // 0x13D0 (size: 0x8)
    class ASkyLight* SkyLight;                                                        // 0x13D8 (size: 0x8)
    class ADirectionalLightActor_C* dirLight;                                         // 0x13E0 (size: 0x8)
    TArray<class UWidget*> oldQuestLog;                                               // 0x13E8 (size: 0x10)
    bool anyNewQuest;                                                                 // 0x13F8 (size: 0x1)
    int32 numTutMessages;                                                             // 0x13FC (size: 0x4)
    bool hasClickedAnyMainTab;                                                        // 0x1400 (size: 0x1)
    int32 lastHomeID;                                                                 // 0x1404 (size: 0x4)
    class APostProcessVolume* postProcess;                                            // 0x1408 (size: 0x8)
    TArray<class UMessageFullscreen_C*> MessageWidgets;                               // 0x1410 (size: 0x10)
    TArray<class UtutorialMessage_C*> TutorialMessages;                               // 0x1420 (size: 0x10)
    double timeCorrectedPrevFrame;                                                    // 0x1430 (size: 0x8)
    TArray<class UsquadWidget_C*> squadWidgets;                                       // 0x1438 (size: 0x10)
    bool scheduleSquadWidgetUpdate;                                                   // 0x1448 (size: 0x1)
    bool isHoveringOverUnitCard;                                                      // 0x1449 (size: 0x1)
    TEnumAsByte<DMS_Mood::Type> DMS_Mood;                                             // 0x144A (size: 0x1)
    TEnumAsByte<DMS_Mood::Type> DMS_PrevMood;                                         // 0x144B (size: 0x1)
    FDMS_Track DMS_CurrentLeadingTrack;                                               // 0x1450 (size: 0x30)
    double percentOfNextTransition;                                                   // 0x1480 (size: 0x8)
    class UDataTable* DMS_DT_Tracks;                                                  // 0x1488 (size: 0x8)
    double DMS_transition_treshold;                                                   // 0x1490 (size: 0x8)
    double DMS_last_transition_considertion;                                          // 0x1498 (size: 0x8)
    double DMS_last_track_change;                                                     // 0x14A0 (size: 0x8)
    double DMS_transition_offset_mul;                                                 // 0x14A8 (size: 0x8)
    double DMS_current_progress;                                                      // 0x14B0 (size: 0x8)
    bool DMS_usingBComponent;                                                         // 0x14B8 (size: 0x1)
    bool DMS_schedule_transition;                                                     // 0x14B9 (size: 0x1)
    class USoundBase* DMS_next_transition;                                            // 0x14C0 (size: 0x8)
    class UDataTable* DMS_DT_Transitions;                                             // 0x14C8 (size: 0x8)
    FDMS_Track DMS_nextProposedTrack;                                                 // 0x14D0 (size: 0x30)
    double DMS_currentTrackTime;                                                      // 0x1500 (size: 0x8)
    TArray<FDMS_Track> DMS_LastPlayedTracks;                                          // 0x1508 (size: 0x10)
    double DMS_lag;                                                                   // 0x1518 (size: 0x8)
    class UQuartzClockHandle* clock;                                                  // 0x1520 (size: 0x8)
    TArray<double> DMS_currentTransitionTImes;                                        // 0x1528 (size: 0x10)
    bool DMS_finalTransition;                                                         // 0x1538 (size: 0x1)
    TArray<class UWidget*> questsToRemove;                                            // 0x1540 (size: 0x10)
    double prevClearance;                                                             // 0x1550 (size: 0x8)
    bool smoothMapMode;                                                               // 0x1558 (size: 0x1)
    bool prevSmoothMapMode;                                                           // 0x1559 (size: 0x1)
    double smoothMapThreshold;                                                        // 0x1560 (size: 0x8)
    double zoomBeforeClickedMap;                                                      // 0x1568 (size: 0x8)
    int32 DMS_numTracksPlayed;                                                        // 0x1570 (size: 0x4)
    bool DMS_MoodChanged;                                                             // 0x1574 (size: 0x1)
    class ARegion* prevRegionUnderCursor;                                             // 0x1578 (size: 0x8)
    double lastRegionChangeSfx;                                                       // 0x1580 (size: 0x8)
    class UMessageFullscreen_C* lastMessagePlayed;                                    // 0x1588 (size: 0x8)
    TArray<FQueuedEventMessage> eventMsgQueue;                                        // 0x1590 (size: 0x10)
    TArray<EAmbienceType> DAS_CurrentAmbienceTypes;                                   // 0x15A0 (size: 0x10)
    class UDataTable* DT_Ambience;                                                    // 0x15B0 (size: 0x8)
    int32 DAS_LastDayChange;                                                          // 0x15B8 (size: 0x4)
    class USourceEffectFilterPreset* ambient_SC;                                      // 0x15C0 (size: 0x8)
    double DAS_Lowpass;                                                               // 0x15C8 (size: 0x8)
    class UReverbEffect* DAS_ReverbFX;                                                // 0x15D0 (size: 0x8)
    class AAudioVolume* DAS_ReverbVolume;                                             // 0x15D8 (size: 0x8)
    double previewGuy_newAnimPos;                                                     // 0x15E0 (size: 0x8)
    class AActor* mapPlane;                                                           // 0x15E8 (size: 0x8)
    class AFogBP_C* heightFog;                                                        // 0x15F0 (size: 0x8)
    class AActor* mapEdgeFade;                                                        // 0x15F8 (size: 0x8)
    TSoftObjectPtr<USoundBase> Last_Voiceline_Path;                                   // 0x1600 (size: 0x28)
    int32 chosenVoiceLineVariation;                                                   // 0x1628 (size: 0x4)
    FTimerHandle tutorialTimerHandle;                                                 // 0x1630 (size: 0x8)
    TArray<class ARegion*> allRegions;                                                // 0x1638 (size: 0x10)
    class UmainMenu_widget_C* pauseMenu;                                              // 0x1648 (size: 0x8)
    TArray<class UAudioComponent*> DAS_CurrentlyPlayingComponentForNode;              // 0x1650 (size: 0x10)
    TArray<double> DAS_PrevFadeInTimes;                                               // 0x1660 (size: 0x10)
    class UAudioComponent* DAS_newCurrentComponent;                                   // 0x1670 (size: 0x8)
    double DAS_fadeTime;                                                              // 0x1678 (size: 0x8)
    bool command_setSprintMode;                                                       // 0x1680 (size: 0x1)
    FVector cinematic_actorPositionAboveGround;                                       // 0x1688 (size: 0x18)
    double gameSpeedBeforeEnginePause;                                                // 0x16A0 (size: 0x8)
    double gameSpeedBeforeMapView;                                                    // 0x16A8 (size: 0x8)
    FTimerHandle updateFloatersTimerHandle;                                           // 0x16B0 (size: 0x8)
    class AActor* starDome;                                                           // 0x16B8 (size: 0x8)
    bool UI_assignmentMode_BP;                                                        // 0x16C0 (size: 0x1)
    bool UI_assignmentModeChanged;                                                    // 0x16C1 (size: 0x1)
    FTimerHandle autosaveHandle;                                                      // 0x16C8 (size: 0x8)
    int32 AmbientNodeLoopIndex;                                                       // 0x16D0 (size: 0x4)
    FDMS_Track DMS_PreviousTrack;                                                     // 0x16D8 (size: 0x30)
    bool everChangedGameSpeed;                                                        // 0x1708 (size: 0x1)
    double gameSpeed3_value;                                                          // 0x1710 (size: 0x8)
    TArray<FQueuedPopup> queuedPopups;                                                // 0x1718 (size: 0x10)
    bool triggeredVisitMode;                                                          // 0x1728 (size: 0x1)
    TArray<class AActor*> landscapeMeshActors;                                        // 0x1730 (size: 0x10)
    class ASkyAtmosphereClouds_Blueprint_C* SkyAtmosphereCloudBP;                     // 0x1740 (size: 0x8)
    class UMaterialInstanceDynamic* paperMapMaterialinstance;                         // 0x1748 (size: 0x8)
    TArray<class AStaticMeshActor*> fogPlanes;                                        // 0x1750 (size: 0x10)

    void SaveToDiskWithThumbnail(FString SlotName, FString OverrideSaveName);
    void Set Water Texture In Paper Map Material(const class UTextureRenderTarget2D* WaterInfoTexture);
    void setupPaperMapMaterialInstance();
    bool isPauseMenuVisible();
    void formatTutorialText(FName RowName, FText& tutorialText);
