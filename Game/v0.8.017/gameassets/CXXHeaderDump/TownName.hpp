...
class UTownName_C : public UUserWidget
{
    ...
    class UButton* diplo_button;                                                      // 0x02F0 (size: 0x8)
    class UlevelButton_C* levelButton;                                                // 0x02F8 (size: 0x8)
    class UImage* ownerEmblem;                                                        // 0x0300 (size: 0x8)
    class UCanvasPanel* ribbon_Canvas;                                                // 0x0308 (size: 0x8)
    class UEditableText* TownName_Editable;                                           // 0x0310 (size: 0x8)
    class UTextBlock* TownName_Fixed;                                                 // 0x0318 (size: 0x8)
    class ASMBuildingMaster* building;                                                // 0x0320 (size: 0x8)
    TArray<class UButton*> buttons;                                                   // 0x0328 (size: 0x10)
    bool ownedByMainPlayer;                                                           // 0x0338 (size: 0x1)
    class ARegion* Region;                                                            // 0x0340 (size: 0x8)
    bool hasManor;                                                                    // 0x0348 (size: 0x1)
    bool selectedByPlayer;                                                            // 0x0349 (size: 0x1)
    bool hoveredByPlayer;                                                             // 0x034A (size: 0x1)
