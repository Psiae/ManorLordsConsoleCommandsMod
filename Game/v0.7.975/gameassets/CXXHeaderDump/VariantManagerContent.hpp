...
{
    FSoftObjectPath LevelVariantSets;                                                 // 0x0220 (size: 0x18)
    TMap<class UClass*, class ULevelVariantSetsFunctionDirector*> DirectorInstances;  // 0x0238 (size: 0x50)
...
class ASwitchActor : public AActor
{
    ...
    int32 LastSelectedOption;                                                         // 0x0240 (size: 0x4)
