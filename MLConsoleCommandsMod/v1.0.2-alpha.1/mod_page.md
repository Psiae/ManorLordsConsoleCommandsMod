...
- k.removeDepositAtCursor &nbsp;&nbsp; \<typeID>
    - Remove Deposit identified by <ins>typeID</ins> under **Player** cursor<br/><br/>
...
- k.addGrowthForPlantsOnRegion &nbsp;&nbsp; \<plantID> &nbsp; \<amount>
    - Increase / decrease the **growth** of Plants identified by <ins>typeID</ins> on **Current Region** by <ins>amount</ins><br/><br/>

    - **growth** is in percent ( % ), will be coerced between `10` and `100`<br/><br/>

    - **<ins>plantID</ins>**
      - "apple"<br/><br/>

    - **<ins>amount</ins>** must be an integer or decimal between `-100` .. `100`<br/><br/><br/><br/>


- k.coerceGrowthForPlantsOnRegion &nbsp;&nbsp; \<plantID> &nbsp; \<amount>
    - Coerce the **growth** of Plants identified by <ins>typeID</ins> on **Current Region** to be at least <ins>amount</ins><br/><br/>

    - **growth** is in percent ( % )<br/><br/>

    - **<ins>plantID</ins>**
      - "apple"<br/><br/>

  - **<ins>amount</ins>** must be an integer or decimal between `10` .. `100`<br/><br/><br/><br/>
