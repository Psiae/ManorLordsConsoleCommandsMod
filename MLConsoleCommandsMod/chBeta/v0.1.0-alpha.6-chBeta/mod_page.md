### Mod Page (v0.1.0-alpha.6-chBeta)
<br/><br/>
...
- k.removeDepositAtCursor &nbsp;&nbsp; \<depositID>
    ...
    - To see updated icon: save and load the game<br/><br/><br/><br/>
...
- k.markNormalWildAnimalsAtCursor
    ...
    - To see updated decal on the Paper Map: save and load the game<br/><br/><br/><br/>
