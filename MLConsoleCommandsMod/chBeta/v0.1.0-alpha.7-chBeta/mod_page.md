...
- k.addDepositAtCursor &nbsp;&nbsp; \<depositID> &nbsp; \<amount>
    - Add <ins>amount</ins> to deposit identified by <ins>depositID</ins> at location under player cursor<br/><br/>
...
- k.markNormalDepositAtCursor &nbsp;&nbsp; \<depositID>
    - mark deposit identified by <ins>depositID</ins> at location under player cursor as **Normal** type deposit<br/><br/>
...
- k.markRichDepositAtCursor &nbsp;&nbsp; \<depositID>
    - mark deposit identified by <ins>depositID</ins> at location under player cursor as **Rich** type deposit<br/><br/>
...
- k.removeDepositAtCursor &nbsp;&nbsp; \<depositID>
    - remove deposit identified by <ins>depositID</ins> at location under player cursor<br/><br/>
    ...
    - <ins>depositID</ins>=stone
        - If resource clump still exist above the deposit then marked as non-rich instead.<br/><br/>

    - **Warning**: pause the game while modifying, save and load the game when done<br/><br/><br/><br/>


- k.spawnDepositAtCursor &nbsp;&nbsp; \<depositID>
    - spawn deposit identified by <ins>depositID</ins> at location under player cursor<br/><br/>
...
- k.markNormalResourceClumpAtCursor &nbsp;&nbsp; \<resID>
    - mark resource clump identified by <ins>resID</ins> at location under player cursor as **Normal** type resource<br/><br/>
...
- k.markRichResourceClumpAtCursor &nbsp;&nbsp; \<resID>
    - mark resource clump identified by <ins>depositID</ins> at location under player cursor as **Rich** type resource<br/><br/>
...
- k.spawnResourceAtCursor &nbsp;&nbsp; \<resID>
    ...
    - **Warning**: pause the game while modifying, save and load the game when done<br/><br/>

    - If there is an existing node of the same type within **23 meter** radius then the spawned resource will join that node **resource clump**, else a new node will be spawned at that location.<br/><br/><br/><br/>
...
- k.addCapacityToWildAnimalsAtCursor  &nbsp;&nbsp; \<amount>
    - Increase/Decrease capacity of **Wild Animals** under Player cursor by <ins>amount</ins><br/><br/>

    - resulting capacity is coerced between 1..1024<br/><br/><br/><br/>


- k.breedWildAnimalsAtCursor
    - Breed the animals in **Wild Animals** under Player cursor<br/><br/>


- k.markNormalWildAnimalsAtCursor
    - mark **Wild Animals** at location under player cursor as **Normal** type<br/><br/>


- k.markRichWildAnimalsAtCursor
    - mark **Wild Animals** at location under player cursor as **Rich** type<br/><br/>


- k.removeRichWildAnimalsAtCursor
    - remove **Wild Animals** at location under Player cursor<br/><br/>
