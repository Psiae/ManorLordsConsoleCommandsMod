...
struct FMediaPlayerOptions
{
    ...
    EMediaPlayerOptionTrackSelectMode TrackSelection;                                 // 0x001C (size: 0x1)
    FTimespan SeekTime;                                                               // 0x0020 (size: 0x8)
    EMediaPlayerOptionSeekTimeType SeekTimeType;                                      // 0x0028 (size: 0x1)
    EMediaPlayerOptionBooleanOverride PlayOnOpen;                                     // 0x0029 (size: 0x1)
    EMediaPlayerOptionBooleanOverride Loop;                                           // 0x002A (size: 0x1)
