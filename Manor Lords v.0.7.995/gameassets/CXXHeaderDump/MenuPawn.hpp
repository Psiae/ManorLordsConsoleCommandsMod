...
class AMenuPawn_C : public AMenuPawn
{
    ...
    TEnumAsByte<ETimelineDirection::Type> setDefaultAA__Direction_D3EF9C61458491A93D560ABCAEAB8CF8; // 0x0338 (size: 0x1)
    class UTimelineComponent* setDefaultAA;                                           // 0x0340 (size: 0x8)
