...
class UsettlementTypeButton_C : public UUserWidget
{
    ...
    class UMLDefaultSpinner_C* MLDefaultSpinner;                                      // 0x0308 (size: 0x8)
    class USizeBox* outpostMotherSelector;                                            // 0x0310 (size: 0x8)
    class UTextBlock* TextBlock_294;                                                  // 0x0318 (size: 0x8)
    class UMaterialInterface* Material;                                               // 0x0320 (size: 0x8)
    FsettlementTypeButton_COnButtonPressed onButtonPressed;                           // 0x0328 (size: 0x10)
    void onButtonPressed();
    ESettlementType settlementType;                                                   // 0x0338 (size: 0x1)
    FsettlementTypeButton_CRegionChanged regionChanged;                               // 0x0340 (size: 0x10)
