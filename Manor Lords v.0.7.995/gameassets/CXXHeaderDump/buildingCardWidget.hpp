...
class UbuildingCardWidget_C : public UNaviUi
{
    ...
    class UVerticalBox* VerticalBox_2;                                                // 0x03A0 (size: 0x8)
    int32 ID;                                                                         // 0x03A8 (size: 0x4)
    int32 cat;                                                                        // 0x03AC (size: 0x4)
    bool show;                                                                        // 0x03B0 (size: 0x1)
    class UTexture2D* buildingCard;                                                   // 0x03B8 (size: 0x8)
    ...
    int32 minSettlementLevel;                                                         // 0x0418 (size: 0x4)
