...
class UfullscreenConfirmationGeneric_C : public UNaviSubGrid
{
    ...
    class UmenuButton_C* No;                                                          // 0x0358 (size: 0x8)
    class UTextBlock* TextBlock_0;                                                    // 0x0360 (size: 0x8)
    class UmenuButton_C* Yes;                                                         // 0x0368 (size: 0x8)
    FfullscreenConfirmationGeneric_COnDecision onDecision;                            // 0x0370 (size: 0x10)
    void onDecision(bool confirmed);
    FName questionKey;                                                                // 0x0380 (size: 0x8)
