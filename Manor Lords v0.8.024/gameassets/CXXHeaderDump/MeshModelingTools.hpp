...
{
    class UCurveControlPointsMechanic* ControlPointsMechanic;                         // 0x0128 (size: 0x8)
    class UConstructionPlaneMechanic* PlaneMechanic;                                  // 0x0130 (size: 0x8)
    class UCreateMeshObjectTypeProperties* OutputTypeProperties;                      // 0x0138 (size: 0x8)
    class URevolveToolProperties* Settings;                                           // 0x0140 (size: 0x8)
    class UNewMeshMaterialProperties* MaterialProperties;                             // 0x0148 (size: 0x8)
    class UMeshOpPreviewWithBackgroundCompute* Preview;                               // 0x0150 (size: 0x8)
...
class UDrawPolygonTool : public UInteractiveTool
{
    ...
    class UPlaneDistanceFromHitMechanic* HeightMechanic;                              // 0x0528 (size: 0x8)
    class UDragAlignmentMechanic* DragAlignmentMechanic;                              // 0x0530 (size: 0x8)
    class UConstructionPlaneMechanic* PlaneMechanic;                                  // 0x0538 (size: 0x8)
