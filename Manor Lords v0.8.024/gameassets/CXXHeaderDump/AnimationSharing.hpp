...
{
    TWeakObjectPtr<class USkeletalMeshComponent> BaseComponent;                       // 0x0368 (size: 0x8)
    TWeakObjectPtr<class UAnimSequence> AdditiveAnimation;                            // 0x0370 (size: 0x8)
    float Alpha;                                                                      // 0x0378 (size: 0x4)
    bool bStateBool;                                                                  // 0x037C (size: 0x1)
...
{
    class UAnimSequence* AnimationToPlay;                                             // 0x0368 (size: 0x8)
    float PermutationTimeOffset;                                                      // 0x0370 (size: 0x4)
    float PlayRate;                                                                   // 0x0374 (size: 0x4)
    bool bStateBool;                                                                  // 0x0378 (size: 0x1)
    class UAnimSharingInstance* Instance;                                             // 0x0380 (size: 0x8)
...
{
    TWeakObjectPtr<class USkeletalMeshComponent> FromComponent;                       // 0x0368 (size: 0x8)
    TWeakObjectPtr<class USkeletalMeshComponent> ToComponent;                         // 0x0370 (size: 0x8)
    float BlendTime;                                                                  // 0x0378 (size: 0x4)
    bool bBlendBool;                                                                  // 0x037C (size: 0x1)
