...
class UgoodStat_C : public UUserWidget
{
    ...
    int32 amt;                                                                        // 0x0348 (size: 0x4)
    bool bunchedGoods;                                                                // 0x034C (size: 0x1)
    TArray<int32> goodTypes;                                                          // 0x0350 (size: 0x10)
    class UTexture2D* customIcon;                                                     // 0x0360 (size: 0x8)
    FString CustomName;                                                               // 0x0368 (size: 0x10)
    bool showNextHarvestForGood;                                                      // 0x0378 (size: 0x1)
    int32 previousDayValue;                                                           // 0x037C (size: 0x4)
    int32 previousUpdateDay;                                                          // 0x0380 (size: 0x4)
    int32 currentDay;                                                                 // 0x0384 (size: 0x4)
    double increase;                                                                  // 0x0388 (size: 0x8)
