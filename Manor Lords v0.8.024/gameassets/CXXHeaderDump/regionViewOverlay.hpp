...
class UregionViewOverlay_C : public UNaviSubGrid
{
    ...
    class UMD_NaviConsoleCursor_C* MD_NaviConsoleCursor;                              // 0x04A0 (size: 0x8)
    class UOverlay* Navi_FakeCursorParent;                                            // 0x04A8 (size: 0x8)
    class UMD_NaviAutoButton_C* naviBtn_claimByFavor;                                 // 0x04B0 (size: 0x8)
    class UMD_NaviAutoButton_C* naviBtn_claimByInfluence;                             // 0x04B8 (size: 0x8)
    class UMD_NaviHijackProxy_C* NaviHijack_SelectRegion;                             // 0x04C0 (size: 0x8)
    class UImage* overlayThingy;                                                      // 0x04C8 (size: 0x8)
    class UpawnButton_C* pawnButton;                                                  // 0x04D0 (size: 0x8)
    class UTextBlock* policyTime_txt_1;                                               // 0x04D8 (size: 0x8)
    class UHorizontalBox* portraits_HB;                                               // 0x04E0 (size: 0x8)
    class UVerticalBox* RegionDetails_VB;                                             // 0x04E8 (size: 0x8)
    class UBorder* regionDetailsBorder;                                               // 0x04F0 (size: 0x8)
    class UHorizontalBox* regionName_bar;                                             // 0x04F8 (size: 0x8)
    class UEditableText* regionName_Editable;                                         // 0x0500 (size: 0x8)
    class UTextBlock* regionName_text;                                                // 0x0508 (size: 0x8)
    class UImage* regionOwnerColorBanner;                                             // 0x0510 (size: 0x8)
    class UVerticalBox* regionOwnership_VB;                                           // 0x0518 (size: 0x8)
    class UNamedSlot* tradeTargetsUI_C_1;                                             // 0x0520 (size: 0x8)
    class UImage* vignette;                                                           // 0x0528 (size: 0x8)
    class UButton* war_button;                                                        // 0x0530 (size: 0x8)
    class UTextBlock* war_cost;                                                       // 0x0538 (size: 0x8)
    class UlocalizedTextBox_C* you_own_this;                                          // 0x0540 (size: 0x8)
    class AMyPawnCPP_BP3_C* playerRef;                                                // 0x0548 (size: 0x8)
    class ARegion* selectedRegion;                                                    // 0x0550 (size: 0x8)
    bool selectedRegionIsClaimable;                                                   // 0x0558 (size: 0x1)
    bool canDeclareWar;                                                               // 0x0559 (size: 0x1)
    bool isBeingClaimed;                                                              // 0x055A (size: 0x1)
    bool isOwned;                                                                     // 0x055B (size: 0x1)
    FName confirmTag;                                                                 // 0x055C (size: 0x8)
    TArray<class UpawnButton_C*> pawnPortraits;                                       // 0x0568 (size: 0x10)
    bool canAffordClaimWithInfluence;                                                 // 0x0578 (size: 0x1)
    double smoothLerpValue;                                                           // 0x0580 (size: 0x8)
    bool enemiesPresentInSelectedRegion;                                              // 0x0588 (size: 0x1)
