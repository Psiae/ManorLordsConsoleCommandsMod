...
class UstorageFilterCategory_C : public UUserWidget
{
    ...
    class UMD_NaviAutoButton_C* MD_NaviAutoButton_127;                                // 0x0320 (size: 0x8)
    TArray<int32> typesOfGoods;                                                       // 0x0328 (size: 0x10)
    FName category_name;                                                              // 0x0338 (size: 0x8)
    EItemCategory Category;                                                           // 0x0340 (size: 0x1)
    EStorageType storageType;                                                         // 0x0341 (size: 0x1)
    class ASMBuildingMaster* building;                                                // 0x0348 (size: 0x8)
    TArray<int32> maretkplaceDistributableNonFoodItems;                               // 0x0350 (size: 0x10)
