#ifndef UE4SS_SDK_High_Peaks_HPP
#define UE4SS_SDK_High_Peaks_HPP

class AHigh_Peaks_C : public ALevelScriptActor
{
    ...
    void ExecuteUbergraph_High_Peaks(int32 EntryPoint);
}; // Size: 0x2D0
