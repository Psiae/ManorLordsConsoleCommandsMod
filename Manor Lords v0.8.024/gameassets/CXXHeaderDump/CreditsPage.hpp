...
class UCreditsPage_C : public UNaviSubGrid
{
    ...
    void OnDone();
    double RollTime;                                                                  // 0x03B0 (size: 0x8)
    double EndTime;                                                                   // 0x03B8 (size: 0x8)
    double Time;                                                                      // 0x03C0 (size: 0x8)
    bool InSetup;                                                                     // 0x03C8 (size: 0x1)
    TArray<FCreditsLine> PendingCreditLines;                                          // 0x03D0 (size: 0x10)
    int32 PerFrameCreationCount;                                                      // 0x03E0 (size: 0x4)
    FString Raw Credits Source;                                                       // 0x03E8 (size: 0x10)
